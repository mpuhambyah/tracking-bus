...
function (e, t) {
	...
	return function (e) {
		...
		class n extends Error {
			constructor(e, t, i) {
				super(`${e}${i?" "+JSON.stringify(i):""}${r(e)}`), this.name = "CKEditorError", this.context = t, this.data = i
			}
			is(e) {
		...
		function p(e, t) {
			...
			if (t.singleton) {
				var r = m++;
				i = g || (g = l(t)), n = h.bind(null, i, r, !1), o = h.bind(null, i, r, !0)
			} else i = l(t), n = f.bind(null, i, t), o = function () {
				! function (e) {
		...
		(function (e) {
			var n = i(3),
				...
				a = s && s.exports === r ? n.a.Buffer : void 0,
		...
		(function (e) {
			var t = i(0);
			const n = "object" == typeof window ? window : e;
			if (n.CKEDITOR_VERSION) throw new t.a("ckeditor-duplicated-modules", null);
			n.CKEDITOR_VERSION = "27.0.0"
		}).call(this, i(11))
	}, function (e, t, i) {
		var n = i(1),
			o = i(75);
		...
		(function (e) {
			var n = i(3),
				o = "object" == typeof exports && exports && !exports.nodeType && exports,
				r = o && "object" == typeof e && e && !e.nodeType && e,
				s = r && r.exports === o ? n.a.Buffer : void 0,
		...
		e.exports = ".ck-content .image{display:table;clear:both;text-align:center;margin:1em auto}.ck-content .image img{display:block;margin:0 auto;max-width:100%;min-width:50px}.ck.ck-editor__editable .image>figcaption.ck-placeholder:before{position:static}"
	}, function (e, t, i) {
		var n = i(1),
			o = i(79);
		"string" == typeof (o = o.__esModule ? o.default : o) && (o = [
		...
		e.exports = ".ck .ck-link_selected{background:var(--ck-color-link-selected-background)}.ck .ck-fake-link-selection{background:var(--ck-color-link-fake-selection)}.ck .ck-fake-link-selection_collapsed{height:100%;border-right:1px solid var(--ck-color-base-text);margin-right:-1px;outline:1px solid hsla(0,0%,100%,.5)}"
	}, function (e, t, i) {
		var n = i(1),
			o = i(91);
		"string" == typeof (o = o.__esModule ? o.default : o) && (o = [
		...
		e.exports = ".ck-content .table{margin:1em auto;display:table}.ck-content .table table{border-collapse:collapse;border-spacing:0;width:100%;height:100%;border:1px double #b3b3b3}.ck-content .table table td,.ck-content .table table th{min-width:2em;padding:.4em;border:1px solid #bfbfbf}.ck-content .table table th{font-weight:700;background:hsla(0,0%,0%,5%)}.ck-content[dir=rtl] .table th{text-align:right}.ck-content[dir=ltr] .table th{text-align:left}"
	}, function (e, t, i) {
		"use strict";
		...
		class o {
			constructor(e, t) {
				this.source = e, this.name = t, this.path = [], this.stop = n(), this.off = n()
			}
		}
		const r = new Array(256).fill().map((e, t) => ("0" + t.toString(16)).slice(-2));
		...
		function s() {
			...
			return "e" + r[e >> 0 & 255] + r[e >> 8 & 255] + r[e >> 16 & 255] + r[e >> 24 & 255] + r[t >> 0 & 255] + r[t >> 8 & 255] + r[t >> 16 & 255] + r[t >> 24 & 255] + r[i >> 0 & 255] + r[i >> 8 & 255] + r[i >> 16 & 255] + r[i >> 24 & 255] + r[n >> 0 & 255] + r[n >> 8 & 255] + r[n >> 16 & 255] + r[n >> 24 & 255]
		}
		var a = {
				get(e) {
		...
		var u = {
			...
			once(e, t, i) {
				let n = !1;
				this.listenTo(this, e, (function (e, ...i) {
			...
			listenTo(e, t, i, n = {}) {
				...
				(o = s[a]) || (o = s[a] = {
					emitter: e,
					callbacks: {}
				}), (r = o.callbacks[t]) || (r = o.callbacks[t] = []), r.push(i),
					function (e, t, i, n, o) {
			...
			stopListening(e, t, i) {
				...
				if (!(!n || e && !r || t && !s))
					if (i) {
						b(this, e, t, i); - 1 !== s.indexOf(i) && (1 === s.length ? delete r.callbacks[t] : b(this, e, t, i))
					} else if (s) {
					for (; i = s.pop();) b(this, e, t, i);
			...
			fire(e, ...t) {
				try {
					const i = e instanceof o ? e : new o(this, e),
						n = i.name;
					...
					if (i.path.push(this), r) {
						const e = [i, ...t];
						r = Array.from(r);
						for (let t = 0; t < r.length && (r[t].callback.apply(this, e), i.off.called && (delete i.off.called, this._removeEventListener(n, r[t].callback)), !i.stop.called); t++);
					}
			...
			delegate(...e) {
				return {
					to: (t, i) => {
						this._delegations || (this._delegations = new Map), e.forEach(e => {
							const n = this._delegations.get(e);
							n ? n.set(t, i) : this._delegations.set(e, new Map([
								[t, i]
							]))
						})
					}
			...
			_removeEventListener(e, t) {
				const i = m(this, e);
				for (const e of i)
					for (let i = 0; i < e.length; i++) e[i].callback == t && (e.splice(i, 1), i--)
			}
		};
		...
		function p(e, t, i) {
			for (let [n, r] of e) {
				r ? "function" == typeof r && (r = r(t.name)) : r = t.name;
				const e = new o(t.source, r);
		...
		var S = function (e) {
			return null == e ? void 0 === e ? "[object Undefined]" : "[object Null]" : P && P in Object(e) ? C(e) : E(e)
		};
		var M, I = function (e) {
				if (!w(e)) return !1;
				var t = S(e);
			...
			R = (M = /[^.]+$/.exec(N && N.keys && N.keys.IE_PROTO || "")) ? "Symbol(src)_1." + M : "";
		var O = function (e) {
				return !!R && R in e
			},
		...
		var L = function (e) {
			...
			B = V.toString,
			F = j.hasOwnProperty,
			H = RegExp("^" + B.call(F).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
		var U = function (e) {
			return !(!w(e) || O(e)) && (I(e) ? H : z).test(L(e))
		};
		var W = function (e, t) {
		...
		var Q = function (e, t, i) {
			var n = e[t];
			K.call(e, t) && G(n, i) && (void 0 !== i || t in e) || Y(e, t, i)
		};
		var J = function (e, t, i, n) {
			...
			for (var r = -1, s = t.length; ++r < s;) {
				var a = t[r],
					c = n ? n(i[a], e[a], a, i, e) : void 0;
				void 0 === c && (c = e[a]), o ? Y(i, a, c) : Q(i, a, c)
			}
			return i
		};
		var Z = function (e) {
		...
		var te = function (e, t, i) {
			return t = ee(void 0 === t ? e.length - 1 : t, 0),
				function () {
					for (var n = arguments, o = -1, r = ee(n.length - t, 0), s = Array(r); ++o < r;) s[o] = n[t + o];
					o = -1;
					for (var a = Array(t + 1); ++o < t;) a[o] = n[o];
					return a[t] = i(s), X(e, this, a)
				}
		};
		var ie = function (e) {
				return function () {
		...
		var se = function (e, t) {
			return re(te(e, t, Z), e + "")
		};
		var ae = function (e) {
			return "number" == typeof e && e > -1 && e % 1 == 0 && e <= 9007199254740991
		};
		var ce = function (e) {
				return null != e && ae(e.length) && !I(e)
			},
			le = /^(?:0|[1-9]\d*)$/;
		var de = function (e, t) {
			var i = typeof e;
		...
		var ue = function (e, t, i) {
			if (!w(i)) return !1;
			var n = typeof t;
			return !!("number" == n ? ce(i) && de(t, i.length) : "string" == n && t in i) && G(i[t], e)
		};
		var he = function (e) {
			return se((function (t, i) {
				var n = -1,
					...
					r = o > 1 ? i[o - 1] : void 0,
					s = o > 2 ? i[2] : void 0;
				for (r = e.length > 3 && "function" == typeof r ? (o--, r) : void 0, s && ue(i[0], i[1], s) && (r = o < 3 ? void 0 : r, o = 1), t = Object(t); ++n < o;) {
					var a = i[n];
					a && e(t, a, n, r)
				}
				return t
		...
		var me = function (e) {
				return ge(e) && "[object Arguments]" == S(e)
			},
			pe = Object.prototype,
			be = pe.hasOwnProperty,
			we = pe.propertyIsEnumerable,
			ke = me(function () {
				return arguments
			}()) ? me : function (e) {
				return ge(e) && be.call(e, "callee") && !we.call(e, "callee")
			},
			_e = Array.isArray,
			ve = i(4),
			ye = {};
		...
		var xe = function (e) {
			return ge(e) && ae(e.length) && !!ye[S(e)]
		};
		var Ae = function (e) {
				return function (t) {
					return e(t)
		...
		var Se = function (e, t) {
				var i = _e(e),
					...
					r = !i && !n && !o && Ee(e),
					s = i || n || o || r,
					a = s ? fe(e.length, String) : [],
					c = a.length;
				for (var l in e) !t && !Pe.call(e, l) || s && ("length" == l || o && ("offset" == l || "parent" == l) || r && ("buffer" == l || "byteLength" == l || "byteOffset" == l) || de(l, c)) || a.push(l);
				return a
			},
			Me = Object.prototype;
		var Ie = function (e) {
		...
		var Oe = function (e) {
			...
			var t = Ie(e),
				i = [];
			for (var n in e)("constructor" != n || !t && Re.call(e, n)) && i.push(n);
			return i
		};
		var De = function (e) {
				return ce(e) ? Se(e, !0) : Oe(e)
			},
			Le = he((function (e, t) {
				J(t, De(t), e)
			}));
		const ze = Symbol("observableProperties"),
			Ve = Symbol("boundObservables"),
			je = Symbol("boundProperties"),
			Be = Symbol("decoratedMethods"),
			Fe = Symbol("decoratedOriginal"),
			He = {
				set(e, t) {
					if (w(e)) return void Object.keys(e).forEach(t => {
						this.set(t, e[t])
					}, this);
					We(this);
					const i = this[ze];
					if (e in this && !i.has(e)) throw new c.a("observable-set-cannot-override", this);
				...
				bind(...e) {
					if (!e.length || !Ye(e)) throw new c.a("observable-bind-wrong-properties", this);
					if (new Set(e).size !== e.length) throw new c.a("observable-bind-duplicate-properties", this);
					We(this);
					const t = this[je];
					e.forEach(e => {
						if (t.has(e)) throw new c.a("observable-bind-rebind", this)
					});
					const i = new Map;
					return e.forEach(e => {
						const n = {
				...
				unbind(...e) {
					...
					const t = this[je],
						i = this[Ve];
					if (e.length) {
						if (!Ye(e)) throw new c.a("observable-unbind-wrong-properties", this);
						e.forEach(e => {
							const n = t.get(e);
							if (!n) return;
							let o, r, s, a;
							n.to.forEach(e => {
								o = e[0], r = e[1], s = i.get(o), a = s[r], a.delete(n), a.size || delete s[r], Object.keys(s).length || (i.delete(o), this.stopListening(o, "change"))
							}), t.delete(e)
						})
					} else i.forEach((e, t) => {
				...
				decorate(e) {
					...
					}, this[e][Fe] = t, this[Be] || (this[Be] = []), this[Be].push(e)
				}
			};
		Le(He, u), He.stopListening = function (e, t, i) {
			if (!e && this[Be]) {
				for (const e of this[Be]) this[e] = this[e][Fe];
				delete this[Be]
			}
			u.stopListening.call(this, e, t, i)
		};
		var Ue = He;

		function We(e) {
			e[ze] || (Object.defineProperty(e, ze, {
				value: new Map
		...
		function qe(...e) {
			...
			if (n > 1 && t.callback) throw new c.a("observable-bind-to-extra-callback", this);
			var o;
			t.to.forEach(e => {
					if (e.properties.length && e.properties.length !== n) throw new c.a("observable-bind-to-properties-length", this);
					e.properties.length || (e.properties = this._bindProperties)
				}), this._to = t.to, t.callback && (this._bindings.get(i[0]).callback = t.callback), o = this._observable, this._to.forEach(e => {
					const t = o[Ve];
					let i;
					t.get(e.observable) || o.listenTo(e.observable, "change", (n, r) => {
						i = t.get(e.observable)[r], i && i.forEach(e => {
							Ge(o, e.property)
						})
					})
				}),
				function (e) {
					...
					e._bindings.forEach((i, n) => {
						e._to.forEach(o => {
							t = o.properties[i.callback ? 0 : e._bindProperties.indexOf(n)], i.to.push([o.observable, t]),
								function (e, t, i, n) {
									const o = e[Ve],
										r = o.get(i),
										s = r || {};
									s[n] || (s[n] = new Set);
									s[n].add(t), r || o.set(i, s)
								}(e._observable, i, o.observable, t)
						})
					})
				}(this), this._bindProperties.forEach(e => {
					Ge(this._observable, e)
				})
		}
		...
		function Ge(e, t) {
			const i = e[je].get(t);
			let n;
			i.callback ? n = i.callback.apply(e, i.to.map(e => e[0][e[1]])) : (n = i.to[0], n = n[0][n[1]]), Object.prototype.hasOwnProperty.call(e, t) ? e[t] = n : e.set(t, n)
		}

		function Ke(e, ...t) {
			t.forEach(t => {
				Object.getOwnPropertyNames(t).concat(Object.getOwnPropertySymbols(t)).forEach(i => {
		...
		class Ze {
			constructor(e) {
				this.editor = e, this.set("value", void 0), this.set("isEnabled", !1), this._disableStack = new Set, this.decorate("execute"), this.listenTo(this.editor.model.document, "change", () => {
					this.refresh()
				}), this.on("execute", e => {
		...
		class et extends Ze {
			...
			refresh() {}
			execute(...e) {
				return this._getFirstEnabledCommand().execute(e)
			}
			registerChildCommand(e) {
				this._childCommands.push(e), e.on("change:isEnabled", () => this._checkEnabled()), this._checkEnabled()
			}
			_checkEnabled() {
		...
		var tt = function (e, t) {
			...
			it = tt(Object.getPrototypeOf, Object),
			...
			at = rt.call(Object);
		var ct = function (e) {
			if (!ge(e) || "[object Object]" != S(e)) return !1;
			var t = it(e);
			if (null === t) return !0;
			var i = st.call(t, "constructor") && t.constructor;
			return "function" == typeof i && i instanceof i && rt.call(i) == at
		};
		var lt = function () {
		...
		var dt = function (e, t) {
				for (var i = e.length; i--;)
					if (G(e[i][0], t)) return i;
				return -1
			},
			ut = Array.prototype.splice;
		var ht = function (e) {
			var t = this.__data__,
				i = dt(t, e);
			return !(i < 0) && (i == t.length - 1 ? t.pop() : ut.call(t, i, 1), --this.size, !0)
		};
		var ft = function (e) {
			var t = this.__data__,
				i = dt(t, e);
		...
		pt.prototype.clear = lt, pt.prototype.delete = ht, pt.prototype.get = ft, pt.prototype.has = gt, pt.prototype.set = mt;
		var bt = pt;
		var wt = function () {
		...
		var St = function (e) {
			var t = this.__data__;
			return xt ? void 0 !== t[e] : Pt.call(t, e)
		};
		var Mt = function (e, t) {
			var i = this.__data__;
			return this.size += this.has(e) ? 0 : 1, i[e] = xt && void 0 === t ? "__lodash_hash_undefined__" : t, this
		};
		...
		It.prototype.clear = At, It.prototype.delete = Ct, It.prototype.get = Et, It.prototype.has = St, It.prototype.set = Mt;
		var Nt = It;
		var Rt = function () {
		...
		var Dt = function (e, t) {
			var i = e.__data__;
			return Ot(t) ? i["string" == typeof t ? "string" : "hash"] : i.map
		};
		var Lt = function (e) {
		...
		Bt.prototype.clear = Rt, Bt.prototype.delete = Lt, Bt.prototype.get = zt, Bt.prototype.has = Vt, Bt.prototype.set = jt;
		var Ft = Bt;
		var Ht = function (e, t) {
			var i = this.__data__;
			if (i instanceof bt) {
				var n = i.__data__;
				if (!yt || n.length < 199) return n.push([e, t]), this.size = ++i.size, this;
				i = this.__data__ = new Ft(n)
			}
		...
		var qt = function (e, t) {
			...
			$t = tt(Object.keys, Object),
			Yt = Object.prototype.hasOwnProperty;
		var Gt = function (e) {
			if (!Ie(e)) return $t(e);
			var t = [];
			for (var i in Object(e)) Yt.call(e, i) && "constructor" != i && t.push(i);
			return t
		};
		var Kt = function (e) {
			return ce(e) ? Se(e) : Gt(e)
		};
		var Qt = function (e, t) {
			return e && J(t, Kt(t), e)
		};
		...
		var ei = function (e, t) {
			for (var i = -1, n = null == e ? 0 : e.length, o = 0, r = []; ++i < n;) {
				var s = e[i];
				t(s, i, e) && (r[o++] = s)
			}
			return r
		...
		var ti = function () {
			...
			oi = ni ? function (e) {
				return null == e ? [] : (e = Object(e), ei(ni(e), (function (t) {
					return ii.call(e, t)
				})))
			} : ti;
		var ri = function (e, t) {
		...
		var si = function (e, t) {
			...
			ai = Object.getOwnPropertySymbols ? function (e) {
				for (var t = []; e;) si(t, oi(e)), e = it(e);
				return t
			} : ti;
		var ci = function (e, t) {
			return J(e, ai(e), t)
		...
		var ui = function (e) {
			...
			_i = L(mi),
			vi = S;
		(hi && "[object DataView]" != vi(new hi(new ArrayBuffer(1))) || yt && "[object Map]" != vi(new yt) || fi && "[object Promise]" != vi(fi.resolve()) || gi && "[object Set]" != vi(new gi) || mi && "[object WeakMap]" != vi(new mi)) && (vi = function (e) {
			var t = S(e),
		...
		var Ai = function (e) {
				...
				return t && "string" == typeof e[0] && xi.call(e, "index") && (i.index = e.index, i.input = e.input), i
			},
			Ci = k.a.Uint8Array;
		var Ti = function (e) {
		...
		var Si = function (e) {
			...
			Mi = _ ? _.prototype : void 0,
			Ii = Mi ? Mi.valueOf : void 0;
		var Ni = function (e) {
		...
		var zi = function (e) {
			return "function" != typeof e.constructor || Ie(e) ? {} : Li(it(e))
		};
		var Vi = function (e) {
				return ge(e) && "[object Map]" == yi(e)
			},
			ji = Ce.a && Ce.a.isMap,
			Bi = ji ? Ae(ji) : Vi;
		var Fi = function (e) {
				return ge(e) && "[object Set]" == yi(e)
			},
			Hi = Ce.a && Ce.a.isSet,
			Ui = Hi ? Ae(Hi) : Fi,
			Wi = {};
		...
		var qi = function e(t, i, n, o, r, s) {
			...
			var u = _e(t);
			if (u) {
				if (a = Ai(t), !c) return Xt(t, a)
			} else {
				var h = yi(t),
					f = "[object Function]" == h || "[object GeneratorFunction]" == h;
				if (Object(ve.a)(t)) return Object(Zt.a)(t, c);
				if ("[object Object]" == h || "[object Arguments]" == h || f && !r) {
					if (a = l || f ? {} : zi(t), !c) return l ? ci(t, Jt(a, t)) : ri(t, Qt(a, t))
				} else {
					if (!Wi[h]) return r ? t : {};
					a = Oi(t, h, c)
				}
			...
			var g = s.get(t);
			if (g) return g;
			s.set(t, a), Ui(t) ? t.forEach((function (o) {
				a.add(e(o, i, n, o, t, s))
			})) : Bi(t) && t.forEach((function (o, r) {
				a.set(r, e(o, i, n, r, t, s))
			}));
			var m = u ? void 0 : (d ? l ? ui : di : l ? De : Kt)(t);
			return qt(m || t, (function (o, r) {
				m && (o = t[r = o]), Q(a, r, e(o, i, n, r, t, s))
			})), a
		};
		var $i = function (e, t) {
			return qi(e, 5, t = "function" == typeof t ? t : void 0)
		};
		var Yi = function (e) {
			return ge(e) && 1 === e.nodeType && !ct(e)
		};
		class Gi {
			constructor(e, t) {
				this._config = {}, t && this.define(Ki(t)), e && this._setObjectToTarget(this._config, e)
			}
			set(e, t) {
			...
			_setToTarget(e, t, i, n = !1) {
				...
				const o = t.split(".");
				t = o.pop();
				for (const t of o) ct(e[t]) || (e[t] = {}), e = e[t];
				if (ct(i)) return ct(e[t]) || (e[t] = {}), e = e[t], void this._setObjectToTarget(e, i, n);
				n && void 0 !== e[t] || (e[t] = i)
			}
			_getFromSource(e, t) {
				const i = t.split(".");
		...
		class Zi {
			constructor(e = {}, t = {}) {
				const i = Ji(e);
				if (i || (t = e), this._items = [], this._itemMap = new Map, this._idProperty = t.idProperty || "id", this._bindToExternalToInternalMap = new WeakMap, this._bindToInternalToExternalMap = new WeakMap, this._skippedIndexesFromExternal = [], i)
			...
			addMany(e, t) {
				...
				else if (t > this._items.length || t < 0) throw new c.a("collection-add-item-invalid-index", this);
				for (let i = 0; i < e.length; i++) {
					const n = e[i],
						o = this._getItemIdBeforeAdding(n),
						r = t + i;
					this._items.splice(r, 0, n), this._itemMap.set(o, n), this.fire("add", n, r)
				}
			...
			_setUpBindToBinding(e) {
				const t = this._bindToCollection,
					i = (i, n, o) => {
						...
						if (r && s) this._bindToExternalToInternalMap.set(n, s), this._bindToInternalToExternalMap.set(s, n);
						else {
							const i = e(n);
				...
				this.listenTo(t, "add", i), this.listenTo(t, "remove", (e, t, i) => {
					const n = this._bindToExternalToInternalMap.get(t);
					n && this.remove(n), this._skippedIndexesFromExternal = this._skippedIndexesFromExternal.reduce((e, t) => (i < t && e.push(t - 1), i > t && e.push(t), e), [])
				})
			}
			_getItemIdBeforeAdding(e) {
				...
				let i;
				if (t in e) {
					if (i = e[t], "string" != typeof i) throw new c.a("collection-add-invalid-id", this);
					if (this.get(i)) throw new c.a("collection-add-item-already-exists", this)
				} else e[t] = i = s();
				return i
			}
			_remove(e) {
				...
				if ("string" == typeof e ? (i = e, n = this._itemMap.get(i), o = !n, n && (t = this._items.indexOf(n))) : "number" == typeof e ? (t = e, n = this._items[t], o = !n, n && (i = n[r])) : (n = e, i = n[r], t = this._items.indexOf(n), o = -1 == t || !this._itemMap.get(i)), o) throw new c.a("collection-remove-404", this);
				this._items.splice(t, 1), this._itemMap.delete(i);
				const s = this._bindToInternalToExternalMap.get(n);
				return this._bindToInternalToExternalMap.delete(n), this._bindToExternalToInternalMap.delete(s), this.fire("remove", n, t), [n, t]
			} [Symbol.iterator]() {
		...
		class Xi {
			constructor(e, t = [], i = []) {
				...
				for (const e of t) e.pluginName && this._availablePlugins.set(e.pluginName, e);
				this._contextPlugins = new Map;
				for (const [e, t] of i) this._contextPlugins.set(e, t), this._contextPlugins.set(t, e), e.pluginName && this._availablePlugins.set(e.pluginName, e)
			}*[Symbol.iterator]() {
			...
			get(e) {
				...
				if (!t) {
					let t = e;
					throw "function" == typeof e && (t = e.pluginName || e.name), new c.a("plugincollection-plugin-not-loaded", this._context, {
						plugin: t
					})
				}
				return t
			...
			init(e, t = [], i = []) {
				...
				! function e(t, i = new Set) {
					t.forEach(t => {
						a(t) && (i.has(t) || (i.add(t), t.pluginName && !n._availablePlugins.has(t.pluginName) && n._availablePlugins.set(t.pluginName, t), t.requires && e(t.requires, i)))
					})
				}(e), h(e);
				const r = [... function e(t, i = new Set) {
					return t.map(e => a(e) ? e : n._availablePlugins.get(e)).reduce((t, n) => i.has(n) ? t : (i.add(n), n.requires && (h(n.requires, n), e(n.requires, i).forEach(e => t.add(e))), t.add(n)), new Set)
				}(e.filter(e => !d(e, t)))];
				! function (e, t) {
					for (const i of t) {
						if ("function" != typeof i) throw new c.a("plugincollection-replace-plugin-invalid-type", null, {
							pluginItem: i
						});
						const t = i.pluginName;
						if (!t) throw new c.a("plugincollection-replace-plugin-missing-name", null, {
							pluginItem: i
						});
						if (i.requires && i.requires.length) throw new c.a("plugincollection-plugin-for-replacing-cannot-have-dependencies", null, {
							pluginName: t
						});
						const o = n._availablePlugins.get(t);
						if (!o) throw new c.a("plugincollection-plugin-for-replacing-not-exist", null, {
							pluginName: t
						});
						const r = e.indexOf(o);
						if (-1 === r) {
						...
						if (o.requires && o.requires.length) throw new c.a("plugincollection-replaced-plugin-cannot-have-dependencies", null, {
							pluginName: t
						});
				...
				const s = function (e) {
					return e.map(e => {
						const t = n._contextPlugins.get(e) || new e(o);
						return n._add(e, t), t
					})
				}(r);
				return f(s, "init").then(() => f(s, "afterInit")).then(() => s);
				...
				function d(e, t) {
					return t.some(t => t === e || (u(e) === t || u(t) === e))
				}
				...
				function h(e, i = null) {
					e.map(e => a(e) ? e : n._availablePlugins.get(e) || e).forEach(e => {
						! function (e, t) {
							if (a(e)) return;
				...
				function f(e, t) {
					return e.reduce((e, i) => i[t] ? n._contextPlugins.has(i) ? e : e.then(i[t].bind(i)) : e, Promise.resolve())
				}
			}
			destroy() {
				const e = [];
				for (const [, t] of this) "function" != typeof t.destroy || this._contextPlugins.has(t) || e.push(t.destroy());
			...
			_add(e, t) {
				...
				if (i) {
					if (this._plugins.has(i)) throw new c.a("plugincollection-plugin-name-conflict", null, {
						pluginName: i,
		...
		function tn(e, t, i = 1) {
			if ("number" != typeof i) throw new c.a("translation-service-quantity-not-a-number", null, {
				quantity: i
			});
			...
			if (0 === n || ! function (e, t) {
				...
				}(e, o)) return 1 !== i ? t.plural : t.string;
			const r = window.CKEDITOR_TRANSLATIONS[e].dictionary,
				s = window.CKEDITOR_TRANSLATIONS[e].getPluralForm || (e => 1 === e ? 0 : 1);
			if ("string" == typeof r[o]) return r[o];
			const a = Number(s(i));
			return r[o][a]
		}
		Ke(Xi, u), window.CKEDITOR_TRANSLATIONS || (window.CKEDITOR_TRANSLATIONS = {});
		const nn = ["ar", "ara", "fa", "per", "fas", "he", "heb", "ku", "kur", "ug", "uig"];

		function on(e) {
			return nn.includes(e) ? "rtl" : "ltr"
		}
		class rn {
			constructor(e = {}) {
				this.uiLanguage = e.uiLanguage || "en", this.contentLanguage = e.contentLanguage || this.uiLanguage, this.uiLanguageDirection = on(this.uiLanguage), this.contentLanguageDirection = on(this.contentLanguage), this.t = (e, t) => this._t(e, t)
			}
			get language() {
			...
			_t(e, t = []) {
				...
				}(tn(this.uiLanguage, e, i), t)
			}
		}
		class sn {
			constructor(e) {
				this.config = new Gi(e, this.constructor.defaultConfig);
				const t = this.constructor.builtinPlugins;
				this.config.define("plugins", t), this.plugins = new Xi(this, t);
			...
			initPlugins() {
				...
				for (const i of e.concat(t)) {
					if ("function" != typeof i) throw new c.a("context-initplugins-constructor-only", null, {
						Plugin: i
					});
					if (!0 !== i.isContextPlugin) throw new c.a("context-initplugins-invalid-plugin", null, {
						Plugin: i
					})
				}
		...
		class un extends dn {
			...
			isSimilar(e) {
				return e instanceof un && (this === e || this.data === e.data)
			}
			_clone() {
				return new un(this.document, this.data)
			}
		}
		class hn {
			constructor(e, t, i) {
				if (this.textNode = e, t < 0 || t > e.data.length) throw new c.a("view-textproxy-wrong-offsetintext", this);
				if (i < 0 || t + i > e.data.length) throw new c.a("view-textproxy-wrong-length", this);
			...
			getAncestors(e = {
				...
				for (; null !== i;) t[e.parentFirst ? "push" : "unshift"](i), i = i.parent;
				return t
			}
		}
		...
		function mn(e, t) {
			...
			const i = {};
			return t.name && (i.name = function (e, t) {
				if (e instanceof RegExp) return e.test(t);
				return e === t
			}(t.name, e.name), !i.name) || t.attributes && (i.attributes = function (e, t) {
				const i = [];
				for (const n in e) {
					const o = e[n];
					if (!t.hasAttribute(n)) return null; {
				...
				return i
			}(t.attributes, e), !i.attributes) ? null : !(t.classes && (i.classes = function (e, t) {
				const i = [];
				for (const n of e)
					if (n instanceof RegExp) {
						const e = t.getClassNames();
						for (const t of e) n.test(t) && i.push(t);
						if (0 === i.length) return null
					} else {
						if (!t.hasClass(n)) return null;
						i.push(n)
					} return i
			}(t.classes, e), !i.classes)) && (!(t.styles && (i.styles = function (e, t) {
				const i = [];
				for (const n in e) {
					const o = e[n];
					if (!t.hasStyle(n)) return null; {
				...
				return i
			}(t.styles, e), !i.styles)) && i)
		}
		var pn = function (e) {
				return "symbol" == typeof e || ge(e) && "[object Symbol]" == S(e)
			},
			bn = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
			wn = /^\w*$/;
		var kn = function (e, t) {
			if (_e(e)) return !1;
			var i = typeof e;
			return !("number" != i && "symbol" != i && "boolean" != i && null != e && !pn(e)) || (wn.test(e) || !bn.test(e) || null != t && e in Object(t))
		};
		...
		function _n(e, t) {
			...
			return i.cache = new(_n.Cache || Ft), i
		}
		_n.Cache = Ft;
		var vn = _n;
		var yn = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,
			...
			An = function (e) {
				...
				var t = [];
				return 46 === e.charCodeAt(0) && t.push(""), e.replace(yn, (function (e, i, n, o) {
					t.push(n ? o.replace(xn, "$1") : i || e)
				})), t
			}));
		var Cn = function (e, t) {
			...
			Tn = _ ? _.prototype : void 0,
			En = Tn ? Tn.toString : void 0;
		var Pn = function e(t) {
			if ("string" == typeof t) return t;
			if (_e(t)) return Cn(t, e) + "";
			if (pn(t)) return En ? En.call(t) : "";
			var i = t + "";
		...
		var Mn = function (e, t) {
			return _e(e) ? e : kn(e, t) ? [e] : An(Sn(e))
		};
		var In = function (e) {
		...
		var Rn = function (e, t) {
			for (var i = 0, n = (t = Mn(t, e)).length; null != e && i < n;) e = e[Nn(t[i++])];
		...
		var Dn = function (e, t) {
			return t.length < 2 ? e : Rn(e, On(t, 0, -1))
		};
		var Ln = function (e, t) {
			return t = Mn(t, e), null == (e = Dn(e, t)) || delete e[Nn(In(t))]
		};
		var zn = function (e, t) {
			return null == e || Ln(e, t)
		};
		var Vn = function (e, t, i) {
			var n = null == e ? void 0 : Rn(e, t);
			return void 0 === n ? i : n
		};
		var jn = function (e, t, i) {
			(void 0 !== i && !G(e[t], i) || void 0 === i && !(t in e)) && Y(e, t, i)
		};
		var Bn = function (e) {
			return function (t, i, n) {
				for (var o = -1, r = Object(t), s = n(t), a = s.length; a--;) {
					var c = s[e ? a : ++o];
					if (!1 === i(r[c], c, r)) break
				}
				return t
			}
		}();
		...
		var Wn = function (e, t, i, n, o, r, s) {
			var a = Hn(e, i),
				c = Hn(t, i),
				l = s.get(c);
			if (l) jn(e, i, l);
			else {
				var d = r ? r(a, c, i + "", e, t, s) : void 0,
					u = void 0 === d;
				if (u) {
					var h = _e(c),
						f = !h && Object(ve.a)(c),
						g = !h && !f && Ee(c);
					d = c, h || f || g ? _e(a) ? d = a : Fn(a) ? d = Xt(a) : f ? (u = !1, d = Object(Zt.a)(c, !0)) : g ? (u = !1, d = Ri(c, !0)) : d = [] : ct(c) || ke(c) ? (d = a, ke(a) ? d = Un(a) : w(a) && !I(a) || (d = zi(c))) : u = !1
				}
				u && (s.set(c, d), o(d, c, n, r, s), s.delete(c)), jn(e, i, d)
			}
		};
		var qn = function e(t, i, n, o, r) {
				t !== i && Bn(i, (function (s, a) {
					if (r || (r = new Wt), w(s)) Wn(t, i, a, n, e, o, r);
					else {
						var c = o ? o(Hn(t, a), s, a + "", t, i, r) : void 0;
						void 0 === c && (c = s), jn(t, a, c)
					}
				}), De)
			},
			$n = he((function (e, t, i) {
		...
		var Yn = function (e, t, i, n) {
			if (!w(e)) return e;
			for (var o = -1, r = (t = Mn(t, e)).length, s = r - 1, a = e; null != a && ++o < r;) {
				var c = Nn(t[o]),
					l = i;
				if ("__proto__" === c || "constructor" === c || "prototype" === c) return e;
				if (o != s) {
					var d = a[c];
					void 0 === (l = n ? n(d, c, a) : void 0) && (l = w(d) ? d : de(t[o + 1]) ? [] : {})
				}
				Q(a, c, l), a = a[c]
			}
			return e
		...
		class Kn {
			...
			set(e, t) {
				if (w(e))
					for (const [t, i] of Object.entries(e)) this._styleProcessor.toNormalizedForm(t, i, this._styles);
				else this._styleProcessor.toNormalizedForm(e, t, this._styles)
			}
			remove(e) {
				const t = Jn(e);
				zn(this._styles, t), delete this._styles[e], this._cleanEmptyObjectsOnPath(t)
			}
			getNormalized(e) {
			...
			_cleanEmptyObjectsOnPath(e) {
				...
				const i = t.splice(0, t.length - 1).join("."),
					n = Vn(this._styles, i);
				if (!n) return;
				!Array.from(Object.keys(n)).length && this.remove(i)
			}
		}
		class Qn {
			constructor() {
			...
			getNormalized(e, t) {
				...
				if (this._extractors.has(e)) {
					...
					if ("string" == typeof i) return Vn(t, i);
					const n = i(e, t);
					if (n) return n
				}
				return Vn(t, Jn(e))
		...
		function Zn(e, t, i) {
			let n = i;
			w(i) && (n = $n({}, Vn(e, t), i)), Gn(e, t, n)
		}
		class Xn extends dn {
			constructor(e, t, i, n) {
				if (super(e), this.name = t, this._attrs = function (e) {
						e = fn(e);
						for (const [t, i] of e) null === i ? e.delete(t) : "string" != typeof i && e.set(t, String(i));
						return e
					}(i), this._children = [], n && this._insertChild(0, n), this._classes = new Set, this._attrs.has("class")) {
					const e = this._attrs.get("class");
					eo(this._classes, e), this._attrs.delete("class")
				}
				this._styles = new Kn(this.document.stylesProcessor), this._attrs.has("style") && (this._styles.setTo(this._attrs.get("style")), this._attrs.delete("style")), this._customProperties = new Map, this._isAllowedInsideAttributeElement = !1
			}
			get childCount() {
			...
			getAttribute(e) {
				if ("class" == e) return this._classes.size > 0 ? [...this._classes].join(" ") : void 0;
				if ("style" == e) {
			...
			isSimilar(e) {
				...
				for (const t of this._styles.getStyleNames())
					if (!e._styles.has(t) || e._styles.getAsString(t) !== this._styles.getAsString(t)) return !1;
				return !0
			}
			hasClass(...e) {
				for (const t of e)
			...
			getIdentity() {
				const e = Array.from(this._classes).sort().join(","),
					...
					i = Array.from(this._attrs).map(e => `${e[0]}="${e[1]}"`).sort().join(" ");
				return this.name + ("" == e ? "" : ` class="${e}"`) + (t ? ` style="${t}"` : "") + ("" == i ? "" : " " + i)
			}
			_clone(e = !1) {
				const t = [];
				if (e)
					for (const i of this.getChildren()) t.push(i._clone(e));
				const i = new this.constructor(this.document, this.name, this._attrs, t);
				return i._classes = new Set(this._classes), i._styles.set(this._styles.getNormalized()), i._customProperties = new Map(this._customProperties), i.getFillerOffset = this.getFillerOffset, i._isAllowedInsideAttributeElement = this.isAllowedInsideAttributeElement, i
			}
			_appendChild(e) {
			...
			_insertChild(e, t) {
				...
				const n = function (e, t) {
					if ("string" == typeof t) return [new un(e, t)];
					Ji(t) || (t = [t]);
					return Array.from(t).map(t => "string" == typeof t ? new un(e, t) : t instanceof hn ? new un(e, t.data) : t)
				}(this.document, t);
				for (const t of n) null !== t.parent && t._remove(), t.parent = this, t.document = this.document, this._children.splice(e, 0, t), e++, i++;
				return i
			}
			...
			_setAttribute(e, t) {
				t = String(t), this._fireChange("attributes", this), "class" == e ? eo(this._classes, t) : "style" == e ? this._styles.setTo(t) : this._attrs.set(e, t)
			}
			_removeAttribute(e) {
			...
			_addClass(e) {
				...
				for (const t of en(e)) this._classes.add(t)
			}
			_removeClass(e) {
				this._fireChange("attributes", this);
				for (const t of en(e)) this._classes.delete(t)
			}
			_setStyle(e, t) {
			...
			_removeStyle(e) {
				this._fireChange("attributes", this);
				for (const t of en(e)) this._styles.remove(t)
			}
		...
		class to extends Xn {
			constructor(e, t, i, n) {
				super(e, t, i, n), this.getFillerOffset = io
			}
			is(e, t = null) {
		...
		function io() {
			...
			for (const t of e)
				if (!t.is("uiElement")) return null;
			return this.childCount
		}
		class no extends to {
			constructor(e, t, i, n) {
				super(e, t, i, n), this.set("isReadOnly", !1), this.set("isFocused", !1), this.bind("isReadOnly").to(e), this.bind("isFocused").to(e, "isFocused", t => t && e.selection.editableElement == this), this.listenTo(e.selection, "change", () => {
		...
		class ro extends no {
			...
			get rootName() {
				return this.getCustomProperty(oo)
			}
			set rootName(e) {
				this._setCustomProperty(oo, e)
			}
			set _name(e) {
				this.name = e
			}
		...
		class so {
			...
			_next() {
				...
				const t = this.position,
					i = e.parent;
				if (null === i.parent && e.offset === i.childCount) return {
					done: !0
				};
				if (i === this._boundaryEndParent && e.offset == this.boundaries.end.offset) return {
					done: !0
				};
				let n;
				if (i instanceof un) {
					if (e.isAtEnd) return this.position = ao._createAfter(i), this._next();
					n = i.data[e.offset]
				} else n = i.getChild(e.offset);
				if (n instanceof Xn) return this.shallow ? e.offset++ : e = new ao(n, 0), this.position = e, this._formatReturnValue("elementStart", n, t, e, 1);
				if (n instanceof un) {
					if (this.singleCharacters) return e = new ao(n, 0), this.position = e, this._next(); {
						let i, o = n.data.length;
						return n == this._boundaryEndParent ? (o = this.boundaries.end.offset, i = new hn(n, 0, o), e = ao._createAfter(i)) : (i = new hn(n, 0, n.data.length), e.offset++), this.position = e, this._formatReturnValue("text", i, t, e, o)
					}
				}
				if ("string" == typeof n) {
					let n;
					if (this.singleCharacters) n = 1;
						...
						n = (i === this._boundaryEndParent ? this.boundaries.end.offset : i.data.length) - e.offset
					}
					const o = new hn(i, e.offset, n);
					return e.offset += n, this.position = e, this._formatReturnValue("text", o, t, e, n)
				}
				return e = ao._createAfter(i), this.position = e, this.ignoreElementEnd ? this._next() : this._formatReturnValue("elementEnd", i, t, e)
			}
			_previous() {
				let e = this.position.clone();
				const t = this.position,
					i = e.parent;
				if (null === i.parent && 0 === e.offset) return {
					done: !0
				};
				...
				let n;
				if (i instanceof un) {
					if (e.isAtStart) return this.position = ao._createBefore(i), this._previous();
					n = i.data[e.offset - 1]
				} else n = i.getChild(e.offset - 1);
				if (n instanceof Xn) return this.shallow ? (e.offset--, this.position = e, this._formatReturnValue("elementStart", n, t, e, 1)) : (e = new ao(n, n.childCount), this.position = e, this.ignoreElementEnd ? this._previous() : this._formatReturnValue("elementEnd", n, t, e));
				if (n instanceof un) {
					if (this.singleCharacters) return e = new ao(n, n.data.length), this.position = e, this._previous(); {
						let i, o = n.data.length;
						if (n == this._boundaryStartParent) {
							const t = this.boundaries.start.offset;
							i = new hn(n, t, n.data.length - t), o = i.data.length, e = ao._createBefore(i)
						} else i = new hn(n, 0, n.data.length), e.offset--;
		...
		class ao {
			...
			getWalker(e = {}) {
				return e.startPosition = this, new so(e)
			}
			clone() {
				return new ao(this.parent, this.offset)
			}
			static _createAt(e, t) {
				if (e instanceof ao) return new this(e.parent, e.offset); {
					const i = e;
					if ("end" == t) t = i.is("$text") ? i.data.length : i.childCount;
						...
						if (0 !== t && !t) throw new c.a("view-createpositionat-offset-required", i)
					}
					return new ao(i, t)
				}
			}
			static _createAfter(e) {
				if (e.is("$textProxy")) return new ao(e.textNode, e.offsetInText + e.data.length);
				if (!e.parent) throw new c.a("view-position-after-root", e, {
					root: e
				});
				return new ao(e.parent, e.index + 1)
			}
			static _createBefore(e) {
				if (e.is("$textProxy")) return new ao(e.textNode, e.offsetInText);
				if (!e.parent) throw new c.a("view-position-before-root", e, {
					root: e
				});
				return new ao(e.parent, e.index)
			}
		}
		class co {
			...
			getEnlarged() {
				let e = this.start.getLastMatchingPosition(lo, {
						direction: "backward"
					}),
					t = this.end.getLastMatchingPosition(lo);
				return e.parent.is("$text") && e.isAtStart && (e = ao._createBefore(e.parent)), t.parent.is("$text") && t.isAtEnd && (t = ao._createAfter(t.parent)), new co(e, t)
			}
			getTrimmed() {
				let e = this.start.getLastMatchingPosition(lo);
				if (e.isAfter(this.end) || e.isEqual(this.end)) return new co(e, e);
				let t = this.end.getLastMatchingPosition(lo, {
					direction: "backward"
				});
				const i = e.nodeAfter,
					n = t.nodeBefore;
				return i && i.is("$text") && (e = new ao(i, 0)), n && n.is("$text") && (t = new ao(n, n.data.length)), new co(e, t)
			}
			isEqual(e) {
			...
			getDifference(e) {
				const t = [];
				return this.isIntersecting(e) ? (this.containsPosition(e.start) && t.push(new co(this.start, e.start)), this.containsPosition(e.end) && t.push(new co(e.end, this.end))) : t.push(this.clone()), t
			}
			getIntersection(e) {
				if (this.isIntersecting(e)) {
					let t = this.start,
						i = this.end;
					return this.containsPosition(e.start) && (t = e.start), this.containsPosition(e.end) && (i = e.end), new co(t, i)
				}
				return null
			}
			getWalker(e = {}) {
				return e.boundaries = this, new so(e)
			}
			getCommonAncestor() {
			...
			clone() {
				return new co(this.start, this.end)
			}* getItems(e = {}) {
			...
			static _createFromParentsAndOffsets(e, t, i, n) {
				return new this(new ao(e, t), new ao(i, n))
			}
			...
			static _createOn(e) {
				...
				return this._createFromPositionAndShift(ao._createBefore(e), t)
			}
		}
		...
		class ho {
			constructor(e = null, t, i) {
				this._ranges = [], this._lastRangeBackward = !1, this._isFake = !1, this._fakeSelectionLabel = "", this.setTo(e, t, i)
			}
			get isFake() {
				return this._isFake
			}
			...
			isSimilar(e) {
				...
				const t = uo(this.getRanges());
				if (t != uo(e.getRanges())) return !1;
				if (0 == t) return !0;
			...
			setTo(e, t, i) {
				...
				else if (e instanceof ho || e instanceof fo) this._setRanges(e.getRanges(), e.isBackward), this._setFakeOptions({
					fake: e.isFake,
					label: e.fakeSelectionLabel
				});
				else if (e instanceof co) this._setRanges([e], t && t.backward), this._setFakeOptions(t);
				else if (e instanceof ao) this._setRanges([new co(e)]), this._setFakeOptions(t);
				else if (e instanceof dn) {
					const n = !!i && !!i.backward;
					let o;
					if (void 0 === t) throw new c.a("view-selection-setto-required-second-parameter", this);
					o = "in" == t ? co._createIn(e) : "on" == t ? co._createOn(e) : new co(ao._createAt(e, t)), this._setRanges([o], n), this._setFakeOptions(i)
				} else {
			...
			setFocus(e, t) {
				...
				const i = ao._createAt(e, t);
				if ("same" == i.compareWith(this.focus)) return;
				const n = this.anchor;
				this._ranges.pop(), "before" == i.compareWith(n) ? this._addRange(new co(i, n), !0) : this._addRange(new co(n, i)), this.fire("change")
			}
			is(e) {
			...
			_addRange(e, t = !1) {
				if (!(e instanceof co)) throw new c.a("view-selection-add-range-not-range", this);
				this._pushRange(e), this._lastRangeBackward = !!t
			}
			_pushRange(e) {
				for (const t of this._ranges)
					if (e.isIntersecting(t)) throw new c.a("view-selection-range-intersects", this, {
						addedRange: e,
						intersectingRange: t
					});
				this._ranges.push(new co(e.start, e.end))
			}
		}
		Ke(ho, u);
		class fo {
			constructor(e = null, t, i) {
				this._selection = new ho, this._selection.delegate("change").to(this), this._selection.setTo(e, t, i)
			}
			get isFake() {
		...
		const mo = Symbol("bubbling contexts");
		var po = {
			fire(e, ...t) {
				try {
					const i = e instanceof o ? e : new o(this, e),
						n = _o(this);
					if (!n.size) return;
					if (bo(i, "capturing", this), wo(n, "$capture", i, ...t)) return i.return;
					...
					if (bo(i, "atTarget", c), !a) {
						if (wo(n, "$text", i, ...t)) return i.return;
						bo(i, "bubbling", c)
					}
					for (; c;) {
						if (c.is("rootElement")) {
							if (wo(n, "$root", i, ...t)) return i.return
						} else if (c.is("element") && wo(n, c.name, i, ...t)) return i.return;
						if (wo(n, c, i, ...t)) return i.return;
						c = c.parent, bo(i, "bubbling", c)
					}
					return bo(i, "bubbling", this), wo(n, "$document", i, ...t), i.return
				} catch (e) {
					c.a.rethrowUnexpectedError(e, this)
				}
			},
			_addEventListener(e, t, i) {
				const n = en(i.context || "$document"),
					o = _o(this);
				for (const r of n) {
					let n = o.get(r);
					n || (n = Object.create(u), o.set(r, n)), this.listenTo(n, e, t, i)
				}
			},
			_removeEventListener(e, t) {
				const i = _o(this);
		...
		function bo(e, t, i) {
			e instanceof go && (e._eventPhase = t, e._currentTarget = i)
		}

		function wo(e, t, i, ...n) {
			const o = "string" == typeof t ? e.get(t) : ko(e, t);
			return !!o && (o.fire(i, ...n), i.stop.called)
		}

		function ko(e, t) {
			for (const [i, n] of e)
				if ("function" == typeof i && i(t)) return n;
			return null
		}

		function _o(e) {
			return e[mo] || (e[mo] = new Map), e[mo]
		}
		class vo {
			constructor(e) {
				this.selection = new fo, this.roots = new Zi({
					idProperty: "rootName"
				}), this.stylesProcessor = e, this.set("isReadOnly", !1), this.set("isFocused", !1), this.set("isComposing", !1), this._postFixers = new Set
			}
			getRoot(e = "main") {
		...
		class yo extends Xn {
			constructor(e, t, i, n) {
				super(e, t, i, n), this.getFillerOffset = xo, this._priority = 10, this._id = null, this._clonesGroup = null
			}
			get priority() {
		...
		function xo() {
			...
			for (; e && e.is("attributeElement");) {
				if (Ao(e) > 1) return null;
				e = e.parent
			}
			return !e || Ao(e) > 1 ? null : this.childCount
		}

		function Ao(e) {
			return Array.from(e.getChildren()).filter(e => !e.is("uiElement")).length
		}
		yo.DEFAULT_PRIORITY = 10;
		class Co extends Xn {
			constructor(e, t, i, n) {
				super(e, t, i, n), this._isAllowedInsideAttributeElement = !0, this.getFillerOffset = To
			}
			is(e, t = null) {
			...
			_insertChild(e, t) {
				if (t && (t instanceof dn || Array.from(t).length > 0)) throw new c.a("view-emptyelement-cannot-add", [this, t])
			}
		}
		...
		const Eo = navigator.userAgent.toLowerCase();
		var Po = {
			isMac: function (e) {
		...
		const So = {
			...
			No = Object.fromEntries(Object.entries(Io).map(([e, t]) => [t, e.charAt(0).toUpperCase() + e.slice(1)]));

		function Ro(e) {
			let t;
			if ("string" == typeof e) {
				if (t = Io[e.toLowerCase()], !t) throw new c.a("keyboard-unknown-key", null, {
					key: e
				})
			} else t = e.keyCode + (e.altKey ? Io.alt : 0) + (e.ctrlKey ? Io.ctrl : 0) + (e.shiftKey ? Io.shift : 0) + (e.metaKey ? Io.cmd : 0);
			return t
		}
		...
		function Oo(e) {
			...
			}(e)), e.map(e => "string" == typeof e ? function (e) {
				if (e.endsWith("!")) return Ro(e.slice(0, -1));
				const t = Ro(e);
				return Po.isMac && t == Io.ctrl ? Io.cmd : t
			}(e) : e).reduce((e, t) => t + e, 0)
		}

		function Do(e) {
			let t = Oo(e);
			return Object.entries(Po.isMac ? So : Mo).reduce((e, [i, n]) => (0 != (t & Io[i]) && (t &= ~Io[i], e += n), e), "") + (t ? No[t] : "")
		}
		...
		class Vo extends Xn {
			constructor(e, t, i, n) {
				super(e, t, i, n), this._isAllowedInsideAttributeElement = !0, this.getFillerOffset = Bo
			}
			is(e, t = null) {
			...
			_insertChild(e, t) {
				if (t && (t instanceof dn || Array.from(t).length > 0)) throw new c.a("view-uielement-cannot-add", this)
			}
			render(e) {
		...
		function jo(e) {
			e.document.on("arrowKey", (t, i) => function (e, t, i) {
				if (t.keyCode == Io.arrowright) {
					...
					if (n || t.shiftKey) {
						...
						if (null === r) return;
						let s = !1;
						const a = r.getLastMatchingPosition(e => (e.item.is("uiElement") && (s = !0), !(!e.item.is("uiElement") && !e.item.is("attributeElement"))));
						if (s) {
		...
		class Fo extends Xn {
			constructor(e, t, i, n) {
				super(e, t, i, n), this._isAllowedInsideAttributeElement = !0, this.getFillerOffset = Ho
			}
			is(e, t = null) {
			...
			_insertChild(e, t) {
				if (t && (t instanceof dn || Array.from(t).length > 0)) throw new c.a("view-rawelement-cannot-add", [this, t])
			}
		}
		...
		class Uo {
			...
			_insertChild(e, t) {
				...
				for (const t of n) null !== t.parent && t._remove(), t.parent = this, this._children.splice(e, 0, t), e++, i++;
				return i
			}
			_removeChildren(e, t = 1) {
				this._fireChange("children", this);
		...
		class Wo {
			...
			createText(e) {
				return new un(this.document, e)
			}
			createAttributeElement(e, t, i = {}) {
				const n = new yo(this.document, e, t);
				return i.priority && (n._priority = i.priority), i.id && (n._id = i.id), n
			}
			createContainerElement(e, t, i = {}) {
				const n = new to(this.document, e, t);
				return void 0 !== i.isAllowedInsideAttributeElement && (n._isAllowedInsideAttributeElement = i.isAllowedInsideAttributeElement), n
			}
			...
			createEmptyElement(e, t, i = {}) {
				const n = new Co(this.document, e, t);
				return void 0 !== i.isAllowedInsideAttributeElement && (n._isAllowedInsideAttributeElement = i.isAllowedInsideAttributeElement), n
			}
			createUIElement(e, t, i, n = {}) {
				const o = new Vo(this.document, e, t);
				return i && (o.render = i), void 0 !== n.isAllowedInsideAttributeElement && (o._isAllowedInsideAttributeElement = n.isAllowedInsideAttributeElement), o
			}
			createRawElement(e, t, i, n = {}) {
				const o = new Fo(this.document, e, t);
				return o.render = i || (() => {}), void 0 !== n.isAllowedInsideAttributeElement && (o._isAllowedInsideAttributeElement = n.isAllowedInsideAttributeElement), o
			}
			setAttribute(e, t, i) {
				i._setAttribute(e, t)
			}
			...
			breakAttributes(e) {
				return e instanceof ao ? this._breakAttributes(e) : this._breakAttributesRange(e)
			}
			breakContainer(e) {
				const t = e.parent;
				...
				if (e.isAtStart) return ao._createBefore(t);
				if (!e.isAtEnd) {
					const i = t._clone(!1);
					this.insert(ao._createAfter(t), i);
					const n = new co(e, ao._createAt(t, "end")),
						o = new ao(i, 0);
					this.move(n, o)
				}
				return ao._createAfter(t)
			}
			mergeAttributes(e) {
				const t = e.offset,
					i = e.parent;
				...
				if (i.is("attributeElement") && 0 === i.childCount) {
					const e = i.parent,
						t = i.index;
					return i._remove(), this._removeFromClonedElementsGroup(i), this.mergeAttributes(new ao(e, t))
				}
				const n = i.getChild(t - 1),
					o = i.getChild(t);
				if (!n || !o) return e;
				if (n.is("$text") && o.is("$text")) return Ko(n, o);
				if (n.is("attributeElement") && o.is("attributeElement") && n.isSimilar(o)) {
					const e = n.childCount;
					return n._appendChild(o.getChildren()), o._remove(), this._removeFromClonedElementsGroup(o), this.mergeAttributes(new ao(n, e))
				}
				return e
			}
			mergeContainers(e) {
				const t = e.nodeBefore,
					i = e.nodeAfter;
				if (!(t && i && t.is("containerElement") && i.is("containerElement"))) throw new c.a("view-writer-merge-containers-invalid-position", this.document);
				const n = t.getChild(t.childCount - 1),
					o = n instanceof un ? ao._createAt(n, "end") : ao._createAt(t, "end");
				return this.move(co._createIn(i), ao._createAt(t, "end")), this.remove(co._createOn(i)), o
			}
			insert(e, t) {
				(function e(t, i) {
					for (const n of t) {
						if (!Qo.some(e => n instanceof e)) throw new c.a("view-writer-insert-invalid-node-type", i);
						n.is("$text") || e(n.getChildren(), i)
					}
				})(t = Ji(t) ? [...t] : [t], this.document);
				const i = t.reduce((e, t) => {
					const i = e[e.length - 1],
						n = !(t.is("uiElement") && t.isAllowedInsideAttributeElement);
					return i && i.breakAttributes == n ? i.nodes.push(t) : e.push({
						breakAttributes: n,
						nodes: [t]
					}), e
				}, []);
				...
				return n ? new co(n, o) : new co(e)
			}
			remove(e) {
				const t = e instanceof co ? e : co._createOn(e);
				if (Zo(t, this.document), t.isCollapsed) return new Uo(this.document);
				const {
					start: i,
					end: n
				} = this._breakAttributesRange(t, !0), o = i.parent, r = n.offset - i.offset, s = o._removeChildren(i.offset, r);
				for (const e of s) this._removeFromClonedElementsGroup(e);
				const a = this.mergeAttributes(i);
				return t.start = a, t.end = a.clone(), new Uo(this.document, s)
			}
			clear(e, t) {
				Zo(e, this.document);
				const i = e.getWalker({
				...
				for (const n of i) {
					const i = n.item;
					let o;
					if (i.is("element") && t.isSimilar(i)) o = co._createOn(i);
					else if (!n.nextPosition.isAfter(e.start) && i.is("$textProxy")) {
						const e = i.getAncestors().find(e => e.is("element") && t.isSimilar(e));
						e && (o = co._createIn(e))
					}
			...
			wrap(e, t) {
				if (!(t instanceof yo)) throw new c.a("view-writer-wrap-invalid-attribute", this.document);
				if (Zo(e, this.document), e.isCollapsed) {
					let n = e.start;
					n.parent.is("element") && (i = n.parent, !Array.from(i.getChildren()).some(e => !e.is("uiElement"))) && (n = n.getLastMatchingPosition(e => e.item.is("uiElement"))), n = this._wrapPosition(n, t);
					const o = this.document.selection;
					return o.isCollapsed && o.getFirstPosition().isEqual(e.start) && this.setSelection(n), new co(n)
				}
				return this._wrapRange(e, t);
				var i
			}
			unwrap(e, t) {
				if (!(t instanceof yo)) throw new c.a("view-writer-unwrap-invalid-attribute", this.document);
				if (Zo(e, this.document), e.isCollapsed) return e;
				const {
					start: i,
					end: n
				} = this._breakAttributesRange(e, !0), o = i.parent, r = this._unwrapChildren(o, i.offset, n.offset, t), s = this.mergeAttributes(r.start);
				s.isEqual(r.start) || r.end.offset--;
				const a = this.mergeAttributes(r.end);
				return new co(s, a)
			}
			rename(e, t) {
				const i = new to(this.document, e, t.getAttributes());
				return this.insert(ao._createAfter(t), i), this.move(co._createIn(t), ao._createAt(i, 0)), this.remove(co._createOn(t)), i
			}
			clearClonedElementsGroup(e) {
				this._cloneGroups.delete(e)
			}
			createPositionAt(e, t) {
				return ao._createAt(e, t)
			}
			createPositionAfter(e) {
				return ao._createAfter(e)
			}
			createPositionBefore(e) {
				return ao._createBefore(e)
			}
			createRange(e, t) {
				return new co(e, t)
			}
			createRangeOn(e) {
				return co._createOn(e)
			}
			createRangeIn(e) {
				return co._createIn(e)
			}
			...
			_insertNodes(e, t, i) {
				let n, o;
				if (n = i ? qo(e) : e.parent.is("$text") ? e.parent.parent : e.parent, !n) throw new c.a("view-writer-invalid-position-container", this.document);
				o = i ? this._breakAttributes(e, !0) : e.parent.is("$text") ? Go(e) : e;
			...
			_wrapChildren(e, t, i, n) {
				...
				for (; o < i;) {
					const t = e.getChild(o),
						...
						a = t.isAllowedInsideAttributeElement;
					if (s && this._wrapAttributeElement(n, t)) r.push(new ao(e, o));
					else if (i || a || s && $o(n, t)) {
						const i = n._clone();
						t._remove(), i._appendChild(t), e._insertChild(o, i), this._addToClonedElementsGroup(i), r.push(new ao(e, o))
					} else s && this._wrapChildren(t, 0, t.childCount, n);
					o++
				}
				let s = 0;
				for (const e of r) {
				...
				return co._createFromParentsAndOffsets(e, t, e, i)
			}
					...
					if (t.is("attributeElement"))
						if (t.isSimilar(n)) {
							const n = t.getChildren(),
								s = t.childCount;
							t._remove(), e._insertChild(o, n), this._removeFromClonedElementsGroup(t), r.push(new ao(e, o), new ao(e, o + s)), o += s, i += s - 1
						} else this._unwrapAttributeElement(n, t) ? (r.push(new ao(e, o), new ao(e, o + 1)), o++) : (this._unwrapChildren(t, 0, t.childCount, n), o++);
					else o++
				}
				let s = 0;
				for (const e of r) {
					if (e.offset -= s, e.offset == t || e.offset == i) continue;
					this.mergeAttributes(e).isEqual(e) || (s++, i--)
				}
				return co._createFromParentsAndOffsets(e, t, e, i)
			}
			_wrapRange(e, t) {
				...
				} = this._breakAttributesRange(e, !0), o = i.parent, r = this._wrapChildren(o, i.offset, n.offset, t), s = this.mergeAttributes(r.start);
				s.isEqual(r.start) || r.end.offset--;
				const a = this.mergeAttributes(r.end);
				return new co(s, a)
			}
			_wrapPosition(e, t) {
				if (t.isSimilar(e.parent)) return Yo(e.clone());
				e.parent.is("$text") && (e = Go(e));
				const i = this.createAttributeElement();
				i._priority = Number.POSITIVE_INFINITY, i.isSimilar = () => !1, e.parent._insertChild(e.offset, i);
				const n = new co(e, e.getShiftedBy(1));
				this.wrap(n, t);
				const o = new ao(i.parent, i.index);
				i._remove();
				const r = o.nodeBefore,
					s = o.nodeAfter;
				return r instanceof un && s instanceof un ? Ko(r, s) : Yo(o)
			}
			_wrapAttributeElement(e, t) {
				if (!Xo(e, t)) return !1;
				if (e.name !== t.name || e.priority !== t.priority) return !1;
				for (const i of e.getAttributeKeys())
					if ("class" !== i && "style" !== i && t.hasAttribute(i) && t.getAttribute(i) !== e.getAttribute(i)) return !1;
				for (const i of e.getStyleNames())
					if (t.hasStyle(i) && t.getStyle(i) !== e.getStyle(i)) return !1;
				for (const i of e.getAttributeKeys()) "class" !== i && "style" !== i && (t.hasAttribute(i) || this.setAttribute(i, e.getAttribute(i), t));
				for (const i of e.getStyleNames()) t.hasStyle(i) || this.setStyle(i, e.getStyle(i), t);
				for (const i of e.getClassNames()) t.hasClass(i) || this.addClass(i, t);
				return !0
			}
			_unwrapAttributeElement(e, t) {
				...
				for (const i of e.getStyleNames())
					if (!t.hasStyle(i) || t.getStyle(i) !== e.getStyle(i)) return !1;
				for (const i of e.getAttributeKeys()) "class" !== i && "style" !== i && this.removeAttribute(i, t);
			...
			_breakAttributesRange(e, t = !1) {
				...
				return o.offset += o.parent.childCount - r, new co(s, o)
			}
			_breakAttributes(e, t = !1) {
				...
				if (!t && n.is("$text") && Jo(n.parent)) return e.clone();
				if (Jo(n)) return e.clone();
				if (n.is("$text")) return this._breakAttributes(Go(e), t);
				if (i == n.childCount) {
					const e = new ao(n.parent, n.index + 1);
					return this._breakAttributes(e, t)
				}
				if (0 === i) {
					const e = new ao(n.parent, n.index);
					return this._breakAttributes(e, t)
				} {
					const e = n.index + 1,
						o = n._clone();
		...
		function Yo(e) {
			const t = e.nodeBefore;
			if (t && t.is("$text")) return new ao(t, t.data.length);
			const i = e.nodeAfter;
			return i && i.is("$text") ? new ao(i, 0) : e
		}

		function Go(e) {
			if (e.offset == e.parent.data.length) return new ao(e.parent.parent, e.parent.index + 1);
			if (0 === e.offset) return new ao(e.parent.parent, e.parent.index);
			const t = e.parent.data.slice(e.offset);
			return e.parent._data = e.parent.data.slice(0, e.offset), e.parent.parent._insertChild(e.parent.index + 1, new un(e.root.document, t)), new ao(e.parent.parent, e.parent.index + 1)
		}

		function Ko(e, t) {
			const i = e.data.length;
			return e._data += t.data, t._remove(), new ao(e, i)
		}
		const Qo = [un, yo, to, Co, Fo, Vo];
		...
		function Zo(e, t) {
			const i = qo(e.start),
				n = qo(e.end);
			if (!i || !n || i !== n) throw new c.a("view-writer-invalid-range-container", t)
		}
		...
		function or(e) {
			return er(e) && e.data.substr(0, 7) === nr
		}
		...
		function ur(e, t, i) {
			...
			const n = e.length,
				o = t.length;
			if (n > 200 || o > 200 || n + o > 300) return ur.fastDiff(e, t, i, !0);
			let r, s;
			if (o < n) {
				const i = e;
			...
			function h(n) {
				const o = (void 0 !== u[n - 1] ? u[n - 1] : -1) + 1,
					l = void 0 !== u[n + 1] ? u[n + 1] : -1,
					h = o > l ? -1 : 1;
				d[n + h] && (d[n] = d[n + h].slice(0)), d[n] || (d[n] = []), d[n].push(o > l ? r : s);
				let f = Math.max(o, l),
					g = f - n;
				for (; g < a && f < c && i(e[g], t[f]);) g++, f++, d[n].push("equal");
				return f
			}
			let f, g = 0;
			do {
		...
		class mr {
			constructor(e, t) {
				this.domDocuments = new Set, this.domConverter = e, this.markedAttributes = new Set, this.markedChildren = new Set, this.markedTexts = new Set, this.selection = t, this.isFocused = !1, this._inlineFiller = null, this._fakeSelectionContainer = null
			}
			markToSync(e, t) {
			...
			render() {
				...
				if (e) {
					...
					or(t.parent) ? this._inlineFiller = t.parent : this._inlineFiller = pr(i, t.parent, t.offset)
			...
			_updateChildrenMappings(e) {
				...
				if (!t) return;
				const i = this.domConverter.mapViewToDom(e).childNodes,
					n = Array.from(this.domConverter.viewChildrenToDom(e, t.ownerDocument, {
						withChildren: !1
					})),
					o = this._diffNodeLists(i, n),
					r = this._findReplaceActions(o, i, n);
					...
					for (const o of r)
						if ("replace" === o) {
							const o = t.equal + t.insert,
								r = t.equal + t.delete,
								s = e.getChild(o);
							!s || s.is("uiElement") || s.is("rawElement") || this._updateElementMappings(s, i[r]), fr(n[o]), t.equal++
						} else t[o]++
				}
			}
			...
			_getInlineFillerPosition() {
				...
				return e.parent.is("$text") ? ao._createBefore(this.selection.getFirstPosition().parent) : e
			}
			...
			_removeInlineFiller() {
				...
				if (!or(e)) throw new c.a("view-renderer-filler-was-lost", this);
				rr(e) ? e.parentNode.removeChild(e) : e.data = e.data.substr(7), this._inlineFiller = null
			}
			_needsInlineFillerAtSelection() {
				...
				const n = e.nodeBefore,
					o = e.nodeAfter;
				return !(n instanceof un || o instanceof un)
			}
			_updateText(e, t) {
				const i = this.domConverter.findCorrespondingDomText(e),
					n = this.domConverter.viewToDom(e, i.ownerDocument),
					o = i.data;
				let r = n.data;
				const s = t.inlineFillerPosition;
				if (s && s.parent == e.parent && s.offset == e.index && (r = nr + r), o != r) {
					const e = cr(o, r);
					for (const t of e) "insert" === t.type ? i.insertData(t.index, t.values.join("")) : i.deleteData(t.index, t.howMany)
				}
			}
			_updateAttrs(e) {
				const t = this.domConverter.mapViewToDom(e);
				...
				for (const i of n) t.setAttribute(i, e.getAttribute(i));
				for (const n of i) e.hasAttribute(n) || t.removeAttribute(n)
			}
			_updateChildren(e, t) {
				const i = this.domConverter.mapViewToDom(e);
				if (!i) return;
				const n = t.inlineFillerPosition,
					o = this.domConverter.mapViewToDom(e).childNodes,
					r = Array.from(this.domConverter.viewChildrenToDom(e, i.ownerDocument, {
						bind: !0,
						inlineFillerPosition: n
					}));
				n && n.parent === e && pr(i.ownerDocument, r, n.offset);
				const s = this._diffNodeLists(o, r);
				let a = 0;
				const c = new Set;
				for (const e of s) "delete" === e ? (c.add(o[a]), fr(o[a])) : "equal" === e && a++;
				a = 0;
				for (const e of s) "insert" === e ? (hr(i, a, r[a]), a++) : "equal" === e && (this._markDescendantTextToSync(this.domConverter.domToView(r[a])), a++);
				for (const e of c) e.parentNode || this.domConverter.unbindDomElement(e)
			}
			_diffNodeLists(e, t) {
				return ur(e = function (e, t) {
					const i = Array.from(e);
					if (0 == i.length || !t) return i;
					i[i.length - 1] == t && i.pop();
					return i
				}(e, this._fakeSelectionContainer), t, wr.bind(null, this.domConverter))
			}
			_findReplaceActions(e, t, i) {
				...
				for (const a of e) "insert" === a ? r.push(i[s.equal + s.insert]) : "delete" === a ? o.push(t[s.equal + s.delete]) : (n = n.concat(ur(o, r, br).map(e => "equal" === e ? "replace" : e)), n.push("equal"), o = [], r = []), s[a]++;
				return n.concat(ur(o, r, br).map(e => "equal" === e ? "replace" : e))
			}
			...
			_updateDomSelection(e) {
				...
				t.collapse(i.parent, i.offset), t.extend(n.parent, n.offset), Po.isGecko && function (e, t) {
					const i = e.parent;
					if (i.nodeType != Node.ELEMENT_NODE || e.offset != i.childNodes.length - 1) return;
			...
			_fakeSelectionNeedsUpdate(e) {
				...
				return !t || t.parentElement !== e || (i.anchorNode !== t && !t.contains(i.anchorNode) || t.textContent !== this.selection.fakeSelectionLabel)
			}
			_removeDomSelection() {
				for (const e of this.domDocuments) {
					if (e.getSelection().rangeCount) {
						const t = e.activeElement,
							i = this.domConverter.mapDomToView(t);
						t && i && e.getSelection().removeAllRanges()
					}
				}
			}
		...
		function pr(e, t, i) {
			const n = t instanceof Array ? t : t.childNodes,
				o = n[i];
			if (er(o)) return o.data = nr + o.data, o; {
				const o = e.createTextNode(nr);
				return Array.isArray(t) ? n.splice(i, 0, o) : hr(t, i, o), o
			}
		}

		function br(e, t) {
			return gr(e) && gr(t) && !er(e) && !er(t) && e.nodeType !== Node.COMMENT_NODE && t.nodeType !== Node.COMMENT_NODE && e.tagName.toLowerCase() === t.tagName.toLowerCase()
		}

		function wr(e, t, i) {
			return t === i || (er(t) && er(i) ? t.data === i.data : !(!e.isBlockFiller(t) || !e.isBlockFiller(i)))
		}
		Ke(mr, Ue);
		var kr = {
			window: window,
		...
		class xr {
			...
			unbindDomElement(e) {
				...
				if (t) {
					...
					for (const t of e.childNodes) this.unbindDomElement(t)
				}
			}
			...
			viewToDom(e, t, i = {}) {
				if (e.is("$text")) {
					...
					let n;
					if (e.is("documentFragment")) n = t.createDocumentFragment(), i.bind && this.bindDocumentFragments(n, e);
					else {
						if (e.is("uiElement")) return n = e.render(t), i.bind && this.bindElements(n, e), n;
						n = e.hasAttribute("xmlns") ? t.createElementNS(e.getAttribute("xmlns"), e.name) : t.createElement(e.name), e.is("rawElement") && e.render(n), i.bind && this.bindElements(n, e);
						for (const t of e.getAttributeKeys()) n.setAttribute(t, e.getAttribute(t))
					}
					if (!1 !== i.withChildren)
						for (const o of this.viewChildrenToDom(e, t, i)) n.appendChild(o);
					return n
				}
			}* viewChildrenToDom(e, t, i = {}) {
				const n = e.getFillerOffset && e.getFillerOffset();
				let o = 0;
				for (const r of e.getChildren()) n === o && (yield this._blockFiller(t)), yield this.viewToDom(r, t, i), o++;
				n === o && (yield this._blockFiller(t))
			}
			viewRangeToDom(e) {
			...
			domToView(e, t = {}) {
				if (this.isBlockFiller(e, this.blockFillerMode)) return null;
				const i = this.getHostViewElement(e);
				if (i) return i;
				if (er(e)) {
					if (rr(e)) return null; {
						const t = this._processDataFromDomText(e);
						return "" === t ? null : new un(this.document, t)
					}
				}
				if (this.isComment(e)) return null; {
					if (this.mapDomToView(e)) return this.mapDomToView(e);
					let i;
					if (this.isDocumentFragment(e)) i = new Uo(this.document), t.bind && this.bindDocumentFragments(e, i);
					else {
						const n = t.keepOriginalCase ? e.tagName : e.tagName.toLowerCase();
						i = new Xn(this.document, n), t.bind && this.bindElements(e, i);
						const o = e.attributes;
						for (let e = o.length - 1; e >= 0; e--) i._setAttribute(o[e].name, o[e].value);
						if (!1 !== t.withChildren && this._rawContentElementMatcher.match(i)) return i._setCustomProperty("$rawContent", e.innerHTML), this._encounteredRawContentDomNodes.add(e), i
					}
					if (!1 !== t.withChildren)
			...
			domRangeToView(e) {
				...
				return t && i ? new co(t, i) : null
			}
			domPositionToView(e, t) {
				if (this.isBlockFiller(e, this.blockFillerMode)) return this.domPositionToView(e.parentNode, _r(e));
				const i = this.mapDomToView(e);
				if (i && (i.is("uiElement") || i.is("rawElement"))) return ao._createBefore(i);
				if (er(e)) {
					if (rr(e)) return this.domPositionToView(e.parentNode, _r(e));
					const i = this.findCorrespondingViewText(e);
					let n = t;
					return i ? (or(e) && (n -= 7, n = n < 0 ? 0 : n), new ao(i, n)) : null
				}
				if (0 === t) {
					const t = this.mapDomToView(e);
					if (t) return new ao(t, 0)
				} else {
					const i = e.childNodes[t - 1],
						n = er(i) ? this.findCorrespondingViewText(i) : this.mapDomToView(i);
					if (n && n.parent) return new ao(n.parent, n.index + 1)
				}
				return null
			}
			mapDomToView(e) {
			...
			findCorrespondingViewText(e) {
				...
				if (i) {
					...
					if (e) {
						return e.nextSibling instanceof un ? e.nextSibling : null
					}
				} else {
					const t = this.mapDomToView(e.parentNode);
					if (t) {
						const e = t.getChild(0);
						return e instanceof un ? e : null
					}
				}
				return null
			}
			...
			isBlockFiller(e) {
				return "br" == this.blockFillerMode ? e.isEqualNode(yr) : !("BR" !== e.tagName || !Tr(e, this.blockElements) || 1 !== e.parentNode.childNodes.length) || function (e, t) {
					return er(e) && " " == e.data && Tr(e, t) && 1 === e.parentNode.childNodes.length
			...
			_processDataFromViewText(e) {
				...
				if (" " == t.charAt(0)) {
					const i = this._getTouchingViewTextNode(e, !1);
					!(i && this._nodeEndsWithSpace(i)) && i || (t = " " + t.substr(1))
				}
				if (" " == t.charAt(t.length - 1)) {
					const i = this._getTouchingViewTextNode(e, !0);
					" " != t.charAt(t.length - 2) && i && " " != i.data.charAt(0) || (t = t.substr(0, t.length - 1) + " ")
				}
			...
			_processDataFromDomText(e) {
				let t = e.data;
				if (Ar(e, this.preElements)) return sr(e);
				t = t.replace(/[ \n\t\r]{1,}/g, " ");
				...
				return o && (t = t.replace(/^ /, "")), r && (t = t.replace(/ $/, "")), t = sr(new Text(t)), t = t.replace(/ \u00A0/g, "  "), (/( |\u00A0)\u00A0$/.test(t) || !n || n.data && " " == n.data.charAt(0)) && (t = t.replace(/\u00A0$/, " ")), o && (t = t.replace(/^\u00A0/, " ")), t
			}
			_checkShouldLeftTrimDomText(e, t) {
				return !t || (!!Yi(t) || !this._encounteredRawContentDomNodes.has(e.previousSibling) && /[^\S\u00A0]/.test(t.data.charAt(t.data.length - 1)))
			}
			...
			_getTouchingViewTextNode(e, t) {
				const i = new so({
					startPosition: t ? ao._createAfter(e) : ao._createBefore(e),
			...
			_getTouchingInlineDomNode(e, t) {
				...
				const i = t ? "nextNode" : "previousNode",
					n = e.ownerDocument,
					o = vr(e)[0],
					r = n.createTreeWalker(o, NodeFilter.SHOW_TEXT | NodeFilter.SHOW_ELEMENT, {
						acceptNode: e => er(e) || "BR" == e.tagName ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP
					});
				r.currentNode = e;
				const s = r[i]();
				if (null !== s) {
					...
					if (t && !Ar(e, this.blockElements, t) && !Ar(s, this.blockElements, t)) return s
				}
				return null
			}
		}
		...
		function Ar(e, t, i) {
			let n = vr(e);
			return i && (n = n.slice(n.indexOf(i) + 1)), n.some(e => e.tagName && t.includes(e.tagName.toLowerCase()))
		}

		function Cr(e, t) {
			for (; e && e != kr.document;) t(e), e = e.parentNode
		}
		...
		var Pr = Le({}, u, {
			listenTo(e, ...t) {
				if (gr(e) || Er(e)) {
					const i = this._getProxyEmitter(e) || new Sr(e);
					i.attach(...t), e = i
				}
				u.listenTo.call(this, e, ...t)
			},
			stopListening(e, t, i) {
				if (gr(e) || Er(e)) {
				...
				u.stopListening.call(this, e, t, i), e instanceof Sr && e.detach(t)
			},
			_getProxyEmitter(e) {
				return t = this, i = Mr(e), t[l] && t[l][i] ? t[l][i].emitter : null;
				var t, i
			}
		});
		class Sr {
			constructor(e) {
				h(this, Mr(e)), this._domNode = e
			}
		}
		...
		Le(Sr.prototype, u, {
			attach(e, t, i = {}) {
				...
				const n = {
					...
					o = this._createDomListener(e, n);
				this._domNode.addEventListener(e, o, n), this._domListeners || (this._domListeners = {}), this._domListeners[e] = o
			},
			detach(e) {
				let t;
			...
			_createDomListener(e, t) {
				...
				return i.removeListener = () => {
					this._domNode.removeEventListener(e, i, t), delete this._domListeners[e]
				}, i
			}
		});
		class Ir {
		...
		function Or(e) {
			var t = -1,
				i = null == e ? 0 : e.length;
			for (this.__data__ = new Ft; ++t < i;) this.add(e[t])
		}
		Or.prototype.add = Or.prototype.push = Nr, Or.prototype.has = Rr;
		var Dr = Or;
		var Lr = function (e, t) {
		...
		var Vr = function (e, t, i, n, o, r) {
			...
			for (r.set(e, t), r.set(t, e); ++u < a;) {
				var g = e[u],
					m = t[u];
				if (n) var p = s ? n(m, g, u, t, e, r) : n(g, m, u, e, t, r);
				if (void 0 !== p) {
					if (p) continue;
					h = !1;
					break
				...
				if (f) {
					if (!Lr(t, (function (e, t) {
							if (!zr(f, t) && (g === e || o(g, e, i, n, r))) return f.push(t)
						}))) {
						h = !1;
						break
					}
				} else if (g !== m && !o(g, m, i, n, r)) {
					h = !1;
					break
				}
			}
		...
		var Br = function (e) {
			...
			Fr = _ ? _.prototype : void 0,
			Hr = Fr ? Fr.valueOf : void 0;
		var Ur = function (e, t, i, n, o, r, s) {
				switch (i) {
					case "[object DataView]":
						if (e.byteLength != t.byteLength || e.byteOffset != t.byteOffset) return !1;
						e = e.buffer, t = t.buffer;
					case "[object ArrayBuffer]":
						return !(e.byteLength != t.byteLength || !r(new Ci(e), new Ci(t)));
					case "[object Boolean]":
					case "[object Date]":
					case "[object Number]":
						return G(+e, +t);
					...
					case "[object Set]":
						var c = 1 & n;
						if (a || (a = Br), e.size != t.size && !c) return !1;
						var l = s.get(e);
						if (l) return l == t;
						n |= 2, s.set(e, t);
						var d = Vr(a(e), a(t), n, o, r, s);
						return s.delete(e), d;
					case "[object Symbol]":
		...
		var qr = function (e, t, i, n, o, r) {
				var s = 1 & i,
					a = di(e),
					c = a.length;
				if (c != di(t).length && !s) return !1;
				for (var l = c; l--;) {
					var d = a[l];
					if (!(s ? d in t : Wr.call(t, d))) return !1
				}
				var u = r.get(e),
					h = r.get(t);
				...
				for (var g = s; ++l < c;) {
					var m = e[d = a[l]],
						p = t[d];
					if (n) var b = s ? n(p, m, d, t, e, r) : n(m, p, d, e, t, r);
					if (!(void 0 === b ? m === p || o(m, p, i, n, r) : b)) {
						f = !1;
						break
					}
					g || (g = "constructor" == d)
				...
				if (f && !g) {
					var w = e.constructor,
						k = t.constructor;
					w == k || !("constructor" in e) || !("constructor" in t) || "function" == typeof w && w instanceof w && "function" == typeof k && k instanceof k || (f = !1)
				}
				return r.delete(e), r.delete(t), f
			},
			$r = Object.prototype.hasOwnProperty;
		var Yr = function (e, t, i, n, o, r) {
			var s = _e(e),
				a = _e(t),
				c = s ? "[object Array]" : yi(e),
				l = a ? "[object Array]" : yi(t),
				d = "[object Object]" == (c = "[object Arguments]" == c ? "[object Object]" : c),
				u = "[object Object]" == (l = "[object Arguments]" == l ? "[object Object]" : l),
				h = c == l;
			if (h && Object(ve.a)(e)) {
				if (!Object(ve.a)(t)) return !1;
				s = !0, d = !1
			}
			if (h && !d) return r || (r = new Wt), s || Ee(e) ? Vr(e, t, i, n, o, r) : Ur(e, t, c, i, n, o, r);
			if (!(1 & i)) {
				var f = d && $r.call(e, "__wrapped__"),
					g = u && $r.call(t, "__wrapped__");
				if (f || g) {
					var m = f ? e.value() : e,
						p = g ? t.value() : t;
					return r || (r = new Wt), o(m, p, i, n, r)
				}
			}
			return !!h && (r || (r = new Wt), qr(e, t, i, n, o, r))
		};
		var Gr = function e(t, i, n, o, r) {
			return t === i || (null == t || null == i || !ge(t) && !ge(i) ? t != t && i != i : Yr(t, i, n, o, e, r))
		};
		var Kr = function (e, t, i) {
			var n = (i = "function" == typeof i ? i : void 0) ? i(e, t) : void 0;
			return void 0 === n ? Gr(e, t, void 0, i) : !!n
		};
		class Qr extends Ir {
			constructor(e) {
			...
			_onMutations(e) {
				...
				for (const i of e)
					if ("childList" === i.type) {
						...
						if (e && (e.is("uiElement") || e.is("rawElement"))) continue;
						e && !this._isBogusBrMutation(i) && n.add(e)
					} for (const o of e) {
					const e = t.mapDomToView(o.target);
					if ((!e || !e.is("uiElement") && !e.is("rawElement")) && "characterData" === o.type) {
						const e = t.findCorrespondingViewText(o.target);
						e && !n.has(e.parent) ? i.set(e, {
							type: "text",
							oldText: e.data,
							newText: sr(o.target),
							node: e
						}) : !e && or(o.target) && n.add(t.mapDomToView(o.target.parentNode))
					}
				}
				const o = [];
				for (const e of i.values()) this.renderer.markToSync("text", e.node), o.push(e);
				for (const e of n) {
					const i = t.mapViewToDom(e),
						n = Array.from(e.getChildren()),
						r = Array.from(t.domChildrenToView(i, {
							withChildren: !1
						}));
					Kr(n, r, a) || (this.renderer.markToSync("children", e), o.push({
						type: "children",
						oldChildren: n,
						newChildren: r,
						node: e
				...
				let s = null;
				if (r && r.anchorNode) {
					const e = t.domPositionToView(r.anchorNode, r.anchorOffset),
						i = t.domPositionToView(r.focusNode, r.focusOffset);
					e && i && (s = new ho(e), s.setFocus(i))
				}
		...
		class Jr {
			constructor(e, t, i) {
				this.view = e, this.document = e.document, this.domEvent = t, this.domTarget = t.target, Le(this, i)
			}
			get target() {
		...
		class Zr extends Ir {
			...
			observe(e) {
				("string" == typeof this.domEventType ? [this.domEventType] : this.domEventType).forEach(t => {
					this.listenTo(e, t, (e, t) => {
						this.isEnabled && !this.checkShouldIgnoreEventFromTarget(t.target) && this.onDomEvent(t)
					}, {
			...
			fire(e, t, i) {
				this.isEnabled && this.document.fire(e, new Jr(this.view, t, i))
			}
		}
		class Xr extends Zr {
			constructor(e) {
		...
		var is = function (e) {
			...
			ns = /^\s+/;
		var os = function (e) {
				return e ? e.slice(0, is(e) + 1).replace(ns, "") : e
			},
			rs = /^[-+]0x[0-9a-f]+$/i,
			ss = /^0b[01]+$/i,
			as = /^0o[0-7]+$/i,
		...
		var ls = function (e) {
				...
				e = os(e);
				var i = ss.test(e);
				return i || as.test(e) ? cs(e.slice(2), i ? 2 : 8) : rs.test(e) ? NaN : +e
			},
			ds = Math.max,
			us = Math.min;
		var hs = function (e, t, i) {
			var n, o, r, s, a, c, l = 0,
				d = !1,
				u = !1,
				h = !0;
			...
			function f(t) {
				var i = n,
					r = o;
				return n = o = void 0, l = t, s = e.apply(r, i)
			}

			function g(e) {
				return l = e, a = setTimeout(p, t), d ? f(e) : s
			}

			function m(e) {
				var i = e - c;
				return void 0 === c || i >= t || i < 0 || u && e - l >= r
			}

			function p() {
				var e = es();
				if (m(e)) return b(e);
				a = setTimeout(p, function (e) {
					var i = t - (e - c);
					return u ? us(i, r - (e - l)) : i
				}(e))
			}

			function b(e) {
				return a = void 0, h && n ? f(e) : (n = o = void 0, s)
			}

			function k() {
				var e = es(),
					i = m(e);
				if (n = arguments, o = this, c = e, i) {
					if (void 0 === a) return g(c);
					if (u) return clearTimeout(a), a = setTimeout(p, t), f(c)
				}
				return void 0 === a && (a = setTimeout(p, t)), s
			}
			return t = ls(t) || 0, w(i) && (d = !!i.leading, r = (u = "maxWait" in i) ? ds(ls(i.maxWait) || 0, t) : r, h = "trailing" in i ? !!i.trailing : h), k.cancel = function () {
				void 0 !== a && clearTimeout(a), l = 0, n = c = o = a = void 0
			}, k.flush = function () {
				return void 0 === a ? s : b(es())
			}, k
		};
		class fs extends Ir {
			constructor(e) {
				super(e), this._fireSelectionChangeDoneDebounced = hs(e => this.document.fire("selectionChangeDone", e), 200)
			}
			observe() {
			...
			_handleSelectionMove(e) {
				const t = this.document.selection,
					i = new ho(t.getRanges(), {
						backward: t.isBackward,
						fake: !1
					});
				e != Io.arrowleft && e != Io.arrowup || i.setTo(i.getFirstPosition()), e != Io.arrowright && e != Io.arrowdown || i.setTo(i.getLastPosition());
				const n = {
					oldSelection: t,
					newSelection: i,
					domSelection: null
		...
		class gs extends Ir {
			constructor(e) {
				super(e), this.mutationObserver = e.getObserver(Qr), this.selection = this.document.selection, this.domConverter = e.domConverter, this._documents = new WeakSet, this._fireSelectionChangeDoneDebounced = hs(e => this.document.fire("selectionChangeDone", e), 200), this._clearInfiniteLoopInterval = setInterval(() => this._clearInfiniteLoop(), 1e3), this._loopbackCounter = 0
			}
			observe(e) {
				const t = e.ownerDocument;
				this._documents.has(t) || (this.listenTo(t, "selectionchange", (e, i) => {
			...
			_handleSelectionChange(e, t) {
				...
				if (0 != n.rangeCount) {
					if (this.view.hasDomSelection = !0, !(this.selection.isEqual(n) && this.domConverter.isDomSelectionCorrect(i) || ++this._loopbackCounter > 60))
		...
		class ms extends Zr {
			constructor(e) {
				...
				t.on("focus", () => {
					t.isFocused = !0, this._renderTimeoutId = setTimeout(() => e.forceRender(), 50)
				}), t.on("blur", (i, n) => {
					const o = t.selection.editableElement;
					null !== o && o !== n.target || (t.isFocused = !1, e.forceRender())
				})
			}
			onDomEvent(e) {
				this.fire(e.type, e)
		...
		var ks = function (e) {
			return "string" == typeof e || !_e(e) && ge(e) && "[object String]" == S(e)
		};
		...
		class xs {
			constructor(e) {
				...
				if (Object.defineProperty(this, "_source", {
					...
					if (t) {
						const t = xs.getDomRangeRects(e);
						As(this, xs.getBoundingRect(t))
					} else As(this, e.getBoundingClientRect());
				else if (Er(e)) {
					const {
						innerWidth: t,
						innerHeight: i
			...
			getIntersection(e) {
				...
				return t.width = t.right - t.left, t.height = t.bottom - t.top, t.width < 0 || t.height < 0 ? null : new xs(t)
			}
			...
			excludeScrollbarsAndBorders() {
				const e = this._source;
				let t, i, n;
				if (Er(e)) t = e.innerWidth - e.document.documentElement.clientWidth, i = e.innerHeight - e.document.documentElement.clientHeight, n = e.getComputedStyle(e.document.documentElement).direction;
				else {
			...
			static getDomRangeRects(e) {
				...
				if (i.length)
					for (const e of i) t.push(new xs(e));
				else {
			...
			static getBoundingRect(e) {
				...
				return 0 == i ? null : (t.width = t.right - t.left, t.height = t.bottom - t.top, new xs(t))
			}
		}

		function As(e, t) {
			for (const i of ys) e[i] = t[i]
		}

		function Cs(e) {
			return !!Yi(e) && e === e.ownerDocument.body
		}
		class Ts {
			constructor(e, t) {
				Ts._observerInstance || Ts._createObserver(), this._element = e, this._callback = t, Ts._addElementCallback(e, t), Ts._observerInstance.observe(e)
			}
			destroy() {
				Ts._deleteElementCallback(this._element, this._callback)
			}
			static _addElementCallback(e, t) {
				Ts._elementCallbacks || (Ts._elementCallbacks = new Map);
				let i = Ts._elementCallbacks.get(e);
				i || (i = new Set, Ts._elementCallbacks.set(e, i)), i.add(t)
			}
			static _deleteElementCallback(e, t) {
				const i = Ts._getElementCallbacks(e);
				i && (i.delete(t), i.size || (Ts._elementCallbacks.delete(e), Ts._observerInstance.unobserve(e))), Ts._elementCallbacks && !Ts._elementCallbacks.size && (Ts._observerInstance = null, Ts._elementCallbacks = null)
			}
			static _getElementCallbacks(e) {
				return Ts._elementCallbacks ? Ts._elementCallbacks.get(e) : null
			}
			static _createObserver() {
				let e;
				e = "function" == typeof kr.window.ResizeObserver ? kr.window.ResizeObserver : Es, Ts._observerInstance = new e(e => {
					for (const t of e) {
						const e = Ts._getElementCallbacks(t.target);
						if (e)
		...
		Ts._observerInstance = null, Ts._elementCallbacks = null;
		class Es {
			constructor(e) {
			...
			_checkElementRectsAndExecuteCallback() {
				const e = [];
				for (const t of this._elements) this._hasRectChanged(t) && e.push({
					target: t,
			...
			_hasRectChanged(e) {
				...
				const t = new xs(e),
					i = this._previousRects.get(e),
					n = !i || !i.isEqual(t);
				return this._previousRects.set(e, t), n
			}
		}
		...
		class Is {
			...
			listenTo(e) {
				this._listener.listenTo(e, "keydown", (e, t) => {
					this._listener.fire("_keydown:" + Ro(t), t)
				})
			}
			set(e, t, i = {}) {
				const n = Oo(e),
					o = i.priority;
				this._listener.listenTo(this._listener, "_keydown:" + n, (e, i) => {
					t(i, () => {
			...
			press(e) {
				return !!this._listener.fire("_keydown:" + Ro(e), e)
			}
			destroy() {
		...
		class Ns extends Ir {
			constructor(e) {
				super(e), this.document.on("keydown", (e, t) => {
					if (this.isEnabled && ((i = t.keyCode) == Io.arrowright || i == Io.arrowleft || i == Io.arrowup || i == Io.arrowdown)) {
						const i = new go(this.document, "arrowKey", this.document.selection.getFirstRange());
		...
		function Rs({
			...
			for (; n;) {
				let r;
				r = Fs(n == i ? e : o), Ds(r, () => Hs(e, n));
				const s = Hs(e, n);
				if (Os(n, s, t), n.parent != n) {
		...
		function Os(e, t, i) {
			const n = t.clone().moveBy(0, i),
				o = t.clone().moveBy(0, -i),
				r = new xs(e).excludeScrollbarsAndBorders();
			if (![o, n].every(e => r.contains(e))) {
				let {
					scrollX: s,
					scrollY: a
				} = e;
				zs(o, r) ? a -= r.top - t.top + i : Ls(n, r) && (a += t.bottom - r.bottom + i), Vs(t, r) ? s -= r.left - t.left + i : js(t, r) && (s += t.right - r.right + i), e.scrollTo(s, a)
			}
		}
		...
		function Ds(e, t) {
			const i = Bs(e);
			let n, o;
			for (; e != i.document.body;) o = t(), n = new xs(e).excludeScrollbarsAndBorders(), n.contains(o) || (zs(o, n) ? e.scrollTop -= n.top - o.top : Ls(o, n) && (e.scrollTop += o.bottom - n.bottom), Vs(o, n) ? e.scrollLeft -= n.left - o.left : js(o, n) && (e.scrollLeft += o.right - n.right)), e = e.parentNode
		}
		...
		function Bs(e) {
			return _s(e) ? e.startContainer.ownerDocument.defaultView : e.ownerDocument.defaultView
		}
			...
			if (i === t) return n; {
				...
				for (; e != t;) {
					const t = e.frameElement,
						i = new xs(t).excludeScrollbarsAndBorders();
		...
		class Us {
			...
			attachDomRoot(e, t = "main") {
				...
				for (const {
						name: t,
						value: o
					} of Array.from(e.attributes)) n[t] = o, "class" === t ? this._writer.addClass(o.split(" "), i) : this._writer.setAttribute(t, o, i);
				...
				o(), this.domRoots.set(t, e), this.domConverter.bindElements(e, i), this._renderer.markToSync("children", i), this._renderer.markToSync("attributes", i), this._renderer.domDocuments.add(e.ownerDocument), i.on("change:children", (e, t) => this._renderer.markToSync("children", t)), i.on("change:attributes", (e, t) => this._renderer.markToSync("attributes", t)), i.on("change:text", (e, t) => this._renderer.markToSync("text", t)), i.on("change:isReadOnly", () => this.change(o)), i.on("change", () => {
					this._hasChangedSinceTheLastRendering = !0
				});
		...
		class Ws {
			constructor(e) {
				this.parent = null, this._attrs = fn(e)
			}
			get index() {
				let e;
				if (!this.parent) return null;
			...
			toJSON() {
				const e = {};
				return this._attrs.size && (e.attributes = Array.from(this._attrs).reduce((e, t) => (e[t[0]] = t[1], e), {})), e
			}
			is(e) {
				return "node" === e || "model:node" === e
			}
			_clone() {
				return new Ws(this._attrs)
			}
			_remove() {
				this.parent._removeChildren(this.index)
			}
		...
		class qs extends Ws {
			...
			static fromJSON(e) {
				return new qs(e.data, e.attributes)
			}
		}
		class $s {
			constructor(e, t, i) {
				if (this.textNode = e, t < 0 || t > e.offsetSize) throw new c.a("model-textproxy-wrong-offsetintext", this);
				if (i < 0 || t + i > e.offsetSize) throw new c.a("model-textproxy-wrong-length", this);
				this.data = e.data.substring(t, t + i), this.offsetInText = t
			}
			get startOffset() {
		...
		class Ys {
			...
			_insertNodes(e, t) {
				for (const e of t)
					if (!(e instanceof Ws)) throw new c.a("model-nodelist-insertnodes-not-node", this);
		...
		class Gs extends Ws {
			constructor(e, t, i) {
				super(t), this.name = e, this._children = new Ys, i && this._insertChild(0, i)
			}
			get childCount() {
				return this._children.length
			}
			...
			_insertChild(e, t) {
				const i = function (e) {
					if ("string" == typeof e) return [new qs(e)];
					Ji(e) || (e = [e]);
					return Array.from(e).map(e => "string" == typeof e ? new qs(e) : e instanceof $s ? new qs(e.data, e.getAttributes()) : e)
				}(t);
				for (const e of i) null !== e.parent && e._remove(), e.parent = this;
			...
			static fromJSON(e) {
				...
				if (e.children) {
					t = [];
					for (const i of e.children) i.name ? t.push(Gs.fromJSON(i)) : t.push(qs.fromJSON(i))
				}
		...
		class Ks {
			...
			skip(e) {
				let t, i, n, o;
				do {
					n = this.position, o = this._visitedParent, ({
						done: t,
						value: i
					} = this.next())
				} while (!t && e(i));
				t || (this.position = n, this._visitedParent = o)
			}
			next() {
				return "forward" == this.direction ? this._next() : this._previous()
			}
			_next() {
				...
				if (null === i.parent && t.offset === i.maxOffset) return {
					done: !0
				};
				if (i === this._boundaryEndParent && t.offset == this.boundaries.end.offset) return {
					done: !0
				};
				const n = t.parent,
					o = Zs(t, n),
					r = o || Xs(t, n, o);
				if (r instanceof Gs) return this.shallow ? t.offset++ : (t.path.push(0), this._visitedParent = r), this.position = t, Qs("elementStart", r, e, t, 1);
				if (r instanceof qs) {
					let n;
					if (this.singleCharacters) n = 1;
					else {
						let e = r.endOffset;
						this._boundaryEndParent == i && this.boundaries.end.offset < e && (e = this.boundaries.end.offset), n = e - t.offset
					}
					const o = t.offset - r.startOffset,
						s = new $s(r, o, n);
					return t.offset += n, this.position = t, Qs("text", s, e, t, n)
				}
				return t.path.pop(), t.offset++, this.position = t, this._visitedParent = i.parent, this.ignoreElementEnd ? this._next() : Qs("elementEnd", i, e, t)
			}
			_previous() {
				const e = this.position,
					t = this.position.clone(),
					i = this._visitedParent;
				if (null === i.parent && 0 === t.offset) return {
					done: !0
				};
				...
				const n = t.parent,
					o = Zs(t, n),
					r = o || ea(t, n, o);
				if (r instanceof Gs) return t.offset--, this.shallow ? (this.position = t, Qs("elementStart", r, e, t, 1)) : (t.path.push(r.maxOffset), this.position = t, this._visitedParent = r, this.ignoreElementEnd ? this._previous() : Qs("elementEnd", r, e, t));
				if (r instanceof qs) {
					let n;
					if (this.singleCharacters) n = 1;
					else {
						let e = r.startOffset;
						this._boundaryStartParent == i && this.boundaries.start.offset > e && (e = this.boundaries.start.offset), n = t.offset - e
					}
					const o = t.offset - r.startOffset,
						s = new $s(r, o - n, n);
					return t.offset -= n, this.position = t, Qs("text", s, e, t, n)
				}
				return t.path.pop(), this.position = t, this._visitedParent = i.parent, Qs("elementStart", i, e, t, 1)
			}
		}
		...
		class Js {
			...
			get parent() {
				...
				for (let t = 0; t < this.path.length - 1; t++)
					if (e = e.getChild(e.offsetToIndex(this.path[t])), !e) throw new c.a("model-position-path-incorrect", this, {
						position: this
					});
			...
			get nodeAfter() {
				const e = this.parent;
				return Xs(this, e, Zs(this, e))
			}
			get nodeBefore() {
				const e = this.parent;
				return ea(this, e, Zs(this, e))
			}
			get isAtStart() {
				return 0 === this.offset
			}
			...
			getCommonPath(e) {
				...
				const t = cn(this.path, e.path),
					i = "string" == typeof t ? Math.min(this.path.length, e.path.length) : t;
			...
			isTouching(e) {
				...
				switch (this.compareWith(e)) {
					case "same":
						return !0;
					case "before":
						t = Js._createAt(this), i = Js._createAt(e);
						break;
					case "after":
						t = Js._createAt(e), i = Js._createAt(this);
						break;
					default:
						return !1
				}
				let n = t.parent;
				for (; t.path.length + i.path.length;) {
					if (t.isEqual(i)) return !0;
					if (t.path.length > i.path.length) {
			...
			_getTransformedByMergeOperation(e) {
				const t = e.movedRange;
				let i;
				return t.containsPosition(this) || t.start.isEqual(this) ? (i = this._getCombined(e.sourcePosition, e.targetPosition), e.sourcePosition.isBefore(e.targetPosition) && (i = i._getTransformedByDeletion(e.deletionPosition, 1))) : i = this.isEqual(e.deletionPosition) ? Js._createAt(e.deletionPosition) : this._getTransformedByMove(e.deletionPosition, e.graveyardPosition, 1), i
			}
			_getTransformedByDeletion(e, t) {
				const i = Js._createAt(this);
			...
			_getTransformedByInsertion(e, t) {
				const i = Js._createAt(this);
				if (this.root != e.root) return i;
				if ("same" == cn(e.getParentPath(), this.getParentPath()))(e.offset < this.offset || e.offset == this.offset && "toPrevious" != this.stickiness) && (i.offset += t);
				else if ("prefix" == cn(e.getParentPath(), this.getParentPath())) {
					const n = e.path.length - 1;
			...
			_getTransformedByMove(e, t, i) {
				if (t = t._getTransformedByDeletion(e, i), e.isEqual(t)) return Js._createAt(this);
				const n = this._getTransformedByDeletion(e, i);
				return null === n || e.isEqual(this) && "toNext" == this.stickiness || e.getShiftedBy(i).isEqual(this) && "toPrevious" == this.stickiness ? this._getCombined(e, t) : n._getTransformedByInsertion(t, i)
			}
			_getCombined(e, t) {
			...
			static _createAt(e, t, i = "toNone") {
				if (e instanceof Js) return new Js(e.root, e.path, e.stickiness); {
					const n = e;
					...
					if (!n.is("element") && !n.is("documentFragment")) throw new c.a("model-position-parent-incorrect", [this, e]);
					const o = n.getPath();
		...
		class ta {
			constructor(e, t = null) {
				this.start = Js._createAt(e), this.end = t ? Js._createAt(t) : Js._createAt(e), this.start.stickiness = this.isCollapsed ? "toNone" : "toNext", this.end.stickiness = this.isCollapsed ? "toNone" : "toPrevious"
			}*[Symbol.iterator]() {
				yield* new Ks({
					boundaries: this,
					ignoreElementEnd: !0
			...
			getDifference(e) {
				const t = [];
				return this.isIntersecting(e) ? (this.containsPosition(e.start) && t.push(new ta(this.start, e.start)), this.containsPosition(e.end) && t.push(new ta(e.end, this.end))) : t.push(new ta(this.start, this.end)), t
			}
			getIntersection(e) {
				if (this.isIntersecting(e)) {
					let t = this.start,
						i = this.end;
					return this.containsPosition(e.start) && (t = e.start), this.containsPosition(e.end) && (i = e.end), new ta(t, i)
				}
				return null
			}
			getJoined(e, t = !1) {
				let i = this.isIntersecting(e);
				if (i || (i = this.start.isBefore(e.start) ? t ? this.end.isTouching(e.start) : this.end.isEqual(e.start) : t ? e.end.isTouching(this.start) : e.end.isEqual(this.start)), !i) return null;
				let n = this.start,
					o = this.end;
				return e.start.isBefore(n) && (n = e.start), e.end.isAfter(o) && (o = e.end), new ta(n, o)
			}
			getMinimalFlatRanges() {
				const e = [],
					t = this.start.getCommonPath(this.end).length,
					i = Js._createAt(this.start);
				let n = i.parent;
				for (; i.path.length > t + 1;) {
					const t = n.maxOffset - i.offset;
					0 !== t && e.push(new ta(i, i.getShiftedBy(t))), i.path = i.path.slice(0, -1), i.offset++, n = n.parent
				}
				for (; i.path.length <= this.end.path.length;) {
					const t = this.end.path[i.path.length - 1],
						n = t - i.offset;
					0 !== n && e.push(new ta(i, i.getShiftedBy(n))), i.offset = t, i.path.push(0)
				}
				return e
			}
			getWalker(e = {}) {
				return e.boundaries = this, new Ks(e)
			}* getItems(e = {}) {
				e.boundaries = this, e.ignoreElementEnd = !0;
				const t = new Ks(e);
				for (const e of t) yield e.item
			...
			getTransformedByOperations(e) {
				const t = [new ta(this.start, this.end)];
				for (const i of e)
				...
				for (let e = 0; e < t.length; e++) {
					...
					for (let n = e + 1; n < t.length; n++) {
						const e = t[n];
						(i.containsRange(e) || e.containsRange(i) || i.isEqual(e)) && t.splice(n, 1)
					}
				}
				return t
			}
			...
			_getTransformedBySplitOperation(e) {
				...
				return this.end.isEqual(e.insertionPosition) && (i = this.end.getShiftedBy(1)), t.root != i.root && (i = this.end.getShiftedBy(-1)), new ta(t, i)
			}
			_getTransformedByMergeOperation(e) {
				if (this.start.isEqual(e.targetPosition) && this.end.isEqual(e.deletionPosition)) return new ta(this.start);
				let t = this.start._getTransformedByMergeOperation(e),
					i = this.end._getTransformedByMergeOperation(e);
				return t.root != i.root && (i = this.end.getShiftedBy(-1)), t.isAfter(i) ? (e.sourcePosition.isBefore(e.targetPosition) ? (t = Js._createAt(i), t.offset = 0) : (e.deletionPosition.isEqual(t) || (i = e.deletionPosition), t = e.targetPosition), new ta(t, i)) : new ta(t, i)
			}
			_getTransformedByInsertion(e, t, i = !1) {
				if (i && this.containsPosition(e)) return [new ta(this.start, e), new ta(e.getShiftedBy(t), this.end._getTransformedByInsertion(e, t))]; {
					const i = new ta(this.start, this.end);
			...
			_getTransformedByMove(e, t, i, n = !1) {
				...
				const o = ta._createFromPositionAndShift(e, i),
				...
				if (1 == a.length ? c = new ta(a[0].start._getTransformedByDeletion(e, i), a[0].end._getTransformedByDeletion(e, i)) : 2 == a.length && (c = new ta(this.start, this.end._getTransformedByDeletion(e, i))), s = c ? c._getTransformedByInsertion(r, i, null !== l || n) : [], l) {
					const e = new ta(l.start._getCombined(o.start, r), l.end._getCombined(o.start, r));
			...
			_getTransformedByDeletion(e, t) {
				...
				return null == i && null == n ? null : (null == i && (i = e), null == n && (n = e), new ta(i, n))
			}
			static _createFromPositionAndShift(e, t) {
				const i = e,
					n = e.getShiftedBy(t);
			...
			static _createIn(e) {
				return new this(Js._createAt(e, 0), Js._createAt(e, e.maxOffset))
			}
			static _createOn(e) {
				return this._createFromPositionAndShift(Js._createBefore(e), e.offsetSize)
			}
			static _createFromRanges(e) {
				...
				if (i > 0)
					for (let t = i - 1; e[t].end.isEqual(n.start); t++) n.start = Js._createAt(e[t].start);
				for (let t = i + 1; t < e.length && e[t].start.isEqual(n.end); t++) n.end = Js._createAt(e[t].end);
				return n
			}
			static fromJSON(e, t) {
				return new this(Js.fromJSON(e.start, t), Js.fromJSON(e.end, t))
			}
		}
		class ia {
			constructor() {
				this._modelToViewMapping = new WeakMap, this._viewToModelMapping = new WeakMap, this._viewToModelLengthCallbacks = new Map, this._markerNameToElements = new Map, this._elementToMarkerNames = new Map, this._unboundMarkerNames = new Set, this.on("modelToViewPosition", (e, t) => {
					...
					t.modelPosition = Js._createAt(n, o)
				}, {
					priority: "low"
				})
			}
			...
			unbindViewElement(e) {
				...
				if (this._viewToModelMapping.delete(e), this._elementToMarkerNames.has(e))
					for (const t of this._elementToMarkerNames.get(e)) this._unboundMarkerNames.add(t);
			...
			unbindElementFromMarkerName(e, t) {
				...
				i && (i.delete(e), 0 == i.size && this._markerNameToElements.delete(t));
				const n = this._elementToMarkerNames.get(e);
				n && (n.delete(t), 0 == n.size && this._elementToMarkerNames.delete(e))
			}
			...
			toModelRange(e) {
				return new ta(this.toModelPosition(e.start), this.toModelPosition(e.end))
			}
			toViewRange(e) {
				return new co(this.toViewPosition(e.start), this.toViewPosition(e.end))
			}
			toModelPosition(e) {
				const t = {
					viewPosition: e,
			...
			_toModelOffset(e, t, i) {
				if (i != e) {
					return this._toModelOffset(e.parent, e.index, i) + this._toModelOffset(e, t, e)
				}
			...
			findPositionIn(e, t) {
				let i, n = 0,
					o = 0,
					r = 0;
				if (e.is("$text")) return new ao(e, t);
				for (; o < t;) i = e.getChild(r), n = this.getModelLength(i), o += n, r++;
				return o == t ? this._moveViewPositionToTextNode(new ao(e, r)) : this.findPositionIn(i, t - (o - n))
			}
			_moveViewPositionToTextNode(e) {
				const t = e.nodeBefore,
					i = e.nodeAfter;
				return t instanceof un ? new ao(t, t.data.length) : i instanceof un ? new ao(i, 0) : e
			}
		}
		Ke(ia, u);
		class na {
			...
			add(e, t) {
				t = oa(t), e instanceof $s && (e = this._getSymbolForTextProxy(e)), this._consumable.has(e) || this._consumable.set(e, new Map), this._consumable.get(e).set(t, !0)
			}
			consume(e, t) {
				return t = oa(t), e instanceof $s && (e = this._getSymbolForTextProxy(e)), !!this.test(e, t) && (this._consumable.get(e).set(t, !1), !0)
			}
			test(e, t) {
				t = oa(t), e instanceof $s && (e = this._getSymbolForTextProxy(e));
			...
			revert(e, t) {
				...
				return !1 === i ? (this._consumable.get(e).set(t, !0), !0) : !0 !== i && null
			}
			...
			_addSymbolForTextProxy(e, t, i) {
				...
				let o, r;
				return o = this._textProxyRegistry.get(e), o || (o = new Map, this._textProxyRegistry.set(e, o)), r = o.get(t), r || (r = new Map, o.set(t, r)), r.set(i, n), n
			}
		}
		...
		class ra {
			...
			convertChanges(e, t, i) {
				for (const t of e.getMarkersToRemove()) this.convertMarkerRemove(t.name, t.range, i);
				const n = this._mapChangesWithAutomaticReconversion(e);
				for (const e of n) "insert" === e.type ? this.convertInsert(ta._createFromPositionAndShift(e.position, e.length), i) : "remove" === e.type ? this.convertRemove(e.position, e.length, e.name, i) : "reconvert" === e.type ? this.reconvertElement(e.element, i) : this.convertAttribute(e.range, e.attributeKey, e.attributeOldValue, e.attributeNewValue, i);
				for (const e of this.conversionApi.mapper.flushUnboundMarkerNames()) {
					const n = t.get(e).getRange();
					this.convertMarkerRemove(e, n, i), this.convertMarkerAdd(e, n, i)
				}
				for (const t of e.getMarkersToAdd()) this.convertMarkerAdd(t.name, t.range, i)
			}
			convertInsert(e, t) {
				this.conversionApi.writer = t, this.conversionApi.consumable = this._createInsertConsumable(e);
				for (const t of Array.from(e).map(aa)) this._convertInsertWithAttributes(t);
			...
			convertAttribute(e, t, i, n, o) {
				...
				for (const o of e) {
					const e = {
						item: o.item,
						range: ta._createFromPositionAndShift(o.previousPosition, o.length),
						attributeKey: t,
						attributeOldValue: i,
						attributeNewValue: n
					};
			...
			reconvertElement(e, t) {
				const i = ta._createOn(e);
				this.conversionApi.writer = t, this.conversionApi.consumable = this._createInsertConsumable(i);
				const n = this.conversionApi.mapper,
					o = n.toViewElement(e);
				...
				for (const i of ta._createIn(e)) {
					const {
						item: e
					} = i, o = ca(e, n);
					o ? o.root !== r.root && t.move(t.createRangeOn(o), n.toViewPosition(Js._createBefore(e))) : this._convertInsertWithAttributes(aa(i))
				}
				n.unbindViewElement(o), this._clearConversionApi()
			}
			convertSelection(e, t, i) {
				const n = Array.from(t.getMarkersAtPosition(e.getFirstPosition()));
				if (this.conversionApi.writer = i, this.conversionApi.consumable = this._createSelectionConsumable(e, n), this.fire("selection", {
						selection: e
					}, this.conversionApi), e.isCollapsed) {
					for (const t of n) {
						const i = t.getRange();
						if (!sa(e.getFirstPosition(), t, this.conversionApi.mapper)) continue;
						const n = {
							item: e,
							markerName: t.name,
							markerRange: i
					...
					for (const t of e.getAttributeKeys()) {
						...
						this.conversionApi.consumable.test(e, "attribute:" + i.attributeKey) && this.fire("attribute:" + i.attributeKey + ":$text", i, this.conversionApi)
					}
					this._clearConversionApi()
				}
			}
			convertMarkerAdd(e, t, i) {
				...
				const n = "addMarker:" + e,
					o = new na;
				if (o.add(t, n), this.conversionApi.consumable = o, this.fire(n, {
						markerName: e,
						markerRange: t
					}, this.conversionApi), o.test(t, n)) {
			...
			convertMarkerRemove(e, t, i) {
				t.root.document && "$graveyard" != t.root.rootName && (this.conversionApi.writer = i, this.fire("removeMarker:" + e, {
					markerName: e,
					markerRange: t
				}, this.conversionApi), this._clearConversionApi())
			}
			...
			_createInsertConsumable(e) {
				...
				for (const i of e) {
					const e = i.item;
					t.add(e, "insert");
					for (const i of e.getAttributeKeys()) t.add(e, "attribute:" + i)
				}
				return t
			}
			_createConsumableForRange(e, t) {
				const i = new na;
				for (const n of e.getItems()) i.add(n, t);
				return i
			}
			_createSelectionConsumable(e, t) {
				const i = new na;
				i.add(e, "selection");
				for (const n of t) i.add(e, "addMarker:" + n.name);
				for (const t of e.getAttributeKeys()) i.add(e, "attribute:" + t);
				return i
			}
			_testAndFire(e, t) {
				this.conversionApi.consumable.test(t.item, e) && this.fire(function (e, t) {
					const i = t.item.name || "$text";
					return `${e}:${i}`
			...
			_convertInsertWithAttributes(e) {
				...
				for (const t of e.item.getAttributeKeys()) e.attributeKey = t, e.attributeOldValue = null, e.attributeNewValue = e.item.getAttribute(t), this._testAndFire("attribute:" + t, e)
			}
			_mapChangesWithAutomaticReconversion(e) {
				const t = new Set,
					i = [];
				for (const n of e.getChanges()) {
					const e = n.position || n.range.start,
						o = e.parent;
					if (Zs(e, o)) {
						i.push(n);
						continue
					}
					const r = "attribute" === n.type ? Xs(e, o, null) : o;
					if (r.is("$text")) {
						i.push(n);
						continue
					}
					let s;
					if (s = "attribute" === n.type ? `attribute:${n.attributeKey}:${r.name}` : `${n.type}:${n.name}`, this._isReconvertTriggerEvent(s, r.name)) {
						if (t.has(r)) continue;
						t.add(r), i.push({
							type: "reconvert",
							element: r
		...
		function aa(e) {
			return {
				item: e.item,
				range: ta._createFromPositionAndShift(e.previousPosition, e.length)
			}
		}

		function ca(e, t) {
			if (e.is("textProxy")) {
				const i = t.toViewPosition(Js._createBefore(e)).parent;
		...
		class la {
			constructor(e, t, i) {
				this._lastRangeBackward = !1, this._ranges = [], this._attrs = new Map, e && this.setTo(e, t, i)
			}
			get anchor() {
			...
			isEqual(e) {
				...
				for (const e of this._ranges) yield new ta(e.start, e.end)
			}
			getFirstRange() {
				let e = null;
				for (const t of this._ranges) e && !t.start.isBefore(e.start) || (e = t);
				return e ? new ta(e.start, e.end) : null
			}
			getLastRange() {
				let e = null;
				for (const t of this._ranges) e && !t.end.isAfter(e.end) || (e = t);
			...
			setTo(e, t, i) {
				...
				else if (e instanceof la) this._setRanges(e.getRanges(), e.isBackward);
				else if (e && "function" == typeof e.getRanges) this._setRanges(e.getRanges(), e.isBackward);
				else if (e instanceof ta) this._setRanges([e], !!t && !!t.backward);
				else if (e instanceof Js) this._setRanges([new ta(e)]);
				else if (e instanceof Ws) {
					const n = !!i && !!i.backward;
					let o;
					if ("in" == t) o = ta._createIn(e);
					else if ("on" == t) o = ta._createOn(e);
					else {
						if (void 0 === t) throw new c.a("model-selection-setto-required-second-parameter", [this, e]);
						o = new ta(Js._createAt(e, t))
					}
					this._setRanges([o], n)
				} else {
			...
			_setRanges(e, t = !1) {
				const i = (e = Array.from(e)).some(t => {
					if (!(t instanceof ta)) throw new c.a("model-selection-set-ranges-not-range", [this, e]);
					return this._ranges.every(e => !e.isEqual(t))
				});
				if (e.length !== this._ranges.length || i) {
			...
			setFocus(e, t) {
				...
				const i = Js._createAt(e, t);
				if ("same" == i.compareWith(this.focus)) return;
				const n = this.anchor;
				this._ranges.length && this._popRange(), "before" == i.compareWith(n) ? (this._pushRange(new ta(i, n)), this._lastRangeBackward = !0) : (this._pushRange(new ta(n, i)), this._lastRangeBackward = !1), this.fire("change:range", {
					directChange: !0
				})
			}
			getAttribute(e) {
			...
			is(e) {
				...
				for (const t of this.getRanges()) {
					const i = ha(t.start, e);
					i && fa(i, t) && (yield i);
					for (const i of t.getWalker()) {
						const n = i.item;
						"elementEnd" == i.type && ua(n, e, t) && (yield n)
					}
					const n = ha(t.end, e);
					n && !t.end.isTouching(Js._createAt(n, 0)) && fa(n, t) && (yield n)
				}
			}
			containsEntireContent(e = this.anchor.root) {
				const t = Js._createAt(e, 0),
					i = Js._createAt(e, "end");
				return t.isTouching(this.getFirstPosition()) && i.isTouching(this.getLastPosition())
			}
			_pushRange(e) {
				this._checkRange(e), this._ranges.push(new ta(e.start, e.end))
			}
			_checkRange(e) {
				for (let t = 0; t < this._ranges.length; t++)
					if (e.isIntersecting(this._ranges[t])) throw new c.a("model-selection-range-intersects", [this, e], {
						addedRange: e,
		...
		function ua(e, t, i) {
			return da(e, t) && fa(e, i)
		}

		function ha(e, t) {
			const i = e.parent.root.document.model.schema,
				n = e.parent.getAncestors({
					parentFirst: !0,
					includeSelf: !0
				});
			let o = !1;
			const r = n.find(e => !o && (o = i.isLimit(e), !o && da(e, t)));
		...
		function fa(e, t) {
			...
			if (!i) return !0;
			return !t.containsRange(ta._createOn(i), !0)
		}
		Ke(la, u);
		class ga extends ta {
			constructor(e, t) {
				super(e, t), ma.call(this)
			}
			detach() {
				this.stopListening()
			}
			...
			static fromRange(e) {
				return new ga(e.start, e.end)
			}
		}

		function ma() {
			this.listenTo(this.root.document.model, "applyOperation", (e, t) => {
				const i = t[0];
				i.isDocumentOperation && pa.call(this, i)
			}, {
				priority: "low"
			})
		}
		...
		function pa(e) {
			...
			let r = null;
			if (n) {
				"$graveyard" == i.root.rootName && (r = "remove" == e.type ? e.sourcePosition : e.deletionPosition);
				const t = this.toRange();
				this.start = i.start, this.end = i.end, this.fire("change:range", t, {
					deletionPosition: r
				})
		...
		class ba {
			constructor(e) {
				this._selection = new wa(e), this._selection.delegate("change:range").to(this), this._selection.delegate("change:attribute").to(this), this._selection.delegate("change:marker").to(this)
			}
			get isCollapsed() {
				return this._selection.isCollapsed
			}
		...
		class wa extends la {
			constructor(e) {
				super(), this.markers = new Zi({
					idProperty: "name"
				}), this._model = e.model, this._document = e, this._attributePriority = new Map, this._selectionRestorePosition = null, this._hasChangedRange = !1, this._overriddenGravityRegister = new Set, this._observedMarkers = new Set, this.listenTo(this._model, "applyOperation", (e, t) => {
					const i = t[0];
					i.isDocumentOperation && "marker" != i.type && "rename" != i.type && "noop" != i.type && (0 == this._ranges.length && this._selectionRestorePosition && this._fixGraveyardSelection(this._selectionRestorePosition), this._selectionRestorePosition = null, this._hasChangedRange && (this._hasChangedRange = !1, this.fire("change:range", {
						directChange: !1
					})))
				}, {
					priority: "lowest"
					...
					for (const e of this.getRanges())
						if (!this._document._validateSelectionRange(e)) throw new c.a("document-selection-wrong-position", this, {
							range: e
						})
					...
					! function (e, t) {
						...
						for (const n of i.getChanges()) {
							...
							n.length === i.maxOffset && e.enqueueChange(t, e => {
								const t = Array.from(i.getAttributeKeys()).filter(e => e.startsWith("selection:"));
			...
			_prepareRange(e) {
				...
				const t = ga.fromRange(e);
				return t.on("change:range", (e, i, n) => {
			...
			_updateMarkers() {
				...
				for (const t of this._model.markers) {
					...
					const n = t.getRange();
					for (const i of this.getRanges()) n.containsRange(i, !i.isCollapsed) && e.push(t)
				}
				...
				if (t) {
					...
					for (const e of this.getRanges())
						if (t.containsRange(e, !e.isCollapsed)) {
							i = !0;
							break
						} i && !r ? (this.markers.add(e), n = !0) : !i && r && (this.markers.remove(e), n = !0)
				} else r && (this.markers.remove(e), n = !0);
				n && this.fire("change:marker", {
					oldMarkers: o,
					directChange: !1
				})
			}
			_updateAttributes(e) {
				const t = fn(this._getSurroundingAttributes()),
					i = fn(this.getAttributes());
				...
				const n = [];
				for (const [e, t] of this.getAttributes()) i.has(e) && i.get(e) === t || n.push(e);
				for (const [e] of i) this.hasAttribute(e) || n.push(e);
				n.length > 0 && this.fire("change:attribute", {
					attributeKeys: n,
					directChange: !1
				})
			}
			_setAttribute(e, t, i = !0) {
				...
				return super.getAttribute(e) !== t && (this._attrs.set(e, t), this._attributePriority.set(e, n), !0)
			}
			_removeAttribute(e, t = !0) {
				const i = t ? "normal" : "low";
				return ("low" != i || "normal" != this._attributePriority.get(e)) && (this._attributePriority.set(e, i), !!super.hasAttribute(e) && (this._attrs.delete(e), !0))
			}
			_setAttributesTo(e) {
				const t = new Set;
				for (const [t, i] of this.getAttributes()) e.get(t) !== i && this._removeAttribute(t, !1);
				for (const [i, n] of e) {
					this._setAttribute(i, n, !1) && t.add(i)
				}
				return t
			}* _getStoredAttributes() {
				...
				if (this.isCollapsed && e.isEmpty)
					for (const t of e.getAttributeKeys())
						if (t.startsWith("selection:")) {
							const i = t.substr("selection:".length);
			...
			_getSurroundingAttributes() {
				...
				if (this.isCollapsed) {
					...
					if (this.isGravityOverridden || (i = ka(n)), i || (i = ka(o)), !this.isGravityOverridden && !i) {
						let e = n;
						for (; e && !t.isInline(e) && !i;) e = e.previousSibling, i = ka(e)
					}
					if (!i) {
						let e = o;
						for (; e && !t.isInline(e) && !i;) e = e.nextSibling, i = ka(e)
					}
		...
		function ka(e) {
			return e instanceof $s || e instanceof qs ? e.getAttributes() : null
		}
		class _a {
			constructor(e) {
				this._dispatchers = e
		...
		class ya extends _a {
			elementToElement(e) {
				return this.add(function (e) {
					return (e = va(e)).view = Ca(e.view, "container"), t => {
						var i;
						if (t.on("insert:" + e.model, (i = e.view, (e, t, n) => {
								const o = i(t.item, n);
								if (!o) return;
								if (!n.consumable.consume(t.item, "insert")) return;
								const r = n.mapper.toViewPosition(t.range.start);
								n.mapper.bindElements(t.item, o), n.writer.insert(r, o)
							}), {
								priority: e.converterPriority || "normal"
							}), e.triggerBy) {
							if (e.triggerBy.attributes)
								for (const i of e.triggerBy.attributes) t._mapReconversionTriggerEvent(e.model, `attribute:${i}:${e.model}`);
							if (e.triggerBy.children)
								for (const i of e.triggerBy.children) t._mapReconversionTriggerEvent(e.model, "insert:" + i), t._mapReconversionTriggerEvent(e.model, "remove:" + i)
						}
					}
				}(e))
			}
			attributeToElement(e) {
				return this.add(function (e) {
					e = va(e);
					let t = "attribute:" + (e.model.key ? e.model.key : e.model);
					e.model.name && (t += ":" + e.model.name);
					if (e.model.values)
						for (const t of e.model.values) e.view[t] = Ca(e.view[t], "attribute");
					else e.view = Ca(e.view, "attribute");
					const i = Ta(e);
					return n => {
						n.on(t, function (e) {
							return (t, i, n) => {
								const o = e(i.attributeOldValue, n),
									r = e(i.attributeNewValue, n);
								if (!o && !r) return;
								if (!n.consumable.consume(i.item, t.name)) return;
								const s = n.writer,
									a = s.document.selection;
								if (i.item instanceof la || i.item instanceof ba) s.wrap(a.getFirstRange(), r);
								else {
									let e = n.mapper.toViewRange(i.range);
									null !== i.attributeOldValue && o && (e = s.unwrap(e, o)), null !== i.attributeNewValue && r && s.wrap(e, r)
								}
							}
						}(i), {
							priority: e.converterPriority || "normal"
			...
			attributeToAttribute(e) {
				return this.add(function (e) {
					...
					e.model.name && (t += ":" + e.model.name);
					if (e.model.values)
						for (const t of e.model.values) e.view[t] = Ea(e.view[t]);
					else e.view = Ea(e.view);
					const i = Ta(e);
					return n => {
						var o;
						n.on(t, (o = i, (e, t, i) => {
							const n = o(t.attributeOldValue, i),
								r = o(t.attributeNewValue, i);
							if (!n && !r) return;
							if (!i.consumable.consume(t.item, e.name)) return;
							const s = i.mapper.toViewElement(t.item),
								a = i.writer;
							if (!s) throw new c.a("conversion-attribute-to-attribute-on-text", [t, i]);
			...
			markerToElement(e) {
				return this.add(function (e) {
					return (e = va(e)).view = Ca(e.view, "ui"), t => {
						var i;
						t.on("addMarker:" + e.model, (i = e.view, (e, t, n) => {
							t.isOpening = !0;
							const o = i(t, n);
							t.isOpening = !1;
							const r = i(t, n);
							...
							const a = n.mapper,
								c = n.writer;
							c.insert(a.toViewPosition(s.start), o), n.mapper.bindElementToMarker(o, t.markerName), s.isCollapsed || (c.insert(a.toViewPosition(s.end), r), n.mapper.bindElementToMarker(r, t.markerName)), e.stop()
						}), {
							priority: e.converterPriority || "normal"
						}), t.on("removeMarker:" + e.model, (e.view, (e, t, i) => {
							const n = i.mapper.markerNameToElements(t.markerName);
							if (n) {
								for (const e of n) i.mapper.unbindElementFromMarkerName(e, t.markerName), i.writer.clear(i.writer.createRangeOn(e), e);
			...
			markerToHighlight(e) {
				return this.add(function (e) {
					return t => {
						...
						t.on("addMarker:" + e.model, (i = e.view, (e, t, n) => {
							if (!t.item) return;
							if (!(t.item instanceof la || t.item instanceof ba || t.item.is("$textProxy"))) return;
							const o = Pa(i, t, n);
							if (!o) return;
							if (!n.consumable.consume(t.item, e.name)) return;
							const r = n.writer,
							...
							if (t.item instanceof la || t.item instanceof ba) r.wrap(a.getFirstRange(), s, a);
							else {
							...
							return (t, i, n) => {
								if (!i.item) return;
								if (!(i.item instanceof Gs)) return;
								const o = Pa(e, i, n);
								if (!o) return;
								...
								if (r && r.getCustomProperty("addHighlight")) {
									...
									for (const e of ta._createIn(i.item)) n.consumable.consume(e.item, t.name);
							...
							return (t, i, n) => {
								...
								const o = Pa(e, i, n);
								if (!o) return;
								const r = xa(n.writer, o),
									s = n.mapper.markerNameToElements(i.markerName);
								if (s) {
									for (const e of s) n.mapper.unbindElementFromMarkerName(e, i.markerName), e.is("attributeElement") ? n.writer.unwrap(n.writer.createRangeOn(e), r) : e.getCustomProperty("removeHighlight")(e, o.id, n.writer);
									n.writer.clearClonedElementsGroup(i.markerName), t.stop()
								}
							}
						}(e.view), {
							priority: e.converterPriority || "normal"
			...
			markerToData(e) {
				return this.add(function (e) {
					const t = (e = va(e)).model;
					e.view || (e.view = i => ({
						group: t,
						name: i.substr(e.model.length + 1)
					}));
					return i => {
						var n;
						i.on("addMarker:" + t, (n = e.view, (e, t, i) => {
							const o = n(t.markerName, i);
							if (!o) return;
							const r = t.markerRange;
							i.consumable.consume(r, e.name) && (Aa(r, !1, i, t, o), Aa(r, !0, i, t, o), e.stop())
						}), {
							priority: e.converterPriority || "normal"
						}), i.on("removeMarker:" + t, function (e) {
							return (t, i, n) => {
								const o = e(i.markerName, n);
								if (!o) return;
								const r = n.mapper.markerNameToElements(i.markerName);
								if (r) {
									for (const e of r) n.mapper.unbindElementFromMarkerName(e, i.markerName), e.is("containerElement") ? (s(`data-${o.group}-start-before`, e), s(`data-${o.group}-start-after`, e), s(`data-${o.group}-end-before`, e), s(`data-${o.group}-end-after`, e)) : n.writer.clear(n.writer.createRangeOn(e), e);
									n.writer.clearClonedElementsGroup(i.markerName), t.stop()
								}
								...
								function s(e, t) {
									if (t.hasAttribute(e)) {
										...
										i.delete(o.name), 0 == i.size ? n.writer.removeAttribute(e, t) : n.writer.setAttribute(e, Array.from(i).join(","), t)
									}
								}
							}
						}(e.view), {
		...
		function xa(e, t) {
			...
			return t.classes && i._addClass(t.classes), t.priority && (i._priority = t.priority), i._id = t.id, i
		}

		function Aa(e, t, i, n, o) {
			const r = t ? e.start : e.end;
			if (i.schema.checkChild(r, "$text")) {
				! function (e, t, i, n, o) {
				...
				let e, s;
				t && r.nodeAfter || !t && !r.nodeBefore ? (e = r.nodeAfter, s = !0) : (e = r.nodeBefore, s = !1);
				! function (e, t, i, n, o, r) {
					const s = `data-${r.group}-${t?"start":"end"}-${i?"before":"after"}`,
						a = e.hasAttribute(s) ? e.getAttribute(s).split(",") : [];
					a.unshift(r.name), n.writer.setAttribute(s, a.join(","), e), n.mapper.bindElementToMarker(e, o.markerName)
				}(i.mapper.toViewElement(e), t, s, i, n, o)
			}
		}

		function Ca(e, t) {
			return "function" == typeof e ? e : (i, n) => function (e, t, i) {
				"string" == typeof e && (e = {
					name: e
				});
				let n;
				...
				if ("container" == i) n = o.createContainerElement(e.name, r);
					...
					const t = {
						priority: e.priority || yo.DEFAULT_PRIORITY
					};
				...
				if (e.classes) {
					...
					if ("string" == typeof t) o.addClass(t, n);
						...
						for (const e of t) o.addClass(e, n)
				}
				return n
			}(e, n, t)
		}
		...
		function Pa(e, t, i) {
			...
			return n ? (n.priority || (n.priority = 10), n.id || (n.id = t.markerName), n) : null
		}
		...
		function Sa(e) {
			...
			for (const n of i.getRootNames()) {
				const o = i.getRoot(n);
				if (o.isEmpty && !t.checkChild(o, "$text") && t.checkChild(o, "paragraph")) return e.insertElement("paragraph", o), !0
			}
			return !1
		}
		...
		class Na extends _a {
			...
			attributeToAttribute(e) {
				return this.add(function (e) {
					e = va(e);
					let t = null;
					("string" == typeof e.view || e.view.key) && (t = function (e) {
						...
						if ("class" == t || "style" == t) {
							...
							const n = void 0 === e.view.value ? /[\s\S]*/ : e.view.value;
							i = {
								attributes: {
									[t]: n
								}
			...
			elementToMarker(e) {
				return Object(c.b)("upcast-helpers-element-to-marker-deprecated"), this.add(function (e) {
					return function (e) {
						const t = e.model;
						e.model = (e, i) => {
							const n = "string" == typeof t ? t : t(e, i);
							return i.writer.createElement("$marker", {
								"data-name": n
							})
						}
					}(e = va(e)), Ra(e)
			...
			dataToMarker(e) {
				return this.add(function (e) {
					(e = va(e)).model || (e.model = t => t ? e.view + ":" + t : e.view);
					const t = Da(Va(e, "start")),
						i = Da(Va(e, "end"));
					return n => {
						n.on("element:" + e.view + "-start", t, {
							priority: e.converterPriority || "normal"
						}), n.on("element:" + e.view + "-end", i, {
							priority: e.converterPriority || "normal"
						});
						const o = a.get("low"),
							r = a.get("highest"),
							s = a.get(e.converterPriority) / r;
						n.on("element", function (e) {
							return (t, i, n) => {
								const o = "data-" + e.view;
								...
								function r(t, o) {
									for (const r of o) {
										...
										n.writer.insert(s, t), i.modelCursor.isEqual(t) ? i.modelCursor = i.modelCursor.getShiftedBy(1) : i.modelCursor = i.modelCursor._getTransformedByInsertion(t, 1), i.modelRange = i.modelRange._getTransformedByInsertion(t, 1)[0]
									}
								}
								i.modelRange || (i = Object.assign(i, n.convertChildren(i.viewItem, i.modelCursor))), n.consumable.consume(i.viewItem, {
									attributes: o + "-end-after"
								}) && r(i.modelRange.end, i.viewItem.getAttribute(o + "-end-after").split(",")), n.consumable.consume(i.viewItem, {
									attributes: o + "-start-after"
								}) && r(i.modelRange.end, i.viewItem.getAttribute(o + "-start-after").split(",")), n.consumable.consume(i.viewItem, {
									attributes: o + "-end-before"
								}) && r(i.modelRange.start, i.viewItem.getAttribute(o + "-end-before").split(",")), n.consumable.consume(i.viewItem, {
									attributes: o + "-start-before"
								}) && r(i.modelRange.start, i.viewItem.getAttribute(o + "-start-before").split(","))
							}
						}(e), {
							priority: o + s
						})
		...
		function Da(e) {
			...
			return (i, n, o) => {
				...
				a && o.safeInsert(a, n.modelCursor) && (o.consumable.consume(n.viewItem, s), o.convertChildren(n.viewItem, a), o.updateConversionResult(a, n))
			}
		}
		...
		function La(e, t = null) {
			const i = null === t || (e => e.getAttribute(t)),
				...
				o = "object" != typeof e.model || void 0 === e.model.value ? i : e.model.value;
			e.model = {
				key: n,
				value: o
			}
		...
		function za(e, t) {
			...
			return (n, o, r) => {
				...
				if (! function (e, t) {
						...
						if ("object" == typeof i && !Oa(i)) return !1;
				...
				(function (e, t, i, n) {
					let o = !1;
					for (const r of Array.from(e.getItems({
							shallow: i
						}))) n.schema.checkAttribute(r, t.key) && (n.writer.setAttribute(t.key, t.value, r), o = !0);
					return o
				})(o.modelRange, {
					key: a,
					value: c
		...
		function Va(e, t) {
			const i = {};
			return i.view = e.view + "-" + t, i.model = (t, i) => {
		...
		class ja {
			constructor(e, t) {
				this.model = e, this.view = new Us(t), this.mapper = new ia, this.downcastDispatcher = new ra({
					mapper: this.mapper,
					schema: e.schema
				});
				...
				this.listenTo(this.model, "_beforeChanges", () => {
					...
					this.view.change(e => {
						this.downcastDispatcher.convertChanges(i.differ, o, e), this.downcastDispatcher.convertSelection(n, o, e)
					})
				}, {
					priority: "low"
					...
					return (i, n) => {
						...
						s.isEqual(e.document.selection) || e.change(e => {
							e.setSelection(s)
						})
					}
				}(this.model, this.mapper)), this.downcastDispatcher.on("insert:$text", (e, t, i) => {
					if (!i.consumable.consume(t.item, "insert")) return;
					const n = i.writer,
					...
					priority: "lowest"
				}), this.downcastDispatcher.on("remove", (e, t, i) => {
					const n = i.mapper.toViewPosition(t.position),
						o = t.position.getShiftedBy(t.length),
						r = i.mapper.toViewPosition(o, {
							isPhantom: !0
						}),
						s = i.writer.createRange(n, r),
						a = i.writer.remove(s.getTrimmed());
					for (const e of i.writer.createRangeIn(a).getItems()) i.mapper.unbindViewElement(e)
				}, {
					priority: "low"
				}), this.downcastDispatcher.on("selection", (e, t, i) => {
					const n = i.writer,
						o = n.document.selection;
					for (const e of o.getRanges()) e.isCollapsed && e.end.parent.isAttached() && i.writer.mergeAttributes(e.start);
					n.setSelection(null)
				}, {
					priority: "low"
				}), this.downcastDispatcher.on("selection", (e, t, i) => {
					...
					const t = new ro(this.view.document, e.name);
					return t.rootName = e.rootName, this.mapper.bindElements(e, t), t
				})
			}
			destroy() {
		...
		class Ba {
			...
			execute(e, ...t) {
				const i = this.get(e);
				if (!i) throw new c.a("commandcollection-command-not-found", this, {
					commandName: e
				});
				return i.execute(...t)
			}* names() {
		...
		class Fa {
			...
			add(e, t) {
				let i;
				e.is("$text") || e.is("documentFragment") ? this._consumables.set(e, !0) : (this._consumables.has(e) ? i = this._consumables.get(e) : (i = new Ha(e), this._consumables.set(e, i)), i.add(t))
			}
			test(e, t) {
				const i = this._consumables.get(e);
				return void 0 === i ? null : e.is("$text") || e.is("documentFragment") ? i : i.test(t)
			}
			consume(e, t) {
			...
			revert(e, t) {
				const i = this._consumables.get(e);
				void 0 !== i && (e.is("$text") || e.is("documentFragment") ? this._consumables.set(e, !0) : i.revert(t))
			}
			static consumablesFromElement(e) {
				...
				for (const e of i) "style" != e && "class" != e && t.attributes.push(e);
			...
			static createFrom(e, t) {
				if (t || (t = new Fa(e)), e.is("$text")) return t.add(e), t;
				e.is("element") && t.add(e, Fa.consumablesFromElement(e)), e.is("documentFragment") && t.add(e);
				for (const i of e.getChildren()) t = Fa.createFrom(i, t);
				return t
			}
		}
		class Ha {
			...
			consume(e) {
				...
				for (const t in this._consumables) t in e && this._consume(t, e[t])
			}
			revert(e) {
				e.name && (this._canConsumeName = !0);
				for (const t in this._consumables) t in e && this._revert(t, e[t])
			}
			_add(e, t) {
				const i = _e(t) ? t : [t],
					n = this._consumables[e];
				for (const t of i) {
					if ("attributes" === e && ("class" === t || "style" === t)) throw new c.a("viewconsumable-invalid-attribute", this);
					if (n.set(t, !0), "styles" === e)
						for (const e of this.element.document.stylesProcessor.getRelatedStyles(t)) n.set(e, !0)
				}
			}
			_test(e, t) {
				const i = _e(t) ? t : [t],
				...
				for (const t of i)
					if ("attributes" !== e || "class" !== t && "style" !== t) {
						if (n.set(t, !1), "styles" == e)
							for (const e of this.element.document.stylesProcessor.getRelatedStyles(t)) n.set(e, !1)
					} else {
						const e = "class" == t ? "classes" : "styles";
		...
		class Ua {
			constructor() {
				this._sourceDefinitions = {}, this._attributeProperties = {}, this.decorate("checkChild"), this.decorate("checkAttribute"), this.on("checkAttribute", (e, t) => {
					t[0] = new Wa(t[0])
				}, {
					priority: "highest"
				}), this.on("checkChild", (e, t) => {
					t[0] = new Wa(t[0]), t[1] = this.getDefinition(t[1])
				}, {
					priority: "highest"
				})
			}
			...
			checkMerge(e, t = null) {
				if (e instanceof Js) {
					const t = e.nodeBefore,
						i = e.nodeAfter;
					if (!(t instanceof Gs)) throw new c.a("schema-check-merge-no-element-before", this);
					if (!(i instanceof Gs)) throw new c.a("schema-check-merge-no-element-after", this);
			...
			getLimitElement(e) {
				let t;
				if (e instanceof Js) t = e.parent;
				else {
					t = (e instanceof ta ? [e] : Array.from(e.getRanges())).reduce((e, t) => {
						const i = t.getCommonAncestor();
						return e ? e.getCommonAncestor(i, {
							includeSelf: !0
						}) : i
					}, null)
				}
			...
			checkAttributeInSelection(e, t) {
				if (e.isCollapsed) {
					const i = [...e.getFirstPosition().getAncestors(), new qs("", e.getAttributes())];
					return this.checkAttribute(i, t)
				} {
					const i = e.getRanges();
					for (const e of i)
						for (const i of e)
							if (this.checkAttribute(i.item, t)) return !0
				}
				return !1
			}* getValidRanges(e, t) {
				e = function* (e) {
			...
			getNearestSelectionRange(e, t = "both") {
				if (this.checkChild(e, "$text")) return new ta(e);
				let i, n;
				const o = e.getAncestors().reverse().find(e => this.isLimit(e)) || e.root;
				"both" != t && "backward" != t || (i = new Ks({
					boundaries: ta._createIn(o),
					startPosition: e,
					direction: "backward"
				})), "both" != t && "forward" != t || (n = new Ks({
					boundaries: ta._createIn(o),
					startPosition: e
				}));
				for (const e of function* (e, t) {
					...
					const t = e.walker == i ? "elementEnd" : "elementStart",
						n = e.value;
					if (n.type == t && this.isObject(n.item)) return ta._createOn(n.item);
					if (this.checkChild(n.nextPosition, "$text")) return new ta(n.nextPosition)
				}
				return null
			}
			...
			removeDisallowedAttributes(e, t) {
				for (const i of e)
					if (i.is("$text")) tc(this, i, t);
					else {
						const e = ta._createIn(i).getPositions();
						for (const i of e) {
							tc(this, i.nodeBefore || i.parent, t)
						}
					}
			}
			createContext(e) {
			...
			_compile() {
				const e = {},
					...
					i = Object.keys(t);
				for (const n of i) e[n] = qa(t[n], n);
				for (const t of i) $a(e, t);
				for (const t of i) Ya(e, t);
				for (const t of i) Ga(e, t), Ka(e, t);
				for (const t of i) Qa(e, t), Ja(e, t);
			...
			_checkContextMatch(e, t, i = t.length - 1) {
				...
				for (const o of e.getItems({
						shallow: !0
					})) o.is("element") && (yield* this._getValidRangesForRange(ta._createIn(o), t)), this.checkAttribute(o, t) || (i.isEqual(n) || (yield new ta(i, n)), i = Js._createAfter(o)), n = Js._createAfter(o);
				i.isEqual(n) || (yield new ta(i, n))
			}
		}
		Ke(Ua, Ue);
		class Wa {
			constructor(e) {
				...
				"string" == typeof e ? e = [e] : Array.isArray(e) || (e = e.getAncestors({
					includeSelf: !0
				})), e[0] && "string" != typeof e[0] && e[0].is("documentFragment") && e.shift(), this._items = e.map(ec)
			}
			get length() {
				return this._items.length
			}
		...
		function qa(e, t) {
			...
			return function (e, t) {
				...
				}(e, i), Za(e, i, "allowIn"), Za(e, i, "allowContentOf"), Za(e, i, "allowWhere"), Za(e, i, "allowAttributes"), Za(e, i, "allowAttributesOf"), Za(e, i, "inheritTypesFrom"),
				function (e, t) {
					for (const i of e) {
		...
		function Za(e, t, i) {
			for (const n of e) "string" == typeof n[i] ? t[i].push(n[i]) : Array.isArray(n[i]) && t[i].push(...n[i])
		}

		function Xa(e, t) {
			const i = e[t];
			return (n = e, Object.keys(n).map(e => n[e])).filter(e => e.allowIn.includes(i.name));
			var n
		}
		...
		function tc(e, t, i) {
			for (const n of t.getAttributeKeys()) e.checkAttribute(t, n) || i.removeAttribute(n, t)
		}
		class ic {
			constructor(e = {}) {
			...
			convert(e, t, i = ["$root"]) {
				this.fire("viewCleanup", e), this._modelCursor = function (e, t) {
					let i;
					for (const n of new Wa(e)) {
						const e = {};
						for (const t of n.getAttributeKeys()) e[t] = n.getAttribute(t);
						const o = t.createElement(n.name, e);
						i && t.append(o, i), i = Js._createAt(o, 0)
					}
					return i
				}(i, t), this.conversionApi.writer = t, this.conversionApi.consumable = Fa.createFrom(e), this.conversionApi.store = {};
				const {
					modelRange: n
				} = this._convertItem(e, this._modelCursor), o = t.createDocumentFragment();
				if (n) {
					this._removeEmptyElements();
					for (const e of Array.from(this._modelCursor.parent.getChildren())) t.append(e, o);
					o.markers = function (e, t) {
						const i = new Set,
							n = new Map,
							o = ta._createIn(e).getItems();
						for (const e of o) "$marker" == e.name && i.add(e);
						for (const e of i) {
							const i = e.getAttribute("data-name"),
								o = t.createPositionBefore(e);
							n.has(i) ? n.get(i).end = o.clone() : n.set(i, new ta(o.clone())), t.remove(e)
						}
						return n
					}(o, t)
				}
			...
			_convertItem(e, t) {
				...
				if (e.is("element") ? this.fire("element:" + e.name, i, this.conversionApi) : e.is("$text") ? this.fire("text", i, this.conversionApi) : this.fire("documentFragment", i, this.conversionApi), i.modelRange && !(i.modelRange instanceof ta)) throw new c.a("view-conversion-dispatcher-incorrect-result", this);
				return {
					modelRange: i.modelRange,
					modelCursor: i.modelCursor
				}
			}
			_convertChildren(e, t) {
				let i = t.is("position") ? t : Js._createAt(t, 0);
				const n = new ta(i);
				for (const t of Array.from(e.getChildren())) {
					const e = this._convertItem(t, i);
					e.modelRange instanceof ta && (n.end = e.modelRange.end, i = e.modelCursor)
				}
				return {
					modelRange: n,
					modelCursor: i
			...
			_removeEmptyElements() {
				let e = !1;
				for (const t of this._splitParts.keys()) t.isEmpty && (this.conversionApi.writer.remove(t), this._splitParts.delete(t), e = !0);
		...
		class oc {
			constructor(e) {
				this._domParser = new DOMParser, this._domConverter = new xr(e, {
		...
		class rc {
			constructor(e, t) {
				this.model = e, this.mapper = new ia, this.downcastDispatcher = new ra({
					mapper: this.mapper,
					schema: e.schema
				}), this.downcastDispatcher.on("insert:$text", (e, t, i) => {
					if (!i.consumable.consume(t.item, "insert")) return;
					const n = i.writer,
						o = i.mapper.toViewPosition(t.range.start),
						r = n.createText(t.item.data);
					...
					priority: "lowest"
				}), this.upcastDispatcher = new ic({
					schema: e.schema
				}), this.viewDocument = new vo(t), this.stylesProcessor = t, this.htmlProcessor = new oc(this.viewDocument), this.processor = this.htmlProcessor, this._viewWriter = new Wo(this.viewDocument), this.upcastDispatcher.on("text", (e, t, {
					schema: i,
					consumable: n,
					writer: o
				}) => {
					...
					priority: "lowest"
				}), this.upcastDispatcher.on("element", (e, t, i) => {
					if (!t.modelRange && i.consumable.consume(t.viewItem, {
							name: !0
						})) {
						const {
							modelRange: e,
							modelCursor: n
						} = i.convertChildren(t.viewItem, t.modelCursor);
						t.modelRange = e, t.modelCursor = n
					}
				}, {
					priority: "lowest"
				}), this.upcastDispatcher.on("documentFragment", (e, t, i) => {
					if (!t.modelRange && i.consumable.consume(t.viewItem, {
							name: !0
						})) {
						const {
					...
					this.model.enqueueChange("transparent", Sa)
				}, {
					priority: "lowest"
				})
			}
			get(e = {}) {
				...
				return "empty" !== i || this.model.hasContent(n, {
					ignoreWhitespaces: !0
				}) ? this.stringify(n, e) : ""
			}
			stringify(e, t = {}) {
			...
			toView(e, t = {}) {
				...
				const o = ta._createIn(e),
					r = new Uo(i);
				if (this.mapper.bindElements(e, r), this.downcastDispatcher.conversionApi.options = t, this.downcastDispatcher.convertInsert(o, n), !e.is("documentFragment")) {
					const t = function (e) {
						const t = [],
							i = e.root.document;
						if (!i) return [];
						const n = ta._createIn(e);
						for (const e of i.model.markers) {
							const i = n.getIntersection(e.getRange());
							i && t.push([e.name, i])
						}
						return t
					}(e);
					for (const [e, i] of t) this.downcastDispatcher.convertMarkerAdd(e, i, n)
				}
			...
			set(e) {
				let t = {};
				if ("string" == typeof e ? t.main = e : t = e, !this._checkIfRootsExists(Object.keys(t))) throw new c.a("datacontroller-set-non-existent-root", this);
				this.model.enqueueChange("transparent", e => {
					e.setSelection(null), e.removeSelectionAttribute(this.model.document.selection.getAttributeKeys());
					for (const i of Object.keys(t)) {
						const n = this.model.document.getRoot(i);
						e.remove(e.createRangeIn(n)), e.insert(this.parse(t[i], n), n, 0)
					}
				})
			}
			parse(e, t = "$root") {
		...
		class sc {
			constructor(e, t) {
				this._helpers = new Map, this._downcast = en(e), this._createConversionHelpers({
					name: "downcast",
					dispatchers: this._downcast,
					isDowncast: !0
				}), this._upcast = en(t), this._createConversionHelpers({
					name: "upcast",
			...
			addAlias(e, t) {
				...
				if (!this._upcast.includes(t) && !i) throw new c.a("conversion-add-alias-dispatcher-not-registered", this);
			...
			elementToElement(e) {
				...
				for (const {
						model: t,
						view: i
					} of ac(e)) this.for("upcast").elementToElement({
					model: t,
					view: i,
			...
			attributeToElement(e) {
				...
				for (const {
						model: t,
						view: i
					} of ac(e)) this.for("upcast").elementToAttribute({
					view: i,
					model: t,
					converterPriority: e.converterPriority
				})
			...
			attributeToAttribute(e) {
				...
				for (const {
						model: t,
						view: i
					} of ac(e)) this.for("upcast").attributeToAttribute({
					view: i,
					model: t
				})
			}
		...
		function* ac(e) {
			if (e.model.values)
				for (const t of e.model.values) {
					...
					yield* cc(i, n, o)
				} else yield* cc(e.model, e.view, e.upcastAlso)
		}
		...
		class uc {
			constructor(e) {
				this.markers = new Map, this._children = new Ys, e && this._insertChild(0, e)
			} [Symbol.iterator]() {
			...
			static fromJSON(e) {
				const t = [];
				for (const i of e) i.name ? t.push(Gs.fromJSON(i)) : t.push(qs.fromJSON(i));
				return new uc(t)
			}
			_appendChild(e) {
				this._insertChild(this.childCount, e)
		...
		function hc(e, t) {
			const i = (t = mc(t)).reduce((e, t) => e + t.offsetSize, 0),
				n = e.parent;
			bc(e);
			const o = e.index;
			return n._insertChild(o, t), pc(n, o + t.length), pc(n, o), new ta(e, e.getShiftedBy(i))
		}
		...
		function fc(e) {
			...
			return pc(t, e.start.index), i
		}

		function gc(e, t) {
			if (!e.isFlat) throw new c.a("operation-utils-move-range-not-flat", this);
			const i = fc(e);
			return hc(t = t._getTransformedByDeletion(e.start, e.end.offset - e.start.offset), i)
		}
		...
		function mc(e) {
			...
			for (let i = 0; i < e.length; i++)
				if ("string" == typeof e[i]) t.push(new qs(e[i]));
				else if (e[i] instanceof $s) t.push(new qs(e[i].data, e[i].getAttributes()));
			else if (e[i] instanceof uc || e[i] instanceof Ys)
				for (const n of e[i]) t.push(n);
			else e[i] instanceof Ws && t.push(e[i]);
			for (let e = 1; e < t.length; e++) {
				const i = t[e],
					n = t[e - 1];
				i instanceof qs && n instanceof qs && wc(i, n) && (t.splice(e - 1, 2, new qs(n.data + i.data, n.getAttributes())), e--)
			}
			return t
		}
		...
		function pc(e, t) {
			const i = e.getChild(t - 1),
				n = e.getChild(t);
			if (i && n && i.is("$text") && n.is("$text") && wc(i, n)) {
				const o = new qs(i.data + n.data, i.getAttributes());
		...
		function bc(e) {
			...
			if (t) {
				...
				const r = new qs(t.data.substr(0, n), t.getAttributes()),
					s = new qs(t.data.substr(n), t.getAttributes());
		...
		class _c extends dc {
			constructor(e, t, i, n, o) {
				super(o), this.range = e.clone(), this.key = t, this.oldValue = void 0 === i ? null : i, this.newValue = void 0 === n ? null : n
			}
			get type() {
				return null === this.oldValue ? "addAttribute" : null === this.newValue ? "removeAttribute" : "changeAttribute"
			}
			clone() {
				return new _c(this.range, this.key, this.oldValue, this.newValue, this.baseVersion)
			}
			getReversed() {
				return new _c(this.range, this.key, this.newValue, this.oldValue, this.baseVersion + 1)
			}
			toJSON() {
				const e = super.toJSON();
			...
			_validate() {
				...
				for (const e of this.range.getItems({
					...
					if (null !== this.oldValue && !kc(e.getAttribute(this.key), this.oldValue)) throw new c.a("attribute-operation-wrong-old-value", this, {
						item: e,
						key: this.key,
						value: this.oldValue
					});
					if (null === this.oldValue && null !== this.newValue && e.hasAttribute(this.key)) throw new c.a("attribute-operation-attribute-exists", this, {
						node: e,
						key: this.key
					})
				}
			...
			_execute() {
				kc(this.oldValue, this.newValue) || function (e, t, i) {
					bc(e.start), bc(e.end);
					for (const n of e.getItems({
							shallow: !0
						})) {
						const e = n.is("$textProxy") ? n.textNode : n;
						null !== i ? e._setAttribute(t, i) : e._removeAttribute(t), pc(e.parent, e.index)
					}
					pc(e.end.parent, e.end.index)
			...
			static fromJSON(e, t) {
				return new _c(ta.fromJSON(e.range, t), e.key, e.oldValue, e.newValue, e.baseVersion)
			}
		}
		class vc extends dc {
			constructor(e, t) {
			...
			_execute() {
				fc(ta._createFromPositionAndShift(this.sourcePosition, this.howMany))
			}
			static get className() {
		...
		class yc extends dc {
			...
			_validate() {
				...
				if (i + this.howMany > e.maxOffset) throw new c.a("move-operation-nodes-do-not-exist", this);
				if (e === t && i < n && n < i + this.howMany) throw new c.a("move-operation-range-into-itself", this);
				if (this.sourcePosition.root == this.targetPosition.root && "prefix" == cn(this.sourcePosition.getParentPath(), this.targetPosition.getParentPath())) {
					...
					if (this.targetPosition.path[e] >= i && this.targetPosition.path[e] < i + this.howMany) throw new c.a("move-operation-node-into-itself", this)
				}
			}
			_execute() {
				gc(ta._createFromPositionAndShift(this.sourcePosition, this.howMany), this.targetPosition)
			}
			toJSON() {
				const e = super.toJSON();
			...
			static fromJSON(e, t) {
				const i = Js.fromJSON(e.sourcePosition, t),
					n = Js.fromJSON(e.targetPosition, t);
				return new this(i, e.howMany, n, e.baseVersion)
			}
		}
		class xc extends dc {
			constructor(e, t, i) {
				super(i), this.position = e.clone(), this.position.stickiness = "toNone", this.nodes = new Ys(mc(t)), this.shouldReceiveAttributes = !1
			}
			get type() {
				return "insert"
			}
			...
			clone() {
				const e = new Ys([...this.nodes].map(e => e._clone(!0))),
					t = new xc(this.position, e, this.baseVersion);
				return t.shouldReceiveAttributes = this.shouldReceiveAttributes, t
			}
			getReversed() {
				const e = this.position.root.document.graveyard,
					t = new Js(e, [0]);
				return new yc(this.position, this.nodes.maxOffset, t, this.baseVersion + 1)
			}
			_validate() {
			...
			_execute() {
				const e = this.nodes;
				this.nodes = new Ys([...e].map(e => e._clone(!0))), hc(this.position, e)
			}
			toJSON() {
				const e = super.toJSON();
			...
			static fromJSON(e, t) {
				const i = [];
				for (const t of e.nodes) t.name ? i.push(Gs.fromJSON(t)) : i.push(qs.fromJSON(t));
				const n = new xc(Js.fromJSON(e.position, t), i, e.baseVersion);
		...
		class Ac extends dc {
			...
			static fromJSON(e, t) {
				return new Ac(e.name, e.oldRange ? ta.fromJSON(e.oldRange, t) : null, e.newRange ? ta.fromJSON(e.newRange, t) : null, t.model.markers, e.affectsData, e.baseVersion)
			}
		}
		class Cc extends dc {
			constructor(e, t, i, n) {
			...
			clone() {
				return new Cc(this.position.clone(), this.oldName, this.newName, this.baseVersion)
			}
			getReversed() {
				return new Cc(this.position.clone(), this.newName, this.oldName, this.baseVersion + 1)
			}
			_validate() {
				const e = this.position.nodeAfter;
				if (!(e instanceof Gs)) throw new c.a("rename-operation-wrong-position", this);
			...
			static fromJSON(e, t) {
				return new Cc(Js.fromJSON(e.position, t), e.oldName, e.newName, e.baseVersion)
			}
		}
		class Tc extends dc {
			constructor(e, t, i, n, o) {
				super(o), this.root = e, this.key = t, this.oldValue = i, this.newValue = n
			}
			get type() {
			...
			getReversed() {
				return new Tc(this.root, this.key, this.newValue, this.oldValue, this.baseVersion + 1)
			}
			_validate() {
			...
			static fromJSON(e, t) {
				...
				return new Tc(t.getRoot(e.root), e.key, e.oldValue, e.newValue, e.baseVersion)
			}
		}
		class Ec extends dc {
			constructor(e, t, i, n, o) {
			...
			get deletionPosition() {
				return new Js(this.sourcePosition.root, this.sourcePosition.path.slice(0, -1))
			}
			get movedRange() {
				const e = this.sourcePosition.getShiftedBy(Number.POSITIVE_INFINITY);
				return new ta(this.sourcePosition, e)
			}
			clone() {
			...
			getReversed() {
				const e = this.targetPosition._getTransformedByMergeOperation(this),
					...
					i = new Js(this.sourcePosition.root, t)._getTransformedByMergeOperation(this);
				return new Pc(e, this.howMany, i, this.graveyardPosition, this.baseVersion + 1)
			}
			_validate() {
				const e = this.sourcePosition.parent,
					t = this.targetPosition.parent;
			...
			_execute() {
				const e = this.sourcePosition.parent;
				gc(ta._createIn(e), this.targetPosition), gc(ta._createOn(e), this.graveyardPosition)
			}
			toJSON() {
				const e = super.toJSON();
			...
			static fromJSON(e, t) {
				const i = Js.fromJSON(e.sourcePosition, t),
					n = Js.fromJSON(e.targetPosition, t),
					o = Js.fromJSON(e.graveyardPosition, t);
		...
		class Pc extends dc {
			...
			get moveTargetPosition() {
				...
				return e.push(0), new Js(this.insertionPosition.root, e)
			}
			get movedRange() {
				const e = this.splitPosition.getShiftedBy(Number.POSITIVE_INFINITY);
				return new ta(this.splitPosition, e)
			}
			clone() {
			...
			getReversed() {
				const e = this.splitPosition.root.document.graveyard,
					t = new Js(e, [0]);
				return new Ec(this.moveTargetPosition, this.howMany, this.splitPosition, t, this.baseVersion + 1)
			}
			_validate() {
			...
			_execute() {
				const e = this.splitPosition.parent;
				if (this.graveyardPosition) gc(ta._createFromPositionAndShift(this.graveyardPosition, 1), this.insertionPosition);
				else {
					const t = e._clone();
					hc(this.insertionPosition, t)
				}
				gc(new ta(Js._createAt(e, this.splitPosition.offset), Js._createAt(e, e.maxOffset)), this.moveTargetPosition)
			}
			toJSON() {
				const e = super.toJSON();
			...
			static getInsertionPosition(e) {
				...
				return t[t.length - 1]++, new Js(e.root, t, "toPrevious")
			}
			static fromJSON(e, t) {
				const i = Js.fromJSON(e.splitPosition, t),
					n = Js.fromJSON(e.insertionPosition, t),
					o = e.graveyardPosition ? Js.fromJSON(e.graveyardPosition, t) : null;
				return new this(i, e.howMany, n, o, e.baseVersion)
			}
		}
		class Sc extends Gs {
		...
		class Mc {
			...
			insert(e, t, i = 0) {
				if (this._assertWriterUsedCorrectly(), e instanceof qs && "" == e.data) return;
				const n = Js._createAt(t, i);
				if (e.parent) {
					if (Dc(e.root, n.root)) return void this.move(ta._createOn(e), n);
				...
				const o = n.root.document ? n.root.document.version : null,
					r = new xc(n, e, o);
				if (e instanceof qs && (r.shouldReceiveAttributes = !0), this.batch.addOperation(r), this.model.applyOperation(r), e instanceof uc)
					for (const [t, i] of e.markers) {
						const e = Js._createAt(i.root, 0),
							o = {
								range: new ta(i.start._getCombined(e, n), i.end._getCombined(e, n)),
								usingOperation: !0,
								affectsData: !0
							};
						this.model.markers.has(t) ? this.updateMarker(t, o) : this.addMarker(t, o)
					}
			}
			insertText(e, t, i, n) {
				t instanceof uc || t instanceof Gs || t instanceof Js ? this.insert(this.createText(e), t, i) : this.insert(this.createText(e, t), i, n)
			}
			insertElement(e, t, i, n) {
				t instanceof uc || t instanceof Gs || t instanceof Js ? this.insert(this.createElement(e), t, i) : this.insert(this.createElement(e, t), i, n)
			}
			append(e, t) {
				this.insert(e, t, "end")
			}
			appendText(e, t, i) {
				t instanceof uc || t instanceof Gs ? this.insert(this.createText(e), t, "end") : this.insert(this.createText(e, t), i, "end")
			}
			appendElement(e, t, i) {
				t instanceof uc || t instanceof Gs ? this.insert(this.createElement(e), t, "end") : this.insert(this.createElement(e, t), i, "end")
			}
			setAttribute(e, t, i) {
				if (this._assertWriterUsedCorrectly(), i instanceof ta) {
					const n = i.getMinimalFlatRanges();
					for (const i of n) Ic(this, e, t, i)
				} else Nc(this, e, t, i)
			}
			setAttributes(e, t) {
				for (const [i, n] of fn(e)) this.setAttribute(i, n, t)
			}
			removeAttribute(e, t) {
				if (this._assertWriterUsedCorrectly(), t instanceof ta) {
					const i = t.getMinimalFlatRanges();
					for (const t of i) Ic(this, e, null, t)
				} else Nc(this, e, null, t)
			}
			clearAttributes(e) {
				...
				if (e instanceof ta)
					for (const i of e.getItems()) t(i);
				else t(e)
			}
			move(e, t, i) {
				if (this._assertWriterUsedCorrectly(), !(e instanceof ta)) throw new c.a("writer-move-invalid-range", this);
				if (!e.isFlat) throw new c.a("writer-move-range-not-flat", this);
				const n = Js._createAt(t, i);
				if (n.isEqual(e.start)) return;
				if (this._addOperationForAffectedMarkers("move", e), !Dc(e.root, n.root)) throw new c.a("writer-move-different-document", this);
				const o = e.root.document ? e.root.document.version : null,
					r = new yc(e.start, e.end.offset - e.start.offset, n, o);
				this.batch.addOperation(r), this.model.applyOperation(r)
			}
			remove(e) {
				this._assertWriterUsedCorrectly();
				const t = (e instanceof ta ? e : ta._createOn(e)).getMinimalFlatRanges().reverse();
				for (const e of t) this._addOperationForAffectedMarkers("move", e), Oc(e.start, e.end.offset - e.start.offset, this.batch, this.model)
			}
			merge(e) {
				this._assertWriterUsedCorrectly();
				const t = e.nodeBefore,
					i = e.nodeAfter;
				if (this._addOperationForAffectedMarkers("merge", e), !(t instanceof Gs)) throw new c.a("writer-merge-no-element-before", this);
				if (!(i instanceof Gs)) throw new c.a("writer-merge-no-element-after", this);
			...
			_mergeDetached(e) {
				const t = e.nodeBefore,
					i = e.nodeAfter;
				this.move(ta._createIn(i), Js._createAt(t, "end")), this.remove(i)
			}
			_merge(e) {
				const t = Js._createAt(e.nodeBefore, "end"),
					i = Js._createAt(e.nodeAfter, 0),
					n = e.root.document.graveyard,
					o = new Js(n, [0]),
					r = e.root.document.version,
					s = new Ec(i, e.nodeAfter.maxOffset, t, o, r);
				this.batch.addOperation(s), this.model.applyOperation(s)
			}
			rename(e, t) {
				if (this._assertWriterUsedCorrectly(), !(e instanceof Gs)) throw new c.a("writer-rename-not-element-instance", this);
				const i = e.root.document ? e.root.document.version : null,
					n = new Cc(Js._createBefore(e), e.name, t, i);
			...
			split(e, t) {
				...
				do {
					const t = o.root.document ? o.root.document.version : null,
						...
						s = Pc.getInsertionPosition(e),
						a = new Pc(e, r, s, null, t);
					this.batch.addOperation(a), this.model.applyOperation(a), i || n || (i = o, n = e.parent.nextSibling), o = (e = this.createPositionAfter(e.parent)).parent
				} while (o !== t);
				return {
					position: e,
					range: new ta(Js._createAt(i, "end"), Js._createAt(n, 0))
				}
			}
			wrap(e, t) {
				if (this._assertWriterUsedCorrectly(), !e.isFlat) throw new c.a("writer-wrap-range-not-flat", this);
				const i = t instanceof Gs ? t : new Gs(t);
				if (i.childCount > 0) throw new c.a("writer-wrap-element-not-empty", this);
				if (null !== i.parent) throw new c.a("writer-wrap-element-attached", this);
				this.insert(i, e.start);
				const n = new ta(e.start.getShiftedBy(1), e.end.getShiftedBy(1));
				this.move(n, Js._createAt(i, 0))
			}
			unwrap(e) {
				if (this._assertWriterUsedCorrectly(), null === e.parent) throw new c.a("writer-unwrap-element-no-parent", this);
				this.move(ta._createIn(e), this.createPositionAfter(e)), this.remove(e)
			}
			addMarker(e, t) {
				...
				if (!n) throw new c.a("writer-addmarker-no-range", this);
				return i ? (Rc(this, e, null, n, o), this.model.markers.get(e)) : this.model.markers._set(e, n, i, o)
			}
			updateMarker(e, t) {
				this._assertWriterUsedCorrectly();
				const i = "string" == typeof e ? e : e.name,
					n = this.model.markers.get(i);
				if (!n) throw new c.a("writer-updatemarker-marker-not-exists", this);
				if (!t) return void this.model.markers._refresh(n);
				...
				const a = n.getRange(),
					l = t.range ? t.range : a;
				o && t.usingOperation !== n.managedUsingOperations ? t.usingOperation ? Rc(this, i, null, l, s) : (Rc(this, i, a, null, s), this.model.markers._set(i, l, void 0, s)) : n.managedUsingOperations ? Rc(this, i, a, l, s) : this.model.markers._set(i, l, void 0, s)
			}
			removeMarker(e) {
				this._assertWriterUsedCorrectly();
				...
				if (!i.managedUsingOperations) return void this.model.markers._remove(t);
				Rc(this, t, i.getRange(), null, i.affectsData)
			}
			setSelection(e, t, i) {
			...
			setSelectionAttribute(e, t) {
				if (this._assertWriterUsedCorrectly(), "string" == typeof e) this._setSelectionAttribute(e, t);
					...
					for (const [t, i] of fn(e)) this._setSelectionAttribute(t, i)
			}
			...
			_setSelectionAttribute(e, t) {
				...
				if (i.isCollapsed && i.anchor.parent.isEmpty) {
					const n = ba._getStoreAttributeKey(e);
			...
			_removeSelectionAttribute(e) {
				...
				if (t.isCollapsed && t.anchor.parent.isEmpty) {
					const i = ba._getStoreAttributeKey(e);
			...
			_addOperationForAffectedMarkers(e, t) {
				for (const i of this.model.markers) {
					...
					const n = i.getRange();
					let o = !1;
					if ("move" === e) o = t.containsPosition(n.start) || t.start.isEqual(n.start) || t.containsPosition(n.end) || t.end.isEqual(n.end);
					else {
						const e = t.nodeBefore,
							i = t.nodeAfter,
							r = n.start.parent == e && n.start.isAtEnd,
							s = n.end.parent == i && 0 == n.end.offset,
							a = n.end.nodeAfter == i,
							c = n.start.nodeAfter == i;
						o = r || s || a || c
					}
					o && this.updateMarker(i.name, {
						range: n
					})
				}
			}
		...
		function Ic(e, t, i, n) {
			const o = e.model,
				r = o.document;
			let s, a, c, l = n.start;
			for (const e of n.getWalker({
					shallow: !0
				})) c = e.item.getAttribute(t), s && a != c && (a != i && d(), l = s), s = e.nextPosition, a = c;

			function d() {
				const n = new ta(l, s),
					c = n.root.document ? r.version : null,
					d = new _c(n, t, a, i, c);
				e.batch.addOperation(d), o.applyOperation(d)
			}
			s instanceof Js && s != l && a != i && d()
		}
		...
		function Nc(e, t, i, n) {
			...
			if (s != i) {
				if (n.root === n) {
					...
					a = new ta(Js._createBefore(n), e.createPositionAfter(n));
		...
		function Rc(e, t, i, n, o) {
			const r = e.model,
				s = r.document,
				a = new Ac(t, i, n, r.markers, o, s.version);
		...
		function Oc(e, t, i, n) {
			...
			if (e.root.document) {
				const i = n.document,
					r = new Js(i.graveyard, [0]);
				o = new yc(e, t, r, i.version)
			} else o = new vc(e, t);
			i.addOperation(o), n.applyOperation(o)
		}

		function Dc(e, t) {
			return e === t || e instanceof Sc && t instanceof Sc
		}
		class Lc {
			constructor(e) {
				...
				switch (e.type) {
					...
					case "reinsert": {
						...
						const t = this._isInInsertedElement(e.sourcePosition.parent),
							i = this._isInInsertedElement(e.targetPosition.parent);
						t || this._markRemove(e.sourcePosition.parent, e.sourcePosition.offset, e.howMany), i || this._markInsert(e.targetPosition.parent, e.getMovedRangeStart().offset, e.howMany);
						break
					}
					case "rename": {
						if (this._isInInsertedElement(e.position.parent)) return;
						this._markRemove(e.position.parent, e.position.offset, 1), this._markInsert(e.position.parent, e.position.offset, 1);
						const t = ta._createFromPositionAndShift(e.position, 1);
						for (const e of this._markerCollection.getMarkersIntersectingRange(t)) {
							const t = e.getRange();
							this.bufferMarkerChange(e.name, t, t, e.affectsData)
						}
					...
					case "merge": {
						...
						const i = e.graveyardPosition.parent;
						this._markInsert(i, e.graveyardPosition.offset, 1);
						const n = e.targetPosition.parent;
			...
			bufferMarkerChange(e, t, i, n) {
				...
				o ? (o.newRange = i, o.affectsData = n, null == o.oldRange && null == o.newRange && this._changedMarkers.delete(e)) : this._changedMarkers.set(e, {
					oldRange: t,
					newRange: i,
					affectsData: n
				})
			...
			getMarkersToRemove() {
				const e = [];
				for (const [t, i] of this._changedMarkers) null != i.oldRange && e.push({
					name: t,
					range: i.oldRange
				});
				return e
			...
			getMarkersToAdd() {
				const e = [];
				for (const [t, i] of this._changedMarkers) null != i.newRange && e.push({
					name: t,
					range: i.newRange
				});
				return e
			...
			getChanges(e = {
				...
				for (const e of this._changesInElement.keys()) {
					const i = this._changesInElement.get(e).sort((e, t) => e.offset === t.offset ? e.type != t.type ? "remove" == e.type ? -1 : 1 : 0 : e.offset < t.offset ? -1 : 1),
					...
					let s = 0,
						a = 0;
					for (const i of r)
						if ("i" === i) t.push(this._getInsertDiff(e, s, o[s].name)), s++;
						else if ("r" === i) t.push(this._getRemoveDiff(e, s, n[a].name)), a++;
					else if ("a" === i) {
						const i = o[s].attributes,
							r = n[a].attributes;
						let c;
						if ("$text" == o[s].name) c = new ta(Js._createAt(e, s), Js._createAt(e, s + 1));
						else {
							const t = e.offsetToIndex(s);
							c = new ta(Js._createAt(e, s), Js._createAt(e.getChild(t), 0))
						}
						t.push(...this._getAttributesDiff(c, r, i)), s++, a++
					} else s++, a++
				}
				t.sort((e, t) => e.position.root != t.position.root ? e.position.root.rootName < t.position.root.rootName ? -1 : 1 : e.position.isEqual(t.position) ? e.changeCount - t.changeCount : e.position.isBefore(t.position) ? -1 : 1);
				for (let e = 1, i = 0; e < t.length; e++) {
					const n = t[i],
						o = t[e],
						r = "remove" == n.type && "remove" == o.type && "$text" == n.name && "$text" == o.name && n.position.isEqual(o.position),
						s = "insert" == n.type && "insert" == o.type && "$text" == n.name && "$text" == o.name && n.position.parent == o.position.parent && n.position.offset + n.length == o.position.offset,
						a = "attribute" == n.type && "attribute" == o.type && n.position.parent == o.position.parent && n.range.isFlat && o.range.isFlat && n.position.offset + n.length == o.position.offset && n.attributeKey == o.attributeKey && n.attributeOldValue == o.attributeOldValue && n.attributeNewValue == o.attributeNewValue;
					r || s || a ? (n.length++, a && (n.range.end = n.range.end.getShiftedBy(1)), t[e] = null) : i = e
				}
				t = t.filter(e => e);
				for (const e of t) delete e.changeCount, "attribute" == e.type && (delete e.position, delete e.length);
				return this._changeCount = 0, this._cachedChangesWithGraveyard = t.slice(), this._cachedChanges = t.filter(jc), e.includeChangesInGraveyard ? this._cachedChangesWithGraveyard : this._cachedChanges
			}
			reset() {
			...
			_markChange(e, t) {
				...
				for (let e = 0; e < i.length; e++) i[e].howMany < 1 && (i.splice(e, 1), e--)
			}
			...
			_makeSnapshot(e) {
				this._elementSnapshots.has(e) || this._elementSnapshots.set(e, zc(e.getChildren()))
			}
			_handleChange(e, t) {
				...
				for (const i of t) {
					...
					if ("insert" == e.type && ("insert" == i.type && (e.offset <= i.offset ? i.offset += e.howMany : e.offset < o && (i.howMany += e.nodesToHandle, e.nodesToHandle = 0)), "remove" == i.type && e.offset < i.offset && (i.offset += e.howMany), "attribute" == i.type))
					...
					if ("remove" == e.type) {
						if ("insert" == i.type)
							...
							if (e.offset < i.offset) {
								const t = n - i.offset;
								i.offset = e.offset, i.howMany -= t, e.nodesToHandle -= t
							} else i.howMany -= e.nodesToHandle, e.nodesToHandle = 0;
						else if (e.offset <= i.offset) e.nodesToHandle -= i.howMany, i.howMany = 0;
						else if (e.offset < o) {
							const t = o - e.offset;
							i.howMany -= t, e.nodesToHandle -= t
						}
						if ("remove" == i.type && (n <= i.offset ? i.offset -= e.howMany : e.offset < i.offset && (e.nodesToHandle += i.howMany, i.howMany = 0)), "attribute" == i.type)
							if (n <= i.offset) i.offset -= e.howMany;
					...
					if ("attribute" == e.type) {
						...
						"attribute" == i.type && (e.offset >= i.offset && n <= o ? (e.nodesToHandle = 0, e.howMany = 0, e.offset = 0) : e.offset <= i.offset && n >= o && (i.howMany = 0))
					}
				}
			...
			_removeAllNestedChanges(e, t, i) {
				const n = new ta(Js._createAt(e, t), Js._createAt(e, t + i));
				for (const e of n.getItems({
						shallow: !0
					})) e.is("element") && (this._elementSnapshots.delete(e), this._changesInElement.delete(e), this._removeAllNestedChanges(e, 0, e.maxOffset))
			}
		}
		...
		function zc(e) {
			...
			for (const i of e)
				if (i.is("$text"))
					for (let e = 0; e < i.data.length; e++) t.push({
						name: "$text",
		...
		function Vc(e, t) {
			...
			for (const e of t) {
				...
				} else i.push(..."a".repeat(e.howMany).split("")), n = e.offset + e.howMany, o += e.howMany
			}
			if (o < e)
				for (let t = 0; t < e - o - n; t++) i.push("e");
			return i
		}

		function jc(e) {
			const t = e.position && "$graveyard" == e.position.root.rootName,
				i = e.range && "$graveyard" == e.range.root.rootName;
			return !t && !i
		}
		class Bc {
			constructor() {
			...
			getOperations(e = Number.NEGATIVE_INFINITY, t = Number.POSITIVE_INFINITY) {
				const i = [];
				for (const n of this._operations) n.baseVersion >= e && n.baseVersion < t && i.push(n);
				return i
			}
			getOperation(e) {
		...
		function Fc(e, t) {
			return !!(i = e.charAt(t - 1)) && 1 == i.length && /[\ud800-\udbff]/.test(i) && function (e) {
		...
		function Hc(e, t) {
			return !!(i = e.charAt(t)) && 1 == i.length && /[\u0300-\u036f\u1ab0-\u1aff\u1dc0-\u1dff\u20d0-\u20ff\ufe20-\ufe2f]/.test(i);
			var i
		}
		class Uc {
			constructor(e) {
				this.model = e, this.version = 0, this.history = new Bc(this), this.selection = new ba(this), this.roots = new Zi({
					idProperty: "rootName"
				}), this.differ = new Lc(e.markers), this._postFixers = new Set, this._hasSelectionChangedFromTheLastChangeBlock = !1, this.createRoot("$root", "$graveyard"), this.listenTo(e, "applyOperation", (e, t) => {
					const i = t[0];
					if (i.isDocumentOperation && i.baseVersion !== this.version) throw new c.a("model-document-applyoperation-wrong-version", this, {
						operation: i
					})
				}, {
					priority: "highest"
				...
				}), this.listenTo(e.markers, "update", (e, t, i, n) => {
					this.differ.bufferMarkerChange(t.name, i, n, t.affectsData), null === i && t.on("change", (e, i) => {
						this.differ.bufferMarkerChange(t.name, i, t.getRange(), t.affectsData)
					})
				})
			}
			get graveyard() {
			...
			getRootNames() {
				return Array.from(this.roots, e => e.rootName).filter(e => "$graveyard" != e)
			}
			registerPostFixer(e) {
				this._postFixers.add(e)
			}
		...
		class qc {
			...
			_set(e, t, i = !1, n = !1) {
				const o = e instanceof $c ? e.name : e;
				if (o.includes(",")) throw new c.a("markercollection-incorrect-marker-name", this);
				const r = this._markers.get(o);
				if (r) {
					const e = r.getRange();
					let s = !1;
					return e.isEqual(t) || (r._attachLiveRange(ga.fromRange(t)), s = !0), i != r.managedUsingOperations && (r._managedUsingOperations = i, s = !0), "boolean" == typeof n && n != r.affectsData && (r._affectsData = n, s = !0), s && this.fire("update:" + o, r, e, t), r
				}
				const s = ga.fromRange(t),
					a = new $c(o, s, i, n);
				return this._markers.set(o, a), this.fire("update:" + o, a, null, t), a
			}
			_remove(e) {
				const t = e instanceof $c ? e.name : e,
					i = this._markers.get(t);
				return !!i && (this._markers.delete(t), this.fire("update:" + t, i, i.getRange(), null), this._destroyMarker(i), !0)
			}
			_refresh(e) {
				const t = e instanceof $c ? e.name : e,
					i = this._markers.get(t);
				if (!i) throw new c.a("markercollection-refresh-marker-not-exists", this);
				const n = i.getRange();
				this.fire("update:" + t, i, n, n, i.managedUsingOperations, i.affectsData)
		...
		class $c {
			constructor(e, t, i, n) {
				this.name = e, this._liveRange = this._attachLiveRange(t), this._managedUsingOperations = i, this._affectsData = n
			}
		...
		const Gc = {};
		Gc[_c.className] = _c, Gc[xc.className] = xc, Gc[Ac.className] = Ac, Gc[yc.className] = yc, Gc[Yc.className] = Yc, Gc[dc.className] = dc, Gc[Cc.className] = Cc, Gc[Tc.className] = Tc, Gc[Pc.className] = Pc, Gc[Ec.className] = Ec;
		class Kc extends Js {
			constructor(e, t, i = "toNone") {
				if (super(e, t, i), !this.root.is("rootElement")) throw new c.a("model-liveposition-root-not-rootelement", e);
				Qc.call(this)
			}
			detach() {
				this.stopListening()
			...
			toPosition() {
				return new Js(this.root, this.path.slice(), this.stickiness)
			}
		...
		function Qc() {
			this.listenTo(this.root.document.model, "applyOperation", (e, t) => {
				const i = t[0];
				i.isDocumentOperation && Jc.call(this, i)
			}, {
				priority: "low"
			})
		}
		...
		class Zc {
			...
			_insertPartialFragment() {
				...
				const e = Kc.fromPosition(this.position, "toNext");
			...
			_setAffectedBoundaries(e) {
				this._affectedStart || (this._affectedStart = Kc.fromPosition(e, "toPrevious")), this._affectedEnd && !this._affectedEnd.isBefore(e) || (this._affectedEnd && this._affectedEnd.detach(), this._affectedEnd = Kc.fromPosition(e, "toNext"))
			}
			_mergeOnLeft() {
				const e = this._firstNode;
				if (!(e instanceof Gs)) return;
				if (!this._canMergeLeft(e)) return;
				const t = Kc._createBefore(e);
				t.stickiness = "toNext";
				const i = Kc.fromPosition(this.position, "toNext");
				this._affectedStart.isEqual(t) && (this._affectedStart.detach(), this._affectedStart = Kc._createAt(t.nodeBefore, "end", "toPrevious")), this._firstNode === this._lastNode && (this._firstNode = t.nodeBefore, this._lastNode = t.nodeBefore), this.writer.merge(t), t.isEqual(this._affectedEnd) && this._firstNode === this._lastNode && (this._affectedEnd.detach(), this._affectedEnd = Kc._createAt(t.nodeBefore, "end", "toNext")), this.position = i.toPosition(), i.detach(), this._filterAttributesOf.push(this.position.parent), t.detach()
			}
			_mergeOnRight() {
				const e = this._lastNode;
				if (!(e instanceof Gs)) return;
				if (!this._canMergeRight(e)) return;
				const t = Kc._createAfter(e);
				if (t.stickiness = "toNext", !this.position.isEqual(t)) throw new c.a("insertcontent-invalid-insertion-position", this);
				this.position = Js._createAt(t.nodeBefore, "end");
				const i = Kc.fromPosition(this.position, "toPrevious");
				this._affectedEnd.isEqual(t) && (this._affectedEnd.detach(), this._affectedEnd = Kc._createAt(t.nodeBefore, "end", "toNext")), this._firstNode === this._lastNode && (this._firstNode = t.nodeBefore, this._lastNode = t.nodeBefore), this.writer.merge(t), t.getShiftedBy(-1).isEqual(this._affectedStart) && this._firstNode === this._lastNode && (this._affectedStart.detach(), this._affectedStart = Kc._createAt(t.nodeBefore, 0, "toPrevious")), this.position = i.toPosition(), i.detach(), this._filterAttributesOf.push(this.position.parent), t.detach()
			}
			_canMergeLeft(e) {
				const t = e.previousSibling;
				return t instanceof Gs && this.canMergeWith.has(t) && this.model.schema.checkMerge(t, e)
			}
			_canMergeRight(e) {
				const t = e.nextSibling;
				return t instanceof Gs && this.canMergeWith.has(t) && this.model.schema.checkMerge(e, t)
			}
			_tryAutoparagraphing(e) {
				const t = this.writer.createElement("paragraph");
				this._getAllowedIn(t, this.position.parent) && this.schema.checkChild(t, e) && (t._appendChild(e), this._handleNode(t))
			}
		...
		function Xc(e, t, i = {}) {
			...
			const o = e.schema;
			e.change(e => {
				if (!i.doNotResetEntireContent && function (e, t) {
				...
				function (e, t) {
					...
					e.remove(e.createRangeIn(i)), tl(e, e.createPositionAt(i, 0), t)
				}(e, t);
				const [r, s] = function (e) {
					...
					return [Kc.fromPosition(i, "toPrevious"), Kc.fromPosition(n, "toNext")]
				}(n);
				r.isTouching(s) || e.remove(e.createRange(r, s)), i.leaveUnmerged || (! function (e, t, i) {
					const n = e.model;
					if (!el(e.model.schema, t, i)) return;
					...
					!n.hasContent(o, {
						...
						const r = i.parent,
							s = n.parent;
						if (r == o || s == o) return;
						i = t.createPositionAfter(r), (n = t.createPositionBefore(s)).isEqual(i) || t.insert(r, n);
						for (; i.parent.isEmpty;) {
							const e = i.parent;
							i = t.createPositionBefore(e), t.remove(e)
						}
						if (n = t.createPositionBefore(s), function (e, t) {
								const i = t.nodeBefore,
									n = t.nodeAfter;
								i.name != n.name && e.rename(i, n.name);
								e.clearAttributes(i), e.setAttributes(Object.fromEntries(n.getAttributes()), i), e.merge(t)
							}(t, n), !el(t.model.schema, i, n)) return;
						e(t, i, n, o)
					}(e, t, i, o.parent) : function e(t, i, n, o) {
						const r = i.parent,
							s = n.parent;
						if (r == o || s == o) return;
						i = t.createPositionAfter(r), (n = t.createPositionBefore(s)).isEqual(i) || t.insert(s, i);
						t.merge(i);
						for (; n.parent.isEmpty;) {
							const e = n.parent;
							n = t.createPositionBefore(e), t.remove(e)
						}
						if (!el(t.model.schema, i, n)) return;
						e(t, i, n, o)
					}(e, t, i, o.parent)
				}(e, r, s), o.removeDisallowedAttributes(r.parent.getChildren(), e)), il(e, t, r), !i.doNotAutoparagraph && function (e, t) {
					const i = e.checkChild(t, "$text"),
						n = e.checkChild(t, "paragraph");
					return !i && n
				}(o, r) && tl(e, r, t), r.detach(), s.detach()
			})
		}
		...
		function el(e, t, i) {
			const n = t.parent,
				o = i.parent;
			return n != o && (!e.isLimit(n) && !e.isLimit(o) && function (e, t, i) {
				const n = new ta(e, t);
				for (const e of n.getWalker())
					if (i.isLimit(e.item)) return !1;
				return !0
			}(t, i, e))
		}
		...
		function tl(e, t, i) {
			...
			e.insert(n, t), il(e, i, e.createPositionAt(n, 0))
		}

		function il(e, t, i) {
			t instanceof ba ? e.setSelection(i) : t.setTo(i)
		}
		...
		function nl(e, t) {
			...
			if ("text" == s) return "word" === e.unit ? function (e, t) {
				...
				if (i) {
					let n = e.position.offset - i.startOffset;
					for (; !rl(i.data, n, t) && !sl(i, n, t);) {
						e.next();
						const o = t ? e.position.nodeAfter : e.position.nodeBefore;
						if (o && o.is("$text")) {
							const n = o.data.charAt(t ? 0 : o.data.length - 1);
							' ,.?!:;"-()'.includes(n) || (e.next(), i = e.position.textNode)
						}
						n = e.position.offset - i.startOffset
					}
				}
				return e.position
			}(n, i) : function (e, t) {
				...
				if (i) {
					const n = i.data;
					let o = e.position.offset - i.startOffset;
					for (; Fc(n, o) || "character" == t && Hc(n, o);) e.next(), o = e.position.offset - i.startOffset
				}
				return e.position
			}(n, o);
			if (s == (i ? "elementStart" : "elementEnd")) {
				if (r.isSelectable(a)) return Js._createAt(a, i ? "after" : "before");
				if (r.checkChild(c, "$text")) return c
			} else {
				if (r.isLimit(a)) return void n.skip(() => !0);
				if (r.checkChild(c, "$text")) return c
			}
		}
		...
		function ol(e, t) {
			const i = e.root,
				n = Js._createAt(i, t ? "end" : 0);
			return t ? new ta(e, n) : new ta(n, e)
		}

		function rl(e, t, i) {
			const n = t + (i ? 0 : -1);
			return ' ,.?!:;"-()'.includes(e.charAt(n))
		}

		function sl(e, t, i) {
			return t === (i ? e.endOffset : 0)
		}
		...
		function al(e, t) {
			...
			Array.from(e.getItems({
				direction: "backward"
			})).map(e => t.createRangeOn(e)).filter(t => (t.start.isAfter(e.start) || t.start.isEqual(e.start)) && (t.end.isBefore(e.end) || t.end.isEqual(e.end))).forEach(e => {
		...
		function cl(e) {
			e.document.registerPostFixer(t => function (e, t) {
				...
				r && e.setSelection(function (e) {
					...
					for (const i of e) {
						const e = t.pop();
						if (i.isEqual(e)) t.push(e);
						else if (i.isIntersecting(e)) {
							const n = e.start.isAfter(i.start) ? i.start : e.start,
								o = e.end.isAfter(i.end) ? e.end : i.end,
								r = new ta(n, o);
							t.push(r)
						} else t.push(e), t.push(i)
					}
					return t
				}(o), {
		...
		function ll(e, t) {
			return e.isCollapsed ? function (e, t) {
				...
				} = e, o = t.checkChild(i, "$text"), r = t.checkChild(n, "$text"), s = t.getLimitElement(i), a = t.getLimitElement(n);
				if (s === a) {
					if (o && r) return null;
					if (function (e, t, i) {
							const n = e.nodeAfter && !i.isLimit(e.nodeAfter) || i.checkChild(e, "$text"),
								o = t.nodeBefore && !i.isLimit(t.nodeBefore) || i.checkChild(t, "$text");
							return n || o
						}(i, n, t)) {
						const e = i.nodeAfter && t.isSelectable(i.nodeAfter) ? null : t.getNearestSelectionRange(i, "forward"),
							o = n.nodeBefore && t.isSelectable(n.nodeBefore) ? null : t.getNearestSelectionRange(n, "backward"),
							r = e ? e.start : i,
							s = o ? o.end : n;
						return new ta(r, s)
					}
				...
				if (c || l) {
					const e = i.nodeAfter && n.nodeBefore && i.nodeAfter.parent === n.nodeBefore.parent,
						o = c && (!e || !ul(i.nodeAfter, t)),
						r = l && (!e || !ul(n.nodeBefore, t));
					let d = i,
						u = n;
					return o && (d = Js._createBefore(dl(s, t))), r && (u = Js._createAfter(dl(a, t))), new ta(d, u)
				}
				return null
			}(e, t)
		}
		...
		class hl {
			constructor() {
				this.markers = new qc, this.document = new Uc(this), this.schema = new Ua, this._pendingChanges = [], this._currentWriter = null, ["insertContent", "deleteContent", "modifySelection", "getSelectedContent", "applyOperation"].forEach(e => this.decorate(e)), this.on("applyOperation", (e, t) => {
					t[0]._validate()
				}, {
					priority: "highest"
				...
				}), cl(this), this.document.registerPostFixer(Sa)
			}
			change(e) {
				try {
			...
			enqueueChange(e, t) {
				try {
					"string" == typeof e ? e = new lc(e) : "function" == typeof e && (t = e, e = new lc), this._pendingChanges.push({
						batch: e,
						callback: t
			...
			insertContent(e, t, i) {
				return function (e, t, i, n) {
					return e.change(o => {
						let r;
						r = i ? i instanceof la || i instanceof ba ? i : o.createSelection(i, n) : e.document.selection, r.isCollapsed || e.deleteContent(r, {
							doNotAutoparagraph: !0
						});
						const s = new Zc(e, o, r.anchor);
						let a;
						a = t.is("documentFragment") ? t.getChildren() : [t], s.handleNodes(a);
						const c = s.getSelectionRange();
						c && (r instanceof ba ? o.setSelection(c) : r.setTo(c));
						const l = s.getAffectedRange() || e.createRange(r.anchor);
						return s.destroy(), l
					})
				}(this, e, t, i)
			}
			...
			modifySelection(e, t) {
				! function (e, t, i = {}) {
					...
					for (; l = a.next();) {
						if (l.done) return;
						const i = nl(c, l.value);
						if (i) return void(t instanceof ba ? e.change(e => {
				...
				return function (e, t) {
					return e.change(e => {
						...
						const o = n.start.root,
							...
							s = o.getNodeByPath(r);
						let a;
						a = n.start.parent == n.end.parent ? n : e.createRange(e.createPositionAt(s, n.start.path[r.length]), e.createPositionAt(s, n.end.path[r.length] + 1));
						const c = a.end.offset - a.start.offset;
						for (const t of a.getItems({
								shallow: !0
							})) t.is("$textProxy") ? e.appendText(t.data, t.getAttributes(), i) : e.append(e.cloneElement(t, !0), i);
						if (a != n) {
							const t = n._getTransformedByMove(a.start, e.createPositionAt(i, 0), c)[0],
								o = e.createRange(e.createPositionAt(i, 0), t.start);
							al(e.createRange(t.end, e.createPositionAt(i, "end")), e), al(o, e)
						}
						return i
					})
				}(this, e)
			...
			hasContent(e, t = {}) {
				const i = e instanceof Gs ? ta._createIn(e) : e;
				if (i.isCollapsed) return !1;
				const {
					ignoreWhitespaces: n = !1,
					ignoreMarkers: o = !1
				} = t;
				if (!o)
			...
			createPositionAt(e, t) {
				return Js._createAt(e, t)
			}
			createPositionAfter(e) {
				return Js._createAfter(e)
			}
			createPositionBefore(e) {
				return Js._createBefore(e)
			}
			createRange(e, t) {
				return new ta(e, t)
			}
			createRangeIn(e) {
				return ta._createIn(e)
			}
			createRangeOn(e) {
				return ta._createOn(e)
			}
			createSelection(e, t, i) {
				return new la(e, t, i)
			}
			...
			createOperationFromJSON(e) {
				return class {
					static fromJSON(e, t) {
						return Gc[e.__className].fromJSON(e, t)
					}
			...
			_runPendingChanges() {
				...
				for (this.fire("_beforeChanges"); this._pendingChanges.length;) {
					...
					this._currentWriter = new Mc(this, t);
		...
		class gl {
			constructor(e = {}) {
				this._context = e.context || new sn({
					language: e.language
				}), this._context._addEditor(this, !e.context);
				const t = Array.from(this.constructor.builtinPlugins || []);
				this.config = new Gi(e, this.constructor.defaultConfig), this.config.define("plugins", t), this.config.define(this._context._getEditorConfig()), this.plugins = new Xi(this, t, this._context.plugins), this.locale = this._context.locale, this.t = this.locale.t, this.commands = new Ba, this.set("state", "initializing"), this.once("ready", () => this.state = "ready", {
					priority: "high"
				}), this.once("destroy", () => this.state = "destroyed", {
					priority: "high"
				}), this.set("isReadOnly", !1), this.model = new hl;
				const i = new Qn;
				this.data = new rc(this.model, i), this.editing = new ja(this.model, i), this.editing.view.document.bind("isReadOnly").to(this), this.conversion = new sc([this.editing.downcastDispatcher, this.data.downcastDispatcher], this.data.upcastDispatcher), this.conversion.addAlias("dataDowncast", this.data.downcastDispatcher), this.conversion.addAlias("editingDowncast", this.editing.downcastDispatcher), this.keystrokes = new fl(this), this.keystrokes.listenTo(this.editing.view.document)
			}
			initPlugins() {
				const e = this.config,
					t = e.get("plugins"),
			...
			destroy() {
				...
				return "initializing" == this.state && (e = new Promise(e => this.once("ready", e))), e.then(() => {
		...
		class bl {
			constructor(e) {
				this.editor = e, this.componentFactory = new ml(e), this.focusTracker = new Ms, this._editableElementsMap = new Map, this.listenTo(e.editing.view.document, "layoutChanged", () => this.update())
			}
			get element() {
				return null
			}
			...
			destroy() {
				...
				for (const e of this._editableElementsMap.values()) e.ckeditorInstance = null;
		...
		const vl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="m11.591 10.177 4.243 4.242a1 1 0 0 1-1.415 1.415l-4.242-4.243-4.243 4.243a1 1 0 0 1-1.414-1.415l4.243-4.242L4.52 5.934A1 1 0 0 1 5.934 4.52l4.243 4.243 4.242-4.243a1 1 0 1 1 1.415 1.414l-4.243 4.243z"/></svg>',
			yl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M6.972 16.615a.997.997 0 0 1-.744-.292l-4.596-4.596a1 1 0 1 1 1.414-1.414l3.926 3.926 9.937-9.937a1 1 0 0 1 1.414 1.415L7.717 16.323a.997.997 0 0 1-.745.292z"/></svg>',
			xl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5.085 6.22 2.943 4.078a.75.75 0 1 1 1.06-1.06l2.592 2.59A11.094 11.094 0 0 1 10 5.068c4.738 0 8.578 3.101 8.578 5.083 0 1.197-1.401 2.803-3.555 3.887l1.714 1.713a.75.75 0 0 1-.09 1.138.488.488 0 0 1-.15.084.75.75 0 0 1-.821-.16L6.17 7.304c-.258.11-.51.233-.757.365l6.239 6.24-.006.005.78.78c-.388.094-.78.166-1.174.215l-1.11-1.11h.011L4.55 8.197a7.2 7.2 0 0 0-.665.514l-.112.098 4.897 4.897-.005.006 1.276 1.276a10.164 10.164 0 0 1-1.477-.117l-.479-.479-.009.009-4.863-4.863-.022.031a2.563 2.563 0 0 0-.124.2c-.043.077-.08.158-.108.241a.534.534 0 0 0-.028.133.29.29 0 0 0 .008.072.927.927 0 0 0 .082.226c.067.133.145.26.234.379l3.242 3.365.025.01.59.623c-3.265-.918-5.59-3.155-5.59-4.668 0-1.194 1.448-2.838 3.663-3.93zm7.07.531a4.632 4.632 0 0 1 1.108 5.992l.345.344.046-.018a9.313 9.313 0 0 0 2-1.112c.256-.187.5-.392.727-.613.137-.134.27-.277.392-.431.072-.091.141-.185.203-.286.057-.093.107-.19.148-.292a.72.72 0 0 0 .036-.12.29.29 0 0 0 .008-.072.492.492 0 0 0-.028-.133.999.999 0 0 0-.036-.096 2.165 2.165 0 0 0-.071-.145 2.917 2.917 0 0 0-.125-.2 3.592 3.592 0 0 0-.263-.335 5.444 5.444 0 0 0-.53-.523 7.955 7.955 0 0 0-1.054-.768 9.766 9.766 0 0 0-1.879-.891c-.337-.118-.68-.219-1.027-.301zm-2.85.21-.069.002a.508.508 0 0 0-.254.097.496.496 0 0 0-.104.679.498.498 0 0 0 .326.199l.045.005c.091.003.181.003.272.012a2.45 2.45 0 0 1 2.017 1.513c.024.061.043.125.069.185a.494.494 0 0 0 .45.287h.008a.496.496 0 0 0 .35-.158.482.482 0 0 0 .13-.335.638.638 0 0 0-.048-.219 3.379 3.379 0 0 0-.36-.723 3.438 3.438 0 0 0-2.791-1.543l-.028-.001h-.013z"/></svg>',
			Al = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M6.91 10.54c.26-.23.64-.21.88.03l3.36 3.14 2.23-2.06a.64.64 0 0 1 .87 0l2.52 2.97V4.5H3.2v10.12l3.71-4.08zm10.27-7.51c.6 0 1.09.47 1.09 1.05v11.84c0 .59-.49 1.06-1.09 1.06H2.79c-.6 0-1.09-.47-1.09-1.06V4.08c0-.58.49-1.05 1.1-1.05h14.38zm-5.22 5.56a1.96 1.96 0 1 1 3.4-1.96 1.96 1.96 0 0 1-3.4 1.96z"/></svg>',
			Cl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414"><path d="M18 4.5V3H2v1.5h16zm0 3V6h-5.674v1.5H18zm0 3V9h-5.674v1.5H18zm0 3V12h-5.674v1.5H18zm-8.5-6V12h-6V7.5h6zm.818-1.5H2.682C2.305 6 2 6.407 2 6.91v5.68c0 .503.305.91.682.91h7.636c.377 0 .682-.407.682-.91V6.91c0-.503-.305-.91-.682-.91zM18 16.5V15H2v1.5h16z"/></svg>',
			Tl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm4.5 3V12h7V7.5h-7zM5.758 6h8.484c.419 0 .758.407.758.91v5.681c0 .502-.34.909-.758.909H5.758c-.419 0-.758-.407-.758-.91V6.91c0-.503.34-.91.758-.91zM2 16.5V15h16v1.5z"/></svg>',
			El = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm0 3V6h5.674v1.5zm0 3V9h5.674v1.5zm0 3V12h5.674v1.5zm8.5-6V12h6V7.5h-6zM9.682 6h7.636c.377 0 .682.407.682.91v5.68c0 .503-.305.91-.682.91H9.682c-.377 0-.682-.407-.682-.91V6.91c0-.503.305-.91.682-.91zM2 16.5V15h16v1.5z"/></svg>',
			Pl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm2.5 3V12h11V7.5h-11zM4.061 6H15.94c.586 0 1.061.407 1.061.91v5.68c0 .503-.475.91-1.061.91H4.06c-.585 0-1.06-.407-1.06-.91V6.91C3 6.406 3.475 6 4.061 6zM2 16.5V15h16v1.5z"/></svg>',
			Sl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="m7.3 17.37-.061.088a1.518 1.518 0 0 1-.934.535l-4.178.663-.806-4.153a1.495 1.495 0 0 1 .187-1.058l.056-.086L8.77 2.639c.958-1.351 2.803-1.076 4.296-.03 1.497 1.047 2.387 2.693 1.433 4.055L7.3 17.37zM9.14 4.728l-5.545 8.346 3.277 2.294 5.544-8.346L9.14 4.728zM6.07 16.512l-3.276-2.295.53 2.73 2.746-.435zM9.994 3.506 13.271 5.8c.316-.452-.16-1.333-1.065-1.966-.905-.634-1.895-.78-2.212-.328zM8 18.5 9.375 17H19v1.5H8z"/></svg>',
			Ml = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 10.423a6.5 6.5 0 0 1 6.056-6.408l.038.67C6.448 5.423 5.354 7.663 5.22 10H9c.552 0 .5.432.5.986v4.511c0 .554-.448.503-1 .503h-5c-.552 0-.5-.449-.5-1.003v-4.574zm8 0a6.5 6.5 0 0 1 6.056-6.408l.038.67c-2.646.739-3.74 2.979-3.873 5.315H17c.552 0 .5.432.5.986v4.511c0 .554-.448.503-1 .503h-5c-.552 0-.5-.449-.5-1.003v-4.574z"/></svg>',
			Il = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle cx="9.5" cy="4.5" r="1.5"/><circle cx="9.5" cy="10.5" r="1.5"/><circle cx="9.5" cy="16.5" r="1.5"/></svg>';
		...
		function Ol({
			...
			e.listenTo(e.element, "submit", (t, i) => {
		...
		class Dl extends Zi {
			...
			delegate(...e) {
				if (!e.length || !e.every(e => "string" == typeof e)) throw new c.a("ui-viewcollection-delegate-wrong-events", this);
				return {
					to: t => {
						for (const i of this)
		...
		class Ll {
			constructor(e) {
				this.element = null, this.isRendered = !1, this.locale = e, this.t = e && e.t, this._viewCollections = new Zi, this._unboundChildren = this.createCollection(), this._viewCollections.on("add", (t, i) => {
					i.locale = e
				}), this.decorate("render")
			}
			get bindTemplate() {
				return this._bindTemplate ? this._bindTemplate : this._bindTemplate = zl.bind(this, this)
			}
			createCollection(e) {
				const t = new Dl(e);
			...
			setTemplate(e) {
				this.template = new zl(e)
			}
			extendTemplate(e) {
				zl.extend(this.template, e)
			}
			render() {
		...
		class zl {
			constructor(e) {
				Object.assign(this, Yl($l(e))), this._isRendered = !1, this._revertData = null
			}
			render() {
			...
			revert(e) {
				...
				yield* function* e(t) {
					if (t.children)
						for (const i of t.children) Zl(i) ? yield i: Xl(i) && (yield* e(i))
				}(this)
			}
			static bind(e, t) {
				return {
			...
			static extend(e, t) {
				...
				! function e(t, i) {
					i.attributes && (t.attributes || (t.attributes = {}), Ql(t.attributes, i.attributes));
					i.eventListeners && (t.eventListeners || (t.eventListeners = {}), Ql(t.eventListeners, i.eventListeners));
					i.text && t.text.push(...i.text);
					if (i.children && i.children.length) {
						if (t.children.length != i.children.length) throw new c.a("ui-template-extend-children-mismatch", t);
						let n = 0;
						for (const o of i.children) e(t.children[n++], o)
					}
				}(e, Yl($l(t)))
			}
			_renderNode(e) {
				let t;
				if (t = e.node ? this.tag && this.text : this.tag ? this.text : !this.text, t) throw new c.a("ui-template-wrong-syntax", this);
			...
			_renderText(e) {
				let t = e.node;
				return t ? e.revertData.text = t.textContent : t = e.node = document.createTextNode(""), Fl(this.text) ? this._bindToObservable({
					schema: this.text,
					updater: Ul(t),
					data: e
			...
			_renderAttributes(e) {
				...
				for (t in this.attributes)
					if (n = r.getAttribute(t), i = this.attributes[t], s && (s.attributes[t] = n), o = w(i[0]) && i[0].ns ? i[0].ns : null, Fl(i)) {
						const a = o ? i[0].value : i;
						s && td(t) && a.unshift(n), this._bindToObservable({
							schema: a,
							updater: Wl(r, t, o),
							data: e
						})
					} else "style" == t && "string" != typeof i[0] ? this._renderStyleAttribute(i[0], e) : (s && n && td(t) && i.unshift(n), i = i.map(e => e && e.value || e).reduce((e, t) => e.concat(t), []).reduce(Kl, ""), Jl(i) || r.setAttributeNS(o, t, i))
			}
			_renderStyleAttribute(e, t) {
				const i = t.node;
				for (const n in e) {
					const o = e[n];
					Fl(o) ? this._bindToObservable({
						schema: [o],
						updater: ql(i, n),
						data: t
					}) : i.style[n] = o
			...
			_renderElementChildren(e) {
				...
				for (const r of this.children)
					...
					} else if (Zl(r)) n || (r.isRendered || r.render(), i.appendChild(r.element));
				else if (gr(r)) i.appendChild(r);
				else if (n) {
					const t = {
						children: [],
						bindings: [],
					...
					e.revertData.children.push(t), r._renderNode({
						node: i.childNodes[o++],
						isApplying: !0,
						revertData: t
					})
			...
			_bindToObservable({
				...
				Hl(e, t, i);
				const o = e.filter(e => !Jl(e)).filter(e => e.observable).map(n => n.activateAttributeListener(e, t, i));
				n && n.bindings.push(o)
			}
			_revertTemplateFromNode(e, t) {
				for (const e of t.bindings)
					for (const t of e) t();
				if (t.text) e.textContent = t.text;
					...
					for (let i = 0; i < t.children.length; ++i) this._revertTemplateFromNode(e.childNodes[i], t.children[i])
				}
			}
		}
		Ke(zl, u);
		...
		class jl extends Vl {
			activateDomEventListener(e, t, i) {
				const n = (e, i) => {
					t && !i.target.matches(t) || ("function" == typeof this.eventNameOrFunction ? this.eventNameOrFunction(i) : this.observable.fire(this.eventNameOrFunction, i))
				};
		...
		class Bl extends Vl {
			getValue(e) {
				return !Jl(super.getValue(e)) && (this.valueIfTrue || !0)
			}
		}

		function Fl(e) {
			return !!e && (e.value && (e = e.value), Array.isArray(e) ? e.some(Fl) : e instanceof Vl)
		}
		...
		function Hl(e, t, {
			...
			let n = function (e, t) {
				return e.map(e => e instanceof Vl ? e.getValue(t) : e)
			}(e, i);
			n = 1 == e.length && e[0] instanceof Bl ? n[0] : n.reduce(Kl, ""), Jl(n) ? t.remove() : t.set(n)
		}
		...
		function $l(e) {
			return $i(e, e => {
				if (e && (e instanceof Vl || Xl(e) || Zl(e) || ed(e))) return e
			})
		}
		...
		function Yl(e) {
			if ("string" == typeof e ? e = function (e) {
					...
					for (const t in e) Gl(e, t);
					return e
				}(e.on), delete e.on), !e.text) {
				e.attributes && function (e) {
					for (const t in e) e[t].value && (e[t].value = en(e[t].value)), Gl(e, t)
				}(e.attributes);
				const t = [];
				if (e.children)
					if (ed(e.children)) t.push(e.children);
					else
						for (const i of e.children) Xl(i) || Zl(i) || gr(i) ? t.push(i) : t.push(new zl(i));
				e.children = t
			}
			return e
		}
		...
		class id extends Dl {
			...
			attachToDom() {
				this._bodyCollectionContainer = new zl({
					tag: "div",
					attributes: {
		...
		class nd extends Ll {
			...
			_updateXMLContent() {
				if (this.content) {
					...
					for (t && (this.viewBox = t), this.element.innerHTML = ""; e.childNodes.length > 0;) this.element.appendChild(e.childNodes[0])
				}
			}
			_colorFillPaths() {
		...
		class rd extends Ll {
			constructor(e) {
				...
				this.set("class"), this.set("labelStyle"), this.set("icon"), this.set("isEnabled", !0), this.set("isOn", !1), this.set("isVisible", !0), this.set("isToggleable", !1), this.set("keystroke"), this.set("label"), this.set("tabindex", -1), this.set("tooltip"), this.set("tooltipPosition", "s"), this.set("type", "button"), this.set("withText", !1), this.set("withKeystroke", !1), this.children = this.createCollection(), this.tooltipView = this._createTooltipView(), this.labelView = this._createLabelView(i), this.iconView = new nd, this.iconView.extendTemplate({
					...
					tag: "button",
					attributes: {
						class: ["ck", "ck-button", t.to("class"), t.if("isEnabled", "ck-disabled", e => !e), t.if("isVisible", "ck-hidden", e => !e), t.to("isOn", e => e ? "ck-on" : "ck-off"), t.if("withText", "ck-button_with-text"), t.if("withKeystroke", "ck-button_with-keystroke")],
						...
						"aria-pressed": t.to("isOn", e => !!this.isToggleable && String(e))
					},
			...
			_createKeystrokeView() {
				...
				return e.setTemplate({
					...
					children: [{
						text: this.bindTemplate.to("keystroke", e => Do(e))
					}]
				}), e
			}
		...
		class ad {
			constructor(e) {
				if (Object.assign(this, e), e.actions && e.keystrokeHandler)
					for (const t in e.actions) {
						let i = e.actions[t];
						"string" == typeof i && (i = [i]);
						for (const n of i) e.keystrokeHandler.set(n, (e, i) => {
							this[t](), i()
						})
					}
			}
			get first() {
				return this.focusables.find(cd) || null
			}
			get last() {
				return this.focusables.filter(cd).slice(-1)[0] || null
			}
			get next() {
			...
			get current() {
				let e = null;
				return null === this.focusTracker.focusedElement ? null : (this.focusables.find((t, i) => {
		...
		function cd(e) {
			return !(!e.focus || "none" == kr.window.getComputedStyle(e.element).display)
		}
		i(24);
		var ld = '<svg viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg"><path d="M.941 4.523a.75.75 0 1 1 1.06-1.06l3.006 3.005 3.005-3.005a.75.75 0 1 1 1.06 1.06l-3.549 3.55a.75.75 0 0 1-1.168-.136L.941 4.523z"/></svg>';
		class dd extends rd {
			constructor(e) {
			...
			_createArrowView() {
				const e = new nd;
				return e.content = ld, e.extendTemplate({
					attributes: {
		...
		class ud extends Ll {
			constructor(e) {
				super(e);
				const t = this.bindTemplate;
				this.set("icon"), this.set("isEnabled", !0), this.set("isOn", !1), this.set("isToggleable", !1), this.set("isVisible", !0), this.set("keystroke"), this.set("label"), this.set("tabindex", -1), this.set("tooltip"), this.set("tooltipPosition", "s"), this.set("type", "button"), this.set("withText", !1), this.children = this.createCollection(), this.actionView = this._createActionView(), this.arrowView = this._createArrowView(), this.keystrokes = new Is, this.focusTracker = new Ms, this.setTemplate({
					tag: "div",
					attributes: {
						class: ["ck", "ck-splitbutton", t.if("isVisible", "ck-hidden", e => !e), this.arrowView.bindTemplate.if("isOn", "ck-splitbutton_open")]
					},
					children: this.children
				})
			}
			...
			_createArrowView() {
				const e = new rd,
					t = e.bindTemplate;
				return e.icon = ld, e.extendTemplate({
					attributes: {
		...
		class hd extends Ll {
			constructor(e) {
				...
				this.set("isVisible", !1), this.set("position", "se"), this.children = this.createCollection(), this.setTemplate({
					tag: "div",
					attributes: {
						class: ["ck", "ck-reset", "ck-dropdown__panel", t.to("position", e => "ck-dropdown__panel_" + e), t.if("isVisible", "ck-dropdown__panel-visible")]
					},
					children: this.children,
					on: {
		...
		function fd({
			...
			I(t) && (t = t()), I(n) && (n = n());
			const r = function (e) {
					return e && e.parentNode ? e.offsetParent === kr.document.body ? null : e.offsetParent : null
				}(e),
				s = new xs(e),
				a = new xs(t);
			let c, l;
				...
				const e = function (e, t) {
					const {
						...
						for (const a of e) {
							...
							if (n)
								if (o) {
									const e = n.getIntersection(o);
									e && (d = e.getIntersectionArea(l))
								} else d = n.getIntersectionArea(l);
					...
					targetRect: a,
					elementRect: s,
					limiterRect: n && new xs(n).getVisible(),
					viewportRect: o && new xs(kr.window)
				});
				[l, c] = e || gd(i[0], a, s)
			} else [l, c] = gd(i[0], a, s);
			let d = pd(c);
			return r && (d = function ({
				...
				const n = pd(new xs(i)),
					o = vs(i);
				return e -= n.left, t -= n.top, e += i.scrollLeft, t += i.scrollTop, e -= o.left, t -= o.top, {
					left: e,
					top: t
				}
			}(d, r)), {
		...
		class bd extends Ll {
			constructor(e, t, i) {
				...
				this.buttonView = t, this.panelView = i, this.set("isOpen", !1), this.set("isEnabled", !0), this.set("class"), this.set("id"), this.set("panelPosition", "auto"), this.keystrokes = new Is, this.setTemplate({
					tag: "div",
					attributes: {
						class: ["ck", "ck-dropdown", n.to("class"), n.if("isEnabled", "ck-disabled", e => !e)],
						id: n.to("id"),
			...
			render() {
				super.render(), this.listenTo(this.buttonView, "open", () => {
					...
					this.isOpen && ("auto" === this.panelPosition ? this.panelView.position = bd._getOptimalPosition({
			...
			get _panelPositions() {
				const {
					...
					northMiddleEast: c,
					northMiddleWest: l
				} = bd.defaultPanelPositions;
				return "rtl" !== this.locale.uiLanguageDirection ? [i, n, s, a, e, o, r, c, l, t] : [n, i, a, s, e, r, o, l, c, t]
			}
		}
		bd.defaultPanelPositions = {
			south: (e, t) => ({
		...
		class vd extends Ll {
			constructor(e, t) {
				...
				const o = ["ck", "ck-toolbar", i.to("class"), i.if("isCompact", "ck-toolbar_compact")];
				var r;
				this.options.shouldGroupWhenFull && this.options.isFloating && o.push("ck-toolbar_floating"), this.setTemplate({
					...
					children: this.children,
					on: {
						mousedown: (r = this, r.bindTemplate.to(e => {
							e.target === r.element && e.preventDefault()
						}))
					}
				}), this._behavior = this.options.shouldGroupWhenFull ? new Ad(this) : new xd(this)
			}
			render() {
				super.render();
			...
			fillFromConfig(e, t) {
				const i = _d(e),
					n = i.items.filter((e, n, o) => "|" === e || -1 === i.removeItems.indexOf(e) && ("-" === e ? !this.options.shouldGroupWhenFull || (Object(c.b)("toolbarview-line-break-ignored-when-grouping-items", o), !1) : !!t.has(e) || (Object(c.b)("toolbarview-item-unavailable", {
						name: e
					}), !1))),
					o = this._cleanSeparators(n).map(e => "|" === e ? new wd : "-" === e ? new kd : t.create(e));
			...
			_cleanSeparators(e) {
				const t = e => "-" !== e && "|" !== e,
					i = e.length,
					n = e.findIndex(t),
					o = i - e.slice().reverse().findIndex(t);
				return e.slice(n, o).filter((e, i, n) => {
					if (t(e)) return !0;
					return !(i > 0 && n[i - 1] === e)
				})
			}
		...
		class xd {
			constructor(e) {
				...
				e.set("isVertical", !1), e.itemsView.children.bindTo(e.items).using(e => e), e.focusables.bindTo(e.items).using(e => e), e.extendTemplate({
					attributes: {
		...
		class Ad {
			constructor(e) {
				this.view = e, this.viewChildren = e.children, this.viewFocusables = e.focusables, this.viewItemsView = e.itemsView, this.viewFocusTracker = e.focusTracker, this.viewLocale = e.locale, this.ungroupedItems = e.createCollection(), this.groupedItems = e.createCollection(), this.groupedItemsDropdown = this._createGroupedItemsDropdown(), this.resizeObserver = null, this.cachedPadding = null, this.shouldUpdateGroupingOnNextResize = !1, e.itemsView.children.bindTo(this.ungroupedItems).using(e => e), this.ungroupedItems.on("add", this._updateFocusCycleableItems.bind(this)), this.ungroupedItems.on("remove", this._updateFocusCycleableItems.bind(this)), e.children.on("add", this._updateFocusCycleableItems.bind(this)), e.children.on("remove", this._updateFocusCycleableItems.bind(this)), e.items.on("change", (e, t) => {
					const i = t.index;
					for (const e of t.removed) i >= this.ungroupedItems.length ? this.groupedItems.remove(e) : this.ungroupedItems.remove(e);
					for (let e = i; e < i + t.added.length; e++) {
						const n = t.added[e - i];
						e > this.ungroupedItems.length ? this.groupedItems.add(n, e - this.ungroupedItems.length) : this.ungroupedItems.add(n, e)
					}
			...
			get _areItemsOverflowing() {
				...
				const e = this.viewElement,
					...
					i = new xs(e.lastChild),
					n = new xs(e);
				if (!this.cachedPadding) {
					const i = kr.window.getComputedStyle(e),
						n = "ltr" === t ? "paddingRight" : "paddingLeft";
					this.cachedPadding = Number.parseInt(i[n])
				}
				return "ltr" === t ? i.right > n.right - this.cachedPadding : i.left < n.left + this.cachedPadding
			}
			_enableGroupingOnResize() {
				let e;
				this.resizeObserver = new Ts(this.viewElement, t => {
			...
			_groupLastItem() {
				this.groupedItems.length || (this.viewChildren.add(new wd), this.viewChildren.add(this.groupedItemsDropdown), this.viewFocusTracker.add(this.groupedItemsDropdown.element)), this.groupedItems.add(this.ungroupedItems.remove(this.ungroupedItems.last), 0)
			}
			_ungroupFirstItem() {
			...
			_createGroupedItemsDropdown() {
				const e = this.viewLocale,
					t = e.t,
					i = Pd(e);
				return i.class = "ck-toolbar__grouped-dropdown", i.panelPosition = "ltr" === e.uiLanguageDirection ? "sw" : "se",
					function (e, t) {
						const i = e.locale,
							n = i.t,
							o = e.toolbarView = new vd(i);
						o.set("ariaLabel", n("Dropdown toolbar")), e.extendTemplate({
							attributes: {
								class: ["ck-toolbar-dropdown"]
							}
						}), t.map(e => o.items.add(e)), e.panelView.children.add(o), o.items.delegate("execute").to(e)
					}(i, []), i.buttonView.set({
						label: t("Show more items"),
						tooltip: !0,
						tooltipPosition: "rtl" === e.uiLanguageDirection ? "se" : "sw",
						icon: Il
					}), i.toolbarView.items.bindTo(this.groupedItems).using(e => e), i
			}
		...
		class Cd extends Ll {
			constructor() {
				super(), this.items = this.createCollection(), this.focusTracker = new Ms, this.keystrokes = new Is, this._focusCycler = new ad({
		...
		function Pd(e, t = dd) {
			const i = new t(e),
				n = new hd(e),
				o = new bd(e, i, n);
			return i.bind("isEnabled").to(o), i instanceof dd ? i.bind("isOn").to(o, "isOpen") : i.arrowView.bind("isOn").to(o, "isOpen"),
				function (e) {
					(function (e) {
						e.on("render", () => {
							Nl({
					...
					function (e) {
						e.on("execute", t => {
							t.source instanceof sd || (e.isOpen = !1)
						})
					}(e),
					function (e) {
		...
		function Sd(e, t) {
			const i = e.locale,
				n = e.listView = new Cd(i);
			n.items.bindTo(t).using(({
				type: e,
				model: t
			}) => {
				if ("separator" === e) return new Ed(i);
				if ("button" === e || "switchbutton" === e) {
					const n = new Td(i);
					let o;
					return o = "button" === e ? new rd(i) : new sd(i), o.bind(...Object.keys(t)).to(t), o.delegate("execute").to(n), n.children.add(o), n
				}
		...
		class Id extends Ll {
			constructor(e) {
				super(e), this.set("text"), this.set("for"), this.id = "ck-editor__label_" + s();
				const t = this.bindTemplate;
				this.setTemplate({
					tag: "label",
					attributes: {
		...
		class Rd extends Ll {
			constructor(e, t, i) {
				...
				}), this.name = null, this.set("isFocused", !1), this._editableElement = i, this._hasExternalElement = !!this._editableElement, this._editingView = t
			}
			render() {
			...
			_updateIsFocusedClasses() {
				...
				function t(t) {
					e.change(i => {
						...
						i.addClass(t.isFocused ? "ck-focused" : "ck-blurred", n), i.removeClass(t.isFocused ? "ck-blurred" : "ck-focused", n)
					})
				}
				e.isRenderingInProgress ? function i(n) {
		...
		class Od extends Rd {
			constructor(e, t, i) {
				super(e, t, i), this.extendTemplate({
					attributes: {
						role: "textbox",
			...
			render() {
				...
				e.change(i => {
					...
					i.setAttribute("aria-label", t("Rich Text Editor, %0", this.name), n)
				})
			}
		}
		i(42);
		...
		class Dd extends Ll {
			constructor(e) {
				super(e), this.set("value"), this.set("id"), this.set("placeholder"), this.set("isReadOnly", !1), this.set("hasError", !1), this.set("ariaDescribedById"), this.focusTracker = new Ms, this.bind("isFocused").to(this.focusTracker), this.set("isEmpty", !0);
				const t = this.bindTemplate;
				this.setTemplate({
					tag: "input",
					attributes: {
		...
		class Ld extends Ll {
			constructor(e, t) {
				super(e);
				const i = "ck-labeled-field-view-" + s(),
					n = "ck-labeled-field-view-status-" + s();
				this.fieldView = t(this, i, n), this.set("label"), this.set("isEnabled", !0), this.set("isEmpty", !0), this.set("isFocused", !1), this.set("errorText", null), this.set("infoText", null), this.set("class"), this.set("placeholder"), this.labelView = this._createLabelView(i), this.statusView = this._createStatusView(n), this.bind("_statusText").to(this, "errorText", this, "infoText", (e, t) => e || t);
				const o = this.bindTemplate;
				this.setTemplate({
					tag: "div",
					attributes: {
						class: ["ck", "ck-labeled-field-view", o.to("class"), o.if("isEnabled", "ck-disabled", e => !e), o.if("isEmpty", "ck-labeled-field-view_empty"), o.if("isFocused", "ck-labeled-field-view_focused"), o.if("placeholder", "ck-labeled-field-view_placeholder"), o.if("errorText", "ck-error")]
					},
					children: [{
						tag: "div",
						attributes: {
			...
			_createLabelView(e) {
				const t = new Id(this.locale);
				return t.for = e, t.bind("text").to(this, "label"), t
			}
			_createStatusView(e) {
				const t = new Ll(this.locale),
					i = this.bindTemplate;
				return t.setTemplate({
					tag: "div",
					attributes: {
						class: ["ck", "ck-labeled-field-view__status", i.if("errorText", "ck-labeled-field-view__status_error"), i.if("_statusText", "ck-hidden", e => !e)],
						id: e,
		...
		function zd(e, t, i) {
			const n = new Dd(e.locale);
			return n.set({
				id: t,
				ariaDescribedById: i
			}), n.bind("isReadOnly").to(e, "isEnabled", e => !e), n.bind("hasError").to(e, "errorText", e => !!e), n.on("input", () => {
				e.errorText = null
			}), e.bind("isEmpty", "isFocused", "placeholder").to(n), n
		}
		class Vd extends an {
			static get pluginName() {
				return "Notification"
		...
		class Hd extends Ll {
			constructor(e) {
				...
				this.set("top", 0), this.set("left", 0), this.set("position", "arrow_nw"), this.set("isVisible", !1), this.set("withArrow", !0), this.set("class"), this.content = this.createCollection(), this.setTemplate({
					tag: "div",
					attributes: {
						class: ["ck", "ck-balloon-panel", t.to("position", e => "ck-balloon-panel_" + e), t.if("isVisible", "ck-balloon-panel_visible"), t.if("withArrow", "ck-balloon-panel_with-arrow"), t.to("class")],
						style: {
							top: t.to("top", Bd),
							left: t.to("left", Bd)
						}
			...
			_startPinning(e) {
				this.attachTo(e);
				const t = Ud(e.target),
					i = e.limiter ? Ud(e.limiter) : Fd;
				this.listenTo(kr.document, "scroll", (n, o) => {
					const r = o.target,
						s = t && r.contains(t),
						a = i && r.contains(i);
			...
			_stopPinning() {
				this.stopListening(kr.document, "scroll"), this.stopListening(kr.window, "resize")
			}
		}

		function Ud(e) {
			return Yi(e) ? e : _s(e) ? e.commonAncestorContainer : "function" == typeof e ? Ud(e()) : null
		}

		function Wd(e, t) {
			return e.top - t.height - Hd.arrowVerticalOffset
		}

		function qd(e) {
			return e.bottom + Hd.arrowVerticalOffset
		}
		Hd.arrowHorizontalOffset = 25, Hd.arrowVerticalOffset = 10, Hd._getOptimalPosition = fd, Hd.defaultPositions = {
			northWestArrowSouthWest: (e, t) => ({
				top: Wd(e, t),
				left: e.left - Hd.arrowHorizontalOffset,
				name: "arrow_sw"
			}),
			northWestArrowSouthMiddleWest: (e, t) => ({
				top: Wd(e, t),
				left: e.left - .25 * t.width - Hd.arrowHorizontalOffset,
				name: "arrow_smw"
			}),
			...
			northWestArrowSouthMiddleEast: (e, t) => ({
				top: Wd(e, t),
				left: e.left - .75 * t.width + Hd.arrowHorizontalOffset,
				name: "arrow_sme"
			}),
			northWestArrowSouthEast: (e, t) => ({
				top: Wd(e, t),
				left: e.left - t.width + Hd.arrowHorizontalOffset,
				name: "arrow_se"
			}),
			northArrowSouthWest: (e, t) => ({
				top: Wd(e, t),
				left: e.left + e.width / 2 - Hd.arrowHorizontalOffset,
				name: "arrow_sw"
			}),
			northArrowSouthMiddleWest: (e, t) => ({
				top: Wd(e, t),
				left: e.left + e.width / 2 - .25 * t.width - Hd.arrowHorizontalOffset,
				name: "arrow_smw"
			}),
			northArrowSouth: (e, t) => ({
				top: Wd(e, t),
			...
			northArrowSouthMiddleEast: (e, t) => ({
				top: Wd(e, t),
				left: e.left + e.width / 2 - .75 * t.width + Hd.arrowHorizontalOffset,
				name: "arrow_sme"
			}),
			northArrowSouthEast: (e, t) => ({
				top: Wd(e, t),
				left: e.left + e.width / 2 - t.width + Hd.arrowHorizontalOffset,
				name: "arrow_se"
			}),
			northEastArrowSouthWest: (e, t) => ({
				top: Wd(e, t),
				left: e.right - Hd.arrowHorizontalOffset,
				name: "arrow_sw"
			}),
			northEastArrowSouthMiddleWest: (e, t) => ({
				top: Wd(e, t),
				left: e.right - .25 * t.width - Hd.arrowHorizontalOffset,
				name: "arrow_smw"
			}),
			...
			northEastArrowSouthMiddleEast: (e, t) => ({
				top: Wd(e, t),
				left: e.right - .75 * t.width + Hd.arrowHorizontalOffset,
				name: "arrow_sme"
			}),
			northEastArrowSouthEast: (e, t) => ({
				top: Wd(e, t),
				left: e.right - t.width + Hd.arrowHorizontalOffset,
				name: "arrow_se"
			}),
		...
		class Yd extends Qe {
			...
			add(e) {
				...
				if (!this._idToStack.has(t)) return this._idToStack.set(t, new Map([
					[e.view, e]
				])), this._viewToStack.set(e.view, this._idToStack.get(t)), this._numberOfStacks = this._idToStack.size, void(this._visibleStack && !e.singleViewMode || this.showStack(t));
			...
			_createRotatorView() {
				const e = new Gd(this.editor.locale),
					t = this.editor.locale.t;
				return this.view.content.add(e), e.bind("isNavigationVisible").to(this, "_numberOfStacks", this, "_singleViewMode", (e, t) => !t && e > 1), e.on("change:isNavigationVisible", () => this.updatePosition(), {
					priority: "low"
				}), e.bind("counter").to(this, "visibleView", this, "_numberOfStacks", (e, i) => {
					if (i < 2) return "";
			...
			_createFakePanelsView() {
				const e = new Kd(this.editor.locale, this.view);
				return e.bind("numberOfPanels").to(this, "_numberOfStacks", this, "_singleViewMode", (e, t) => !t && e >= 2 ? Math.min(e - 1, 2) : 0), e.listenTo(this.view, "change:top", () => e.updatePosition()), e.listenTo(this.view, "change:left", () => e.updatePosition()), this.editor.ui.view.body.add(e), e
			}
			_showView({
				view: e,
				balloonClassName: t = "",
			...
			constructor(e) {
				...
				this.set("isNavigationVisible", !0), this.focusTracker = new Ms, this.buttonPrevView = this._createButtonView(t("Previous"), '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.463 5.187a.888.888 0 1 1 1.254 1.255L9.16 10l3.557 3.557a.888.888 0 1 1-1.254 1.255L7.26 10.61a.888.888 0 0 1 .16-1.382l4.043-4.042z"/></svg>'), this.buttonNextView = this._createButtonView(t("Next"), '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8.537 14.813a.888.888 0 1 1-1.254-1.255L10.84 10 7.283 6.442a.888.888 0 1 1 1.254-1.255L12.74 9.39a.888.888 0 0 1-.16 1.382l-4.043 4.042z"/></svg>'), this.content = this.createCollection(), this.setTemplate({
					...
					children: [{
						tag: "div",
						attributes: {
							class: ["ck-balloon-rotator__navigation", i.to("isNavigationVisible", e => e ? "" : "ck-hidden")]
						},
		...
		class Kd extends Ll {
			constructor(e, t) {
				...
				this.set("top", 0), this.set("left", 0), this.set("height", 0), this.set("width", 0), this.set("numberOfPanels", 0), this.content = this.createCollection(), this._balloonPanelView = t, this.setTemplate({
					tag: "div",
					attributes: {
						class: ["ck-fake-panel", i.to("numberOfPanels", e => e ? "" : "ck-hidden")],
						style: {
							top: i.to("top", $d),
							left: i.to("left", $d),
							width: i.to("width", $d),
							height: i.to("height", $d)
						}
					},
					children: this.content
			...
			_addPanels(e) {
				for (; e--;) {
					...
					e.setTemplate({
						tag: "div"
					}), this.content.add(e), this.registerChild(e)
				}
			}
			_removePanels(e) {
				for (; e--;) {
			...
			updatePosition() {
				if (this.numberOfPanels) {
					const {
						...
						width: i,
						height: n
					} = new xs(this._balloonPanelView.element);
					Object.assign(this, {
						top: e,
						left: t,
						width: i,
		...
		class Jd extends Ll {
			constructor(e) {
				super(e);
				const t = this.bindTemplate;
				this.set("isActive", !1), this.set("isSticky", !1), this.set("limiterElement", null), this.set("limiterBottomOffset", 50), this.set("viewportTopOffset", 0), this.set("_marginLeft", null), this.set("_isStickyToTheLimiter", !1), this.set("_hasViewportTopOffset", !1), this.content = this.createCollection(), this._contentPanelPlaceholder = new zl({
					tag: "div",
					attributes: {
						class: ["ck", "ck-sticky-panel__placeholder"],
						style: {
							display: t.to("isSticky", e => e ? "block" : "none"),
							height: t.to("isSticky", e => e ? Qd(this._panelRect.height) : null)
						}
					}
				}).render(), this._contentPanel = new zl({
					tag: "div",
					attributes: {
						...
						style: {
							width: t.to("isSticky", e => e ? Qd(this._contentPanelPlaceholder.getBoundingClientRect().width) : null),
							top: t.to("_hasViewportTopOffset", e => e ? Qd(this.viewportTopOffset) : null),
							bottom: t.to("_isStickyToTheLimiter", e => e ? Qd(this.limiterBottomOffset) : null),
			...
			render() {
				super.render(), this._checkIfShouldBeSticky(), this.listenTo(kr.window, "scroll", () => {
		...
		function Xd(e) {
			...
			Zd.has(s) || (Zd.set(s, new Map), s.registerPostFixer(e => tu(s, e))), Zd.get(s).set(i, {
				text: n,
				isDirectHost: o,
				keepOnFocus: r,
		...
		function tu(e, t) {
			const i = Zd.get(e),
				n = [];
			let o = !1;
			for (const [e, r] of i) r.isDirectHost && (n.push(e), iu(t, e, r) && (o = !0));
			for (const [e, r] of i) {
				if (r.isDirectHost) continue;
				const i = nu(e);
				i && (n.includes(i) || (r.hostElement = i, iu(t, e, r) && (o = !0)))
			}
			return o
		}
		...
		function iu(e, t, i) {
			...
			let s = !1;
			r.getAttribute("data-placeholder") !== n && (e.setAttribute("data-placeholder", n, r), s = !0);
			return (o || 1 == t.childCount) && function (e, t) {
				if (!e.isAttached()) return !1;
				if (Array.from(e.getChildren()).some(e => !e.is("uiElement"))) return !1;
				if (t) return !0;
				const i = e.document;
				if (!i.isFocused) return !0;
				const n = i.selection.anchor;
				return n && n.parent !== e
			}(r, i.keepOnFocus) ? function (e, t) {
				return !t.hasClass("ck-placeholder") && (e.addClass("ck-placeholder", t), !0)
			}(e, r) && (s = !0) : eu(e, r) && (s = !0), s
		}
		...
		function ru(e, t, i) {
			let n = ou.get(e);
			n || (n = new Map, ou.set(e, n)), n.set(t, i)
		}
		...
		function cu(e, t, i) {
			e = e.slice(), t = t.slice();
			const n = new lu(i.document, i.useRelations, i.forceWeakRemove);
			...
			for (; a < e.length;) {
				...
				const s = t[o],
					c = au(i, s, n.getContext(i, s, !0)),
					l = au(s, i, n.getContext(s, i, !1));
				n.updateRelation(i, s), n.setOriginalOperations(c, i), n.setOriginalOperations(l, s);
				for (const e of c) r.set(e, o + l.length);
				e.splice(a, 1, ...c), t.splice(o, 1, ...l)
			}
			if (i.padWithNoOps) {
			...
			return du(e, s.nextBaseVersionB), du(t, s.nextBaseVersionA), {
				operationsA: e,
				operationsB: t,
				originalOperations: o
			}
			...
			updateRelation(e, t) {
				switch (e.constructor) {
						...
						switch (t.constructor) {
							...
							case yc:
								if (e.splitPosition.isEqual(t.sourcePosition) || e.splitPosition.isBefore(t.sourcePosition)) this._setRelation(e, t, "splitBefore");
									...
									const i = ta._createFromPositionAndShift(t.sourcePosition, t.howMany);
					...
					case Ac: {
						...
						switch (t.constructor) {
							case yc: {
								const n = ta._createFromPositionAndShift(t.sourcePosition, t.howMany),
									o = n.containsPosition(i.start) || n.start.isEqual(i.start),
									r = n.containsPosition(i.end) || n.end.isEqual(i.end);
								!o && !r || n.containsRange(i) || this._setRelation(e, t, {
									side: o ? "left" : "right",
		...
		function uu(e, t) {
			for (let i = 0; i < t; i++) e.push(new Yc(0))
		}

		function hu(e, t, i) {
			const n = e.nodes.getNode(0).getAttribute(t);
			if (n == i) return null;
			const o = new ta(e.position, e.position.getShiftedBy(e.howMany));
			return new _c(o, t, n, i, 0)
		}
		...
		function gu(e, t) {
			...
			for (let n = 0; n < e.length; n++) {
				const o = e[n],
					r = new yc(o.start, o.end.offset - o.start.offset, t, 0);
				i.push(r);
				for (let t = n + 1; t < e.length; t++) e[t] = e[t]._getTransformedByMove(r.sourcePosition, r.targetPosition, r.howMany)[0];
				t = t._getTransformedByMove(r.sourcePosition, r.targetPosition, r.howMany)
			}
			return i
		}
		ru(_c, _c, (e, t, i) => {
			if (e.key === t.key && e.range.start.hasSameParentAs(t.range.start)) {
				const n = e.range.getDifference(t.range).map(t => new _c(t, e.key, e.oldValue, e.newValue, 0)),
					o = e.range.getIntersection(t.range);
				return o && i.aIsStrong && n.push(new _c(o, t.key, t.newValue, e.newValue, 0)), 0 == n.length ? [new Yc(0)] : n
			}
			return [e]
		}), ru(_c, xc, (e, t) => {
			if (e.range.start.hasSameParentAs(t.position) && e.range.containsPosition(t.position)) {
				const i = e.range._getTransformedByInsertion(t.position, t.howMany, !t.shouldReceiveAttributes).map(t => new _c(t, e.key, e.oldValue, e.newValue, e.baseVersion));
				if (t.shouldReceiveAttributes) {
					const n = hu(t, e.key, e.oldValue);
					n && i.unshift(n)
				}
				return i
			}
			...
			const i = [];
			e.range.start.hasSameParentAs(t.deletionPosition) && (e.range.containsPosition(t.deletionPosition) || e.range.start.isEqual(t.deletionPosition)) && i.push(ta._createFromPositionAndShift(t.graveyardPosition, 1));
			const n = e.range._getTransformedByMergeOperation(t);
			return n.isCollapsed || i.push(n), i.map(t => new _c(t, e.key, e.oldValue, e.newValue, e.baseVersion))
		}), ru(_c, yc, (e, t) => function (e, t) {
			const i = ta._createFromPositionAndShift(t.sourcePosition, t.howMany);
			let n = null,
				o = [];
			i.containsRange(e, !0) ? n = e : e.start.hasSameParentAs(i.start) ? (o = e.getDifference(i), n = e.getIntersection(i)) : o = [e];
			const r = [];
			for (let e of o) {
				e = e._getTransformedByDeletion(t.sourcePosition, t.howMany);
				const i = t.getMovedRangeStart(),
					n = e.start.hasSameParentAs(i);
				e = e._getTransformedByInsertion(i, t.howMany, n), r.push(...e)
			}
			n && r.push(n._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany, !1)[0]);
			return r
		}(e.range, t).map(t => new _c(t, e.key, e.oldValue, e.newValue, e.baseVersion))), ru(_c, Pc, (e, t) => {
			...
			if (e.range.start.hasSameParentAs(t.splitPosition) && e.range.containsPosition(t.splitPosition)) {
				const i = e.clone();
				return i.range = new ta(t.moveTargetPosition.clone(), e.range.end._getCombined(t.splitPosition, t.moveTargetPosition)), e.range.end = t.splitPosition.clone(), e.range.end.stickiness = "toPrevious", [e, i]
			}
			...
			if (e.shouldReceiveAttributes && e.position.hasSameParentAs(t.range.start) && t.range.containsPosition(e.position)) {
				const n = hu(e, t.key, t.newValue);
				n && i.push(n)
			}
			return i
		}), ru(xc, xc, (e, t, i) => (e.position.isEqual(t.position) && i.aIsStrong || (e.position = e.position._getTransformedByInsertOperation(t)), [e])), ru(xc, yc, (e, t) => (e.position = e.position._getTransformedByMoveOperation(t), [e])), ru(xc, Pc, (e, t) => (e.position = e.position._getTransformedBySplitOperation(t), [e])), ru(xc, Ec, (e, t) => (e.position = e.position._getTransformedByMergeOperation(t), [e])), ru(Ac, xc, (e, t) => (e.oldRange && (e.oldRange = e.oldRange._getTransformedByInsertOperation(t)[0]), e.newRange && (e.newRange = e.newRange._getTransformedByInsertOperation(t)[0]), [e])), ru(Ac, Ac, (e, t, i) => {
			if (e.name == t.name) {
				if (!i.aIsStrong) return [new Yc(0)];
				e.oldRange = t.newRange ? t.newRange.clone() : null
			}
			return [e]
		}), ru(Ac, Ec, (e, t) => (e.oldRange && (e.oldRange = e.oldRange._getTransformedByMergeOperation(t)), e.newRange && (e.newRange = e.newRange._getTransformedByMergeOperation(t)), [e])), ru(Ac, yc, (e, t, i) => {
			if (e.oldRange && (e.oldRange = ta._createFromRanges(e.oldRange._getTransformedByMoveOperation(t))), e.newRange) {
				if (i.abRelation) {
					const n = ta._createFromRanges(e.newRange._getTransformedByMoveOperation(t));
					if ("left" == i.abRelation.side && t.targetPosition.isEqual(e.newRange.start)) return e.newRange.start.path = i.abRelation.path, e.newRange.end = n.end, [e];
					if ("right" == i.abRelation.side && t.targetPosition.isEqual(e.newRange.end)) return e.newRange.start = n.start, e.newRange.end.path = i.abRelation.path, [e]
				}
				e.newRange = ta._createFromRanges(e.newRange._getTransformedByMoveOperation(t))
			}
			return [e]
		}), ru(Ac, Pc, (e, t, i) => {
			if (e.oldRange && (e.oldRange = e.oldRange._getTransformedBySplitOperation(t)), e.newRange) {
				if (i.abRelation) {
					...
					return e.newRange.start.isEqual(t.splitPosition) && i.abRelation.wasStartBeforeMergedElement ? e.newRange.start = Js._createAt(t.insertionPosition) : e.newRange.start.isEqual(t.splitPosition) && !i.abRelation.wasInLeftElement && (e.newRange.start = Js._createAt(t.moveTargetPosition)), e.newRange.end.isEqual(t.splitPosition) && i.abRelation.wasInRightElement ? e.newRange.end = Js._createAt(t.moveTargetPosition) : e.newRange.end.isEqual(t.splitPosition) && i.abRelation.wasEndBeforeMergedElement ? e.newRange.end = Js._createAt(t.insertionPosition) : e.newRange.end = n.end, [e]
				}
				e.newRange = e.newRange._getTransformedBySplitOperation(t)
			}
			return [e]
		}), ru(Ec, xc, (e, t) => (e.sourcePosition.hasSameParentAs(t.position) && (e.howMany += t.howMany), e.sourcePosition = e.sourcePosition._getTransformedByInsertOperation(t), e.targetPosition = e.targetPosition._getTransformedByInsertOperation(t), [e])), ru(Ec, Ec, (e, t, i) => {
			if (e.sourcePosition.isEqual(t.sourcePosition) && e.targetPosition.isEqual(t.targetPosition)) {
				if (i.bWasUndone) {
					...
					return i.push(0), e.sourcePosition = new Js(t.graveyardPosition.root, i), e.howMany = 0, [e]
				}
				return [new Yc(0)]
			}
			if (e.sourcePosition.isEqual(t.sourcePosition) && !e.targetPosition.isEqual(t.targetPosition) && !i.bWasUndone && "splitAtSource" != i.abRelation) {
				const n = "$graveyard" == e.targetPosition.root.rootName,
					o = "$graveyard" == t.targetPosition.root.rootName,
					r = n && !o;
				if (o && !n || !r && i.aIsStrong) {
					const i = t.targetPosition._getTransformedByMergeOperation(t),
						n = e.targetPosition._getTransformedByMergeOperation(t);
					return [new yc(i, e.howMany, n, 0)]
				}
				return [new Yc(0)]
			}
			return e.sourcePosition.hasSameParentAs(t.targetPosition) && (e.howMany += t.howMany), e.sourcePosition = e.sourcePosition._getTransformedByMergeOperation(t), e.targetPosition = e.targetPosition._getTransformedByMergeOperation(t), e.graveyardPosition.isEqual(t.graveyardPosition) && i.aIsStrong || (e.graveyardPosition = e.graveyardPosition._getTransformedByMergeOperation(t)), [e]
		}), ru(Ec, yc, (e, t, i) => {
			const n = ta._createFromPositionAndShift(t.sourcePosition, t.howMany);
			return "remove" == t.type && !i.bWasUndone && !i.forceWeakRemove && e.deletionPosition.hasSameParentAs(t.sourcePosition) && n.containsPosition(e.sourcePosition) ? [new Yc(0)] : (e.sourcePosition.hasSameParentAs(t.targetPosition) && (e.howMany += t.howMany), e.sourcePosition.hasSameParentAs(t.sourcePosition) && (e.howMany -= t.howMany), e.sourcePosition = e.sourcePosition._getTransformedByMoveOperation(t), e.targetPosition = e.targetPosition._getTransformedByMoveOperation(t), e.graveyardPosition.isEqual(t.targetPosition) || (e.graveyardPosition = e.graveyardPosition._getTransformedByMoveOperation(t)), [e])
		}), ru(Ec, Pc, (e, t, i) => {
			if (t.graveyardPosition && (e.graveyardPosition = e.graveyardPosition._getTransformedByDeletion(t.graveyardPosition, 1), e.deletionPosition.isEqual(t.graveyardPosition) && (e.howMany = t.howMany)), e.targetPosition.isEqual(t.splitPosition)) {
				const n = 0 != t.howMany,
					o = t.graveyardPosition && e.deletionPosition.isEqual(t.graveyardPosition);
				if (n || o || "mergeTargetNotMoved" == i.abRelation) return e.sourcePosition = e.sourcePosition._getTransformedBySplitOperation(t), [e]
			}
			if (e.sourcePosition.isEqual(t.splitPosition)) {
				if ("mergeSourceNotMoved" == i.abRelation) return e.howMany = 0, e.targetPosition = e.targetPosition._getTransformedBySplitOperation(t), [e];
				if ("mergeSameElement" == i.abRelation || e.sourcePosition.offset > 0) return e.sourcePosition = t.moveTargetPosition.clone(), e.targetPosition = e.targetPosition._getTransformedBySplitOperation(t), [e]
			}
			...
			const i = ta._createFromPositionAndShift(e.sourcePosition, e.howMany)._getTransformedByInsertOperation(t, !1)[0];
			return e.sourcePosition = i.start, e.howMany = i.end.offset - i.start.offset, e.targetPosition.isEqual(t.position) || (e.targetPosition = e.targetPosition._getTransformedByInsertOperation(t)), [e]
		}), ru(yc, yc, (e, t, i) => {
			const n = ta._createFromPositionAndShift(e.sourcePosition, e.howMany),
				o = ta._createFromPositionAndShift(t.sourcePosition, t.howMany);
			let r, s = i.aIsStrong,
				a = !i.aIsStrong;
			if ("insertBefore" == i.abRelation || "insertAfter" == i.baRelation ? a = !0 : "insertAfter" != i.abRelation && "insertBefore" != i.baRelation || (a = !1), r = e.targetPosition.isEqual(t.targetPosition) && a ? e.targetPosition._getTransformedByDeletion(t.sourcePosition, t.howMany) : e.targetPosition._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany), fu(e, t) && fu(t, e)) return [t.getReversed()];
			if (n.containsPosition(t.targetPosition) && n.containsRange(o, !0)) return n.start = n.start._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany), n.end = n.end._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany), gu([n], r);
			if (o.containsPosition(e.targetPosition) && o.containsRange(n, !0)) return n.start = n.start._getCombined(t.sourcePosition, t.getMovedRangeStart()), n.end = n.end._getCombined(t.sourcePosition, t.getMovedRangeStart()), gu([n], r);
			const c = cn(e.sourcePosition.getParentPath(), t.sourcePosition.getParentPath());
			if ("prefix" == c || "extension" == c) return n.start = n.start._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany), n.end = n.end._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany), gu([n], r);
			"remove" != e.type || "remove" == t.type || i.aWasUndone || i.forceWeakRemove ? "remove" == e.type || "remove" != t.type || i.bWasUndone || i.forceWeakRemove || (s = !1) : s = !0;
			const l = [],
				d = n.getDifference(o);
			for (const e of d) {
				e.start = e.start._getTransformedByDeletion(t.sourcePosition, t.howMany), e.end = e.end._getTransformedByDeletion(t.sourcePosition, t.howMany);
				const i = "same" == cn(e.start.getParentPath(), t.getMovedRangeStart().getParentPath()),
					n = e._getTransformedByInsertion(t.getMovedRangeStart(), t.howMany, i);
				l.push(...n)
			}
			const u = n.getIntersection(o);
			return null !== u && s && (u.start = u.start._getCombined(t.sourcePosition, t.getMovedRangeStart()), u.end = u.end._getCombined(t.sourcePosition, t.getMovedRangeStart()), 0 === l.length ? l.push(u) : 1 == l.length ? o.start.isBefore(n.start) || o.start.isEqual(n.start) ? l.unshift(u) : l.push(u) : l.splice(1, 0, u)), 0 === l.length ? [new Yc(e.baseVersion)] : gu(l, r)
		}), ru(yc, Pc, (e, t, i) => {
			let n = e.targetPosition.clone();
			e.targetPosition.isEqual(t.insertionPosition) && t.graveyardPosition && "moveTargetAfter" != i.abRelation || (n = e.targetPosition._getTransformedBySplitOperation(t));
			const o = ta._createFromPositionAndShift(e.sourcePosition, e.howMany);
			if (o.end.isEqual(t.insertionPosition)) return t.graveyardPosition || e.howMany++, e.targetPosition = n, [e];
			if (o.start.hasSameParentAs(t.splitPosition) && o.containsPosition(t.splitPosition)) {
				let e = new ta(t.splitPosition, o.end);
				e = e._getTransformedBySplitOperation(t);
				return gu([new ta(o.start, t.splitPosition), e], n)
			}
			e.targetPosition.isEqual(t.splitPosition) && "insertAtSource" == i.abRelation && (n = t.moveTargetPosition), e.targetPosition.isEqual(t.insertionPosition) && "insertBetween" == i.abRelation && (n = e.targetPosition);
			const r = [o._getTransformedBySplitOperation(t)];
			if (t.graveyardPosition) {
				const n = o.start.isEqual(t.graveyardPosition) || o.containsPosition(t.graveyardPosition);
				e.howMany > 1 && n && !i.aWasUndone && r.push(ta._createFromPositionAndShift(t.insertionPosition, 1))
			}
			return gu(r, n)
		}), ru(yc, Ec, (e, t, i) => {
			const n = ta._createFromPositionAndShift(e.sourcePosition, e.howMany);
			if (t.deletionPosition.hasSameParentAs(e.sourcePosition) && n.containsPosition(t.sourcePosition))
				if ("remove" != e.type || i.forceWeakRemove) {
					if (1 == e.howMany) return i.bWasUndone ? (e.sourcePosition = t.graveyardPosition.clone(), e.targetPosition = e.targetPosition._getTransformedByMergeOperation(t), [e]) : [new Yc(0)]
				} else if (!i.aWasUndone) {
				const i = [];
				let n = t.graveyardPosition.clone(),
					o = t.targetPosition._getTransformedByMergeOperation(t);
				e.howMany > 1 && (i.push(new yc(e.sourcePosition, e.howMany - 1, e.targetPosition, 0)), n = n._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany - 1), o = o._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany - 1));
				const r = t.deletionPosition._getCombined(e.sourcePosition, e.targetPosition),
					s = new yc(n, 1, r, 0),
					a = s.getMovedRangeStart().path.slice();
				a.push(0);
				const c = new Js(s.targetPosition.root, a);
				o = o._getTransformedByMove(n, r, 1);
				const l = new yc(o, t.howMany, c, 0);
				return i.push(s), i.push(l), i
			}
			const o = ta._createFromPositionAndShift(e.sourcePosition, e.howMany)._getTransformedByMergeOperation(t);
		...
		}), ru(Cc, xc, (e, t) => (e.position = e.position._getTransformedByInsertOperation(t), [e])), ru(Cc, Ec, (e, t) => e.position.isEqual(t.deletionPosition) ? (e.position = t.graveyardPosition.clone(), e.position.stickiness = "toNext", [e]) : (e.position = e.position._getTransformedByMergeOperation(t), [e])), ru(Cc, yc, (e, t) => (e.position = e.position._getTransformedByMoveOperation(t), [e])), ru(Cc, Cc, (e, t, i) => {
			...
			if ("same" == cn(e.position.path, t.splitPosition.getParentPath()) && !t.graveyardPosition) {
				const t = new Cc(e.position.getShiftedBy(1), e.oldName, e.newName, 0);
				return [e, t]
			}
			return e.position = e.position._getTransformedBySplitOperation(t), [e]
		}), ru(Tc, Tc, (e, t, i) => {
			if (e.root === t.root && e.key === t.key) {
				if (!i.aIsStrong || e.newValue === t.newValue) return [new Yc(0)];
				e.oldValue = t.newValue
			}
			return [e]
		}), ru(Pc, xc, (e, t) => (e.splitPosition.hasSameParentAs(t.position) && e.splitPosition.offset < t.position.offset && (e.howMany += t.howMany), e.splitPosition = e.splitPosition._getTransformedByInsertOperation(t), e.insertionPosition = e.insertionPosition._getTransformedByInsertOperation(t), [e])), ru(Pc, Ec, (e, t, i) => {
			if (!e.graveyardPosition && !i.bWasUndone && e.splitPosition.hasSameParentAs(t.sourcePosition)) {
				const i = t.graveyardPosition.path.slice();
				i.push(0);
				const n = new Js(t.graveyardPosition.root, i),
					o = Pc.getInsertionPosition(new Js(t.graveyardPosition.root, i)),
					r = new Pc(n, 0, o, null, 0);
				return e.splitPosition = e.splitPosition._getTransformedByMergeOperation(t), e.insertionPosition = Pc.getInsertionPosition(e.splitPosition), e.graveyardPosition = r.insertionPosition.clone(), e.graveyardPosition.stickiness = "toNext", [r, e]
			}
			return e.splitPosition.hasSameParentAs(t.deletionPosition) && !e.splitPosition.isAfter(t.deletionPosition) && e.howMany--, e.splitPosition.hasSameParentAs(t.targetPosition) && (e.howMany += t.howMany), e.splitPosition = e.splitPosition._getTransformedByMergeOperation(t), e.insertionPosition = Pc.getInsertionPosition(e.splitPosition), e.graveyardPosition && (e.graveyardPosition = e.graveyardPosition._getTransformedByMergeOperation(t)), [e]
		}), ru(Pc, yc, (e, t, i) => {
			const n = ta._createFromPositionAndShift(t.sourcePosition, t.howMany);
			if (e.graveyardPosition) {
				const o = n.start.isEqual(e.graveyardPosition) || n.containsPosition(e.graveyardPosition);
				if (!i.bWasUndone && o) {
					const i = e.splitPosition._getTransformedByMoveOperation(t),
						n = e.graveyardPosition._getTransformedByMoveOperation(t),
						o = n.path.slice();
					o.push(0);
					const r = new Js(n.root, o);
					return [new yc(i, e.howMany, r, 0)]
				}
				e.graveyardPosition = e.graveyardPosition._getTransformedByMoveOperation(t)
			}
			const o = e.splitPosition.isEqual(t.targetPosition);
			if (o && ("insertAtSource" == i.baRelation || "splitBefore" == i.abRelation)) return e.howMany += t.howMany, e.splitPosition = e.splitPosition._getTransformedByDeletion(t.sourcePosition, t.howMany), e.insertionPosition = Pc.getInsertionPosition(e.splitPosition), [e];
			if (o && i.abRelation && i.abRelation.howMany) {
				const {
					howMany: t,
					offset: n
				} = i.abRelation;
				return e.howMany += t, e.splitPosition = e.splitPosition.getShiftedBy(n), [e]
			}
			if (e.splitPosition.hasSameParentAs(t.sourcePosition) && n.containsPosition(e.splitPosition)) {
				const i = t.howMany - (e.splitPosition.offset - t.sourcePosition.offset);
				return e.howMany -= i, e.splitPosition.hasSameParentAs(t.targetPosition) && e.splitPosition.offset < t.targetPosition.offset && (e.howMany += t.howMany), e.splitPosition = t.sourcePosition.clone(), e.insertionPosition = Pc.getInsertionPosition(e.splitPosition), [e]
			}
			return t.sourcePosition.isEqual(t.targetPosition) || (e.splitPosition.hasSameParentAs(t.sourcePosition) && e.splitPosition.offset <= t.sourcePosition.offset && (e.howMany -= t.howMany), e.splitPosition.hasSameParentAs(t.targetPosition) && e.splitPosition.offset < t.targetPosition.offset && (e.howMany += t.howMany)), e.splitPosition.stickiness = "toNone", e.splitPosition = e.splitPosition._getTransformedByMoveOperation(t), e.splitPosition.stickiness = "toNext", e.graveyardPosition ? e.insertionPosition = e.insertionPosition._getTransformedByMoveOperation(t) : e.insertionPosition = Pc.getInsertionPosition(e.splitPosition), [e]
		}), ru(Pc, Pc, (e, t, i) => {
			if (e.splitPosition.isEqual(t.splitPosition)) {
				if (!e.graveyardPosition && !t.graveyardPosition) return [new Yc(0)];
				if (e.graveyardPosition && t.graveyardPosition && e.graveyardPosition.isEqual(t.graveyardPosition)) return [new Yc(0)];
				if ("splitBefore" == i.abRelation) return e.howMany = 0, e.graveyardPosition = e.graveyardPosition._getTransformedBySplitOperation(t), [e]
			}
			if (e.graveyardPosition && t.graveyardPosition && e.graveyardPosition.isEqual(t.graveyardPosition)) {
				...
				if (o && !n || !r && i.aIsStrong) {
					const i = [];
					return t.howMany && i.push(new yc(t.moveTargetPosition, t.howMany, t.splitPosition, 0)), e.howMany && i.push(new yc(e.splitPosition, e.howMany, e.moveTargetPosition, 0)), i
				}
				return [new Yc(0)]
			}
			if (e.graveyardPosition && (e.graveyardPosition = e.graveyardPosition._getTransformedBySplitOperation(t)), e.splitPosition.isEqual(t.insertionPosition) && "splitBefore" == i.abRelation) return e.howMany++, [e];
			if (t.splitPosition.isEqual(e.insertionPosition) && "splitBefore" == i.baRelation) {
				const i = t.insertionPosition.path.slice();
				i.push(0);
				const n = new Js(t.insertionPosition.root, i);
				return [e, new yc(e.insertionPosition, 1, n, 0)]
			}
			return e.splitPosition.hasSameParentAs(t.splitPosition) && e.splitPosition.offset < t.splitPosition.offset && (e.howMany -= t.howMany), e.splitPosition = e.splitPosition._getTransformedBySplitOperation(t), e.insertionPosition = Pc.getInsertionPosition(e.splitPosition), [e]
		});
		class mu extends Zr {
			constructor(e) {
		...
		class pu extends Zr {
			constructor(e) {
				super(e), this.domEventType = ["mousedown", "mouseup"]
			}
			onDomEvent(e) {
				this.fire(e.type, e)
			}
		...
		class bu {
			...
			createElement(e, t, i) {
				return new Xn(this.document, e, t, i)
			}
			createText(e) {
				return new un(this.document, e)
			}
			...
			rename(e, t) {
				const i = new Xn(this.document, e, t.getAttributes(), t.getChildren());
		...
		class wu extends bl {
			constructor(e, t) {
				super(e), this.view = t, this._toolbarConfig = _d(e.config.get("toolbar")), this._elementReplacer = new ws
			}
			get element() {
			...
			init(e) {
				...
				const s = o.element;
				this.setEditableElement(o.name, s), this.focusTracker.add(s), i.editable.bind("isFocused").to(this.focusTracker), n.attachDomRoot(s), e && this._elementReplacer.replace(e, this.element), this._initPlaceholder(), this._initToolbar(), this.fire("ready")
			}
			destroy() {
				const e = this.view,
			...
			_initToolbar() {
				const e = this.editor,
					t = this.view,
					i = e.editing.view;
				t.stickyPanel.bind("isActive").to(this.focusTracker, "isFocused"), t.stickyPanel.limiterElement = t.element, this._toolbarConfig.viewportTopOffset && (t.stickyPanel.viewportTopOffset = this._toolbarConfig.viewportTopOffset), t.toolbar.fillFromConfig(this._toolbarConfig, this.componentFactory),
					function ({
						origin: e,
						originKeystrokeHandler: t,
						originFocusTracker: i,
						toolbar: n,
						beforeFocus: o,
						afterBlur: r
					}) {
						i.add(n.element), t.set("Alt+F10", (e, t) => {
							i.isFocused && !n.focusTracker.isFocused && (o && o(), n.focus(), t())
						}), n.keystrokes.set("Esc", (t, i) => {
							n.focusTracker.isFocused && (e.focus(), r && r(), i())
						})
					}({
						origin: i,
		...
		class ku extends Nd {
			constructor(e, t, i = {}) {
				super(e), this.stickyPanel = new Jd(e), this.toolbar = new vd(e, {
					shouldGroupWhenFull: i.shouldToolbarGroupWhenFull
				}), this.editable = new Od(e, t)
			}
			render() {
		...
		class _u extends gl {
			constructor(e, t) {
				super(t), Yi(e) && (this.sourceElement = e), this.model.document.createRoot();
				const i = !this.config.get("toolbar.shouldNotGroupWhenFull"),
					n = new ku(this.locale, this.editing.view, {
						shouldToolbarGroupWhenFull: i
					});
				this.ui = new wu(this, n),
					function (e) {
						if (!I(e.updateSourceElement)) throw new c.a("attachtoform-missing-elementapi-interface", e);
						const t = e.sourceElement;
						if (t && "textarea" === t.tagName.toLowerCase() && t.form) {
							let i;
							const n = t.form,
								o = () => e.updateSourceElement();
							I(n.submit) && (i = n.submit, n.submit = () => {
								o(), i.apply(n)
							}), n.addEventListener("submit", o), e.on("destroy", () => {
			...
			static create(e, t = {}) {
				return new Promise(i => {
					...
					i(n.initPlugins().then(() => n.ui.init(Yi(e) ? e : null)).then(() => {
						if (!Yi(e) && t.initialData) throw new c.a("editor-create-initial-data", null);
						const i = t.initialData || function (e) {
							return Yi(e) ? (t = e, t instanceof HTMLTextAreaElement ? t.value : t.innerHTML) : e;
							var t
						}(e);
			...
			constructor(e) {
				this.files = function (e) {
					const t = e.files ? Array.from(e.files) : [],
						i = e.items ? Array.from(e.items) : [];
					if (t.length) return t;
					return i.filter(e => "file" === e.kind).map(e => e.getAsFile())
				}(e), this._native = e
			}
			get types() {
		...
		class yu extends Zr {
			constructor(e) {
				...
				function i(e) {
					return (i, n) => {
						n.preventDefault();
						const r = n.dropRange ? [n.dropRange] : null,
							s = new o(t, e);
						t.fire(s, {
							...
							targetRanges: r,
							target: n.target
						}), s.stop.called && n.stopPropagation()
					}
				}
				this.domEventType = ["paste", "copy", "cut", "drop", "dragover", "dragstart", "dragend", "dragenter", "dragleave"], this.listenTo(t, "paste", i("clipboardInput"), {
					priority: "low"
				}), this.listenTo(t, "drop", i("clipboardInput"), {
					priority: "low"
				}), this.listenTo(t, "dragover", i("dragging"), {
					priority: "low"
				})
			}
			onDomEvent(e) {
				const t = {
					dataTransfer: new vu(e.clipboardData ? e.clipboardData : e.dataTransfer)
				};
				"drop" != e.type && "dragover" != e.type || (t.dropRange = function (e, t) {
					const i = t.target.ownerDocument,
						...
						o = t.clientY;
					let r;
					i.caretRangeFromPoint && i.caretRangeFromPoint(n, o) ? r = i.caretRangeFromPoint(n, o) : t.rangeParent && (r = i.createRange(), r.setStart(t.rangeParent, t.rangeOffset), r.collapse(!0));
					if (r) return e.domConverter.domRangeToView(r);
					return null
				}(this.view, e)), this.fire(e.type, e, t)
			}
		}
		const xu = ["figcaption", "li"];
		class Au extends Qe {
			static get pluginName() {
				return "ClipboardPipeline"
			}
			init() {
				this.editor.editing.view.addObserver(yu), this._setupPasteDrop(), this._setupCopyCut()
			}
			_setupPasteDrop() {
				const e = this.editor,
					t = e.model,
					i = e.editing.view,
					n = i.document;
				this.listenTo(n, "clipboardInput", t => {
					e.isReadOnly && t.stop()
				}, {
					priority: "highest"
				}), this.listenTo(n, "clipboardInput", (e, t) => {
					const n = t.dataTransfer;
					let r = t.content || "";
					var s;
					r || (n.getData("text/html") ? r = function (e) {
						return e.replace(/<span(?: class="Apple-converted-space"|)>(\s+)<\/span>/g, (e, t) => 1 == t.length ? " " : t)
					}(n.getData("text/html")) : n.getData("text/plain") && (((s = (s = n.getData("text/plain")).replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\r?\n\r?\n/g, "</p><p>").replace(/\r?\n/g, "<br>").replace(/^\s/, "&nbsp;").replace(/\s$/, "&nbsp;").replace(/\s\s/g, " &nbsp;")).includes("</p><p>") || s.includes("<br>")) && (s = `<p>${s}</p>`), r = s), r = this.editor.data.htmlProcessor.toView(r));
					const a = new o(this, "inputTransformation");
					this.fire(a, {
						content: r,
						dataTransfer: n,
						targetRanges: t.targetRanges,
						method: t.method
					}), a.stop.called && e.stop(), i.scrollToTheSelection()
				}, {
					priority: "low"
				}), this.listenTo(this, "inputTransformation", (e, i) => {
					if (i.content.isEmpty) return;
					const n = this.editor.data.toModel(i.content, "$clipboardHolder");
					0 != n.childCount && (e.stop(), t.change(() => {
					...
					priority: "low"
				}), this.listenTo(this, "contentInsertion", (e, i) => {
			...
			_setupCopyCut() {
				...
				this.listenTo(i, "copy", n, {
					priority: "low"
				}), this.listenTo(i, "cut", (t, i) => {
					e.isReadOnly ? i.preventDefault() : n(t, i)
				}, {
					priority: "low"
				}), this.listenTo(i, "clipboardOutput", (i, n) => {
					n.content.isEmpty || (n.dataTransfer.setData("text/html", this.editor.data.htmlProcessor.toData(n.content)), n.dataTransfer.setData("text/plain", function e(t) {
						let i = "";
						if (t.is("$text") || t.is("$textProxy")) i = t.data;
						else if (t.is("element", "img") && t.hasAttribute("alt")) i = t.getAttribute("alt");
						else if (t.is("element", "br")) i = "\n";
						else {
							let n = null;
							for (const o of t.getChildren()) {
								const t = e(o);
								n && (n.is("containerElement") || o.is("containerElement")) && (xu.includes(n.name) || xu.includes(o.name) ? i += "\n" : i += "\n\n"), i += t, n = o
							}
						}
						return i
					}(n.content))), "cut" == n.method && e.model.deleteContent(t.selection)
				}, {
					priority: "low"
				})
			}
		...
		function* Cu(e, t) {
			for (const i of t) i && e.getAttributeProperties(i[0]).copyOnEnter && (yield i)
		}
		class Tu extends Ze {
			execute() {
				...
				e.change(i => {
					! function (e, t, i, n) {
						const o = i.isCollapsed,
							...
							s = r.start.parent,
							a = r.end.parent;
						if (n.isLimit(s) || n.isLimit(a)) return void(o || s != a || e.deleteContent(i));
						if (o) {
							const e = Cu(t.model.schema, i.getAttributes());
							Eu(t, r.start), t.setSelectionAttribute(e)
						} else {
							const n = !(r.start.isAtStart && r.end.isAtEnd),
								o = s == a;
							e.deleteContent(i, {
								leaveUnmerged: n
							}), n && (o ? Eu(t, i.focus) : t.setSelection(a, 0))
						}
					}(this.editor.model, i, t.selection, e.schema), this.fire("afterExecute", {
						writer: i
					})
				})
			}
		...
		class Pu extends Ir {
			constructor(e) {
				...
				const t = this.document;
				t.on("keydown", (e, i) => {
					if (this.isEnabled && i.keyCode == Io.enter) {
						const n = new go(t, "enter", t.selection.getFirstRange());
						t.fire(n, new Jr(t, i.domEvent, {
							isSoft: i.shiftKey
						})), n.stop.called && e.stop()
					}
				})
			}
			observe() {}
		...
		class Su extends Qe {
			...
			init() {
				const e = this.editor,
					t = e.editing.view,
					i = t.document;
				t.addObserver(Pu), e.commands.add("enter", new Tu(e)), this.listenTo(i, "enter", (i, n) => {
					n.preventDefault(), n.isSoft || (e.execute("enter"), t.scrollToTheSelection())
				}, {
					priority: "low"
				})
			}
		...
		class Iu extends Ze {
			constructor(e, t) {
				super(e), this.direction = t, this._buffer = new Mu(e.model, e.config.get("typing.undoStep"))
			}
			get buffer() {
				return this._buffer
			}
			execute(e = {}) {
				...
				t.enqueueChange(this._buffer.batch, n => {
					...
					if (o.isCollapsed && t.modifySelection(o, {
							...
							unit: e.unit
						}), this._shouldEntireContentBeReplacedWithParagraph(r)) return void this._replaceEntireContentWithParagraph(n);
					if (this._shouldReplaceFirstBlockWithParagraph(o, r)) return void this.editor.execute("paragraph", {
						selection: o
					});
					...
					o.getFirstRange().getMinimalFlatRanges().forEach(e => {
						...
						direction: this.direction
					}), this._buffer.input(a), n.setSelection(o), this._buffer.unlock()
				})
			}
			...
			_shouldReplaceFirstBlockWithParagraph(e, t) {
				...
				const n = e.getFirstPosition(),
					...
					r = o.getChild(0);
				return n.parent == r && (!!e.containsEntireContent(r) && (!!i.schema.checkChild(o, "paragraph") && "paragraph" != r.name))
			}
		}
		class Nu extends Ir {
			constructor(e) {
				...
				function n(e, i, n) {
					const o = new go(t, "delete", t.selection.getFirstRange());
					t.fire(o, new Jr(t, i, n)), o.stop.called && e.stop()
				}
				t.on("keyup", (e, t) => {
					t.keyCode != Io.delete && t.keyCode != Io.backspace || (i = 0)
				}), t.on("keydown", (e, t) => {
					const o = {};
					if (t.keyCode == Io.delete) o.direction = "forward", o.unit = "character";
					else {
						if (t.keyCode != Io.backspace) return;
						o.direction = "backward", o.unit = "codePoint"
					}
					const r = Po.isMac ? t.altKey : t.ctrlKey;
					o.unit = r ? "word" : o.unit, o.sequence = ++i, n(e, t.domEvent, o)
				}), Po.isAndroid && t.on("beforeinput", (t, i) => {
					...
					r.anchorNode == r.focusNode && r.anchorOffset + 1 != r.focusOffset && (o.selectionToRemove = e.domConverter.domSelectionToView(r)), n(t, i.domEvent, o)
				})
			}
			observe() {}
		}
		class Ru extends Qe {
			...
			init() {
				const e = this.editor,
					...
					i = t.document;
				t.addObserver(Nu);
				const n = new Iu(e, "forward");
				if (e.commands.add("deleteForward", n), e.commands.add("forwardDelete", n), e.commands.add("delete", new Iu(e, "backward")), this.listenTo(i, "delete", (i, n) => {
						const o = {
							unit: n.unit,
							sequence: n.sequence
						};
						if (n.selectionToRemove) {
							const t = e.model.createSelection(),
								i = [];
							for (const t of n.selectionToRemove.getRanges()) i.push(e.editing.mapper.toModelRange(t));
							t.setTo(i), o.selection = t
						}
						e.execute("forward" == n.direction ? "deleteForward" : "delete", o), n.preventDefault(), t.scrollToTheSelection()
					}, {
						priority: "low"
					}), Po.isAndroid) {
					let e = null;
					this.listenTo(i, "delete", (t, i) => {
						...
						priority: "lowest"
					}), this.listenTo(i, "keyup", (t, i) => {
						if (e) {
							const t = i.domTarget.ownerDocument.defaultView.getSelection();
							t.collapse(e.anchorNode, e.anchorOffset), t.extend(e.focusNode, e.focusOffset), e = null
						}
					})
				}
			}
		...
		class Ou {
			...
			add(e, t) {
				...
				const o = i[0];
				n === o || Du(n, o) || this.fire("change:top", {
					oldDescriptor: n,
					newDescriptor: o,
					writer: t
				})
		...
		function Du(e, t) {
			return e && t && e.priority == t.priority && zu(e.classes) == zu(t.classes)
		}

		function Lu(e, t) {
			return e.priority > t.priority || !(e.priority < t.priority) && zu(e.classes) > zu(t.classes)
		}
		...
		function Hu(e, t, i, n) {
			const o = new Ou;
			o.on("change:top", (t, o) => {
				o.oldDescriptor && n(e, o.oldDescriptor, o.writer), o.newDescriptor && i(e, o.newDescriptor, o.writer)
			}), t.setCustomProperty("addHighlight", (e, t, i) => o.add(t, i), e), t.setCustomProperty("removeHighlight", (e, t, i) => o.remove(t, i), e)
		}
		...
		function Wu(e, t) {
			return t.addClass(["ck-editor__editable", "ck-editor__nested-editable"], e), t.setAttribute("contenteditable", e.isReadOnly ? "false" : "true", e), e.on("change:isReadOnly", (i, n, o) => {
		...
		function qu(e, t) {
			...
			if (i) {
				const n = Qu(e);
				if (n) return t.createPositionAt(i, n);
				if (t.schema.isBlock(i)) return t.createPositionAfter(i)
			}
			const n = e.getSelectedBlocks().next().value;
			if (n) {
				if (n.isEmpty) return t.createPositionAt(n, 0);
				const i = t.createPositionAfter(n);
				return e.focus.isTouching(i) ? i : t.createPositionBefore(n)
			}
			return e.focus
		}
		...
		function $u(e, t) {
			const i = e.getSelectedElement();
			return !!i && t.isObject(i)
		}

		function Yu(e, t) {
			const i = new xs(kr.window),
				n = i.getIntersection(e),
				o = t.height + Hd.arrowVerticalOffset;
			if (e.top - o > i.top || e.bottom + o < i.bottom) return null;
			const r = n || e,
				s = r.left + r.width / 2 - t.width / 2;
			return {
				top: Math.max(e.top, 0) + Hd.arrowVerticalOffset,
				left: s,
				name: "arrow_n"
			}
		}
		...
		function Ku(e, t, i) {
			return e && Vu(e) && !i.isInline(t)
		}

		function Qu(e) {
			return e.getAttribute("widget-type-around")
		}
		const Ju = [Ro("arrowUp"), Ro("arrowRight"), Ro("arrowDown"), Ro("arrowLeft"), 9, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 45, 91, 93, 144, 145, 173, 174, 175, 176, 177, 178, 179, 255];
		for (let e = 112; e <= 135; e++) Ju.push(e);

		function Zu(e) {
			return !(!e.ctrlKey && !e.metaKey) || Ju.includes(e.keyCode)
		}
		i(62);
		const Xu = ["before", "after"],
			eh = (new DOMParser).parseFromString('<svg viewBox="0 0 10 8" xmlns="http://www.w3.org/2000/svg"><path d="M9.055.263v3.972h-6.77M1 4.216l2-2.038m-2 2 2 2.038"/></svg>', "image/svg+xml").firstChild;
		class th extends Qe {
			static get pluginName() {
			...
			init() {
				...
				this.on("change:isEnabled", (i, n, o) => {
					t.change(e => {
						for (const i of t.document.roots) o ? e.removeClass("ck-widget__type-around_disabled", i) : e.addClass("ck-widget__type-around_disabled", i)
					}), o || e.model.change(e => {
						e.removeSelectionAttribute("widget-type-around")
					})
			...
			_enableTypeAroundUIInjection() {
				...
				e.editing.downcastDispatcher.on("insert", (e, i, o) => {
					const r = o.mapper.toViewElement(i.item);
					Ku(r, i.item, t) && function (e, t, i) {
							...
							return function (e, t) {
									for (const i of Xu) {
										const n = new zl({
											tag: "div",
											attributes: {
												class: ["ck", "ck-widget__type-around__button", "ck-widget__type-around__button_" + i],
												title: t[i]
											},
											children: [e.ownerDocument.importNode(eh, !0)]
										});
			...
			_enableTypeAroundFakeCaretActivationUsingKeyboardArrows() {
				...
				this._listenToIfEnabled(o.document, "arrowKey", (e, t) => {
					this._handleArrowKeyPress(e, t)
				}, {
					context: [Vu, "$text"],
					priority: "high"
				}), this._listenToIfEnabled(i, "change:range", (t, i) => {
					i.directChange && e.model.change(e => {
						e.removeSelectionAttribute("widget-type-around")
					})
				}), this._listenToIfEnabled(t.document, "change:data", () => {
					const t = i.getSelectedElement();
					if (t) {
						if (Ku(e.editing.mapper.toViewElement(t), t, n)) return
					}
					e.model.change(e => {
						e.removeSelectionAttribute("widget-type-around")
					})
				}), this._listenToIfEnabled(e.editing.downcastDispatcher, "selection", (e, t, i) => {
					const o = i.writer;
					if (this._currentFakeCaretModelElement) {
						const e = i.mapper.toViewElement(this._currentFakeCaretModelElement);
						e && (o.removeClass(Xu.map(r), e), this._currentFakeCaretModelElement = null)
					}
					const s = t.selection.getSelectedElement();
					if (!s) return;
					const a = i.mapper.toViewElement(s);
					if (!Ku(a, s, n)) return;
					const c = Qu(t.selection);
					c && (o.addClass(r(c), a), this._currentFakeCaretModelElement = s)
				}), this._listenToIfEnabled(e.ui.focusTracker, "change:isFocused", (t, i, n) => {
					n || e.model.change(e => {
						e.removeSelectionAttribute("widget-type-around")
					})
				})
			...
			_handleArrowKeyPress(e, t) {
				const i = this.editor,
					...
					r = n.schema,
					s = i.editing.view,
					a = zo(t.keyCode, i.locale.contentLanguageDirection),
					c = s.document.selection.getSelectedElement();
				let l;
				Ku(c, i.editing.mapper.toModelElement(c), r) ? l = this._handleArrowKeyPressOnSelectedWidget(a) : o.isCollapsed && (l = this._handleArrowKeyPressWhenSelectionNextToAWidget(a)), l && (t.preventDefault(), e.stop())
			}
			_handleArrowKeyPressOnSelectedWidget(e) {
				const t = this.editor.model,
					i = Qu(t.document.selection);
				return t.change(t => {
					if (!i) return t.setSelectionAttribute("widget-type-around", e ? "after" : "before"), !0;
					if (!(i === (e ? "after" : "before"))) return t.removeSelectionAttribute("widget-type-around"), !0;
					return !1
				})
			}
			_handleArrowKeyPressWhenSelectionNextToAWidget(e) {
				...
				return !!Ku(t.editing.mapper.toViewElement(r), r, n) && (i.change(t => {
					o._setSelectionOverElement(r), t.setSelectionAttribute("widget-type-around", e ? "before" : "after")
				}), !0)
			}
			...
			_enableInsertingParagraphsOnEnterKeypress() {
				const e = this.editor,
					...
					i = e.editing.view;
				this._listenToIfEnabled(i.document, "enter", (i, n) => {
					if ("atTarget" != i.eventPhase) return;
					const o = t.getSelectedElement(),
						r = e.editing.mapper.toViewElement(o),
						s = e.model.schema;
					let a;
					this._insertParagraphAccordingToFakeCaretPosition() ? a = !0 : Ku(r, o, s) && (this._insertParagraph(o, n.isSoft ? "before" : "after"), a = !0), a && (n.preventDefault(), i.stop())
				}, {
					context: Vu
				})
			}
			_enableInsertingParagraphsOnTypingKeystroke() {
				const e = this.editor.editing.view,
					t = [Io.enter, Io.delete, Io.backspace];
				this._listenToIfEnabled(e.document, "keydown", (e, i) => {
					t.includes(i.keyCode) || Zu(i) || this._insertParagraphAccordingToFakeCaretPosition()
				}, {
					priority: "high"
				})
			}
			_enableDeleteIntegration() {
				const e = this.editor,
					...
					i = e.model,
					n = i.schema;
				this._listenToIfEnabled(t.document, "delete", (t, o) => {
					if ("atTarget" != t.eventPhase) return;
					const r = Qu(i.document.selection);
					if (!r) return;
					const s = o.direction,
						a = i.document.selection.getSelectedElement(),
						c = "forward" == s;
					if ("before" === r === c) e.execute("delete", {
						selection: i.createSelection(a, "on")
					});
					else {
						const t = n.getNearestSelectionRange(i.createPositionAt(a, r), s);
						if (t)
							if (t.isCollapsed) {
								const o = i.createSelection(t.start);
								if (i.modifySelection(o, {
										direction: s
									...
									i.setSelection(t), e.execute(c ? "deleteForward" : "delete")
								})
							} else i.change(i => {
								i.setSelection(t), e.execute(c ? "deleteForward" : "delete")
							})
		...
		function ih(e) {
			const t = e.model;
			return (i, n) => {
				const o = n.keyCode == Io.arrowup,
					r = n.keyCode == Io.arrowdown,
					s = n.shiftKey,
				...
				const l = function (e, t, i) {
					...
					if (i) {
						...
						const o = n.createRange(e, i),
							r = oh(n.schema, o, "backward");
						return r && e.isBefore(r) ? n.createRange(e, r) : null
					} {
						const e = t.isCollapsed ? t.focus : t.getFirstPosition(),
							i = nh(n, e, "backward");
						if (!i) return null;
						const o = n.createRange(i, e),
							r = oh(n.schema, o, "forward");
						return r && e.isAfter(r) ? n.createRange(r, e) : null
					}
				}(e, a, c);
				l && !l.isCollapsed && function (e, t, i) {
					const n = e.model,
		...
		class rh extends Qe {
			...
			init() {
				const e = this.editor.editing.view,
					t = e.document;
				this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (e, t, i) => {
					...
					for (const e of o.getRanges())
						for (const t of e) {
							const e = t.item;
							Vu(e) && !sh(e, s) && (n.addClass("ck-widget_selected", e), this._previouslySelected.add(e), s = e, e == r && n.setSelection(o.getRanges(), {
								fake: !0,
								label: Uu(r)
							}))
						}
					...
					priority: "low"
				}), e.addObserver(pu), this.listenTo(t, "mousedown", (...e) => this._onMousedown(...e)), this.listenTo(t, "arrowKey", (...e) => {
					this._handleSelectionChangeOnArrowKeyPress(...e)
				}, {
					context: [Vu, "$text"]
				}), this.listenTo(t, "arrowKey", (...e) => {
					this._preventDefaultOnArrowKeyPress(...e)
				}, {
					context: "$root"
				}), this.listenTo(t, "arrowKey", ih(this.editor.editing), {
					context: "$text"
			...
			_onMousedown(e, t) {
				...
				if (function (e) {
					...
					if ((Po.isSafari || Po.isGecko) && t.domEvent.detail >= 3) {
						const e = i.editing.mapper,
							n = r.is("attributeElement") ? r.findAncestor(e => !e.is("attributeElement")) : r,
							o = e.toModelElement(n);
						t.preventDefault(), this.editor.model.change(e => {
							e.setSelection(o, "in")
						})
					}
					return
				}
				if (!Vu(r) && (r = r.findAncestor(Vu), !r)) return;
				Po.isAndroid && t.preventDefault(), o.isFocused || n.focus();
			...
			_handleSelectionChangeOnArrowKeyPress(e, t) {
				const i = t.keyCode,
					...
					a = zo(i, this.editor.locale.contentLanguageDirection);
				if (s && o.isObject(s)) {
					const i = a ? r.getLastPosition() : r.getFirstPosition(),
						s = o.getNearestSelectionRange(i, a ? "forward" : "backward");
					return void(s && (n.change(e => {
						e.setSelection(s)
					}), t.preventDefault(), e.stop()))
				}
				if (!r.isCollapsed) return;
				const c = this._getObjectElementNextToSelection(a);
				c && o.isObject(c) && (this._setSelectionOverElement(c), t.preventDefault(), e.stop())
			}
			...
			_handleDelete(e) {
				...
				return i ? (this.editor.model.change(e => {
			...
			_clearPreviouslySelectedWidgets(e) {
				for (const t of this._previouslySelected) e.removeClass("ck-widget_selected", t);
		...
		var ah = function (e, t, i) {
			var n = !0,
				o = !0;
			if ("function" != typeof e) throw new TypeError("Expected a function");
			return w(i) && (n = "leading" in i ? !!i.leading : n, o = "trailing" in i ? !!i.trailing : o), hs(e, t, {
				leading: n,
				maxWait: t,
				trailing: o
			})
		...
		class ch extends Qe {
			...
			init() {
				...
				}), Po.isAndroid && this.forceDisabled("noAndroidSupport")
			}
			destroy() {
			...
			_setupDragging() {
				const e = this.editor,
					...
					n = e.editing.view,
					o = n.document;
				this.listenTo(o, "dragstart", (n, r) => {
					const a = i.selection;
					if (r.target && r.target.is("rootElement")) return void r.preventDefault();
					const c = r.target ? hh(r.target) : null;
					if (c) {
						const i = e.editing.mapper.toModelElement(c);
						this._draggedRange = ga.fromRange(t.createRangeOn(i))
					} else if (!o.selection.isCollapsed) {
						const e = o.selection.getSelectedElement();
						e && Vu(e) || (this._draggedRange = ga.fromRange(a.getFirstRange()))
					}
					if (!this._draggedRange) return void r.preventDefault();
					this._draggingUid = s(), r.dataTransfer.effectAllowed = this.isEnabled ? "copyMove" : "copy", r.dataTransfer.setData("application/ckeditor5-dragging-uid", this._draggingUid);
					...
					priority: "low"
				}), this.listenTo(o, "dragend", (e, t) => {
					this._finalizeDragging(!t.dataTransfer.isCanceled && "move" == t.dataTransfer.dropEffect)
				}, {
					priority: "low"
				...
				}), this.listenTo(o, "dragging", (t, i) => {
					if (!this.isEnabled) return void(i.dataTransfer.dropEffect = "none");
					this._removeDropMarkerDelayed.cancel();
					const n = lh(e, i.targetRanges, i.target);
					this._draggedRange || (i.dataTransfer.dropEffect = "copy"), Po.isGecko || ("copy" == i.dataTransfer.effectAllowed ? i.dataTransfer.dropEffect = "copy" : ["all", "copyMove"].includes(i.dataTransfer.effectAllowed) && (i.dataTransfer.dropEffect = "move")), n && this._updateDropMarkerThrottled(n)
				}, {
					priority: "low"
				})
			}
			_setupClipboardInputIntegration() {
				...
				this.listenTo(t, "clipboardInput", (t, i) => {
					if ("drop" != i.method) return;
					const n = lh(e, i.targetRanges, i.target);
					if (this._removeDropMarker(), !n) return this._finalizeDragging(!1), void t.stop();
					...
					if ("move" == dh(i.dataTransfer) && this._draggedRange && this._draggedRange.containsRange(n, !0)) return this._finalizeDragging(!1), void t.stop();
					i.targetRanges = [e.editing.mapper.toViewRange(n)]
				}, {
					priority: "high"
				})
			}
			_setupContentInsertionIntegration() {
				const e = this.editor.plugins.get(Au);
				e.on("contentInsertion", (e, t) => {
					if (!this.isEnabled || "drop" !== t.method) return;
					const i = t.targetRanges.map(e => this.editor.editing.mapper.toModelRange(e));
					this.editor.model.change(e => e.setSelection(i))
				}, {
					priority: "high"
				}), e.on("contentInsertion", (e, t) => {
					if (!this.isEnabled || "drop" !== t.method) return;
					const i = "move" == dh(t.dataTransfer),
			...
			_setupDraggableAttributeHandling() {
				...
				this.listenTo(i, "mousedown", (n, o) => {
					if (Po.isAndroid || !o) return;
					this._clearDraggableAttributesDelayed.cancel();
					let r = hh(o.target);
					if (Po.isBlink && !r && !i.selection.isCollapsed) {
						const e = i.selection.getSelectedElement();
						e && Vu(e) || (r = i.selection.editableElement)
					}
					r && (t.change(e => {
						e.setAttribute("draggable", "true", r)
					}), this._draggableElement = e.editing.mapper.toModelElement(r))
				}), this.listenTo(i, "mouseup", () => {
					Po.isAndroid || this._clearDraggableAttributesDelayed()
				})
			}
			_clearDraggableAttributes() {
				const e = this.editor.editing;
				e.view.change(t => {
					this._draggableElement && "$graveyard" != this._draggableElement.root.rootName && t.removeAttribute("draggable", e.mapper.toViewElement(this._draggableElement)), this._draggableElement = null
				})
			}
			_setupDropMarker() {
				const e = this.editor;
				e.conversion.for("editingDowncast").markerToHighlight({
					...
					view: (t, {
						...
						if (e.model.schema.checkChild(t.markerRange.start, "$text")) return i.createUIElement("span", {
			...
			_updateDropMarker(e) {
				const t = this.editor,
					i = t.model.markers;
				t.model.change(t => {
					i.has("drop-target") ? i.get("drop-target").getRange().isEqual(e) || t.updateMarker("drop-target", {
						range: e
			...
			_removeDropMarker() {
				const e = this.editor.model;
				this._removeDropMarkerDelayed.cancel(), this._updateDropMarkerThrottled.cancel(), e.markers.has("drop-target") && e.change(e => {
					e.removeMarker("drop-target")
				})
			}
			_finalizeDragging(e) {
				const t = this.editor.model;
				this._removeDropMarker(), this._clearDraggableAttributes(), this._draggingUid = "", this._draggedRange && (e && this.isEnabled && t.deleteContent(t.createSelection(this._draggedRange), {
					doNotAutoparagraph: !0
		...
		function lh(e, t, i) {
			...
			if (i.is("uiElement") && (i = i.parent), r = function (e, t) {
					const i = e.model,
						n = e.editing.mapper;
					if (Vu(t)) return i.createRangeOn(n.toModelElement(t));
					if (!t.is("editableElement")) {
						const e = t.findAncestor(e => Vu(e) || e.is("editableElement"));
						if (Vu(e)) return i.createRangeOn(n.toModelElement(e))
					}
					return null
				}(e, i), r) return r;
			...
			return c ? (r = function (e, t, i) {
				...
				if (s && n.schema.isObject(s)) return n.createRangeOn(s);
				return null
			}(e, c, a), r || (r = n.schema.getNearestSelectionRange(c, Po.isGecko ? "forward" : "backward"), r || function (e, t) {
				const i = e.model;
				for (; t;) {
					if (i.schema.isObject(t)) return i.createRangeOn(t);
					t = t.parent
				}
		...
		function dh(e) {
			return Po.isGecko ? e.dropEffect : ["all", "copyMove"].includes(e.effectAllowed) ? "move" : "copy"
		}
		...
		function hh(e) {
			...
			if (e.hasClass("ck-widget__selection-handle")) return e.findAncestor(Vu);
			if (Vu(e)) return e;
			const t = e.findAncestor(e => Vu(e) || e.is("editableElement"));
			return Vu(t) ? t : null
		}
		class fh extends Qe {
			static get pluginName() {
			...
			init() {
				...
				let r = !1;
				i.addObserver(yu), this.listenTo(n, "keydown", (e, t) => {
					r = t.shiftKey
				}), e.plugins.get(Au).on("contentInsertion", (e, i) => {
					(r || function (e, t) {
						if (e.childCount > 1) return !1;
						const i = e.getChild(0);
						if (t.isObject(i)) return !1;
						return 0 == [...i.getAttributeKeys()].length
					}(i.content, t.schema)) && t.change(e => {
						const n = Array.from(o.getAttributes()).filter(([e]) => t.schema.getAttributeProperties(e).isFormatting);
						o.isCollapsed || t.deleteContent(o, {
							doNotAutoparagraph: !0
						}), n.push(...o.getAttributes());
						const r = e.createRangeIn(i.content);
						for (const t of r.getItems()) t.is("$textProxy") && e.setAttributes(n, t)
					})
				})
			}
		}
				...
				e.change(i => {
					! function (e, t, i) {
						const n = i.isCollapsed,
							...
							a = r == s;
						if (n) {
							const n = Cu(e.schema, i.getAttributes());
							ph(e, t, o.end), t.removeSelectionAttribute(i.getAttributeKeys()), t.setSelectionAttribute(n)
						} else {
							const n = !(o.start.isAtStart && o.end.isAtEnd);
							e.deleteContent(i, {
								leaveUnmerged: n
							}), a ? ph(e, t, i.focus) : n && t.setSelection(s, 0)
						}
					}(e, i, t.selection), this.fire("afterExecute", {
						writer: i
					})
				})
			}
		...
		function bh(e, t) {
			return !e.is("rootElement") && (t.isLimit(e) || bh(e.parent, t))
		}
		class wh extends Qe {
			static get pluginName() {
				return "ShiftEnter"
			...
			init() {
				...
				}), n.addObserver(Pu), e.commands.add("shiftEnter", new mh(e)), this.listenTo(o, "enter", (t, i) => {
					i.preventDefault(), i.isSoft && (e.execute("shiftEnter"), n.scrollToTheSelection())
				}, {
					priority: "low"
				})
			}
		...
		class kh extends Ze {
			execute() {
				...
				if (t.containsEntireContent(i) || !_h(e.schema, i))
					do {
		...
		class yh extends Qe {
			...
			init() {
				const e = this.editor,
					t = e.editing.view.document;
				e.commands.add("selectAll", new kh(e)), this.listenTo(t, "keydown", (t, i) => {
					Ro(i) === vh && (e.execute("selectAll"), i.preventDefault())
				})
			}
		}
		class xh extends Qe {
			...
			init() {
				...
				e.ui.componentFactory.add("selectAll", t => {
					...
					return n.set({
						...
						keystroke: "Ctrl+A",
						tooltip: !0
					}), n.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(n, "execute", () => {
		...
		class Ch extends Ze {
			constructor(e, t) {
				super(e), this._buffer = new Mu(e.model, t), this._batches = new WeakSet
			}
			get buffer() {
				return this._buffer
			}
			...
			execute(e = {}) {
				const t = this.editor.model,
					...
					n = e.text || "",
					o = n.length,
					r = e.range ? t.createSelection(e.range) : i.selection,
					s = e.resultRange;
				t.enqueueChange(this._buffer.batch, e => {
					this._buffer.lock(), this._batches.add(this._buffer.batch), t.deleteContent(r), n && t.insertContent(e.createText(n, i.selection.getAttributes()), r), s ? e.setSelection(s) : r.is("documentSelection") || e.setSelection(r), this._buffer.unlock(), this._buffer.input(o)
				})
			}
		}
		...
		function Th(e) {
			...
			const t = function (e, t) {
				...
				let n, o = 0;
				return e.forEach(e => {
					"equal" == e ? (r(), o++) : "insert" == e ? (s("insert") ? n.values.push(t[o]) : (r(), n = {
						type: "insert",
						index: o,
						values: [t[o]]
					}), o++) : s("delete") ? n.howMany++ : (r(), n = {
						type: "delete",
						index: o,
						howMany: 1
					})
			...
			}(ur(e.oldChildren, e.newChildren, Eh), e.newChildren);
			if (t.length > 1) return;
			const i = t[0];
		...
		class Ph {
			...
			handle(e, t) {
				if (function (e) {
						...
						for (const t of e)
							if ("children" === t.type && !Th(t)) return !0;
						return !1
					}(e)) this._handleContainerChildrenMutations(e, t);
				else
					for (const i of e) this._handleTextMutation(i, t), this._handleTextNodeInsertion(i)
			}
			_handleContainerChildrenMutations(e, t) {
				...
				if (!i) return;
				const n = this.editor.editing.view.domConverter.mapViewToDom(i),
					o = new xr(this.editor.editing.view.document),
				...
				if (!Sh(a, f) || !Sh(c, f)) return;
				const g = a.map(e => e.is("$text") ? e.data : "@").join("").replace(/\u00A0/g, " "),
					m = c.map(e => e.is("$text") ? e.data : "@").join("").replace(/\u00A0/g, " ");
				if (m === g) return;
				const p = ur(m, g),
					{
						firstChangeAt: b,
			...
			_handleTextMutation(e, t) {
				...
				const l = this.editing.view.createPositionAt(e.node, r),
			...
			_handleTextNodeInsertion(e) {
				...
				const t = Th(e),
					i = this.editing.view.createPositionAt(e.node, t.index),
					n = this.editing.mapper.toModelPosition(i),
					o = t.values[0].data;
				this.editor.execute("input", {
					text: o.replace(/\u00A0/g, " "),
					range: this.editor.model.createRange(n)
				})
			}
		}
		...
		function Mh(e) {
			let t = null,
				i = null;
			for (let n = 0; n < e.length; n++) {
				"equal" != e[n] && (t = null === t ? n : t, i = n)
			}
			let n = 0,
				o = 0;
			for (let r = t; r <= i; r++) "insert" != e[r] && n++, "delete" != e[r] && o++;
			return {
				insertions: o,
				deletions: n,
				firstChangeAt: t
		...
		class Ih extends Qe {
			...
			init() {
				const e = this.editor,
					t = new Ch(e, e.config.get("typing.undoStep") || 20);
				e.commands.add("input", t),
					function (e) {
						...
						function r(e) {
							const r = i.document,
								a = n.document.isComposing,
								c = t && t.isEqual(r.selection);
							t = null, o.isEnabled && (Zu(e) || r.selection.isCollapsed || a && 229 === e.keyCode || !a && 229 === e.keyCode && c || s())
						}
						...
						function s() {
							...
							e.lock();
							const t = e.batch;
							o._batches.add(t), i.enqueueChange(t, () => {
								i.deleteContent(i.document.selection)
							}), e.unlock()
						}
						Po.isAndroid ? n.document.on("beforeinput", (e, t) => r(t), {
							priority: "lowest"
						}) : n.document.on("keydown", (e, t) => r(t), {
							priority: "lowest"
						}), n.document.on("compositionstart", (function () {
							const e = i.document,
							...
							t = i.createSelection(i.document.selection)
						}, {
							priority: "lowest"
						})
					}(e),
					function (e) {
						e.editing.view.document.on("mutations", (t, i, n) => {
							new Ph(e).handle(i, n)
						})
					}(e)
			}
		...
		function Rh(e, t) {
			let i = e.start;
			return {
				text: Array.from(e.getItems()).reduce((e, n) => n.is("$text") || n.is("$textProxy") ? e + n.data : (i = t.createPositionAfter(n), ""), ""),
				range: t.createRange(i, e.end)
			}
		}
		class Oh {
			constructor(e, t) {
				this.model = e, this.testCallback = t, this.hasMatch = !1, this.set("isEnabled", !0), this.on("change:isEnabled", () => {
			...
			_startListening() {
				...
				this.listenTo(e.selection, "change:range", (t, {
					...
					i && (e.selection.isCollapsed ? this._evaluateTextBeforeSelection("selection") : this.hasMatch && (this.fire("unmatched"), this.hasMatch = !1))
				}), this.listenTo(e, "change:data", (e, t) => {
					"transparent" != t.type && this._evaluateTextBeforeSelection("data", {
						batch: t
					})
				})
			}
		...
		class Dh extends Qe {
			...
			init() {
				const e = this.editor,
					...
					n = e.locale,
					o = t.document.selection;
				this.listenTo(i.document, "arrowKey", (e, t) => {
					if (!o.isCollapsed) return;
					if (t.shiftKey || t.altKey || t.ctrlKey) return;
					const i = t.keyCode == Io.arrowright,
						r = t.keyCode == Io.arrowleft;
					if (!i && !r) return;
					const s = n.contentLanguageDirection;
					let a = !1;
					a = "ltr" === s && i || "rtl" === s && r ? this._handleForwardMovement(t) : this._handleBackwardMovement(t), !0 === a && e.stop()
				}, {
					context: "$text",
					priority: "highest"
				}), this._isNextGravityRestorationSkipped = !1, this.listenTo(o, "change:range", (e, t) => {
					this._isNextGravityRestorationSkipped ? this._isNextGravityRestorationSkipped = !1 : this._isGravityOverridden && (!t.directChange && jh(o.getFirstPosition(), this.attributes) || this._restoreGravity())
				})
			}
			registerAttribute(e) {
			...
			_handleForwardMovement(e) {
				...
				return !this._isGravityOverridden && ((!n.isAtStart || !Lh(i, t)) && (jh(n, t) ? (Vh(e), this._overrideGravity(), !0) : void 0))
			}
			_handleBackwardMovement(e) {
				...
				return this._isGravityOverridden ? (Vh(e), this._restoreGravity(), zh(i, t, o), !0) : o.isAtStart ? !!Lh(n, t) && (Vh(e), zh(i, t, o), !0) : function (e, t) {
					return jh(e.getShiftedBy(-1), t)
				}(o, t) ? o.isAtEnd && !Lh(n, t) && jh(o, t) ? (Vh(e), zh(i, t, o), !0) : (this._isNextGravityRestorationSkipped = !0, this._overrideGravity(), !1) : void 0
			}
		...
		function zh(e, t, i) {
			...
			e.change(e => {
				n ? e.setSelectionAttribute(n.getAttributes()) : e.removeSelectionAttribute(t)
			})
		}
		...
		var Bh = /[\\^$.*+?()[\]{}|]/g,
			Fh = RegExp(Bh.source);
		var Hh = function (e) {
			return (e = Sn(e)) && Fh.test(e) ? e.replace(Bh, "\\$&") : e
		};
		const Uh = {
				copyright: {
					from: "(c)",
			...
			qh = ["symbols", "mathematical", "typography", "quotes"];

		function $h(e) {
			return "string" == typeof e ? new RegExp(`(${Hh(e)})$`) : e
		}

		function Yh(e) {
			return "string" == typeof e ? () => [e] : e instanceof Array ? () => e : e
		}
		...
		function Qh(e, t, i, n) {
			return n.createRange(Jh(e, t, i, !0, n), Jh(e, t, i, !1, n))
		}

		function Jh(e, t, i, n, o) {
			let r = e.textNode || (n ? e.nodeBefore : e.nodeAfter),
				s = null;
			for (; r && r.getAttribute(t) == i;) s = r, r = n ? r.previousSibling : r.nextSibling;
			return s ? o.createPositionAt(s, n ? "before" : "after") : e
		}
		class Zh extends Ze {
			constructor(e) {
				super(e), this._stack = [], this._createdBatches = new WeakSet, this.refresh(), this.listenTo(e.data, "set", () => this.clearStack())
			}
			refresh() {
			...
			_restoreSelection(e, t, i) {
				const n = this.editor.model,
					...
					a = s.flat();
				for (const e of s) {
					const t = e.filter(e => e.root != o.graveyard).filter(e => !ef(e, a));
					t.length && (Xh(t), r.push(t[0]))
				}
				r.length && n.change(e => {
					e.setSelection(r, {
						backward: t
			...
			_undo(e, t) {
				...
				for (const e of o) {
					const o = e.baseVersion + 1,
						...
						s = cu([e.getReversed()], r, {
							useRelations: !0,
							document: this.editor.model.document,
							padWithNoOps: !1,
							forceWeakRemove: !0
						}).operationsA;
					for (const o of s) t.addOperation(o), i.applyOperation(o), n.history.setOperationAsUndone(e, o)
				}
			}
		}
		...
		class tf extends Zh {
			execute(e = null) {
				const t = e ? this._stack.findIndex(t => t.batch == e) : this._stack.length - 1,
					...
					n = this.editor.model.createBatch("transparent");
				this.editor.model.enqueueChange(n, () => {
					this._undo(i.batch, n);
					const e = this.editor.model.document.history.getOperations(i.batch.baseVersion);
					this._restoreSelection(i.selection.ranges, i.selection.isBackward, e), this.fire("revert", i.batch, n)
				}), this.refresh()
			}
		}
		class nf extends Zh {
			execute() {
				...
				this.editor.model.enqueueChange(t, () => {
					const i = e.batch.operations[e.batch.operations.length - 1].baseVersion + 1,
						n = this.editor.model.document.history.getOperations(i);
					this._restoreSelection(e.selection.ranges, e.selection.isBackward, n), this._undo(e.batch, t)
				}), this.refresh()
			}
		}
		class of extends Qe {
			...
			init() {
				const e = this.editor;
				this._undoCommand = new tf(e), this._redoCommand = new nf(e), e.commands.add("undo", this._undoCommand), e.commands.add("redo", this._redoCommand), this.listenTo(e.model, "applyOperation", (e, t) => {
					const i = t[0];
					if (!i.isDocumentOperation) return;
					const n = i.batch,
						o = this._redoCommand._createdBatches.has(n),
		...
		var rf = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="m5.042 9.367 2.189 1.837a.75.75 0 0 1-.965 1.149l-3.788-3.18a.747.747 0 0 1-.21-.284.75.75 0 0 1 .17-.945L6.23 4.762a.75.75 0 1 1 .964 1.15L4.863 7.866h8.917A.75.75 0 0 1 14 7.9a4 4 0 1 1-1.477 7.718l.344-1.489a2.5 2.5 0 1 0 1.094-4.73l.008-.032H5.042z"/></svg>',
			sf = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="m14.958 9.367-2.189 1.837a.75.75 0 0 0 .965 1.149l3.788-3.18a.747.747 0 0 0 .21-.284.75.75 0 0 0-.17-.945L13.77 4.762a.75.75 0 1 0-.964 1.15l2.331 1.955H6.22A.75.75 0 0 0 6 7.9a4 4 0 1 0 1.477 7.718l-.344-1.489A2.5 2.5 0 1 1 6.039 9.4l-.008-.032h8.927z"/></svg>';
		class af extends Qe {
			static get pluginName() {
				return "UndoUI"
			}
			init() {
				const e = this.editor,
					t = e.locale,
					i = e.t,
					n = "ltr" == t.uiLanguageDirection ? rf : sf,
					o = "ltr" == t.uiLanguageDirection ? sf : rf;
				this._addButton("undo", i("Undo"), "CTRL+Z", n), this._addButton("redo", i("Redo"), "CTRL+Y", o)
			}
			_addButton(e, t, i, n) {
				const o = this.editor;
		...
		class lf {
			constructor() {
				...
				this._reader = e, this._data = void 0, this.set("loaded", 0), e.onprogress = e => {
		...
		class df extends Qe {
			...
			init() {
				this.loaders = new Zi, this.loaders.on("add", () => this._updatePendingAction()), this.loaders.on("remove", () => this._updatePendingAction()), this._loadersMap = new Map, this._pendingAction = null, this.set("uploaded", 0), this.set("uploadTotal", null), this.bind("uploadedPercent").to(this, "uploaded", this, "uploadTotal", (e, t) => t ? e / t * 100 : 0)
			}
			getLoader(e) {
			...
			createLoader(e) {
				...
				const t = new uf(Promise.resolve(e), this.createUploadAdapter);
				return this.loaders.add(t), this._loadersMap.set(e, t), e instanceof Promise && t.file.then(e => {
					this._loadersMap.set(e, t)
				}).catch(() => {}), t.on("change:uploaded", () => {
					let e = 0;
			...
			destroyLoader(e) {
				const t = e instanceof uf ? e : this.getLoader(e);
				t._destroy(), this.loaders.remove(t), this._loadersMap.forEach((e, i) => {
					e === t && this._loadersMap.delete(i)
				})
			}
			_updatePendingAction() {
				const e = this.editor.plugins.get(_l);
		...
		class uf {
			constructor(e, t) {
				this.id = s(), this._filePromiseWrapper = this._createFilePromiseWrapper(e), this._adapter = t(this), this._reader = new lf, this.set("status", "idle"), this.set("uploaded", 0), this.set("uploadTotal", null), this.bind("uploadedPercent").to(this, "uploaded", this, "uploadTotal", (e, t) => t ? e / t * 100 : 0), this.set("uploadResponse", null)
			}
			get file() {
			...
			abort() {
				const e = this.status;
				this.status = "aborted", this._filePromiseWrapper.isFulfilled ? "reading" == e ? this._reader.abort() : "uploading" == e && this._adapter.abort && this._adapter.abort() : (this._filePromiseWrapper.promise.catch(() => {}), this._filePromiseWrapper.rejecter("aborted")), this._destroy()
			}
			_destroy() {
			...
			_createFilePromiseWrapper(e) {
				...
				return t.promise = new Promise((i, n) => {
					t.rejecter = n, t.isFulfilled = !1, e.then(e => {
						t.isFulfilled = !0, i(e)
					}).catch(e => {
						t.isFulfilled = !0, n(e)
					})
		...
		class hf extends Ll {
			constructor(e) {
				super(e), this.buttonView = new rd(e), this._fileInputView = new ff(e), this._fileInputView.bind("acceptedType").to(this), this._fileInputView.bind("allowMultipleFiles").to(this), this._fileInputView.delegate("done").to(this), this.setTemplate({
					tag: "span",
					attributes: {
		...
		function gf() {
			...
			return e && 40 == e.length || (e = function (e) {
				...
				for (let e = 0; e < i.length; e++) {
					const n = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(i[e] % "abcdefghijklmnopqrstuvwxyz0123456789".length);
					t += Math.random() > .5 ? n.toUpperCase() : n
				}
				return t
			}(40), t = "ckCsrfToken", i = e, document.cookie = encodeURIComponent(t) + "=" + encodeURIComponent(i) + ";path=/"), e
		}
		class mf {
			constructor(e, t, i) {
				this.loader = e, this.url = t, this.t = i
			}
			upload() {
			...
			_initListeners(e, t, i) {
				const n = this.xhr,
					o = this.loader,
					r = (0, this.t)("Cannot upload file:") + ` ${i.name}.`;
				n.addEventListener("error", () => t(r)), n.addEventListener("abort", () => t()), n.addEventListener("load", () => {
					const i = n.response;
					if (!i || !i.uploaded) return t(i && i.error && i.error.message ? i.error.message : r);
					e({
						default: i.url
					})
			...
			_sendRequest(e) {
				...
				t.append("upload", e), t.append("ckCsrfToken", gf()), this.xhr.send(t)
			}
		}

		function pf(e, t, i, n) {
			let o, r = null;
			"function" == typeof n ? o = n : (r = e.commands.get(n), o = () => {
				e.execute(n)
			}), e.model.document.on("change:data", (s, a) => {
				if (r && !r.isEnabled || !t.isEnabled) return;
				const c = Ss(e.model.document.selection.getRanges());
				if (!c.isCollapsed) return;
				if ("transparent" == a.type) return;
				const l = Array.from(e.model.document.differ.getChanges()),
					d = l[0];
				if (1 != l.length || "insert" !== d.type || "$text" != d.name || 1 != d.length) return;
				const u = d.position.parent;
				if (u.is("element", "codeBlock")) return;
				if (u.is("element", "listItem") && "function" != typeof n && !["numberedList", "bulletedList", "todoList"].includes(n)) return;
				if (r && !0 === r.value) return;
				const h = u.getChild(0),
					f = e.model.createRangeOn(h);
				if (!f.containsRange(c) && !c.end.isEqual(f.end)) return;
				const g = i.exec(h.data.substr(0, c.end.offset));
				g && e.model.enqueueChange(t => {
					...
					if (!1 !== o({
						...
						const i = e.model.document.selection.getFirstRange(),
							n = t.createRangeIn(u);
						!u.isEmpty || n.isEqual(i) || n.containsRange(i, !0) || t.remove(u)
					}
					r.detach()
				})
			})
		...
		function bf(e, t, i, n) {
			let o, r;
			i instanceof RegExp ? o = i : r = i, r = r || (e => {
				let t;
				const i = [],
					n = [];
				for (; null !== (t = o.exec(e)) && !(t && t.length < 4);) {
					...
					const c = [e, e + o.length],
						l = [e + o.length + r.length, e + o.length + r.length + s.length];
					i.push(c), i.push(l), n.push([e + o.length, e + o.length + r.length])
				}
				return {
					remove: i,
					format: n
				...
				const d = a.focus,
					u = d.parent,
					{
						...
						let i = e.start;
						return {
							text: Array.from(e.getItems()).reduce((e, n) => !n.is("$text") && !n.is("$textProxy") || n.getAttribute("code") ? (i = t.createPositionAfter(n), "") : e + n.data, ""),
							range: t.createRange(i, e.end)
						}
					}(s.createRange(s.createPositionAt(u, 0), d), s),
					g = r(h),
					m = wf(f.start, g.format, s),
					p = wf(f.start, g.remove, s);
				m.length && p.length && s.enqueueChange(e => {
					if (!1 !== n(e, m))
						for (const t of p.reverse()) e.remove(t)
				})
			})
		}
			...
			_getValueFromFirstAllowedNode() {
				...
				for (const e of i.getRanges())
					for (const i of e.getItems())
						if (t.checkAttribute(i, this.attributeKey)) return i.hasAttribute(this.attributeKey);
				return !1
			}
		}
		class vf extends Qe {
			...
			init() {
				...
				}), e.model.schema.setAttributeProperties("bold", {
					isFormatting: !0,
					copyOnEnter: !0
				...
				}), e.commands.add("bold", new _f(e, "bold")), e.keystrokes.set("CTRL+B", "bold")
			}
		}
		class yf extends Qe {
			static get pluginName() {
		...
		class xf extends Qe {
			...
			init() {
				...
				}), e.model.schema.setAttributeProperties("italic", {
					isFormatting: !0,
					copyOnEnter: !0
				}), e.conversion.attributeToElement({
					model: "italic",
				...
				}), e.commands.add("italic", new _f(e, "italic")), e.keystrokes.set("CTRL+I", "italic")
			}
		}
		class Af extends Qe {
			static get pluginName() {
		...
		class Cf extends Ze {
			...
			execute(e = {}) {
				...
				t.change(e => {
					if (r) {
						const t = o.filter(e => Tf(e) || Pf(i, e));
						this._applyQuote(e, t)
					} else this._removeQuote(e, o.filter(Tf))
				})
			}
			_getValue() {
				const e = Ss(this.editor.model.document.selection.getSelectedBlocks());
				return !(!e || !Tf(e))
			}
			_checkEnabled() {
				...
				const e = this.editor.model.document.selection,
					...
					i = Ss(e.getSelectedBlocks());
				return !!i && Pf(t, i)
			}
			_removeQuote(e, t) {
				Ef(e, t).reverse().forEach(t => {
		...
		function Ef(e, t) {
			...
			for (; n < t.length;) {
				const r = t[n],
					s = t[n + 1];
				i || (i = e.createPositionBefore(r)), s && r.nextSibling == s || (o.push(e.createRange(i, e.createPositionAfter(r))), i = null), n++
			}
			return o
		}
		...
		class Sf extends Qe {
			...
			init() {
				const e = this.editor,
					t = e.model.schema;
				e.commands.add("blockQuote", new Cf(e)), t.register("blockQuote", {
					allowWhere: "$block",
					allowContentOf: "$root"
				}), t.addChildCheck((e, t) => {
					...
					for (const e of n)
						if ("insert" == e.type) {
							...
							if (n.is("element")) {
								...
								for (const n of e.getItems())
									if (n.is("element", "blockQuote") && !t.checkChild(i.createPositionBefore(n), n)) return i.unwrap(n), !0
							}
						} else if ("remove" == e.type) {
				...
				this.listenTo(i, "enter", (t, i) => {
					...
					r.isEmpty && !r.previousSibling && (e.execute("blockQuote"), e.editing.view.scrollToTheSelection(), i.preventDefault(), t.stop())
				}, {
					context: "blockquote"
				})
			}
		...
		class If extends Qe {
			...
			init() {
				const e = this.editor,
					...
					i = e.t;
				t.add("ckfinder", t => {
					const n = e.commands.get("ckfinder"),
						o = new rd(t);
					return o.set({
						label: i("Insert image or file"),
		...
		class Nf extends Ze {
			constructor(e) {
				super(e), this.stopListening(this.editor.model.document, "change"), this.listenTo(this.editor.model.document, "change", () => this.refresh(), {
					priority: "low"
				})
			}
			refresh() {
			...
			execute() {
				...
				i.chooseFiles = !0;
				const n = i.onInit;
				i.language || (i.language = e.locale.uiLanguage), i.onInit = t => {
					n && n(t), t.on("files:choose", i => {
						const n = i.data.files.toArray(),
							o = n.filter(e => !e.isImage()),
							r = n.filter(e => e.isImage());
						for (const t of o) e.execute("link", t.getUrl());
						const s = [];
						for (const e of r) {
							const i = e.getUrl();
							s.push(i || t.request("file:getProxyUrl", {
								file: e
							}))
						}
						s.length && Rf(e, s)
					}), t.on("file:choose:resizedImage", t => {
						const i = t.data.resizedUrl;
						if (i) Rf(e, [i]);
						else {
							const t = e.plugins.get("Notification"),
								i = e.locale.t;
							t.showWarning(i("Could not obtain resized image URL."), {
								title: i("Selecting resized image failed"),
								namespace: "ckfinder"
							})
						}
					})
		...
		function Rf(e, t) {
			if (e.commands.get("insertImage").isEnabled) e.execute("insertImage", {
				...
				const t = e.plugins.get("Notification"),
					i = e.locale.t;
				t.showWarning(i("Could not insert image at the current position."), {
					title: i("Inserting image failed"),
					namespace: "ckfinder"
				})
			}
		}
		class Of extends Qe {
			...
			static get requires() {
				return [Vd, "ImageEditing", "LinkEditing"]
			}
			init() {
				const e = this.editor;
				e.commands.add("ckfinder", new Nf(e))
			}
		}
		class Df extends Qe {
			static get pluginName() {
			...
			init() {
				const e = this.editor,
					...
					i = t.token,
					n = t.uploadUrl;
				i && (this._uploadGateway = e.plugins.get("CloudServicesCore").createUploadGateway(i, n), e.plugins.get(df).createUploadAdapter = e => new Lf(this._uploadGateway, e))
			}
		}
		class Lf {
			constructor(e, t) {
			...
			upload() {
				return this.loader.file.then(e => (this.fileUploader = this.uploadGateway.upload(e), this.fileUploader.on("progress", (e, t) => {
		...
		class zf extends Ze {
			refresh() {
				const e = this.editor.model,
					t = Ss(e.document.selection.getSelectedBlocks());
				this.value = !!t && t.is("element", "paragraph"), this.isEnabled = !!t && Vf(t, e.schema)
			}
			execute(e = {}) {
				const t = this.editor.model,
					i = t.document;
				t.change(n => {
					...
					for (const e of o) !e.is("element", "paragraph") && Vf(e, t.schema) && n.rename(e, "paragraph")
				})
			}
		}
		...
		class jf extends Ze {
			execute(e) {
				...
				t.change(e => {
					const n = e.createElement("paragraph");
					if (!t.schema.checkChild(i.parent, n)) {
						const o = t.schema.findAllowedParent(i, n);
						if (!o) return;
						i = e.split(i, o).position
					}
					t.insertContent(n, i), e.setSelection(n, "in")
				})
			}
		}
		class Bf extends Qe {
			...
			init() {
				const e = this.editor,
					t = e.model;
				e.commands.add("paragraph", new zf(e)), e.commands.add("insertParagraph", new jf(e)), t.schema.register("paragraph", {
					...
					model: (e, {
						writer: t
					}) => Bf.paragraphLikeElements.has(e.name) ? e.isEmpty ? null : t.createElement("paragraph") : null,
					view: /.+/,
					converterPriority: "low"
				})
			}
		}
		Bf.paragraphLikeElements = new Set(["blockquote", "dd", "div", "dt", "h1", "h2", "h3", "h4", "h5", "h6", "li", "p", "td", "th"]);
		class Ff extends Ze {
			constructor(e, t) {
			...
			refresh() {
				const e = Ss(this.editor.model.document.selection.getSelectedBlocks());
				this.value = !!e && this.modelElements.includes(e.name) && e.name, this.isEnabled = !!e && this.modelElements.some(t => Hf(e, t, this.editor.model.schema))
			}
			execute(e) {
				const t = this.editor.model,
					i = t.document,
					n = e.value;
				t.change(e => {
					const o = Array.from(i.selection.getSelectedBlocks()).filter(e => Hf(e, n, t.schema));
		...
		class Uf extends Qe {
			...
			init() {
				const e = this.editor,
					...
					i = [];
				for (const n of t) "paragraph" !== n.model && (e.model.schema.register(n.model, {
					inheritAllFrom: "$block"
				}), e.conversion.elementToElement(n), i.push(n.model));
				this._addDefaultH1Conversion(e), e.commands.add("heading", new Ff(e, i))
			}
			afterInit() {
				const e = this.editor,
			...
			init() {
				...
				e.ui.componentFactory.add("heading", t => {
					...
					for (const e of i) {
						...
						"paragraph" === e.model ? (t.model.bind("isOn").to(c, "value"), t.model.set("commandName", "paragraph"), l.push(c)) : (t.model.bind("isOn").to(a, "value", t => t === e.model), t.model.set({
							commandName: "heading",
							commandValue: e.model
						})), s.add(t), r[e.model] = e.title
					}
					const d = Pd(t);
					return Sd(d, s), d.buttonView.set({
						isOn: !1,
						withText: !0,
						tooltip: o
					}), d.extendTemplate({
					...
					}), d.bind("isEnabled").toMany(l, "isEnabled", (...e) => e.some(e => e)), d.buttonView.bind("label").to(a, "value", c, "value", (e, t) => {
		...
		class qf extends Qe {
			...
			register(e, {
				...
				if (!i.length) return void Object(c.b)("widget-toolbar-no-items", {
					toolbarId: e
				});
				const r = this.editor,
					s = r.t,
				...
				a.fillFromConfig(i, r.ui.componentFactory), this._toolbarDefinitions.set(e, {
					view: a,
					getRelatedElement: n,
					balloonClassName: o
				})
			...
			_showToolbar(e, t) {
				this._isToolbarVisible(e) ? $f(this.editor, t) : this._isToolbarInBalloon(e) || (this._balloon.add({
					view: e.view,
					position: Yf(this.editor, t),
					balloonClassName: e.balloonClassName
				}), this.listenTo(this._balloon, "change:visibleView", () => {
					for (const e of this._toolbarDefinitions.values())
						if (this._isToolbarVisible(e)) {
							const t = e.getRelatedElement(this.editor.editing.view.document.selection);
							$f(this.editor, t)
						}
				}))
			}
		...
		function Yf(e, t) {
			const i = e.editing.view,
				n = Hd.defaultPositions;
			return {
				target: i.domConverter.mapViewToDom(t),
				positions: [n.northArrowSouth, n.northArrowSouthWest, n.northArrowSouthEast, n.southArrowNorth, n.southArrowNorthWest, n.southArrowNorthEast, Yu]
			}
		}
		class Gf {
			constructor(e) {
			...
			begin(e, t, i) {
				...
				this.activeHandlePosition = function (e) {
					...
					for (const i of t)
						if (e.classList.contains("ck-widget__resizer__handle-" + i)) return i
				...
				o && o.match(/^\d+(\.\d*)?%$/) ? this.originalWidthPercents = parseFloat(o) : this.originalWidthPercents = function (e, t) {
					const i = e.parentElement,
						n = parseFloat(i.ownerDocument.defaultView.getComputedStyle(i).width);
		...
		class Kf {
			constructor(e) {
				this._options = e, this._domResizerWrapper = null, this._viewResizerWrapper = null, this.set("isEnabled", !0), this.decorate("begin"), this.decorate("cancel"), this.decorate("commit"), this.decorate("updateSize"), this.on("commit", e => {
			...
			attach() {
				...
				this._options.editor.editing.view.change(i => {
					const n = i.createUIElement("div", {
						...
						return e._appendHandles(i), e._appendSizeUI(i), e._domResizerWrapper = i, e.on("change:isEnabled", (e, t, n) => {
							i.style.display = n ? "" : "none"
						}), i.style.display = e.isEnabled ? "" : "none", i
					}));
					i.insert(i.createPositionAt(t, "end"), n), i.addClass("ck-widget_with-resizer", t), this._viewResizerWrapper = n
				})
			}
			begin(e) {
				this.state = new Gf(this._options), this._sizeUI.bindToState(this._options, this.state), this._initialViewWidth = this._options.viewElement.getStyle("width"), this.state.begin(e, this._getHandleHost(), this._getResizeHost())
			}
			updateSize(e) {
				...
				const i = this._getHandleHost(),
					n = new xs(i);
				t.handleHostWidth = Math.round(n.width), t.handleHostHeight = Math.round(n.height);
				const o = new xs(i);
				t.width = Math.round(o.width), t.height = Math.round(o.height), this.redraw(n), this.state.update(t)
			}
			commit() {
			...
			redraw(e) {
				...
				} else a = [o.offsetWidth + "px", o.offsetHeight + "px", o.offsetLeft + "px", o.offsetTop + "px"];
				"same" !== cn(s, a) && this._options.editor.editing.view.change(e => {
					e.setStyle({
						width: a[0],
						height: a[1],
						left: a[2],
			...
			_proposeNewSize(e) {
				...
				o && t.activeHandlePosition.endsWith("-right") && (r.x = i.x - (t._referenceCoordinates.x + t.originalWidth)), o && (r.x *= 2);
				const s = {
					width: Math.abs(t.originalWidth + r.x),
					height: Math.abs(t.originalHeight + r.y)
				};
				s.dominant = s.width / t.aspectRatio > s.height ? "width" : "height", s.max = s[s.dominant];
				const a = {
					width: s.width,
					height: s.height
				};
				return "width" == s.dominant ? a.height = a.width / t.aspectRatio : a.width = a.height * t.aspectRatio, {
					width: Math.round(a.width),
					height: Math.round(a.height),
					widthPercents: Math.min(Math.round(t.originalWidthPercents / t.originalWidth * a.width * 100) / 100, 100)
				}
			}
			_getResizeHost() {
			...
			_appendHandles(e) {
				const t = ["top-left", "top-right", "bottom-right", "bottom-left"];
				for (const n of t) e.appendChild(new zl({
					tag: "div",
					attributes: {
						class: "ck-widget__resizer__handle " + (i = n, "ck-widget__resizer__handle-" + i)
					}
				}).render());
				var i
			}
		...
		class Qf extends Ll {
			constructor() {
				...
				this.setTemplate({
					tag: "div",
					attributes: {
						class: ["ck", "ck-size-view", e.to("activeHandlePosition", e => e ? "ck-orientation-" + e : "")],
						style: {
							display: e.if("isVisible", "none", e => !e)
						}
					},
					children: [{
						text: e.to("label")
			...
			bindToState(e, t) {
				this.bind("isVisible").to(t, "proposedWidth", t, "proposedHeight", (e, t) => null !== e && null !== t), this.bind("label").to(t, "proposedHandleHostWidth", t, "proposedHandleHostHeight", t, "proposedWidthPercents", (t, i, n) => "px" === e.unit ? `${t}×${i}` : n + "%"), this.bind("activeHandlePosition").to(t)
			}
			dismiss() {
		...
		Ke(class extends Qe {
			...
			init() {
				...
				const e = kr.window.document;
				this.editor.model.schema.setAttributeProperties("width", {
					isFormatting: !0
				}), this.editor.editing.view.addObserver(pu), this._observer = Object.create(Pr), this.listenTo(this.editor.editing.view.document, "mousedown", this._mouseDownListener.bind(this), {
					priority: "high"
				...
				const t = () => {
					...
					i = ah(t, 200);
				this.on("change:visibleResizer", t), this.editor.ui.on("update", i), this._observer.listenTo(kr.window, "resize", i);
				const n = this.editor.editing.view.document.selection;
				n.on("change", () => {
					const e = n.getSelectedElement();
					this.visibleResizer = this.getResizerByViewElement(e) || null
				})
			}
			destroy() {
			...
			attachTo(e) {
				...
				const n = this.editor.editing.view.document.selection.getSelectedElement();
				return this.getResizerByViewElement(n) == t && (this.visibleResizer = t), t
			}
			...
			_mouseDownListener(e, t) {
				const i = t.domTarget;
				Kf.isResizeHandle(i) && (this._activeResizer = this._getResizerByHandle(i), this._activeResizer && (this._activeResizer.begin(i), e.stop(), t.preventDefault()))
			}
		...
		function Zf(e) {
			return !!e.getCustomProperty("image") && Vu(e)
		}

		function Xf(e) {
			const t = e.getSelectedElement();
			return t && Zf(t) ? t : null
		}

		function eg(e) {
			return !!e && e.is("element", "image")
		}

		function tg(e, t = {}, i = null) {
			e.change(n => {
				const o = n.createElement("image", t),
					r = i || qu(e.document.selection, e);
				e.insertContent(o, r), o.parent && n.setSelection(o, "on")
			})
		}
		...
		function ig(e) {
			...
			return function (e, t, i) {
				const n = function (e, t) {
					const i = qu(e, t).parent;
					if (i.isEmpty && !i.is("element", "$root")) return i.parent;
					return i
				}(e, i);
				return t.checkChild(n, "image")
			}(i, t, e) && !$u(i, t) && function (e) {
				return [...e.focus.getAncestors()].every(e => !e.is("element", "image"))
			}(i)
		}

		function ng(e) {
			const t = [];
			for (const i of e.getChildren()) t.push(i), i.is("element") && t.push(...i.getChildren());
			return t.find(e => e.is("element", "img"))
		}

		function og(e) {
			return i => {
				i.on(`attribute:${e}:image`, t)
			};

			function t(e, t, i) {
				if (!i.consumable.consume(t.item, e.name)) return;
				const n = i.writer,
					o = ng(i.mapper.toViewElement(t.item));
				n.setAttribute(t.attributeKey, t.attributeNewValue || "", o)
			}
		}
		class rg extends Ze {
			refresh() {
				this.isEnabled = ig(this.editor.model)
			}
			execute(e) {
				const t = this.editor.model;
				for (const i of en(e.source)) tg(t, {
					src: i
				})
			}
		}
		class sg extends Qe {
			...
			init() {
				const e = this.editor,
					...
					i = e.t,
					n = e.conversion;
				e.editing.view.addObserver(Jf), t.register("image", {
					isObject: !0,
					isBlock: !0,
					allowWhere: "$block",
					...
					view: (e, {
						...
						return t.setCustomProperty("image", !0, e), ju(e, t, {
							label: function () {
								const t = ng(e).getAttribute("alt");
								return t ? `${t} ${i}` : i
							}
						})
					}(ag(t), t, i("image widget"))
				}), n.for("downcast").add(og("src")).add(og("alt")).add(function () {
					return t => {
					...
					function e(e, t, i) {
						...
						if (null === t.attributeNewValue) {
							...
							e.data && (n.removeAttribute("srcset", o), n.removeAttribute("sizes", o), e.width && n.removeAttribute("width", o))
						} else {
							const e = t.attributeNewValue;
							e.data && (n.setAttribute("srcset", e.data, o), n.setAttribute("sizes", "100vw", o), e.width && n.setAttribute("width", e.width, o))
						}
					}
					...
					function e(e, t, i) {
						if (!i.consumable.test(t.viewItem, {
								name: !0,
								classes: "image"
							})) return;
						const n = ng(t.viewItem);
						if (!n || !n.hasAttribute("src") || !i.consumable.test(n, {
								name: !0
							})) return;
						const o = Ss(i.convertItem(n, t.modelCursor).modelRange.getItems());
						o && (i.convertChildren(t.viewItem, o), i.updateConversionResult(o, t))
					}
				}());
				const o = new rg(e);
				e.commands.add("insertImage", o), e.commands.add("imageInsert", o)
			}
		}

		function ag(e) {
			const t = e.createEmptyElement("img"),
				i = e.createContainerElement("figure", {
					class: "image"
				});
			return e.insert(e.createPositionAt(i, 0), t), i
		}
		class cg extends Ze {
			refresh() {
				const e = this.editor.model.document.selection.getSelectedElement();
				this.isEnabled = eg(e), eg(e) && e.hasAttribute("alt") ? this.value = e.getAttribute("alt") : this.value = !1
			}
			execute(e) {
				const t = this.editor.model,
					i = t.document.selection.getSelectedElement();
				t.change(t => {
					t.setAttribute("alt", e.newValue, i)
				})
			}
		}
		class lg extends Qe {
			...
			init() {
				this.editor.commands.add("imageTextAlternative", new cg(this.editor))
			}
		}
		i(73), i(7);
		class dg extends Ll {
			...
			render() {
				super.render(), this.keystrokes.listenTo(this.element), Ol({
					view: this
			...
			_createButton(e, t, i, n) {
				...
				}), n && o.delegate("execute").to(this, n), o
			}
			_createLabeledInputView() {
				const e = this.locale.t,
					t = new Ld(this.locale, zd);
		...
		class hg extends Qe {
			...
			_createForm() {
				const e = this.editor,
					t = e.editing.view.document;
				this._balloon = this.editor.plugins.get("ContextualBalloon"), this._form = new dg(e.locale), this._form.render(), this.listenTo(this._form, "submit", () => {
					...
					Xf(t.selection) ? this._isVisible && function (e) {
						const t = e.plugins.get("ContextualBalloon");
						if (Xf(e.editing.view.document.selection)) {
							const i = ug(e);
							t.updatePosition(i)
						}
					}(e) : this._hideForm(!0)
		...
		class pg extends Qe {
			...
			init() {
				...
				i.register("caption", {
					...
					isLimit: !0
				}), e.model.document.registerPostFixer(e => this._insertMissingModelCaptionElement(e)), e.conversion.for("upcast").elementToElement({
					view: mg,
					model: "caption"
				});
				n.downcastDispatcher.on("insert:caption", bg(e => e.createContainerElement("figcaption"), !1));
				const s = function (e, t) {
					return i => {
						const n = i.createEditableElement("figcaption");
						return i.setCustomProperty("imageCaption", !0, n), Xd({
							view: e,
							element: n,
							text: t
						}), Wu(n, i)
					}
				}(t, r("Enter image caption"));
				o.downcastDispatcher.on("insert:caption", bg(s)), o.downcastDispatcher.on("insert", this._fixCaptionVisibility(e => e.item), {
					priority: "high"
				}), o.downcastDispatcher.on("remove", this._fixCaptionVisibility(e => e.position.parent), {
					priority: "high"
				}), t.document.registerPostFixer(e => this._updateCaptionVisibility(e))
			}
			_updateCaptionVisibility(e) {
				const t = this.editor.editing.mapper,
					i = this._lastSelectedCaption;
				let n;
				...
				const s = wg(o.getFirstPosition().parent);
				if (s && (n = t.toViewElement(s)), n && !this.editor.isReadOnly) return i ? (i === n || (kg(i, e), this._lastSelectedCaption = n), _g(n, e)) : (this._lastSelectedCaption = n, _g(n, e));
				if (i) {
					const t = kg(i, e);
			...
			_fixCaptionVisibility(e) {
				return (t, i, n) => {
					const o = wg(e(i)),
						...
						s = n.writer;
					if (o) {
						const e = r.toViewElement(o);
						e && (o.childCount ? s.removeClass("ck-hidden", e) : s.addClass("ck-hidden", e))
					}
				}
			}
			_insertMissingModelCaptionElement(e) {
				const t = this.editor.model,
					i = t.document.differ.getChanges(),
					n = [];
				for (const e of i)
					if ("insert" == e.type && "$text" != e.name) {
						const i = e.position.nodeAfter;
						if (i.is("element", "image") && !gg(i) && n.push(i), !i.is("element", "image") && i.childCount)
							for (const e of t.createRangeIn(i).getItems()) e.is("element", "image") && !gg(e) && n.push(e)
					} for (const t of n) e.appendElement("caption", t);
				return !!n.length
			}
		}
		...
		function bg(e, t = !0) {
			return (i, n, o) => {
				const r = n.item;
				if ((r.childCount || t) && eg(r.parent)) {
					if (!o.consumable.consume(n.item, "insert")) return;
					const t = o.mapper.toViewElement(n.range.start.parent),
						i = e(o.writer),
						s = o.writer;
					r.childCount || s.addClass("ck-hidden", i),
						function (e, t, i, n) {
							const o = n.writer.createPositionAt(i, "end");
							n.writer.insert(o, e), n.mapper.bindElements(t, e)
						}(i, n.item, t, o)
				}
			}
		}
		...
		function wg(e) {
			const t = e.getAncestors({
				includeSelf: !0
			}).find(e => "caption" == e.name);
			return t && t.parent && "image" == t.parent.name ? t : null
		}
		...
		class vg extends Ze {
			constructor(e, t) {
				super(e), this.defaultStyle = !1, this.styles = t.reduce((e, t) => (e[t.name] = t, t.isDefault && (this.defaultStyle = t.name), e), {})
			}
			refresh() {
				const e = this.editor.model.document.selection.getSelectedElement();
				if (this.isEnabled = eg(e), e)
					if (e.hasAttribute("imageStyle")) {
			...
			execute(e) {
				const t = e.value,
					i = this.editor.model,
					n = i.document.selection.getSelectedElement();
				i.change(e => {
		...
		function Tg(e) {
			if ("string" == typeof e) {
				const t = e;
				xg[t] ? e = Object.assign({}, xg[t]) : (Object(c.b)("image-style-not-found", {
					name: t
				}), e = {
					name: t
				})
				...
				const t = xg[e.name],
					i = Object.assign({}, e);
				for (const n in t) Object.prototype.hasOwnProperty.call(e, n) || (i[n] = t[n]);
				e = i
			}
			return "string" == typeof e.icon && Ag[e.icon] && (e.icon = Ag[e.icon]), e
		}
		class Eg extends Qe {
			static get pluginName() {
			...
			init() {
				...
				const o = Cg(e.config.get("image.styles"));
				t.extend("image", {
				...
				const r = function (e) {
					return (t, i, n) => {
						if (!n.consumable.consume(i.item, t.name)) return;
						const o = yg(i.attributeNewValue, e),
							r = yg(i.attributeOldValue, e),
							s = n.mapper.toViewElement(i.item),
							a = n.writer;
						r && a.removeClass(r.className, s), o && a.addClass(o.className, s)
					}
				}(o);
				n.downcastDispatcher.on("attribute:imageStyle:image", r), i.downcastDispatcher.on("attribute:imageStyle:image", r), i.upcastDispatcher.on("element:figure", function (e) {
					const t = e.filter(e => !e.isDefault);
					return (e, i, n) => {
						if (!i.modelRange) return;
						const o = i.viewItem,
							r = Ss(i.modelRange.getItems());
						if (!r || n.schema.checkAttribute(r, "imageStyle"))
							for (const e of t) n.consumable.consume(o, {
								classes: e.className
							}) && n.writer.setAttribute("imageStyle", e.name, r)
					}
				}(o), {
					priority: "low"
				}), e.commands.add("imageStyle", new vg(e, o))
			}
		}
		i(80);
		class Pg extends Qe {
			...
			init() {
				const e = function (e, t) {
					...
					return e
				}(Cg(this.editor.config.get("image.styles")), this.localizedDefaultStylesTitles);
				for (const t of e) this._createButton(t)
			}
			_createButton(e) {
				const t = this.editor,
					i = "imageStyle:" + e.name;
				t.ui.componentFactory.add(i, i => {
					...
					return o.set({
						...
						tooltip: !0,
						isToggleable: !0
					}), o.bind("isEnabled").to(n, "isEnabled"), o.bind("isOn").to(n, "value", t => t === e.name), this.listenTo(o, "execute", () => {
		...
		function Mg(e) {
			return new Promise((t, i) => {
				...
				fetch(n).then(e => e.blob()).then(e => {
					...
					t(r)
				}).catch(e => e && "TypeError" === e.name ? function (e) {
					return function (e) {
						return new Promise((t, i) => {
							const n = kr.document.createElement("img");
							n.addEventListener("load", () => {
								const e = kr.document.createElement("canvas");
								e.width = n.width, e.height = n.height;
								e.getContext("2d").drawImage(n, 0, 0), e.toBlob(e => e ? t(e) : i())
							}), n.addEventListener("error", () => i()), n.src = e
						})
					}(e).then(t => {
						const i = Ig(t, e),
							n = i.replace("image/", "");
						return new File([t], "image." + n, {
							type: i
						})
					})
				}(n).then(t).catch(i) : i(e))
			})
		}
				...
				const e = this.editor,
					...
					i = i => {
						const n = new hf(i),
							...
							s = Sg(r);
						return n.set({
							acceptedType: r.map(e => "image/" + e).join(","),
							allowMultipleFiles: !0
						}), n.buttonView.set({
							label: t("Insert image"),
							icon: Al,
							tooltip: !0
						}), n.buttonView.bind("isEnabled").to(o), n.on("done", (t, i) => {
							const n = Array.from(i).filter(e => s.test(e.type));
							n.length && e.execute("uploadImage", {
								file: n
							})
						}), n
					};
				e.ui.componentFactory.add("uploadImage", i), e.ui.componentFactory.add("imageUpload", i)
			}
		}
		i(82), i(84), i(86);
		class Rg extends Qe {
			...
			constructor(e) {
				super(e), this.placeholder = "data:image/svg+xml;utf8," + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 250"><rect rx="4"/></svg>')
			}
			init() {
			...
			uploadStatusChange(e, t, i) {
				...
				if (!i.consumable.consume(t.item, e.name)) return;
				const s = n.plugins.get(df),
					a = r ? t.attributeNewValue : null,
					c = this.placeholder,
					l = n.editing.mapper.toViewElement(o),
					d = i.writer;
				if ("reading" == a) return Og(l, d), void Dg(c, l, d);
				if ("uploading" == a) {
					const e = s.loaders.get(r);
					return Og(l, d), void(e ? (Lg(l, d), function (e, t, i, n) {
						const o = function (e) {
						...
						t.insert(t.createPositionAt(e, "end"), o), i.on("change:uploadedPercent", (e, t, i) => {
							n.change(e => {
								e.setStyle("width", i + "%", o)
							})
						})
					}(l, d, e, n.editing.view), function (e, t, i) {
						if (i.data) {
							const n = ng(e);
				...
				"complete" == a && s.loaders.get(r) && function (e, t, i) {
						const n = t.createUIElement("div", {
							class: "ck-image-upload-complete-icon"
						});
						t.insert(t.createPositionAt(e, "end"), n), setTimeout(() => {
		...
		function Dg(e, t, i) {
			...
			const n = ng(t);
			n.getAttribute("src") !== e && i.setAttribute("src", e, n), zg(t, "placeholder") || i.insert(i.createPositionAfter(n), function (e) {
				const t = e.createUIElement("div", {
		...
		function Lg(e, t) {
			e.hasClass("ck-image-upload-placeholder") && t.removeClass("ck-image-upload-placeholder", e), Vg(e, t, "placeholder")
		}

		function zg(e, t) {
			for (const i of e.getChildren())
				if (i.getCustomProperty(t)) return i
		}
		...
		class jg extends Ze {
			refresh() {
				const e = this.editor.model.document.selection.getSelectedElement(),
					t = e && "image" === e.name || !1;
				this.isEnabled = ig(this.editor.model) || t
			}
			execute(e) {
				const t = this.editor,
					i = t.model,
					n = t.plugins.get(df);
				for (const t of en(e.file)) Bg(i, n, t)
			}
		}

		function Bg(e, t, i) {
			const n = t.createLoader(i);
			n && tg(e, {
				uploadId: n.id
			})
		}
		class Fg extends Qe {
			...
			init() {
				const e = this.editor,
					...
					n = e.conversion,
					o = e.plugins.get(df),
					r = Sg(e.config.get("image.upload.types"));
				i.extend("image", {
				...
				e.commands.add("uploadImage", s), e.commands.add("imageUpload", s), n.for("upcast").attributeToAttribute({
					...
					var n;
					const o = Array.from(i.dataTransfer.files).filter(e => !!e && r.test(e.type));
					o.length && (t.stop(), e.model.change(t => {
						i.targetRanges && t.setSelection(i.targetRanges.map(t => e.editing.mapper.toModelRange(t))), e.model.enqueueChange("default", () => {
					...
					const n = Array.from(e.editing.view.createRangeIn(i.content)).filter(e => {
						return !(!(t = e.item).is("element", "img") || !t.getAttribute("src")) && (t.getAttribute("src").match(/^data:image\/\w+;base64,/g) || t.getAttribute("src").match(/^blob:/g)) && !e.item.getAttribute("uploadProcessed");
						var t
					}).map(e => ({
						promise: Mg(e.item),
						imageElement: e.item
					...
					if (!n.length) return;
					const r = new bu(e.editing.view.document);
					for (const e of n) {
						r.setAttribute("uploadProcessed", !0, e.imageElement);
						const t = o.createLoader(e.promise);
					...
					for (const t of i)
						if ("insert" == t.type && "$text" != t.name) {
							const i = t.position.nodeAfter,
								n = "$graveyard" == t.position.root.rootName;
							for (const t of Hg(e, i)) {
								const e = t.getAttribute("uploadId");
								if (!e) continue;
								const i = o.loaders.get(e);
								i && (n ? i.abort() : "idle" == i.status && this._readAndUpload(i, t))
							}
						}
				})
			}
			_readAndUpload(e, t) {
				const i = this.editor,
					...
					r = i.plugins.get(df),
					s = i.plugins.get(Vd);
				return n.enqueueChange("transparent", e => {
					e.setAttribute("uploadStatus", "reading", t)
				}), e.read().then(() => {
					const o = e.upload();
					if (Po.isSafari) {
						const e = ng(i.editing.mapper.toViewElement(t));
						i.editing.view.once("render", () => {
							if (!e.parent) return;
							const t = i.editing.view.domConverter.mapViewToDom(e.parent);
							if (!t) return;
							const n = t.style.display;
							t.style.display = "none", t._ckHack = t.offsetHeight, t.style.display = n
						})
					}
					return n.enqueueChange("transparent", e => {
					...
					n.enqueueChange("transparent", i => {
						i.setAttributes({
							...
							src: e.default
						}, t), this._parseAndSetSrcsetAttributeOnImage(e, t, i)
					}), a()
				}).catch(i => {
					if ("error" !== e.status && "aborted" !== e.status) throw i;
					"error" == e.status && i && s.showWarning(i, {
						title: o("Upload failed"),
						namespace: "upload"
					}), a(), n.enqueueChange("transparent", e => {
						e.remove(t)
					})
				});
				...
				function a() {
					n.enqueueChange("transparent", e => {
						e.removeAttribute("uploadId", t), e.removeAttribute("uploadStatus", t)
					}), r.destroyLoader(e)
				}
			}
			_parseAndSetSrcsetAttributeOnImage(e, t, i) {
				let n = 0;
				const o = Object.keys(e).filter(e => {
					const t = parseInt(e, 10);
					if (!isNaN(t)) return n = Math.max(n, t), !0
				}).map(t => `${e[t]} ${t}w`).join(", ");
				"" != o && i.setAttribute("srcset", {
					data: o,
					width: n
				}, t)
			}
		...
		function Hg(e, t) {
			return Array.from(e.model.createRangeOn(t)).filter(e => e.item.is("element", "image")).map(e => e.item)
		}
		class Ug extends Qe {
			static get pluginName() {
			...
			init() {
				const e = this.editor;
				e.commands.add("indent", new et(e)), e.commands.add("outdent", new et(e))
			}
		}
		var Wg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 3.75c0 .414.336.75.75.75h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm5 6c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zM2.75 16.5h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 1 0 0 1.5zM1.632 6.95 5.02 9.358a.4.4 0 0 1-.013.661l-3.39 2.207A.4.4 0 0 1 1 11.892V7.275a.4.4 0 0 1 .632-.326z"/></svg>',
			qg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 3.75c0 .414.336.75.75.75h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm5 6c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zM2.75 16.5h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 1 0 0 1.5zm1.618-9.55L.98 9.358a.4.4 0 0 0 .013.661l3.39 2.207A.4.4 0 0 0 5 11.892V7.275a.4.4 0 0 0-.632-.326z"/></svg>';
		class $g extends Qe {
			static get pluginName() {
				return "IndentUI"
			}
			init() {
				const e = this.editor,
					t = e.locale,
					i = e.t,
					n = "ltr" == t.uiLanguageDirection ? Wg : qg,
					o = "ltr" == t.uiLanguageDirection ? qg : Wg;
		...
		class Yg {
				...
				return e => {
					e.on("attribute:linkHref", (e, t, i) => {
						...
						for (const e of this._definitions) {
							...
							n.setCustomProperty("link", !0, r), e.callback(t.attributeNewValue) ? t.item.is("selection") ? n.wrap(o.getFirstRange(), r) : n.wrap(i.mapper.toViewRange(t.range), r) : n.unwrap(i.mapper.toViewRange(t.range), r)
						}
					}, {
						priority: "high"
					})
			...
			getDispatcherForLinkedImage() {
				return e => {
					e.on("attribute:linkHref:image", (e, t, i) => {
						const n = i.mapper.toViewElement(t.item),
							o = Array.from(n.getChildren()).find(e => "a" === e.name);
						for (const e of this._definitions) {
							const n = fn(e.attributes);
							if (e.callback(t.attributeNewValue))
								for (const [e, t] of n) "class" === e ? i.writer.addClass(t, o) : i.writer.setAttribute(e, t, o);
							else
								for (const [e, t] of n) "class" === e ? i.writer.removeClass(t, o) : i.writer.removeAttribute(e, o)
						}
					})
				}
			}
		...
		var Gg = function (e, t, i) {
				var n = e.length;
				return i = void 0 === i ? n : i, !t && i >= n ? e : On(e, t, i)
			},
			Kg = RegExp("[\\u200d\\ud800-\\udfff\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\ufe0e\\ufe0f]");
		var Qg = function (e) {
			return Kg.test(e)
		};
		var Jg = function (e) {
			...
			nm = "[\\ud800-\\udbff][\\udc00-\\udfff]",
			om = "(?:" + Xg + "|" + em + ")" + "?",
			rm = "[\\ufe0e\\ufe0f]?" + om + ("(?:\\u200d(?:" + [tm, im, nm].join("|") + ")[\\ufe0e\\ufe0f]?" + om + ")*"),
			sm = "(?:" + [tm + Xg + "?", Xg, im, nm, Zg].join("|") + ")",
			am = RegExp(em + "(?=" + em + ")|" + sm + rm, "g");
		var cm = function (e) {
			return e.match(am) || []
		};
		var lm = function (e) {
			return Qg(e) ? cm(e) : Jg(e)
		};
		var dm = function (e) {
			return function (t) {
				t = Sn(t);
				var i = Qg(t) ? lm(t) : void 0,
					n = i ? i[0] : t.charAt(0),
					o = i ? Gg(i, 1).join("") : t.slice(1);
				return n[e]() + o
			}
		}("toUpperCase");
		const um = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,
			hm = /^(?:(?:https?|ftps?|mailto):|[^a-z]|[a-z+.-]+(?:[^a-z+.:-]|$))/i,
			fm = /^[\S]+@((?![-_])(?:[-\w\u00a1-\uffff]{0,63}[^-_]\.))+(?:[a-z\u00a1-\uffff]{2,})$/i,
			gm = /^((\w+:(\/{2,})?)|(\W))/i;

		function mm(e, {
			writer: t
		}) {
			const i = t.createAttributeElement("a", {
				href: e
			}, {
				priority: 5
			});
		...
		function pm(e) {
			return function (e) {
				return e.replace(um, "").match(hm)
			}(e = String(e)) ? e : "#"
		}

		function bm(e, t) {
			return !!e && (e.is("element", "image") && t.checkAttribute("image", "linkHref"))
		}

		function wm(e, t) {
			const i = (n = e, fm.test(n) ? "mailto:" : t);
			var n;
			const o = !!i && !gm.test(e);
			return e && o ? i + e : e
		}
		class km extends Ze {
			constructor(e) {
				super(e), this.manualDecorators = new Zi, this.automaticDecorators = new Yg
			}
			...
			refresh() {
				const e = this.editor.model,
					t = e.document,
					i = Ss(t.selection.getSelectedBlocks());
				bm(i, e.schema) ? (this.value = i.getAttribute("linkHref"), this.isEnabled = e.schema.checkAttribute(i, "linkHref")) : (this.value = t.selection.getAttribute("linkHref"), this.isEnabled = e.schema.checkAttributeInSelection(t.selection, "linkHref"));
				for (const e of this.manualDecorators) e.value = this._getDecoratorStateFromModel(e.id)
			}
			execute(e, t = {}) {
				const i = this.editor.model,
				...
				i.change(t => {
					if (n.isCollapsed) {
						...
						if (n.hasAttribute("linkHref")) {
							const a = Qh(s, "linkHref", n.getAttribute("linkHref"), i);
							t.setAttribute("linkHref", e, a), o.forEach(e => {
								t.setAttribute(e, !0, a)
							}), r.forEach(e => {
								t.removeAttribute(e, a)
							}), t.setSelection(t.createPositionAfter(a.end.nodeBefore))
						} else if ("" !== e) {
							const r = fn(n.getAttributes());
							r.set("linkHref", e), o.forEach(e => {
								r.set(e, !0)
							});
							const {
								end: a
							} = i.insertContent(t.createText(e, r), s);
							t.setSelection(a)
						...
						const c = a.slice();
						for (const e of s) this._isRangeToUpdate(e, a) && c.push(e);
						for (const i of c) t.setAttribute("linkHref", e, i), o.forEach(e => {
			...
			_getDecoratorStateFromModel(e) {
				const t = this.editor.model,
					i = t.document,
					n = Ss(i.selection.getSelectedBlocks());
				return bm(n, t.schema) ? n.getAttribute(e) : i.selection.getAttribute(e)
			}
			_isRangeToUpdate(e, t) {
				for (const i of t)
					if (i.containsRange(e)) return !1;
				return !0
			}
		}
		class _m extends Ze {
			refresh() {
				const e = this.editor.model,
					t = e.document,
					i = Ss(t.selection.getSelectedBlocks());
				bm(i, e.schema) ? this.isEnabled = e.schema.checkAttribute(i, "linkHref") : this.isEnabled = e.schema.checkAttributeInSelection(t.selection, "linkHref")
			}
			execute() {
				const e = this.editor,
					t = this.editor.model,
				...
				t.change(e => {
					const o = i.isCollapsed ? [Qh(i.getFirstPosition(), "linkHref", i.getAttribute("linkHref"), t)] : t.schema.getValidRanges(i.getRanges(), "linkHref");
					for (const t of o)
		...
		class vm {
			constructor({
				...
				this.id = e, this.set("value"), this.defaultValue = n, this.label = t, this.attributes = i
			}
		}
		Ke(vm, Ue);
		i(88);
		...
		class xm extends Qe {
			...
			init() {
				...
				}), e.commands.add("link", new km(e)), e.commands.add("unlink", new _m(e));
				const t = function (e, t) {
					const i = {
				...
				e.plugins.get(Dh).registerAttribute("linkHref"),
					function (e, t, i, n) {
						...
						o.document.registerPostFixer(o => {
							...
							let a = !1;
							if (s.hasAttribute(t)) {
								const c = Qh(s.getFirstPosition(), t, s.getAttribute(t), e.model),
									l = e.editing.mapper.toViewRange(c);
								for (const e of l.getItems()) e.is("element", i) && !e.hasClass(n) && (o.addClass(n, e), r.add(e), a = !0)
							}
							return a
					...
					}(e, "linkHref", "a", "ck-link_selected"), this._enableInsertContentSelectionAttributesFixer(), this._enableClickingAfterLink(), this._enableTypingOverLink(), this._handleDeleteContentAfterLink()
			}
			_enableAutomaticDecorators(e) {
				const t = this.editor,
					i = t.commands.get("link").automaticDecorators;
				t.config.get("link.addTargetToExternalLinks") && i.add({
					id: "linkIsExternal",
					mode: "automatic",
					callback: e => ym.test(e),
					attributes: {
						target: "_blank",
						rel: "noopener noreferrer"
					}
				}), i.add(e), i.length && t.conversion.for("downcast").add(i.getDispatcher())
			}
			_enableManualDecorators(e) {
				...
				e.forEach(e => {
					...
					}), i.add(new vm(e)), t.conversion.for("downcast").attributeToElement({
						model: e.id,
						view: (t, {
							writer: n
						}) => {
							if (t) {
								const t = i.get(e.id).attributes,
									o = n.createAttributeElement("a", t, {
										priority: 5
									});
			...
			_enableInsertContentSelectionAttributesFixer() {
				...
				this.listenTo(t, "insertContent", () => {
					const e = i.anchor.nodeBefore,
						o = i.anchor.nodeAfter;
					i.hasAttribute("linkHref") && e && e.hasAttribute("linkHref") && (o && o.hasAttribute("linkHref") || t.change(e => {
						Am(e, n.manualDecorators)
					}))
				}, {
					priority: "low"
				})
			...
			_enableClickingAfterLink() {
				...
				this.listenTo(e.editing.view.document, "mousedown", () => {
					...
					const o = n.getFirstPosition(),
						r = Qh(o, "linkHref", n.getAttribute("linkHref"), e.model);
					(o.isTouching(r.start) || o.isTouching(r.end)) && e.model.change(e => {
						Am(e, t.manualDecorators)
					})
				})
			}
			_enableTypingOverLink() {
				...
				this.listenTo(t.document, "delete", () => {
					...
					priority: "high"
				}), this.listenTo(e.model, "deleteContent", () => {
					const t = e.model.document.selection;
					t.isCollapsed || (n ? n = !1 : Cm(e) && function (e) {
						...
						const r = n.textNode || n.nodeBefore;
						if (o === r) return !0;
						return Qh(i, "linkHref", o.getAttribute("linkHref"), e).containsRange(e.createRange(i, n), !0)
					}(e.model) && (i = t.getAttributes()))
				}, {
					priority: "high"
				}), this.listenTo(e.model, "insertContent", (t, [o]) => {
					n = !1, Cm(e) && i && (e.model.change(e => {
			...
			_handleDeleteContentAfterLink() {
				...
				let r = !1,
					s = !1;
				this.listenTo(n.document, "delete", (e, t) => {
					s = t.domEvent.keyCode === Io.backspace
				}, {
					priority: "high"
					...
					r = o.containsPosition(e) || o.end.isEqual(e)
				}, {
					priority: "high"
				}), this.listenTo(t, "deleteContent", () => {
					s && (s = !1, r || e.model.enqueueChange(e => {
						Am(e, o.manualDecorators)
					}))
				}, {
					priority: "low"
				})
		...
		function Am(e, t) {
			...
			for (const i of t) e.removeSelectionAttribute(i.id)
		}

		function Cm(e) {
			return e.plugins.get("Input").isInput(e.model.change(e => e.batch))
		}
		i(90);
		class Tm extends Ll {
			constructor(e, t) {
				super(e);
				const i = e.t;
				this.focusTracker = new Ms, this.keystrokes = new Is, this.urlInputView = this._createUrlInput(), this.saveButtonView = this._createButton(i("Save"), yl, "ck-button-save"), this.saveButtonView.type = "submit", this.cancelButtonView = this._createButton(i("Cancel"), vl, "ck-button-cancel", "cancel"), this._manualDecoratorSwitches = this._createManualDecoratorSwitches(t), this.children = this._createFormChildren(t.manualDecorators), this._focusables = new Dl, this._focusCycler = new ad({
					focusables: this._focusables,
					focusTracker: this.focusTracker,
					keystrokeHandler: this.keystrokes,
					actions: {
				...
				t.manualDecorators.length && n.push("ck-link-form_layout-vertical", "ck-vertical-form"), this.setTemplate({
					tag: "form",
					attributes: {
						class: n,
						tabindex: "-1"
			...
			_createManualDecoratorSwitches(e) {
				...
				for (const i of e.manualDecorators) {
					const n = new sd(this.locale);
					n.set({
						name: i.id,
						label: i.label,
						withText: !0
					}), n.bind("isOn").toMany([i, e], "value", (e, t) => void 0 === t && void 0 === e ? i.defaultValue : e), n.on("execute", () => {
						i.set("value", !n.isOn)
					}), t.add(n)
				}
				return t
		...
		class Em extends Ll {
			constructor(e) {
				super(e);
				const t = e.t;
				this.focusTracker = new Ms, this.keystrokes = new Is, this.previewButtonView = this._createPreviewButton(), this.unlinkButtonView = this._createButton(t("Unlink"), '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="m11.077 15 .991-1.416a.75.75 0 1 1 1.229.86l-1.148 1.64a.748.748 0 0 1-.217.206 5.251 5.251 0 0 1-8.503-5.955.741.741 0 0 1 .12-.274l1.147-1.639a.75.75 0 1 1 1.228.86L4.933 10.7l.006.003a3.75 3.75 0 0 0 6.132 4.294l.006.004zm5.494-5.335a.748.748 0 0 1-.12.274l-1.147 1.639a.75.75 0 1 1-1.228-.86l.86-1.23a3.75 3.75 0 0 0-6.144-4.301l-.86 1.229a.75.75 0 0 1-1.229-.86l1.148-1.64a.748.748 0 0 1 .217-.206 5.251 5.251 0 0 1 8.503 5.955zm-4.563-2.532a.75.75 0 0 1 .184 1.045l-3.155 4.505a.75.75 0 1 1-1.229-.86l3.155-4.506a.75.75 0 0 1 1.045-.184zm4.919 10.562-1.414 1.414a.75.75 0 1 1-1.06-1.06l1.414-1.415-1.415-1.414a.75.75 0 0 1 1.061-1.06l1.414 1.414 1.414-1.415a.75.75 0 0 1 1.061 1.061l-1.414 1.414 1.414 1.415a.75.75 0 0 1-1.06 1.06l-1.415-1.414z"/></svg>', "unlink"), this.editButtonView = this._createButton(t("Edit link"), Sl, "edit"), this.set("href"), this._focusables = new Dl, this._focusCycler = new ad({
					focusables: this._focusables,
					focusTracker: this.focusTracker,
					keystrokeHandler: this.keystrokes,
					actions: {
			...
			_createButton(e, t, i) {
				...
				return n.set({
					...
					icon: t,
					tooltip: !0
				}), n.delegate("execute").to(this, i), n
			}
			_createPreviewButton() {
				const e = new rd(this.locale),
					t = this.bindTemplate,
					i = this.t;
				return e.set({
					withText: !0,
					...
					attributes: {
						...
						href: t.to("href", e => e && pm(e)),
						target: "_blank",
						rel: "noopener noreferrer"
					}
				}), e.bind("label").to(this, "href", e => e || i("This link has no URL")), e.bind("isEnabled").to(this, "href", e => !!e), e.template.tag = "a", e.template.eventListeners = {}, e
			}
		}
		class Pm extends Qe {
			static get requires() {
			...
			init() {
				const e = this.editor;
				e.editing.view.addObserver(mu), this.actionsView = this._createActionsView(), this.formView = this._createFormView(), this._balloon = e.plugins.get(Yd), this._createToolbarLinkButton(), this._enableUserBalloonInteractions(), e.conversion.for("editingDowncast").markerToHighlight({
					model: "link-ui",
					view: {
			...
			_createActionsView() {
				...
				return t.bind("href").to(i, "value"), t.editButtonView.bind("isEnabled").to(i), t.unlinkButtonView.bind("isEnabled").to(n), this.listenTo(t, "edit", () => {
					this._addFormView()
			...
			_createFormView() {
				const e = this.editor,
					...
					n = new Tm(e.locale, t);
				return n.urlInputView.fieldView.bind("value").to(t, "value"), n.urlInputView.bind("isReadOnly").to(t, "isEnabled", e => !e), n.saveButtonView.bind("isEnabled").to(t), this.listenTo(n, "submit", () => {
					const {
						value: t
					} = n.urlInputView.fieldView.element, o = wm(t, i);
			...
			_startUpdatingUI() {
				...
				function r() {
					return t.selection.focus.getAncestors().reverse().find(e => e.is("element"))
				}
			...
			_getBalloonPositionData() {
				...
				if (t.markers.has("link-ui")) {
					...
					const t = this._getSelectedLinkElement(),
						o = i.selection.getFirstRange();
					n = t ? e.domConverter.mapViewToDom(t) : e.domConverter.viewRangeToDom(o)
				}
				return {
					target: n
				}
			...
			_getSelectedLinkElement() {
				const e = this.editor.editing.view,
					t = e.document.selection;
				if (t.isCollapsed) return Sm(t.getFirstPosition()); {
			...
			_showFakeVisualSelection() {
				...
				e.change(t => {
					...
					if (e.markers.has("link-ui")) t.updateMarker("link-ui", {
						range: i
					});
			...
			_hideFakeVisualSelection() {
				const e = this.editor.model;
				e.markers.has("link-ui") && e.change(e => {
		...
		const Mm = new RegExp("(^|\\s)(((?:(?:(?:https?|ftp):)?\\/\\/)(?:\\S+(?::\\S*)?@)?(?:(?:[1-9]\\d?|1\\d\\d|2[01]\\d|22[0-3])(?:\\.(?:1?\\d{1,2}|2[0-4]\\d|25[0-5])){2}(?:\\.(?:[1-9]\\d?|1\\d\\d|2[0-4]\\d|25[0-4]))|(((?!www\\.)|(www\\.))(?![-_])(?:[-_a-z0-9\\u00a1-\\uffff]{1,63}\\.)+(?:[a-z\\u00a1-\\uffff]{2,63})))(?::\\d{2,5})?(?:[/?#]\\S*)?)|((www.|(\\S+@))((?![-_])(?:[-_a-z0-9\\u00a1-\\uffff]{1,63}\\.))+(?:[a-z\\u00a1-\\uffff]{2,63})))$", "i");
		class Im extends Qe {
			static get pluginName() {
				return "AutoLink"
			}
			...
			_enableTypingHandling() {
				const e = this.editor,
					t = new Oh(e.model, e => {
						...
						const t = Nm(e.substr(0, e.length - 1));
						return t ? {
							url: t
						} : void 0
					}),
					i = e.plugins.get("Input");
		...
		class Rm extends Ze {
			...
			execute() {
				const e = this.editor.model,
					t = e.document,
					i = Array.from(t.selection.getSelectedBlocks()).filter(t => Dm(t, e.schema)),
					n = !0 === this.value;
				e.change(e => {
					if (n) {
						let t = i[i.length - 1].nextSibling,
					...
					if (!n) {
						...
						for (const t of i) t.is("element", "listItem") && t.getAttribute("listIndent") < e && (e = t.getAttribute("listIndent"));
						e = 0 === e ? 1 : e, Om(i, !0, e), Om(i, !1, e)
					}
					for (const t of i.reverse()) n && "listItem" == t.name ? e.rename(t, "paragraph") : n || "listItem" == t.name ? n || "listItem" != t.name || t.getAttribute("listType") == this.type || e.setAttribute("listType", this.type, t) : (e.setAttributes({
						listType: this.type,
						listIndent: 0
		...
		function Om(e, t, i) {
			...
			if (n.is("element", "listItem")) {
				...
				for (; o && o.is("element", "listItem") && o.getAttribute("listIndent") >= i;) r > o.getAttribute("listIndent") && (r = o.getAttribute("listIndent")), o.getAttribute("listIndent") == r && e[t ? "unshift" : "push"](o), o = o[t ? "previousSibling" : "nextSibling"]
			}
		}
		...
		function Vm(e, t, i, n) {
			...
			if (a = Bm(a), s.insert(a, o), l && "listItem" == l.name) {
				const e = r.toViewElement(l),
					i = s.createRange(s.createPositionAt(e, 0), a).getWalker({
						ignoreElementEnd: !0
					});
				for (const e of i)
					if (e.item.is("element", "li")) {
						...
						jm(s, r.nodeBefore, r.nodeAfter), s.move(s.createRangeOn(o), r), i.position = n
					}
			} else {
				...
				if (i && (i.is("element", "ul") || i.is("element", "ol"))) {
					...
					n && (s.breakContainer(s.createPositionAfter(n)), s.move(s.createRangeOn(n.parent), s.createPositionAt(t, "end")))
				}
			}
			jm(s, o, o.nextSibling), jm(s, o.previousSibling, o)
		}

		function jm(e, t, i) {
			return !t || !i || "ul" != t.name && "ol" != t.name || t.name != i.name || t.getAttribute("class") !== i.getAttribute("class") ? null : e.mergeContainers(e.createPositionAfter(t))
		}
		...
		function Um() {
			...
			return this.isEmpty || e ? 0 : io.call(this)
		}
		...
		function qm(e, t, i) {
			if (!i.consumable.consume(t.item, "attribute:listType")) return;
			const n = i.mapper.toViewElement(t.item),
				o = i.writer;
		...
		function $m(e, t, i) {
			const n = i.mapper.toViewElement(t.item).parent,
				o = i.writer;
			jm(o, n, n.nextSibling), jm(o, n.previousSibling, n);
			for (const e of t.item.getChildren()) i.consumable.consume(e, "insert")
		}
				...
				if (o.length > 0) {
					for (let t = 0; t < o.length; t++) {
						...
						if (e = n.insert(e, o[t]).end, t > 0) {
							const t = jm(n, i, i.nextSibling);
							t && t.parent == i && e.offset--
						}
					}
					jm(n, e.nodeBefore, e.nodeAfter)
				}
			}
		}
		...
		function Km(e, t, i) {
			if (i.consumable.consume(t.viewItem, {
					name: !0
				})) {
				const e = i.writer,
				...
				if (e.setAttribute("listType", r, n), !i.safeInsert(n, t.modelCursor)) return;
				const s = function (e, t, i) {
					...
					for (const s of t)
						if ("ul" == s.name || "ol" == s.name) r = i.convertItem(s, r).modelCursor;
						else {
							const t = i.convertItem(s, n.createPositionAt(e, "end")),
								a = t.modelRange.start.nodeAfter;
							a && a.is("element") && !o.checkChild(e, a.name) && (e = t.modelCursor.parent.is("element", "listItem") ? t.modelCursor.parent : ep(t.modelCursor), r = n.createPositionAfter(e))
						} return r
				}(n, t.viewItem.getChildren(), i);
				t.modelRange = e.createRange(t.modelCursor, s), i.updateConversionResult(n, t)
			}
		}
		...
		function Qm(e, t, i) {
			if (i.consumable.test(t.viewItem, {
				...
				for (const t of e) {
					!(t.is("element", "li") || ip(t)) && t._remove()
				}
			}
		}
		...
		function Jm(e, t, i) {
			if (i.consumable.test(t.viewItem, {
				...
				let i = !1,
					n = !0;
				for (const t of e) i && !ip(t) && t._remove(), t.is("$text") ? (n && (t._data = t.data.trimStart()), t.nextSibling && !ip(t.nextSibling) || (t._data = t.data.trimEnd())) : ip(t) && (i = !0), n = !1
			}
		}
		...
		function Xm(e, [t, i]) {
			let n, o = t.is("documentFragment") ? t.getChild(0) : t;
			if (n = i ? this.createSelection(i) : this.document.selection, o && o.is("element", "listItem")) {
				...
				if (e.parent.is("element", "listItem") ? t = e.parent : e.nodeBefore && e.nodeBefore.is("element", "listItem") && (t = e.nodeBefore), t) {
					const e = t.getAttribute("listIndent");
					if (e > 0)
						for (; o && o.is("element", "listItem");) o._setAttribute("listIndent", o.getAttribute("listIndent") + e), o = o.nextSibling
				}
			}
		}
		...
		function tp(e, t, i, n, o, r) {
			const s = Fm(t.nodeBefore, {
					sameIndent: !0,
					smallerIndent: !0,
					listIndent: e,
					foo: "b"
			...
			d = Bm(d);
			for (const e of [...n.getChildren()]) ip(e) && (d = c.move(c.createRangeOn(e), d).end, jm(c, e, e.nextSibling), jm(c, e.previousSibling, e))
		}
		...
		class np extends Qe {
			...
			init() {
				...
				const t = e.data,
					i = e.editing;
				var n;
				e.model.document.registerPostFixer(t => function (e, t) {
					...
					for (const n of i)
						...
						if ("$text" != n.name) {
							...
							i.hasAttribute("listIndent") && (t.removeAttribute("listIndent", i), o = !0), i.hasAttribute("listType") && (t.removeAttribute("listType", i), o = !0), i.hasAttribute("listStyle") && (t.removeAttribute("listStyle", i), o = !0);
							for (const t of Array.from(e.createRangeIn(i)).filter(e => e.item.is("element", "listItem"))) r(t.previousPosition)
						}
						r(n.position.getShiftedBy(n.length))
					} else "remove" == n.type && "listItem" == n.name ? r(n.position) : ("attribute" == n.type && "listIndent" == n.attributeKey || "attribute" == n.type && "listType" == n.attributeKey) && r(n.range.start);
					...
					function r(e) {
						...
						if (t && t.is("element", "listItem")) {
							let e = t;
							if (n.has(e)) return;
							for (let t = e.previousSibling; t && t.is("element", "listItem"); t = e.previousSibling)
					...
					function s(e) {
						...
						for (; e && e.is("element", "listItem");) {
							...
							if (r > i) {
								let s;
								null === n ? (n = r - i, s = i) : (n > r && (n = r), s = r - n), t.setAttribute("listIndent", s, e), o = !0
					...
					function a(e) {
						...
						for (; e && e.is("element", "listItem");) {
							const r = e.getAttribute("listIndent");
							if (n && n.getAttribute("listIndent") > r && (i = i.slice(0, r + 1)), 0 != r)
								if (i[r]) {
									const n = i[r];
				...
				}(e.model, t)), i.mapper.registerViewToModelLength("li", op), t.mapper.registerViewToModelLength("li", op), i.mapper.on("modelToViewPosition", Zm(i.view)), i.mapper.on("viewToModelPosition", (n = e.model, (e, t) => {
					...
					if ("ul" == o.name || "ol" == o.name) {
						...
						let a = 1,
							c = i.nodeBefore;
						for (; c && ip(c);) a += r.getModelLength(c), c = c.previousSibling;
						t.modelPosition = n.createPositionBefore(s).getShiftedBy(a), e.stop()
					}
				})), t.mapper.on("modelToViewPosition", Zm(i.view)), e.conversion.for("editingDowncast").add(t => {
					t.on("insert", Ym, {
						priority: "high"
					}), t.on("insert:listItem", Wm(e.model)), t.on("attribute:listType:listItem", qm, {
						priority: "high"
					}), t.on("attribute:listType:listItem", $m, {
						priority: "low"
						...
						return (t, i, n) => {
							...
							const s = o.parent,
								a = s.previousSibling,
								c = r.createRangeOn(s);
							r.remove(c), a && a.nextSibling && jm(r, a, a.nextSibling), tp(i.attributeOldValue + 1, i.range.start, c.start, o, n, e), Vm(i.item, o, n, e);
						...
						return (t, i, n) => {
							...
							const s = o.parent,
								...
								c = r.createRangeOn(s),
								l = r.remove(c);
							a && a.nextSibling && jm(r, a, a.nextSibling);
							tp(n.mapper.toModelElement(o).getAttribute("listIndent") + 1, i.position, c.start, o, n, e);
							for (const e of r.createRangeIn(l).getItems()) n.mapper.unbindViewElement(e);
							t.stop()
						}
					}(e.model)), t.on("remove", Gm, {
						priority: "low"
					})
				}), e.conversion.for("dataDowncast").add(t => {
					t.on("insert", Ym, {
						priority: "high"
					}), t.on("insert:listItem", Wm(e.model))
				...
				}), e.model.on("insertContent", Xm, {
					priority: "high"
				}), e.commands.add("numberedList", new Rm(e, "numbered")), e.commands.add("bulletedList", new Rm(e, "bulleted")), e.commands.add("indentList", new Lm(e, "forward")), e.commands.add("outdentList", new Lm(e, "backward"));
				const o = i.view.document;
				this.listenTo(o, "enter", (e, t) => {
				...
				const r = e => (t, i) => {
					this.editor.commands.get(e).isEnabled && (this.editor.execute(e), i())
				};
				e.keystrokes.set("Tab", r("indentList")), e.keystrokes.set("Shift+Tab", r("outdentList"))
			}
			afterInit() {
		...
		function op(e) {
			...
			for (const i of e.getChildren())
				if ("ul" == i.name || "ol" == i.name)
					for (const e of i.getChildren()) t += op(e);
			return t
		}
		class rp extends Qe {
			static get pluginName() {
		...
		function sp(e, t) {
			...
			function i(i, n, o) {
				...
				const r = n.attributeNewValue,
					...
					c = [...a.getChildren()].find(e => e.getCustomProperty("media-content"));
				s.remove(c);
				const l = e.getMediaViewElement(s, r, t);
				s.insert(s.createPositionAt(a, 0), l)
			}
		}

		function ap(e, t, i, n) {
			const o = e.createContainerElement("figure", {
				class: "media"
			});
			return e.insert(e.createPositionAt(o, 0), t.getMediaViewElement(e, i, n)), o
		}
		...
		function lp(e, t, i) {
			e.change(n => {
				const o = n.createElement("media", {
					url: t
				});
				e.insertContent(o, i), n.setSelection(o, "on")
			})
		}
		class dp extends Ze {
			refresh() {
		...
		class up {
			...
			_getMedia(e) {
				if (!e) return new hp(this.locale);
				e = e.trim();
				for (const t of this.providerDefinitions) {
					...
					for (const t of n) {
						...
						if (n) return new hp(this.locale, e, n, i)
					}
				}
				return null
			}
		...
		class hp {
			constructor(e, t, i, n) {
				this.url = this._getValidUrl(t), this._t = e.t, this._match = i, this._previewRenderer = n
			}
			getViewElement(e, t) {
				const i = {};
				let n;
				if (t.renderForEditingView || t.renderMediaPreview && this.url && this._previewRenderer) {
					...
					n = e.createRawElement("div", i, (function (e) {
						e.innerHTML = o
					}))
				} else this.url && (i.url = this.url), n = e.createEmptyElement("oembed", i);
			...
			constructor(e) {
				super(e), e.config.define("mediaEmbed", {
					providers: [{
						...
						html: e => `<div style="position: relative; padding-bottom: 100%; height: 0; "><iframe src="https://www.dailymotion.com/embed/video/${e[1]}" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" width="480" height="270" allowfullscreen allow="autoplay"></iframe></div>`
					}, {
						name: "spotify",
						url: [/^open\.spotify\.com\/(artist\/\w+)/, /^open\.spotify\.com\/(album\/\w+)/, /^open\.spotify\.com\/(track\/\w+)/],
						html: e => `<div style="position: relative; padding-bottom: 100%; height: 0; padding-bottom: 126%;"><iframe src="https://open.spotify.com/embed/${e[1]}" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe></div>`
					}, {
						name: "youtube",
						url: [/^(?:m\.)?youtube\.com\/watch\?v=([\w-]+)/, /^(?:m\.)?youtube\.com\/v\/([\w-]+)/, /^youtube\.com\/embed\/([\w-]+)/, /^youtu\.be\/([\w-]+)/],
						html: e => `<div style="position: relative; padding-bottom: 100%; height: 0; padding-bottom: 56.2493%;"><iframe src="https://www.youtube.com/embed/${e[1]}" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>`
					}, {
						name: "vimeo",
						...
						html: e => `<div style="position: relative; padding-bottom: 100%; height: 0; padding-bottom: 56.2493%;"><iframe src="https://player.vimeo.com/video/${e[1]}" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>`
					}, {
						name: "instagram",
				...
				}), this.registry = new up(e.locale, e.config.get("mediaEmbed"))
			}
			init() {
				const e = this.editor,
					t = e.model.schema,
					...
					r = this.registry;
				e.commands.add("mediaEmbed", new dp(e)), t.register("media", {
					isObject: !0,
					isBlock: !0,
					allowWhere: "$block",
					allowAttributes: ["url"]
					...
					view: (e, {
						...
						return function (e, t, i) {
							return t.setCustomProperty("media", !0, e), ju(e, t, {
								label: i
							})
						}(ap(t, r, n, {
				...
				}), n.for("editingDowncast").add(sp(r, {
					renderForEditingView: !0
				})), n.for("upcast").elementToElement({
					view: {
						name: "oembed",
					...
					model: (e, {
						...
						const i = e.getAttribute("url");
						if (r.hasMedia(i)) return t.createElement("media", {
							url: i
						})
					}
				}).elementToElement({
		...
		class mp extends Qe {
			...
			init() {
				...
				this.listenTo(e.plugins.get("ClipboardPipeline"), "inputTransformation", () => {
					const e = t.selection.getFirstRange(),
						i = Kc.fromPosition(e.start);
					i.stickiness = "toPrevious";
					const n = Kc.fromPosition(e.end);
					n.stickiness = "toNext", t.once("change:data", () => {
						this._embedMediaBetweenPositions(i, n), i.detach(), n.detach()
					}, {
						priority: "high"
					})
				}), e.commands.get("undo").on("execute", () => {
					this._timeoutId && (kr.window.clearTimeout(this._timeoutId), this._positionToInsert.detach(), this._timeoutId = null, this._positionToInsert = null)
				}, {
					priority: "high"
				})
			}
			_embedMediaBetweenPositions(e, t) {
				...
				if (s = s.trim(), !s.match(gp)) return void o.detach();
				if (!n.hasMedia(s)) return void o.detach();
				i.commands.get("mediaEmbed").isEnabled ? (this._positionToInsert = Kc.fromPosition(e), this._timeoutId = kr.window.setTimeout(() => {
					i.model.change(e => {
						let t;
						this._timeoutId = null, e.remove(o), o.detach(), "$graveyard" !== this._positionToInsert.root.rootName && (t = this._positionToInsert), lp(i.model, s, t), this._positionToInsert.detach(), this._positionToInsert = null
					})
				}, 100)) : o.detach()
			}
		}
		...
		class pp extends Ll {
			...
			render() {
				...
				this.keystrokes.set("arrowright", e), this.keystrokes.set("arrowleft", e), this.keystrokes.set("arrowup", e), this.keystrokes.set("arrowdown", e), this.listenTo(this.urlInputView.element, "selectstart", (e, t) => {
					t.stopPropagation()
				}, {
					priority: "high"
				})
		...
		class bp extends Qe {
			...
			init() {
				const e = this.editor,
					...
					i = e.plugins.get(fp).registry;
				e.ui.componentFactory.add("mediaEmbed", n => {
					const o = Pd(n),
						r = new pp(function (e, t) {
							return [t => {
					...
					return this._setUpDropdown(o, r, t, e), this._setUpForm(o, r, t), o
				})
			}
			_setUpDropdown(e, t, i) {
				...
				e.bind("isEnabled").to(i), e.panelView.children.add(t), r.set({
					...
					t.isValid() && (n.execute("mediaEmbed", t.url), s())
				}), e.on("change:isOpen", () => t.resetFormStatus()), e.on("cancel", () => s())
			}
			_setUpForm(e, t, i) {
		...
		function wp(e, t) {
			...
			n.forEach((e, s) => {
				const a = function (e, t) {
						...
						if (!i) return !0;
						return n = i, !(n.is("element", "ol") || n.is("element", "ul"));
						var n
					}(n[s - 1], e),
					c = a ? null : n[s - 1],
					l = (u = e, (d = c) ? u.indent - d.indent : u.indent - 1);
				var d, u;
				if (a && (o = null, r = 1), !o || 0 !== l) {
					const n = function (e, t) {
						const i = new RegExp(`@list l${e.id}:level${e.indent}\\s*({[^}]*)`, "gi"),
							n = /mso-level-number-format:([^;]{0,100});/gi,
							o = i.exec(t);
						let r = "decimal",
							s = "ol";
						if (o && o[1]) {
							const t = n.exec(o[1]);
							if (t && t[1] && (r = t[1].trim(), s = "bullet" !== r && "image" !== r ? "ol" : "ul"), "bullet" === r) {
								const t = function (e) {
									const t = function (e) {
										if (e.getChild(0).is("$text")) return null;
										const t = e.getChild(0).getChild(0);
										if (t.is("$text")) return t;
										return t.getChild(0)
									}(e);
									if (!t) return null;
									const i = t._data;
									if ("o" === i) return "circle";
									if ("·" === i) return "disc";
									if ("§" === i) return "square";
									return null
								}(e.element);
						...
						if (e.indent > r) {
							...
							o = function (e, t) {
								...
								let n = null,
									o = 0;
								for (const e of i)
									if ("ul" !== e.name && "ol" !== e.name || o++, o === t) {
										n = e;
										break
									} return n
							}(o, t), r = parseInt(e.indent)
						}
					} else o = _p(n, e.element, i);
					e.indent <= r && (o.is("element", n.type) || (o = i.rename(n.type, o)))
				}
				const h = function (e, t) {
					return function (e, t) {
						const i = new gn({
							...
							n = t.createRangeIn(e);
						for (const e of n) "elementStart" === e.type && i.match(e.item) && t.remove(e.item)
					}(e, t), t.rename("li", e)
				}(e.element, i);
				i.appendChild(h, o)
			})
		...
		function _p(e, t, i) {
			...
			return i.insertChild(r, o, n), e.style && i.setStyle("list-style-type", e.style, o), o
		}
		...
		function vp(e) {
			...
			if (i) {
				...
				e && n && o && (t.id = e[2], t.order = n[1], t.indent = o[1])
			}
			return t
		}
		const yp = /id=("|')docs-internal-guid-[-0-9a-f]+("|')/i;
		class xp {
			constructor(e) {
				this.document = e
			}
			...
			execute(e) {
				const t = new bu(this.document);
				! function (e, t) {
					for (const i of e.getChildren())
						if (i.is("element", "b") && "normal" === i.getStyle("font-weight")) {
		...
		function Ap(e) {
			return e.replace(/<span(?: class="Apple-converted-space"|)>(\s+)<\/span>/g, (e, t) => 1 === t.length ? " " : Array(t.length + 1).join("  ").substr(0, t.length))
		}

		function Cp(e, t) {
			const i = new DOMParser,
				n = function (e) {
					return Ap(Ap(e)).replace(/(<span\s+style=['"]mso-spacerun:yes['"]>[^\S\r\n]*?)[\r\n]+([^\S\r\n]*<\/span>)/g, "$1$2").replace(/<span\s+style=['"]mso-spacerun:yes['"]><\/span>/g, "").replace(/ <\//g, " </").replace(/ <o:p><\/o:p>/g, " <o:p></o:p>").replace(/<o:p>(&nbsp;|\u00A0)<\/o:p>/g, "").replace(/>([^\S\r\n]*[\r\n]\s*)</g, "><")
				}(function (e) {
					const t = e.indexOf("</body>");
					if (t < 0) return e;
					const i = e.indexOf("</html>", t + "</body>".length);
					return e.substring(0, t + "</body>".length) + (i >= 0 ? e.substring(i) : "")
				}(e = e.replace(/<!--\[if gte vml 1]>/g, ""))),
				o = i.parseFromString(n, "text/html");
			! function (e) {
				e.querySelectorAll("span[style*=spacerun]").forEach(e => {
					const t = e.innerText.length || 0;
			...
			const r = o.body.innerHTML,
				s = function (e, t) {
					...
					return n.domToView(o)
				}(o, t),
				a = function (e) {
					const t = [],
						i = [],
						n = Array.from(e.getElementsByTagName("style"));
					for (const e of n) e.sheet && e.sheet.cssRules && e.sheet.cssRules.length && (t.push(e.sheet), i.push(e.innerHTML));
					return {
						styles: t,
						stylesString: i.join(" ")
					}
		...
		function Tp(e, t) {
			...
			! function (e, t, i) {
				...
				for (const t of n)
					if (o.match(t.item)) {
						const i = t.item,
							n = i.getAttribute("v:shapes") ? i.getAttribute("v:shapes").split(" ") : [];
						n.length && n.every(t => e.indexOf(t) > -1) ? r.push(i) : i.getAttribute("src") || r.push(i)
				...
				for (const e of i) {
					const t = e.item,
						i = t.previousSibling && t.previousSibling.name || null;
					n.match(t) && t.getAttribute("o:gfxdata") && "v:shapetype" !== i && o.push(e.item.getAttribute("id"))
				}
				return o
			}(e, i), e, i),
			function (e, t) {
				const i = t.createRangeIn(e),
					...
					o = [];
				for (const e of i) n.match(e.item) && o.push(e.item);
			...
			const n = function (e, t) {
				const i = t.createRangeIn(e),
					...
					o = [];
				for (const e of i) n.match(e.item) && e.item.getAttribute("src").startsWith("file://") && o.push(e.item);
				return o
			}(e, i);
			n.length && function (e, t, i) {
				if (e.length === t.length)
					for (let o = 0; o < e.length; o++) {
						const r = `data:${t[o].type};base64,${n=t[o].hex,btoa(n.match(/\w{2}/g).map(e=>String.fromCharCode(parseInt(e,16))).join(""))}`;
				...
				if (n)
					for (const e of n) {
						let i = !1;
						e.includes("\\pngblip") ? i = "image/png" : e.includes("\\jpegblip") && (i = "image/jpeg"), i && o.push({
		...
		const Ep = /<meta\s*name="?generator"?\s*content="?microsoft\s*word\s*\d+"?\/?>/i,
			Pp = /xmlns:o="urn:schemas-microsoft-com/i;
		class Sp {
			constructor(e) {
				this.document = e
			}
			isActive(e) {
				return Ep.test(e) || Pp.test(e)
			}
			execute(e) {
				const {
					body: t,
					stylesString: i
				} = Cp(e.dataTransfer.getData("text/html"), this.document.stylesProcessor);
				wp(t, i), Tp(t, e.dataTransfer.getData("text/rtf")), e.content = t
			}
		}

		function Mp(e, t, i, n, o = 1) {
			...
			return e => {
				e.on("element:table", (e, t, i) => {
					...
					const {
						...
						for (const r of Array.from(e.getChildren()))
							if ("tbody" === r.name || "thead" === r.name || "tfoot" === r.name) {
								"thead" !== r.name || o || (o = r);
								const e = Array.from(r.getChildren()).filter(e => e.is("element", "tr"));
								for (const r of e)
									if ("thead" === r.parent.name && r.parent === o) t.headingRows++, i.push(r);
									else {
										n.push(r);
										const e = Dp(r);
					...
					if (i.safeInsert(c, t.modelCursor)) {
						if (i.consumable.consume(n, {
								name: !0
							}), o.forEach(e => i.convertItem(e, i.writer.createPositionAt(c, "end"))), c.isEmpty) {
							const e = i.writer.createElement("tableRow");
							i.writer.insert(e, i.writer.createPositionAt(c, "end")), Ip(i.writer, i.writer.createPositionAt(e, "end"))
						}
		...
		class Lp {
			...
			next() {
				const e = this._table.getChild(this._row);
		...
		class zp {
			constructor(e, t, i, n) {
				this.cell = t, this.row = e._row, this.column = e._column, this.cellAnchorRow = i, this.cellAnchorColumn = n, this._cellIndex = e._cellIndex, this._table = e._table
			}
			get isAnchor() {
		...
		function Vp(e = {}) {
			return t => t.on("insert:table", (t, i, n) => {
				const o = i.item;
				...
				const r = e && e.asWidget,
					s = n.writer.createContainerElement("figure", {
						class: "table"
					}),
					a = n.writer.createContainerElement("table");
				let c;
				var l, d;
				n.writer.insert(n.writer.createPositionAt(s, 0), a), r && (l = s, (d = n.writer).setCustomProperty("table", !0, l), c = ju(l, d, {
				...
				for (const t of u) {
					const {
						row: i,
						cell: r
					} = t, s = o.getChild(i), c = f.get(i) || Up(a, s, i, h, n);
					f.set(i, c), n.consumable.consume(r, "insert");
					Hp(t, h, n.writer.createPositionAt(c, "end"), n, e)
				}
				for (const e of o.getChildren()) {
					const t = e.index;
					f.has(t) || f.set(t, Up(a, e, t, h, n))
				}
				const g = n.mapper.toViewPosition(i.range.start);
				n.mapper.bindElements(o, r ? c : s), n.writer.insert(g, r ? c : s)
			})
		}
		...
		function jp(e, t) {
			...
			if (e.parent.is("element", "tableCell")) return Bp(e) ? i.createContainerElement("span", {
				style: "display:inline-block"
			}) : i.createContainerElement("p")
		}

		function Bp(e) {
			return 1 === e.parent.childCount && !Yp(e)
		}

		function Fp(e, t, i) {
			const {
				cell: n
			} = e, o = Wp(e, t), r = i.mapper.toViewElement(n);
			r && r.name !== o && function (e, t, i) {
				const n = i.writer,
					o = i.mapper.toViewElement(e),
					r = Wu(n.createEditableElement(t, o.getAttributes()), n);
				Hu(r, n, (e, t, i) => i.addClass(en(t.classes), e), (e, t, i) => i.removeClass(en(t.classes), e)), n.insert(n.createPositionAfter(o), r), n.move(n.createRangeIn(o), n.createPositionAt(r, 0)), n.remove(n.createRangeOn(o)), i.mapper.unbindViewElement(o), i.mapper.bindElements(e, r)
			}(n, o, i)
		}

		function Hp(e, t, i, n, o) {
			const r = o && o.asWidget,
				s = Wp(e, t),
				a = r ? Wu(n.writer.createEditableElement(s), n.writer) : n.writer.createContainerElement(s);
			r && Hu(a, n.writer, (e, t, i) => i.addClass(en(t.classes), e), (e, t, i) => i.removeClass(en(t.classes), e));
			const c = e.cell,
				l = c.getChild(0),
				d = 1 === c.childCount && "paragraph" === l.name;
			if (n.writer.insert(i, a), n.mapper.bindElements(c, a), !r && d && !Yp(l)) {
				const e = c.getChild(0);
				n.consumable.consume(e, "insert"), n.mapper.bindElements(e, a)
			}
		}

		function Up(e, t, i, n, o) {
			o.consumable.consume(t, "insert");
			const r = t.isEmpty ? o.writer.createEmptyElement("tr") : o.writer.createContainerElement("tr");
			o.mapper.bindElements(t, r);
			const s = n.headingRows,
				a = function (e, t, i) {
					const n = qp(e, t);
					return n || function (e, t, i) {
						const n = i.writer.createContainerElement(e),
							o = i.writer.createPositionAt(t, "tbody" == e ? "end" : 0);
		...
		function Yp(e) {
			return !![...e.getAttributeKeys()].length
		}
		class Gp extends Ze {
			refresh() {
				const e = this.editor.model,
			...
			execute(e = {}) {
				const t = this.editor.model,
					...
					o = qu(i, t);
				t.change(i => {
					const r = n.createTable(i, e);
					t.insertContent(r, o), i.setSelection(i.createPositionAt(r.getNodeByPath([0, 0, 0]), 0))
				})
			}
		}
		...
		function Jp(e) {
			const t = Kp(e);
			return t.length ? t : Qp(e)
		}

		function Zp(e) {
			return ib(e.map(e => e.parent.index))
		}

		function Xp(e) {
			const t = e[0].findAncestor("table");
			return ib([...new Lp(t)].filter(t => e.includes(t.cell)).map(e => e.column))
		}
		...
		function eb(e, t) {
			...
			for (const r of e) {
				const {
					row: e,
					column: s
				} = t.getCellLocation(r), a = parseInt(r.getAttribute("rowspan") || 1), c = parseInt(r.getAttribute("colspan") || 1);
				i.add(e), n.add(s), a > 1 && i.add(e + a - 1), c > 1 && n.add(s + c - 1), o += a * c
			}
			return function (e, t) {
		...
		class ab extends Ze {
			...
			refresh() {
				const e = Jp(this.editor.model.document.selection);
				this.isEnabled = 1 === e.length
			}
			execute() {
				const e = Jp(this.editor.model.document.selection)[0],
					t = "horizontally" === this.direction,
					i = this.editor.plugins.get("TableUtils");
				t ? i.splitCellHorizontally(e, 2) : i.splitCellVertically(e, 2)
			}
		}
		...
		function cb(e, t, i) {
			const {
				...
				endRow: r,
				endColumn: s
			} = t, a = i.createElement("table"), c = r - n + 1;
			for (let e = 0; e < c; e++) i.insertElement("tableRow", a, "end");
			const l = [...new Lp(e, {
				startRow: n,
				endRow: r,
				startColumn: o,
			...
			for (const {
				...
				const l = e - n,
					f = a.getChild(l);
				if (d) {
					const n = i.cloneElement(c);
					i.append(n, f), fb(n, e, t, r, s, i)
				} else(u < n || h < o) && Ip(i, i.createPositionAt(f, "end"))
			}
			return function (e, t, i, n, o) {
				const r = parseInt(t.getAttribute("headingRows") || 0);
				if (r > 0) {
					Mp("headingRows", r - i, e, o, 0)
				}
				const s = parseInt(t.getAttribute("headingColumns") || 0);
				if (s > 0) {
					Mp("headingColumns", s - n, e, o, 0)
				}
			}(a, e, n, o, i), a
		}
		...
		function db(e, t, i) {
			...
			c > 1 && (a.rowspan = c);
			const l = parseInt(e.getAttribute("colspan") || 1);
			l > 1 && (a.colspan = l);
			const d = r + s,
				u = [...new Lp(o, {
					startRow: r,
			...
			for (const t of u) {
				...
				r === e && void 0 === h && (h = o), void 0 !== h && h === o && n === d && (f = Ip(i, t.getPositionBefore(), a))
			}
			return Mp("rowspan", s, e, i), f
		}
		...
		function hb(e, t, i, n) {
			...
			a > 1 && (r.rowspan = a);
			const c = Ip(n, n.createPositionAfter(e), r);
			return Mp("colspan", o, e, n), c
		}

		function fb(e, t, i, n, o, r) {
			const s = parseInt(e.getAttribute("colspan") || 1),
				a = parseInt(e.getAttribute("rowspan") || 1);
			if (i + s - 1 > o) {
				Mp("colspan", o - i + 1, e, r, 1)
			}
			if (t + a - 1 > n) {
				Mp("rowspan", n - t + 1, e, r, 1)
			}
		}
		...
		class kb extends Ze {
			...
			execute() {
				const e = this.editor.model,
					t = Qp(e.document.selection)[0],
					i = this.value,
					n = this.direction;
				e.change(e => {
					const o = "right" == n || "down" == n,
						r = o ? t : i,
						s = o ? i : t,
						a = s.parent;
					! function (e, t, i) {
						_b(e) || (_b(t) && i.remove(i.createRangeIn(t)), i.move(i.createRangeIn(e), i.createPositionAt(t, "end")));
						i.remove(e)
					}(s, r, e);
					...
					pb(a.findAncestor("table"), u)
				})
			}
			_getMergeableCell() {
				const e = Qp(this.editor.model.document.selection)[0];
				if (!e) return;
				const t = this.editor.plugins.get("TableUtils"),
					i = this.isHorizontal ? function (e, t, i) {
					...
					}(e, this.direction, t) : function (e, t) {
						const i = e.parent,
							n = i.parent,
							o = n.getChildIndex(i);
						if ("down" == t && o === n.childCount - 1 || "up" == t && 0 === o) return;
						const r = parseInt(e.getAttribute("rowspan") || 1),
							s = n.getAttribute("headingRows") || 0,
							a = "down" == t && o + r === s,
							c = "up" == t && o === s;
						if (s && (a || c)) return;
						const l = parseInt(e.getAttribute("rowspan") || 1),
							...
							h = u.find(t => t.cell === e).column,
							f = u.find(({
								row: e,
								cellHeight: i,
								column: n
							}) => n === h && ("down" == t ? e === d : d === e + i));
						return f && f.cell
					}(e, this.direction);
				if (!i) return;
				const n = this.isHorizontal ? "rowspan" : "colspan",
					o = parseInt(e.getAttribute(n) || 1);
			...
			refresh() {
				...
				if (t) {
					const i = t.findAncestor("table"),
						n = this.editor.plugins.get("TableUtils").getRows(i) - 1,
						o = Zp(e),
						r = 0 === o.first && o.last === n;
					this.isEnabled = !r
				} else this.isEnabled = !1
			}
			execute() {
				const e = this.editor.model,
					t = Jp(e.document.selection),
					i = Zp(t),
					n = t[0],
					o = n.findAncestor("table"),
					r = this.editor.plugins.get("TableUtils").getCellLocation(n).column;
				e.change(e => {
					const t = i.last - i.first + 1;
					this.editor.plugins.get("TableUtils").removeRows(o, {
						at: i.first,
						rows: t
					});
					const n = function (e, t, i) {
						const n = e.getChild(t) || e.getChild(e.childCount - 1);
						let o = n.getChild(0),
							r = 0;
						for (const e of n.getChildren()) {
							if (r > i) return o;
							o = e, r += parseInt(e.getAttribute("colspan") || 1)
						}
						return o
					}(o, i.first, r);
					e.setSelection(e.createPositionAt(n, 0))
				})
			}
		}
		class yb extends Ze {
			refresh() {
				...
				if (t) {
					const i = t.findAncestor("table"),
						n = this.editor.plugins.get("TableUtils").getColumns(i),
						{
							first: o,
							last: r
						} = Xp(e);
					this.isEnabled = r - o < n - 1
				} else this.isEnabled = !1
			}
			execute() {
				...
				}(this.editor.model.document.selection), i = e.parent.parent, n = [...new Lp(i)], o = {
					first: n.find(t => t.cell === e).column,
					last: n.find(e => e.cell === t).column
				}, r = function (e, t, i, n) {
					return parseInt(i.getAttribute("colspan") || 1) > 1 ? i : t.previousSibling || i.nextSibling ? i.nextSibling || t.previousSibling : n.first ? e.reverse().find(({
						column: e
					}) => e < n.first).cell : e.reverse().find(({
						column: e
					}) => e > n.last).cell
				}(n, e, t, o);
				this.editor.model.change(e => {
					const t = o.last - o.first + 1;
					this.editor.plugins.get("TableUtils").removeColumns(i, {
						at: o.first,
						columns: t
		...
		class xb extends Ze {
			refresh() {
				const e = Jp(this.editor.model.document.selection),
					t = e.length > 0;
				this.isEnabled = t, this.value = t && e.every(e => this._isInHeading(e, e.parent.parent))
			}
			execute(e = {}) {
				if (e.forceValue === this.value) return;
				const t = this.editor.model,
					i = Jp(t.document.selection),
					...
					s = this.value ? o : r + 1,
					a = n.getAttribute("headingRows") || 0;
				t.change(e => {
					if (s) {
						const t = lb(n, s, s > a ? a : 0);
						for (const {
								cell: i
							} of t) db(i, s, e)
					}
					Mp("headingRows", s, n, e, 0)
				})
			}
			_isInHeading(e, t) {
		...
		class Ab extends Ze {
			refresh() {
				const e = Jp(this.editor.model.document.selection),
					...
					i = e.length > 0;
				this.isEnabled = i, this.value = i && e.every(e => Np(t, e))
			}
			execute(e = {}) {
				if (e.forceValue === this.value) return;
				const t = this.editor.model,
		...
		class Cb extends Qe {
			...
			createTable(e, t) {
				...
				return Tb(e, i, 0, parseInt(t.rows) || 2, parseInt(t.columns) || 2), t.headingRows && Mp("headingRows", t.headingRows, i, e, 0), t.headingColumns && Mp("headingColumns", t.headingColumns, i, e, 0), i
			}
			insertRows(e, t = {}) {
				const i = this.editor.model,
					n = t.at || 0,
				...
				i.change(t => {
					...
					if (i > n && Mp("headingRows", i + o, e, t, 0), !r && (0 === n || n === a)) return void Tb(t, e, n, o, c);
					const l = r ? Math.max(n, s) : n,
						d = new Lp(e, {
							endRow: l
						}),
					...
					for (const {
						...
						const d = e + a - 1,
							h = e <= s && s <= d;
						e < n && n <= d ? (t.setAttribute("rowspan", a + o, l), u[i] = -c) : r && h && (u[i] = c)
					}
					for (let i = 0; i < o; i++) {
			...
			insertColumns(e, t = {}) {
				...
				i.change(t => {
					...
					if (0 === n || r === n) {
						for (const i of e.getChildren()) Eb(o, t, t.createPositionAt(i, n ? "end" : 0));
						return
					}
					const s = new Lp(e, {
						column: n,
					...
					for (const e of s) {
						...
						if (a < n) {
							t.setAttribute("colspan", l + o, r);
							const e = c + d - 1;
							for (let t = i; t <= e; t++) s.skipRow(t)
						} else Eb(o, t, e.getPositionBefore())
					}
				})
			}
			removeRows(e, t) {
							...
							for (const {
								...
								if (i.has(e)) {
									const {
										cell: t,
										rowspan: o
									} = i.get(e), a = s ? n.createPositionAfter(s) : n.createPositionAt(r, 0);
									n.move(n.createRangeOn(t), a), Mp("rowspan", o, t, n), s = t
								} else a && (s = t)
						}(e, r + 1, i, t)
					}
					for (let i = r; i >= o; i--) t.remove(e.getChild(i));
					for (const {
							rowspan: e,
							cell: i
						} of n) Mp("rowspan", e, i, t);
					! function (e, t, i, n) {
						const o = e.getAttribute("headingRows") || 0;
						if (t < o) {
							Mp("headingRows", i < o ? o - (i - t + 1) : t, e, n, 0)
						}
					}(e, o, r, t), gb(e, this) || mb(e, this)
				})
			}
			removeColumns(e, t) {
				const i = this.editor.model,
				...
				i.change(t => {
					...
					for (let i = r; i >= n; i--)
						for (const {
								...
								column: o,
								cellWidth: r
							} of [...new Lp(e)]) o <= i && r > 1 && o + r > i ? Mp("colspan", r - 1, n, t) : o === i && t.remove(n);
					mb(e, this) || gb(e, this)
				})
			}
			splitCellVertically(e, t = 2) {
				...
				i.change(i => {
					if (r > 1) {
						...
						Eb(r > t ? t - 1 : r - 1, i, i.createPositionAfter(e), a)
					}
					if (r < t) {
						const s = t - r,
							a = [...new Lp(n)],
						...
						for (const {
								cell: e,
								cellWidth: t
							} of l) i.setAttribute("colspan", t + s, e);
						const d = {};
						o > 1 && (d.rowspan = o), Eb(s, i, i.createPositionAfter(e), d);
						const u = n.getAttribute("headingColumns") || 0;
						u > c && Mp("headingColumns", u + s, n, i)
					}
				})
			}
				...
				i.change(i => {
					if (s > 1) {
						...
						for (const e of n) {
							...
							n >= r + l && o && s && Eb(1, i, e.getPositionBefore(), u)
						}
					}
					if (s < t) {
						const n = t - s,
						...
						a > 1 && (l.colspan = a), Tb(i, o, r + 1, n, 1, l);
						const d = o.getAttribute("headingRows") || 0;
						d > r && Mp("headingRows", d + n, o, i)
					}
				})
			}
			getColumns(e) {
		...
		function Tb(e, t, i, n, o, r = {}) {
			for (let s = 0; s < n; s++) {
				const n = e.createElement("tableRow");
				e.insert(n, t, i), Eb(o, e, e.createPositionAt(n, "end"), r)
			}
		}

		function Eb(e, t, i, n = {}) {
			for (let o = 0; o < e; o++) Ip(t, i, n)
		}
		...
		class Sb extends Ze {
			refresh() {
				const e = Kp(this.editor.model.document.selection);
				this.isEnabled = eb(e, this.editor.plugins.get(Cb))
			}
			execute() {
				const e = this.editor.model,
					t = this.editor.plugins.get(Cb);
				e.change(i => {
					const n = Kp(e.document.selection),
						o = n.shift(),
						{
							mergeWidth: r,
							mergeHeight: s
							...
							for (const e of t) {
								...
								n = Nb(e, r, n, "colspan"), o = Nb(e, t, o, "rowspan")
							}
							const {
								row: r,
								column: s
					...
					Mp("colspan", r, o, i), Mp("rowspan", s, o, i);
					for (const e of n) Mb(e, o, i);
					pb(o.findAncestor("table"), t), i.setSelection(o, "in")
				})
			}
		}

		function Mb(e, t, i) {
			Ib(e) || (Ib(t) && i.remove(i.createRangeIn(t)), i.move(i.createRangeIn(e), i.createPositionAt(t, "end"))), i.remove(e)
		}
		...
		class Rb extends Ze {
			...
			execute() {
				const e = this.editor.model,
					...
					o = [];
				for (let t = i.first; t <= i.last; t++)
					for (const i of n.getChild(t).getChildren()) o.push(e.createRangeOn(i));
				e.change(e => {
					e.setSelection(o)
				})
			}
		...
		function Db(e) {
			e.document.registerPostFixer(t => function (e, t) {
				...
				for (const t of i) {
					let i;
					"table" == t.name && "insert" == t.type && (i = t.position.nodeAfter), "tableRow" != t.name && "tableCell" != t.name || (i = t.position.findAncestor("table")), Vb(t) && (i = t.range.start.findAncestor("table")), i && !o.has(i) && (n = Lb(i, e) || n, n = zb(i, e) || n, o.add(i))
				}
				return n
			}(t, e))
		}
		...
		function Lb(e, t) {
			...
			if (n.length) {
				i = !0;
				for (const e of n) Mp("rowspan", e.rowspan, e.cell, t, 1)
			}
			return i
		}
		...
		function zb(e, t) {
			...
			const n = function (e) {
				...
				o = [];
			for (const [e, t] of n.entries()) t || o.push(e);
			if (o.length) {
				i = !0;
			...
			const r = n[0];
			if (!n.every(e => e === r)) {
				const o = n.reduce((e, t) => t > e ? t : e, 0);
				for (const [r, s] of n.entries()) {
					const n = o - s;
					if (n) {
						for (let i = 0; i < n; i++) Ip(t, t.createPositionAt(e.getChild(r), "end"));
						i = !0
					}
				}
			}
		...
		function jb(e) {
			e.document.registerPostFixer(t => function (e, t) {
				const i = t.document.differ.getChanges();
				let n = !1;
				for (const t of i) "insert" == t.type && "table" == t.name && (n = Bb(t.position.nodeAfter, e) || n), "insert" == t.type && "tableRow" == t.name && (n = Fb(t.position.nodeAfter, e) || n), "insert" == t.type && "tableCell" == t.name && (n = Hb(t.position.nodeAfter, e) || n), Ub(t) && (n = Hb(t.position.parent, e) || n);
				return n
			}(t, e))
		}
		...
		function Bb(e, t) {
			let i = !1;
			for (const n of e.getChildren()) i = Fb(n, t) || i;
			return i
		}

		function Fb(e, t) {
			let i = !1;
			for (const n of e.getChildren()) i = Hb(n, t) || i;
			return i
		}
		...
		function Wb(e, t) {
			e.document.registerPostFixer(() => function (e, t) {
				const i = new Set;
				...
				for (const n of i.values())
					for (const i of [...n.getChildren()].filter(e => qb(e, t))) e.refreshItem(i);
				return !1
			}(e.document.differ, t))
		}
		...
		function qb(e, t) {
			...
			return !!i && Bp(e) !== i.is("element", "span")
		}

		function $b(e) {
			e.document.registerPostFixer(() => function (e) {
				const t = e.document.differ,
					i = new Set;
				for (const e of t.getChanges()) {
					if ("attribute" != e.type) continue;
					const t = e.range.start.nodeAfter;
					t && t.is("element", "table") && "headingRows" == e.attributeKey && i.add(t)
				}
				if (i.size) {
					for (const e of i.values()) t.refreshItem(e);
					return !0
				}
				return !1
			}(e))
		...
		class Yb extends Qe {
			...
			init() {
				...
				i.register("table", {
					...
					if ("table" == t.name && Array.from(e.getNames()).includes("table")) return !1
				}), n.for("upcast").add(Rp()), n.for("editingDowncast").add(Vp({
					asWidget: !0
				})), n.for("dataDowncast").add(Vp()), n.for("upcast").elementToElement({
					model: "tableRow",
					view: "tr"
				}), n.for("upcast").add(e => {
					e.on("element:tr", (e, t) => {
				...
				}), n.for("editingDowncast").add(e => e.on("insert:tableRow", (e, t, i) => {
					const n = t.item;
					...
					const o = n.parent,
						...
						l = new Map;
					for (const e of a) {
						const t = l.get(s) || Up(r, n, s, c, i);
						l.set(s, t), i.consumable.consume(e.cell, "insert"), Hp(e, c, i.writer.createPositionAt(t, "end"), i, {
							asWidget: !0
						})
					}
				})), n.for("editingDowncast").add(e => e.on("remove:tableRow", (e, t, i) => {
					e.stop();
					const n = i.writer,
						o = i.mapper,
						r = o.toViewPosition(t.position).getLastMatchingPosition(e => !e.item.is("element", "tr")).nodeAfter,
						s = r.parent.parent,
						a = n.createRangeOn(r),
						c = n.remove(a);
					for (const e of n.createRangeIn(c).getItems()) o.unbindViewElement(e);
					$p("thead", s, i), $p("tbody", s, i)
				}, {
					priority: "higher"
				})), n.for("upcast").elementToElement({
					model: "tableCell",
					...
					model: "tableCell",
					view: "th"
				}), n.for("upcast").add(Op("td")), n.for("upcast").add(Op("th")), n.for("editingDowncast").add(e => e.on("insert:tableCell", (e, t, i) => {
					const n = t.item;
					if (!i.consumable.consume(n, "insert")) return;
					const o = n.parent,
						r = o.parent,
					...
					for (const e of a)
						if (e.cell === n) {
							...
							return void Hp(e, c, i.writer.createPositionAt(t, o.getChildIndex(n)), i, {
								asWidget: !0
							})
						}
					...
					model: "rowspan",
					view: "rowspan"
				}), n.for("editingDowncast").add(e => e.on("attribute:headingColumns:table", (e, t, i) => {
					const n = t.item;
					if (!i.consumable.consume(t.item, e.name)) return;
					const o = {
						...
						a = (r > s ? r : s) - 1;
					for (const e of new Lp(n, {
							endColumn: a
						})) Fp(e, o, i)
				})), e.commands.add("insertTable", new Gp(e)), e.commands.add("insertTableRowAbove", new rb(e, {
					order: "above"
				})), e.commands.add("insertTableRowBelow", new rb(e, {
					order: "below"
				})), e.commands.add("insertTableColumnLeft", new sb(e, {
					order: "left"
				})), e.commands.add("insertTableColumnRight", new sb(e, {
					order: "right"
				})), e.commands.add("removeTableRow", new vb(e)), e.commands.add("removeTableColumn", new yb(e)), e.commands.add("splitTableCellVertically", new ab(e, {
					direction: "vertically"
				})), e.commands.add("splitTableCellHorizontally", new ab(e, {
					direction: "horizontally"
				})), e.commands.add("mergeTableCells", new Sb(e)), e.commands.add("mergeTableCellRight", new kb(e, {
					direction: "right"
				})), e.commands.add("mergeTableCellLeft", new kb(e, {
					direction: "left"
				})), e.commands.add("mergeTableCellDown", new kb(e, {
					direction: "down"
				})), e.commands.add("mergeTableCellUp", new kb(e, {
					direction: "up"
				})), e.commands.add("setTableColumnHeader", new Ab(e)), e.commands.add("setTableRowHeader", new xb(e)), e.commands.add("selectTableRow", new Rb(e)), e.commands.add("selectTableColumn", new Ob(e)), $b(t), Db(t), Wb(t, e.editing.mapper), jb(t)
			}
			static get requires() {
				return [Cb]
			}
		...
		class Gb extends Ll {
			constructor(e) {
				super(e);
				const t = this.bindTemplate;
				this.items = this._createGridCollection(), this.set("rows", 0), this.set("columns", 0), this.bind("label").to(this, "columns", this, "rows", (e, t) => `${t} × ${e}`), this.setTemplate({
					tag: "div",
					attributes: {
						class: ["ck"]
					},
			...
			_createGridCollection() {
				...
				for (let t = 0; t < 100; t++) {
					const i = Math.floor(t / 10),
						n = t % 10;
					e.push(new Kb(this.locale, i + 1, n + 1))
				}
		...
		class Kb extends Ll {
			constructor(e, t, i) {
				...
				this.set("isOn", !1), this.setTemplate({
					tag: "div",
					attributes: {
						class: ["ck-insert-table-dropdown-grid-box", n.if("isOn", "ck-on")],
						"data-row": t,
						"data-column": i
					}
				})
		...
		class Qb extends Qe {
			...
			init() {
				...
				e.ui.componentFactory.add("insertTable", i => {
					const n = e.commands.get("insertTable"),
						o = Pd(i);
					let r;
					return o.bind("isEnabled").to(n), o.buttonView.set({
						...
						r || (r = new Gb(i), o.panelView.children.add(r), r.delegate("execute").to(o), o.buttonView.on("open", () => {
					...
					return this._prepareMergeSplitButtonDropdown(t("Merge cells"), '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 1h15A1.5 1.5 0 0 1 19 2.5v15a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 1 17.5v-15A1.5 1.5 0 0 1 2.5 1zM2 2v16h16V2H2z" opacity=".6"/><path d="M7 2h1v16H7V2zm5 0h1v7h-1V2zm6 5v1H2V7h16zM8 12v1H2v-1h6z" opacity=".6"/><path d="M7 7h12a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1zm1 2v9h10V9H8z"/></svg>', n, e)
				})
			}
			_prepareDropdown(e, t, i, n) {
				...
				return r.buttonView.set({
					...
					icon: t,
					tooltip: !0
				}), r.bind("isEnabled").toMany(s, "isEnabled", (...e) => e.some(e => e)), this.listenTo(r, "execute", e => {
			...
			_prepareMergeSplitButtonDropdown(e, t, i, n) {
				const o = this.editor,
					r = Pd(n, ud);
				return this._fillDropdownWithListOptions(r, i), r.buttonView.set({
					label: e,
					icon: t,
					tooltip: !0,
					isEnabled: !0
			...
			_fillDropdownWithListOptions(e, t) {
				const i = this.editor,
					n = [],
					o = new Zi;
				for (const e of t) Jb(e, i, n, o);
				return Sd(e, o, i.ui.componentFactory), n
			}
		}

		function Jb(e, t, i, n) {
			const o = e.model = new jd(e.model),
				{
					commandName: r,
					bindIsOn: s
				} = e.model;
			if ("button" === e.type || "switchbutton" === e.type) {
				const e = t.commands.get(r);
				i.push(e), o.set({
					commandName: r
				}), o.bind("isEnabled").to(e), s && o.bind("isOn").to(e, "value")
			}
			o.set({
				withText: !0
			}), n.add(e)
		...
		class Zb extends Qe {
			...
			init() {
				const e = this.editor.model;
				this.listenTo(e, "deleteContent", (e, t) => this._handleDeleteContent(e, t), {
					priority: "high"
			...
			getSelectionAsFragment() {
				...
				return e ? this.editor.model.change(t => {
					...
					return t.insert(u, i, 0), i
				}) : null
			}
			setCellSelection(e, t) {
				const i = this._getCellsToSelect(e, t);
				this.editor.model.change(e => {
					e.setSelection(i.cells.map(t => e.createRangeOn(t)), {
						backward: i.backward
					})
				})
			}
			...
			getAnchorCell() {
				const e = Ss(this.editor.model.document.selection.getRanges()).getContainedElement();
				return e && e.is("element", "tableCell") ? e : null
			}
			_defineSelectionConverter() {
				const e = this.editor,
					t = new Set;
				e.conversion.for("editingDowncast").add(e => e.on("selection", (e, i, n) => {
					const o = n.writer;
					! function (e) {
			...
			_handleDeleteContent(e, t) {
				const [i, n] = t, o = this.editor.model, r = !n || "backward" == n.direction, s = Kp(i);
				s.length && (e.stop(), o.change(e => {
					const t = s[r ? s.length - 1 : 0];
					o.change(e => {
						for (const t of s) o.deleteContent(e.createSelection(t, "in"))
					});
					const n = o.schema.getNearestSelectionRange(e.createPositionAt(t, 0));
			...
			_getCellsToSelect(e, t) {
				...
				for (const {
						row: t,
						cell: i
					} of new Lp(e.findAncestor("table"), d)) l[t - r].push(i);
				const u = o.row < n.row,
					h = o.column < n.column;
				return u && l.reverse(), h && l.forEach(e => e.reverse()), {
					cells: l.flat(),
					backward: u || h
				}
			}
		...
		class Xb extends Qe {
			...
			init() {
				const e = this.editor,
					t = e.editing.view.document;
				this.listenTo(t, "copy", (e, t) => this._onCopyCut(e, t)), this.listenTo(t, "cut", (e, t) => this._onCopyCut(e, t)), this.listenTo(e.model, "insertContent", (e, t) => this._onInsertContent(e, ...t), {
					priority: "high"
				}), this.decorate("_replaceTableSlotCell")
			}
			_onCopyCut(e, t) {
				const i = this.editor.plugins.get(Zb);
				...
				let r = function (e, t) {
					...
					for (const e of i.getItems())
						if (e.is("element", "table")) {
							...
							return t.hasContent(o, {
								ignoreWhitespaces: !0
							}) ? null : e
						} return null
				}(t, n);
				if (!r) return;
				const s = Jp(n.document.selection);
				s.length ? (e.stop(), n.change(e => {
					const t = {
						...
						i = function (e, t, i, n) {
							const o = e[0].findAncestor("table"),
								...
								c = 1 === e.length;
							c && (a.lastRow += t.height - 1, a.lastColumn += t.width - 1, function (e, t, i, n) {
								const o = n.getColumns(e),
									r = n.getRows(e);
								i > o && n.insertColumns(e, {
									at: o,
									columns: i - o
								});
								t > r && n.insertRows(e, {
							...
							c || !eb(e, n) ? function (e, t, i) {
								...
								tw(e, r, a, i), tw(e, s + 1, a, i), ew(e, n, c, i), ew(e, o + 1, c, i, n)
							}(o, a, i) : (a.lastRow = bb(o, a), a.lastColumn = wb(o, a));
							return a
						}(s, t, e, o),
					...
					const l = s[0].findAncestor("table"),
						d = this._replaceSelectedCellsWithPasted(r, t, l, i, e);
					if (this.editor.plugins.get("TableSelection").isEnabled) {
						const t = tb(d.map(t => e.createRangeOn(t)));
						e.setSelection(t)
			...
			_replaceSelectedCellsWithPasted(e, t, i, n, o) {
				...
				for (const e of c) {
					...
					const c = t - n.firstRow,
						u = i - n.firstColumn,
						h = a[c % s][u % r],
						f = h ? o.cloneElement(h) : null,
						g = this._replaceTableSlotCell(e, f, d, o);
					g && (fb(g, t, i, n.lastRow, n.lastColumn, o), l.push(g), d = o.createPositionAfter(g))
				}
				const u = parseInt(i.getAttribute("headingRows") || 0),
					h = parseInt(i.getAttribute("headingColumns") || 0),
					f = n.firstRow < u && u <= n.lastRow,
		...
		function ew(e, t, i, n, o = 0) {
			if (t < 1) return;
			return lb(e, t, o).filter(({
				column: e,
				cellWidth: t
			}) => iw(e, t, i)).map(({
				cell: e
		...
		class nw extends Qe {
			...
			init() {
				const e = this.editor.editing.view.document;
				this.editor.keystrokes.set("Tab", (...e) => this._handleTabOnSelectedTable(...e), {
					priority: "low"
			...
			_handleTabOnSelectedTable(e, t) {
				...
				n && n.is("element", "table") && (t(), i.model.change(e => {
			...
			_getTabHandler(e) {
				const t = this.editor;
				return (i, n) => {
					let o = Qp(t.model.document.selection)[0];
					if (o || (o = this.editor.plugins.get("TableSelection").getFocusCell()), !o) return;
					n();
					const r = o.parent,
						s = r.parent,
						a = s.getChildIndex(r),
						c = r.getChildIndex(o),
						l = 0 === c;
					if (!e && l && 0 === a) return void t.model.change(e => {
						e.setSelection(e.createRangeOn(s))
					});
					const d = c === r.childCount - 1,
						u = a === s.childCount - 1;
					if (e && u && d && (t.execute("insertTableRowBelow"), a === s.childCount - 1)) return void t.model.change(e => {
						e.setSelection(e.createRangeOn(s))
					});
					let h;
					if (e && d) {
						const e = s.getChild(a + 1);
						h = e.getChild(0)
					} else if (!e && l) {
						const e = s.getChild(a - 1);
						h = e.getChild(e.childCount - 1)
					} else h = r.getChild(c + (e ? 1 : -1));
					t.model.change(e => {
			...
			_onArrowKey(e, t) {
				const i = this.editor,
					n = Lo(t.keyCode, i.locale.contentLanguageDirection);
				this._handleArrowKeys(n, t.shiftKey) && (t.preventDefault(), t.stopPropagation(), e.stop())
			}
			_handleArrowKeys(e, t) {
				const i = this.editor.model.document.selection,
					n = ["right", "down"].includes(e),
					o = Kp(i);
				if (o.length) {
					let i;
					return i = t ? this.editor.plugins.get("TableSelection").getFocusCell() : n ? o[o.length - 1] : o[0], this._navigateFromCellInDirection(i, e, t), !0
				}
				const r = i.focus.findAncestor("tableCell");
				return !!r && (!(t && !i.isCollapsed && i.isBackward == n) && (!!this._isSelectionAtCellEdge(i, r, n) && (this._navigateFromCellInDirection(r, e, t), !0)))
			}
			...
			_navigateFromCellInDirection(e, t, i = !1) {
				...
				if (l < 0 || l > s || d < 0 && l <= 0 || d > a && l >= s) return void n.change(e => {
					e.setSelection(e.createRangeOn(o))
				});
				d < 0 ? (d = i ? 0 : a, l--) : d > a && (d = i ? a : 0, l++);
				const u = r.find(e => e.row == l && e.column == d).cell,
					h = ["right", "down"].includes(t),
					f = this.editor.plugins.get("TableSelection");
				if (i && f.isEnabled) {
					const t = f.getAnchorCell() || e;
					f.setCellSelection(t, u)
				} else {
		...
		class rw extends Qe {
			...
			init() {
				this.editor.editing.view.addObserver(ow), this._enableShiftClickSelection(), this._enableMouseDragSelection()
			}
			_enableShiftClickSelection() {
				const e = this.editor;
				let t = !1;
				const i = e.plugins.get(Zb);
				this.listenTo(e.editing.view.document, "mousedown", (n, o) => {
					if (!this.isEnabled || !i.isEnabled) return;
					if (!o.domEvent.shiftKey) return;
					const r = i.getAnchorCell() || Qp(e.model.document.selection)[0];
					if (!r) return;
					const s = this._getModelTableCellFromDomEvent(o);
					s && sw(r, s) && (t = !0, i.setCellSelection(r, s), o.preventDefault())
				}), this.listenTo(e.editing.view.document, "mouseup", () => {
					t = !1
				}), this.listenTo(e.editing.view.document, "selectionChange", e => {
					t && e.stop()
				}, {
					priority: "highest"
				})
			...
			_enableMouseDragSelection() {
				...
				let t, i, n = !1,
					o = !1;
				const r = e.plugins.get(Zb);
				this.listenTo(e.editing.view.document, "mousedown", (e, i) => {
					this.isEnabled && r.isEnabled && (i.domEvent.shiftKey || i.domEvent.ctrlKey || i.domEvent.altKey || (t = this._getModelTableCellFromDomEvent(i)))
					...
					a && sw(t, a) && (i = a, n || i == t || (n = !0)), n && (o = !0, r.setCellSelection(t, i), s.preventDefault())
				}), this.listenTo(e.editing.view.document, "mouseup", () => {
			...
			_getModelTableCellFromDomEvent(e) {
				...
				return this.editor.editing.mapper.toModelPosition(i).parent.findAncestor("tableCell", {
					includeSelf: !0
				})
			}
		}
		...
		function cw(e) {
			...
			}("table", e.getFirstPosition());
			return t && lw(t.parent) ? t.parent : null
		}

		function lw(e) {
			return !!e.getCustomProperty("table") && Vu(e)
		}
		const dw = {
			autoRefresh: !0
		};
		class uw {
				...
				t.initValue && this._validateTokenValue(t.initValue), this.set("value", t.initValue), this._refresh = "function" == typeof e ? e : () => {
					return t = e, new Promise((e, i) => {
						...
						n.open("GET", t), n.addEventListener("load", () => {
							const t = n.status,
								o = n.response;
							return t < 200 || t > 299 ? i(new c.a("token-cannot-download-new-token", null)) : e(o)
						}), n.addEventListener("error", () => i(new Error("Network Error"))), n.addEventListener("abort", () => i(new Error("Abort"))), n.send()
					});
					var t
				}, this._options = Object.assign({}, dw, t)
			}
			init() {
			...
			refreshToken() {
				return this._refresh().then(e => {
					this._validateTokenValue(e), this.set("value", e), this._options.autoRefresh && this._registerRefreshTokenTimeout()
				}).then(() => this)
			}
			destroy() {
			...
			_validateTokenValue(e) {
				...
				if (!i || !n) throw new c.a("token-not-in-jwt-format", this)
			}
			...
			static create(e, t = dw) {
				return new uw(e, t).init()
			}
		}
		Ke(uw, Ue);
		var hw = uw;
		const fw = /^data:(\S*?);base64,/;
		class gw {
			constructor(e, t, i) {
				if (!e) throw new c.a("fileuploader-missing-file", null);
				if (!t) throw new c.a("fileuploader-missing-token", null);
				if (!i) throw new c.a("fileuploader-missing-api-address", null);
				this.file = function (e) {
					...
					try {
						const i = e.match(fw)[1],
							n = atob(e.replace(fw, "")),
							o = [];
						for (let e = 0; e < n.length; e += t) {
							const i = n.slice(e, e + t),
				...
				}(e) : e, this._token = t, this._apiAddress = i
			}
			onProgress(e) {
			...
			_attachXHRListeners() {
				...
				t.addEventListener("error", i("Network Error")), t.addEventListener("abort", i("Abort")), t.upload && t.upload.addEventListener("progress", e => {
					...
					const e = t.status,
						i = t.response;
					if (e < 200 || e > 299) return this.fire("error", i.message || i.error)
				})
			}
			_sendRequest() {
				const e = new FormData,
					t = this.xhr;
				return e.append("file", this.file), new Promise((i, n) => {
					t.addEventListener("load", () => {
						const e = t.status,
							o = t.response;
						return e < 200 || e > 299 ? o.message ? n(new c.a("fileuploader-uploading-data-failed", this, {
							message: o.message
						})) : n(o.error) : i(o)
					}), t.addEventListener("error", () => n(new Error("Network Error"))), t.addEventListener("abort", () => n(new Error("Abort"))), t.send(e)
				})
			}
		}
		Ke(gw, u);
		class mw {
			...
			upload(e) {
				return new gw(e, this._token, this._apiAddress)
			}
		}
		class pw extends an {
			static get pluginName() {
		...
		class bw extends _u {}
		bw.builtinPlugins = [class extends Qe {
			static get requires() {
				return [gh, Su, Ah, wh, Nh, cf]
			}
			static get pluginName() {
				return "Essentials"
			}
			...
			init() {
				...
				e && (this.editor.plugins.get(df).createUploadAdapter = t => new mf(t, e, this.editor.t))
			}
		}, class extends Qe {
			static get pluginName() {
				return "Autoformat"
			...
			_addListAutoformats() {
				const e = this.editor.commands;
				e.get("bulletedList") && pf(this.editor, this, /^[*-]\s$/, "bulletedList"), e.get("numberedList") && pf(this.editor, this, /^1[.|)]\s$/, "numberedList"), e.get("todoList") && pf(this.editor, this, /^\[\s?\]\s$/, "todoList"), e.get("checkTodoList") && pf(this.editor, this, /^\[\s?x\s?\]\s$/, () => {
			...
			_addBasicStylesAutoformats() {
				const e = this.editor.commands;
				if (e.get("bold")) {
					const e = kf(this.editor, "bold");
					bf(this.editor, this, /(?:^|\s)(\*\*)([^*]+)(\*\*)$/g, e), bf(this.editor, this, /(?:^|\s)(__)([^_]+)(__)$/g, e)
				}
				if (e.get("italic")) {
					const e = kf(this.editor, "italic");
					bf(this.editor, this, /(?:^|\s)(\*)([^*_]+)(\*)$/g, e), bf(this.editor, this, /(?:^|\s)(_)([^_]+)(_)$/g, e)
				}
				if (e.get("code")) {
					const e = kf(this.editor, "code");
					bf(this.editor, this, /(`)([^`]+)(`)$/g, e)
				}
				if (e.get("strikethrough")) {
					const e = kf(this.editor, "strikethrough");
					bf(this.editor, this, /(~~)([^~]+)(~~)$/g, e)
				}
			}
			_addHeadingAutoformats() {
				const e = this.editor.commands.get("heading");
				e && e.modelElements.filter(e => e.match(/^heading[1-6]$/)).forEach(t => {
					const i = t[7],
						n = new RegExp(`^(#{${i}})\\s$`);
					pf(this.editor, this, n, () => {
			...
			_addBlockQuoteAutoformats() {
				this.editor.commands.get("blockQuote") && pf(this.editor, this, /^>\s$/, "blockQuote")
			}
			_addCodeBlockAutoformats() {
				this.editor.commands.get("codeBlock") && pf(this.editor, this, /^```$/, "codeBlock")
			}
			_addHorizontalLineAutoformats() {
				this.editor.commands.get("horizontalLine") && pf(this.editor, this, /^---$/, "horizontalLine")
			}
		}, class extends Qe {
			static get requires() {
				return [vf, yf]
			...
			static get requires() {
				return ["Image", "Link", "CKFinderUploadAdapter", Of, If]
			}
		}, class extends an {
			static get pluginName() {
			...
			registerTokenUrl(e) {
				...
				const t = this.context.plugins.get("CloudServicesCore").createToken(e);
			...
			afterInit() {
				const e = this.editor,
					t = e.t;
				e.plugins.get(qf).register("image", {
					ariaLabel: t("Image toolbar"),
					items: e.config.get("image.toolbar") || [],
					getRelatedElement: Xf
				})
			}
		}, class extends Qe {
			static get pluginName() {
			...
			init() {
				const e = this.editor,
					t = e.editing.view.document,
					i = [];
				i.push(new Sp(t)), i.push(new xp(t)), e.plugins.get("ClipboardPipeline").on("inputTransformation", (e, t) => {
					if (t.isTransformedWithPasteFromOffice) return;
					const n = t.dataTransfer.getData("text/html"),
						o = i.find(e => e.isActive(n));
					o && (o.execute(t), t.isTransformedWithPasteFromOffice = !0)
				}, {
					priority: "high"
				})
			}
			...
			afterInit() {
				...
				n && i.register("tableContent", {
					...
					items: n,
					getRelatedElement: cw
				}), o && i.register("table", {
					ariaLabel: t("Table toolbar"),
					items: o,
					getRelatedElement: aw
				})
			}
		}, class extends Qe {
			static get pluginName() {
				...
				const e = this.editor,
					...
					n = function (e) {
						...
						return function (e) {
							...
							for (const i of e)
								if (Wh[i])
									for (const e of Wh[i]) t.add(e);
								else t.add(i);
							return Array.from(t)
						}(e.include.concat(t).filter(n)).filter(n).map(e => Uh[e] || e).map(e => ({
							from: $h(e.from),
							to: Yh(e.to)
						}))
					...
					o = new Oh(e.model, e => {
						for (const t of n) {
							if (t.from.test(e)) return {
								normalizedTransformation: t
							}
						}
					});
				o.on("matched:data", (e, n) => {
					if (!i.isInput(n.batch)) return;
					const {
						from: o,
						to: r
					} = n.normalizedTransformation, s = o.exec(n.text), a = r(s.slice(1)), c = n.range;
					let l = s.index;
					t.enqueueChange(e => {
						for (let i = 1; i < s.length; i++) {
							...
							const r = c.start.getShiftedBy(l),
								d = t.createRange(r, r.getShiftedBy(n.length)),
								u = Gh(r);
